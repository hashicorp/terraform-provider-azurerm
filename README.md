...
TF_PARL is used to run all tests in parallel, TF_PARL_NUM is used to define the 
number of paralleled tests to run, and TESTARGS is used to pass extra
testing arguments like below.
