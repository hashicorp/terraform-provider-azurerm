...
import (
	...
	managementgroups "github.com/Azure/azure-sdk-for-go/services/preview/resources/mgmt/2018-03-01-preview/management"
...
func getArmClient(c *authentication.Config, skipProviderRegistration bool) (*ArmClient, error) {
	...
	client.registerDataFactoryClients(endpoint, c.SubscriptionID, auth, sender)
...
func (c *ArmClient) registerDataFactoryClients(endpoint, subscriptionId string, auth autorest.Authorizer, sender autorest.Sender) {
