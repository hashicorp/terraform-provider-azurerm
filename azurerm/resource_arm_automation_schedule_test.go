		...
		Steps: []resource.TestStep{
			{
				...
				Check:  testCheckAzureRMAutomationScheduleExists(resourceName),
			},
			{
...
resource "azurerm_automation_schedule" "test" {
  name                    = "${azurerm_automation_schedule.import.name}"
  resource_group_name     = "${azurerm_automation_schedule.import.resource_group_name}"
  automation_account_name = "${azurerm_automation_schedule.import.automation_account_name}"
  frequency               = "${azurerm_automation_schedule.import.frequency}"
}
`, template)
}
