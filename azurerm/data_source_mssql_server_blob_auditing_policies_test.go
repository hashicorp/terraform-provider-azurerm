...
func TestAccDataSourceAzureRMMsSqlServerBlobAuditingPolicies_basic(t *testing.T) {
	dataSourceName := "data.azurerm_mssql_server_blob_auditing_policies.test"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceAzureRMMsSqlServerBlobAuditingPolicies_basic(ri, location),
...
func testAccDataSourceAzureRMMsSqlServerBlobAuditingPolicies_basic(rInt int, location string) string {
