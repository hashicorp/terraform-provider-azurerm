...
func TestAccDataSourceAzureRMMsSqlDatabaseBlobExtendedAuditingPolicies_basic(t *testing.T) {
	dataSourceName := "data.azurerm_mssql_database_blob_extended_auditing_policies.test"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceAzureRMMsSqlDatabaseBlobExtendedAuditingPolicies_basic(ri, location),
...
func testAccDataSourceAzureRMMsSqlDatabaseBlobExtendedAuditingPolicies_basic(rInt int, location string) string {
