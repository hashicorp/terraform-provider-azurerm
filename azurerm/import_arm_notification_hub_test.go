...
func TestAccAzureRMNotificationHub_importBasic(t *testing.T) {
...
func TestAccAzureRMNotificationHub_importTags(t *testing.T) {
	resourceName := "azurerm_notification_hub.test"
...
func TestAccAzureRMNotificationHub_importAPNS(t *testing.T) {
	resourceName := "azurerm_notification_hub.test"
