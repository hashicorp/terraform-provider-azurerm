...
func resourceArmDnsCaaRecordRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err := d.Set("record", flattenAzureRmDnsCaaRecords(resp.SrvRecords)); err != nil {
		return err
	}
...
func flattenAzureRmDnsCaaRecords(records *[]dns.SrvRecord) []map[string]interface{} {
...
func expandAzureRmDnsCaaRecords(d *schema.ResourceData) ([]dns.SrvRecord, error) {
