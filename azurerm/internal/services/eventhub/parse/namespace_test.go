...
func TestNamespaceIDFormatter(t *testing.T) {
	actual := NewNamespaceID("12345678-1234-9876-4563-123456789012", "group1", "namespace1").ID("")
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/group1/providers/Microsoft.EventHub/namespaces/namespace1"
	if actual != expected {
