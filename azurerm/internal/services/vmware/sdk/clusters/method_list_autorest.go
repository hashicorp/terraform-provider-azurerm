...
func (c ClustersClient) preparerForList(ctx context.Context, id PrivateCloudId) (*http.Request, error) {
...
func (c ClustersClient) responderForList(resp *http.Response) (result ListResponse, err error) {
	type page struct {
