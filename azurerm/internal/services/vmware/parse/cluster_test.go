...
func TestClusterIDFormatter(t *testing.T) {
	actual := NewClusterID("12345678-1234-9876-4563-123456789012", "group1", "privateCloud1", "cluster1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/group1/providers/Microsoft.AVS/privateClouds/privateCloud1/clusters/cluster1"
	if actual != expected {
