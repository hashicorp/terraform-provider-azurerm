...
//go:generate go run ../../tools/generator-resource-id/main.go -path=./ -name=ManagementGroupTemplateDeployment -id=/providers/Microsoft.Management/managementGroups/my-management-group-id/providers/Microsoft.Resources/deployments/deploy1
...
//go:generate go run ../../tools/generator-resource-id/main.go -path=./ -name=TenantTemplateDeployment -id=/providers/Microsoft.Resources/deployments/deploy1
