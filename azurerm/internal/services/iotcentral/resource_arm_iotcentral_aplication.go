...
func resourceArmIotCentral() *schema.Resource {
	return &schema.Resource{
		Create: resourceArmIotCentralAppForCreate,
...
func resourceArmIotCentralAppForCreate(d *schema.ResourceData, meta interface{}) error {
