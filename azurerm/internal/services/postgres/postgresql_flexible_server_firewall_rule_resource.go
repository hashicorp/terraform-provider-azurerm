...
func resourcePostgresqlFlexibleServerFirewallRule() *schema.Resource {
...
func resourcePostgresqlFlexibleServerFirewallRuleCreateUpdate(d *schema.ResourceData, meta interface{}) error {
...
func resourcePostgresqlFlexibleServerFirewallRuleRead(d *schema.ResourceData, meta interface{}) error {
	subscriptionId := meta.(*clients.Client).Account.SubscriptionId
	client := meta.(*clients.Client).Postgres.FlexibleServerFirewallRuleClient
...
func resourcePostgresqlFlexibleServerFirewallRuleDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*clients.Client).Postgres.FlexibleServerFirewallRuleClient
