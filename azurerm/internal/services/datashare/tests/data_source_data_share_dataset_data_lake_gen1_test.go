		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(data.ResourceName, "data_lake_store.0.name"),
					resource.TestCheckResourceAttrSet(data.ResourceName, "data_lake_store.0.resource_group_name"),
					resource.TestCheckResourceAttrSet(data.ResourceName, "data_lake_store.0.subscription_id"),
