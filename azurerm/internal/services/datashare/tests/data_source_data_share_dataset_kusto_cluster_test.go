...
func TestAccDataSourceAzureRMDataShareDatasetKustoCluster_basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceDataShareDatasetKustoCluster_basic(data),
...
func testAccDataSourceDataShareDatasetKustoCluster_basic(data acceptance.TestData) string {
