...
resource "azurerm_data_share_dataset_data_lake_gen1" "test" {
  ...
  data_lake_store_name                = azurerm_data_lake_store.test.name
  data_lake_store_resource_group_name = azurerm_data_lake_store.test.resource_group_name
  data_lake_store_subscription_id     = "%s"
...
resource "azurerm_data_share_dataset_data_lake_gen1" "import" {
  ...
  share_id                            = azurerm_data_share.test.id
  data_lake_store_name                = azurerm_data_share_dataset_data_lake_gen1.test.data_lake_store_name
  data_lake_store_resource_group_name = azurerm_data_share_dataset_data_lake_gen1.test.data_lake_store_resource_group_name
  data_lake_store_subscription_id     = azurerm_data_share_dataset_data_lake_gen1.test.data_lake_store_subscription_id
