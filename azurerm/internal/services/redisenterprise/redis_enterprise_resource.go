...
func resourceRedisEnterprise() *schema.Resource {
	return &schema.Resource{
		Create: resourceRedisEnterpriseCreate,
		Read:   resourceRedisEnterpriseRead,
		Delete: resourceRedisEnterpriseDelete,
...
func resourceRedisEnterpriseCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceRedisEnterpriseRead(d, meta)
}

func resourceRedisEnterpriseRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*clients.Client).Redis.LinkedServerClient
...
func resourceRedisEnterpriseDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*clients.Client).Redis.LinkedServerClient
