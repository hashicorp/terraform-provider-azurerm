...
var _ resourceid.Formatter = HealthbotId{}

func TestHealthbotIDFormatter(t *testing.T) {
	actual := NewHealthbotID("12345678-1234-9876-4563-123456789012", "resourceGroup1", "bot1").ID()
...
func TestHealthbotID(t *testing.T) {
	...
	for _, v := range testData {
		...
		actual, err := HealthbotID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
