...
func resourceArmFrontDoorRulesEngine() *schema.Resource {
	return &schema.Resource{
		Create: resourceArmFrontDoorRulesEngineCreateUpdate,
		Read:   resourceArmFrontDoorRulesEngineRead,
		Update: resourceArmFrontDoorRulesEngineCreateUpdate,
		Delete: resourceArmFrontDoorRulesEngineDelete,
						...
						"action": {
							...
							Elem: &schema.Schema{
								...
								ValidateFunc: validation.StringInSlice([]string{
									string(frontdoor.RulesEngineOperatorEqual),
									string(frontdoor.RulesEngineOperator),
								}, false),
							},
						},
						"patterns_to_match": {
...
func resourceArmFrontDoorRulesEngineCreateUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	for _, v := range frontendEndpoints {
		...
		if properties := resp.FrontendEndpointProperties; properties != nil {
			...
			err := resourceArmFrontDoorRulesEngineFrontendEndpointCustomHttpsConfigurationUpdate(ctx, *resp.ID, customHttpsProvisioningEnabled, name, frontendEndpointName, resourceGroup, properties.CustomHTTPSProvisioningState, properties.CustomHTTPSConfiguration, customHttpsConfigurationNew, meta)
			if err != nil {
	...
	return resourceArmFrontDoorRulesEngineRead(d, meta)
}

func resourceArmFrontDoorRulesEngineRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*clients.Client).Frontdoor.FrontDoorsClient
...
func resourceArmFrontDoorRulesEngineDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*clients.Client).Frontdoor.FrontDoorsClient
