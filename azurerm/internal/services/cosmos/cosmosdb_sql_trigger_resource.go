...
func resourceCosmosDbSQLTrigger() *schema.Resource {
...
func resourceCosmosDbSQLTriggerCreateUpdate(d *schema.ResourceData, meta interface{}) error {
...
func resourceCosmosDbSQLTriggerRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*clients.Client).Cosmos.SqlResourceClient
...
func resourceCosmosDbSQLTriggerDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*clients.Client).Cosmos.SqlResourceClient
