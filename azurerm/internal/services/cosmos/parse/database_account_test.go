...
var _ resourceid.Formatter = DatabaseAccountId{}

func TestDatabaseAccountIDFormatter(t *testing.T) {
	actual := NewDatabaseAccountID("12345678-1234-9876-4563-123456789012", "resGroup1", "acc1").ID("")
