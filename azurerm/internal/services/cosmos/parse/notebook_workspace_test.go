...
var _ resourceid.Formatter = NotebookWorkspaceId{}

func TestNotebookWorkspaceIDFormatter(t *testing.T) {
	actual := NewNotebookWorkspaceID("12345678-1234-9876-4563-123456789012", "resourceGroup1", "account1", "notebookWorkspace1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resourceGroup1/providers/Microsoft.DocumentDB/databaseAccounts/account1/notebookWorkspaces/notebookWorkspace1"
	if actual != expected {
...
func TestNotebookWorkspaceID(t *testing.T) {
	...
	for _, v := range testData {
		...
		actual, err := NotebookWorkspaceID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
