...
var _ resourceid.Formatter = EmbeddedId{}

func TestEmbeddedIDFormatter(t *testing.T) {
	actual := NewEmbeddedID("12345678-1234-9876-4563-123456789012", "resGroup1", "capacity1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.PowerBIDedicated/capacities/capacity1"
	if actual != expected {
