...
func (r Registration) SupportedDataSources() map[string]*schema.Resource {
	return map[string]*schema.Resource{
		...
		"azurerm_monitor_scheduled_query_rules_action": dataSourceArmMonitorScheduledQueryRulesAction(),
...
func (r Registration) SupportedResources() map[string]*schema.Resource {
	return map[string]*schema.Resource{
		...
		"azurerm_monitor_scheduled_query_rules_action": resourceArmMonitorScheduledQueryRulesAction(),
