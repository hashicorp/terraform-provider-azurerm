...
func TestAccAzureRMRecoveryNetworkMapping_basic(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_recovery_network_mapping", "test")
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccAzureRMRecoveryNetworkMapping_basic(data),
				Check: resource.ComposeTestCheckFunc(
					testCheckAzureRMRecoveryNetworkMappingExists(data.ResourceName),
				),
			},
			data.ImportStep(),
		},
