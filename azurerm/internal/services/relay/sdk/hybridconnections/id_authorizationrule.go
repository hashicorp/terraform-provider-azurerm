...
func NewAuthorizationRuleID(subscriptionId, resourceGroup, namespaceName, hybridConnectionName, name string) AuthorizationRuleId {
...
func (id AuthorizationRuleId) ID() string {
	...
	return fmt.Sprintf(fmtString, id.SubscriptionId, id.ResourceGroup, id.NamespaceName, id.HybridConnectionName, id.Name)
}
...
func ParseAuthorizationRuleID(input string) (*AuthorizationRuleId, error) {
	...
	if resourceId.HybridConnectionName, err = id.PopSegment("hybridConnections"); err != nil {
		return nil, err
	}
...
func ParseAuthorizationRuleIDInsensitively(input string) (*AuthorizationRuleId, error) {
	...
	if resourceId.HybridConnectionName, err = id.PopSegment(hybridConnectionsKey); err != nil {
		return nil, err
	}
