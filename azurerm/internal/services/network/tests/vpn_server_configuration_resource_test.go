...
func TestAccAzureRMVPNServerConfiguration_radius(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccAzureRMAzureRMVPNServerConfiguration_singleRadiusDeprecated(data),
				Check: resource.ComposeTestCheckFunc(
					testCheckAzureRMVPNServerConfigurationExists(data.ResourceName),
				),
			},
...
func TestAccAzureRMVPNServerConfiguration_multipleRadius(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			data.ImportStep(),
			{
				Config: testAccAzureRMAzureRMVPNServerConfiguration_singleRadius(data),
				Check: resource.ComposeTestCheckFunc(
					testCheckAzureRMVPNServerConfigurationExists(data.ResourceName),
				),
			},
			data.ImportStep(),
			{
				Config: testAccAzureRMAzureRMVPNServerConfiguration_multipleRadius(data),
				Check: resource.ComposeTestCheckFunc(
					testCheckAzureRMVPNServerConfigurationExists(data.ResourceName),
				),
			},
...
func testAccAzureRMAzureRMVPNServerConfiguration_singleRadiusDeprecated(data acceptance.TestData) string {
	template := testAccAzureRMAzureRMVPNServerConfiguration_template(data)
	return fmt.Sprintf(`
%s
...
func testAccAzureRMAzureRMVPNServerConfiguration_singleRadius(data acceptance.TestData) string {
	template := testAccAzureRMAzureRMVPNServerConfiguration_template(data)
	return fmt.Sprintf(`
%s
...
func testAccAzureRMAzureRMVPNServerConfiguration_multipleRadius(data acceptance.TestData) string {
	template := testAccAzureRMAzureRMVPNServerConfiguration_template(data)
	return fmt.Sprintf(`
%s
