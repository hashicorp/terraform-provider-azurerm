...
func resourceNetworkInterfaceApplicationSecurityGroupAssociationUpgradeV0ToV1(ctx context.Context, rawState map[string]interface{}, _ interface{}) (map[string]interface{}, error) {
