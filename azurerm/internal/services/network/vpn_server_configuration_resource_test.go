...
func TestAccVPNServerConfiguration_certificate(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_vpn_server_configuration", "test")
	r := VPNServerConfigurationResource{}
	...
	data.ResourceTest(t, r, []resource.TestStep{
		...
		data.ImportStep(),
		{
			Config: r.certificateUpdated(data),
			Check: resource.ComposeTestCheckFunc(
				check.That(data.ResourceName).ExistsInAzure(r),
			),
		},
...
func TestAccVPNServerConfiguration_requiresImport(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_vpn_server_configuration", "test")
	r := VPNServerConfigurationResource{}
...
func TestAccVPNServerConfiguration_radius(t *testing.T) {
	...
	data.ResourceTest(t, r, []resource.TestStep{
		{
			Config: r.singleRadiusDeprecated(data),
			Check: resource.ComposeTestCheckFunc(
				check.That(data.ResourceName).ExistsInAzure(r),
			),
		},
...
func TestAccVPNServerConfiguration_multipleAuth(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_vpn_server_configuration", "test")
	r := VPNServerConfigurationResource{}
...
func TestAccVPNServerConfiguration_tags(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_vpn_server_configuration", "test")
	r := VPNServerConfigurationResource{}
...
func (t VPNServerConfigurationResource) Exists(ctx context.Context, clients *clients.Client, state *terraform.InstanceState) (*bool, error) {
	id, err := ParseVpnServerConfigurationID(state.ID)
	if err != nil {
		return nil, err
	}

	resp, err := clients.Network.VpnServerConfigurationsClient.Get(ctx, id.ResourceGroup, id.Name)
	if err != nil {
		return nil, fmt.Errorf("reading Vpn Server Configuration (%s): %+v", id, err)
	}

	return utils.Bool(resp.ID != nil), nil
}

func (r VPNServerConfigurationResource) azureAD(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
func (r VPNServerConfigurationResource) certificate(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
func (r VPNServerConfigurationResource) certificateUpdated(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
func (r VPNServerConfigurationResource) singleRadiusDeprecated(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
func (r VPNServerConfigurationResource) singleRadius(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
func (r VPNServerConfigurationResource) multipleRadius(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
func (r VPNServerConfigurationResource) requiresImport(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
func (r VPNServerConfigurationResource) tags(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
