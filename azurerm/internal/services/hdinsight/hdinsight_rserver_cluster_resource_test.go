...
func TestAccHDInsightRServerCluster_requiresImport(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_hdinsight_rserver_cluster", "test")
	r := HDInsightRServerClusterResource{}
...
func (t HDInsightRServerClusterResource) Exists(ctx context.Context, clients *clients.Client, state *terraform.InstanceState) (*bool, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("reading HDInsight R Server Cluster (%s): %+v", id.String(), err)
	}

	return utils.Bool(resp.ID != nil), nil
}

func (r HDInsightRServerClusterResource) basic(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
func (r HDInsightRServerClusterResource) requiresImport(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
func (r HDInsightRServerClusterResource) sshKeys(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
func (r HDInsightRServerClusterResource) updated(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
func (r HDInsightRServerClusterResource) virtualNetwork(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
func (r HDInsightRServerClusterResource) complete(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
func (HDInsightRServerClusterResource) template(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {}
}
...
func (r HDInsightRServerClusterResource) tls(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
