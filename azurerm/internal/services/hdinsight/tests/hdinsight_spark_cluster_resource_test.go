...
func TestAccAzureRMHDInsightSparkCluster_autoscale(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccAzureRMHDInsightSparkCluster_autoscale_capacity(data),
				Check: resource.ComposeTestCheckFunc(
					testCheckAzureRMHDInsightClusterExists(data.ResourceName),
					resource.TestCheckResourceAttrSet(data.ResourceName, "https_endpoint"),
					resource.TestCheckResourceAttrSet(data.ResourceName, "ssh_endpoint"),
			...
			data.ImportStep("roles.0.head_node.0.password",
				...
				"storage_account"),
			{
				Config: testAccAzureRMHDInsightSparkCluster_autoscale_schedule(data),
				Check: resource.ComposeTestCheckFunc(
					testCheckAzureRMHDInsightClusterExists(data.ResourceName),
					resource.TestCheckResourceAttrSet(data.ResourceName, "https_endpoint"),
					resource.TestCheckResourceAttrSet(data.ResourceName, "ssh_endpoint"),
...
func testAccAzureRMHDInsightSparkCluster_autoscale_capacity(data acceptance.TestData) string {
	template := testAccAzureRMHDInsightSparkCluster_template(data)
	return fmt.Sprintf(`
%s
...
func testAccAzureRMHDInsightSparkCluster_autoscale_schedule(data acceptance.TestData) string {
	template := testAccAzureRMHDInsightSparkCluster_template(data)
	return fmt.Sprintf(`
%s
