...
func TestAccAzureRMHDInsightHadoopCluster_scriptActions(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccAzureRMHDInsightHadoopCluster_scriptActions(data),
				Check: resource.ComposeTestCheckFunc(
					testCheckAzureRMHDInsightClusterExists(data.ResourceName),
					resource.TestCheckResourceAttrSet(data.ResourceName, "https_endpoint"),
					resource.TestCheckResourceAttrSet(data.ResourceName, "ssh_endpoint"),
			...
			{
				Config: testAccAzureRMHDInsightHadoopCluster_scriptActionsUpdate(data),
				Check: resource.ComposeTestCheckFunc(
					testCheckAzureRMHDInsightClusterExists(data.ResourceName),
					resource.TestCheckResourceAttrSet(data.ResourceName, "https_endpoint"),
					resource.TestCheckResourceAttrSet(data.ResourceName, "ssh_endpoint"),
...
func testAccAzureRMHDInsightHadoopCluster_scriptActions(data acceptance.TestData) string {
	template := testAccAzureRMHDInsightHadoopCluster_template(data)
	return fmt.Sprintf(`
%s
...
func testAccAzureRMHDInsightHadoopCluster_scriptActionsUpdate(data acceptance.TestData) string {
	template := testAccAzureRMHDInsightHadoopCluster_template(data)
	return fmt.Sprintf(`
%s
