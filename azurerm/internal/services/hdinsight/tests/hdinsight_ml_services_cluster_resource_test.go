...
func TestAccAzureRMHDInsightMLServicesCluster_allMetastores(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_hdinsight_ml_services_cluster", "test")
	resource.ParallelTest(t, resource.TestCase{
		PreCheck:     func() { acceptance.PreCheck(t) },
		Providers:    acceptance.SupportedProviders,
		...
		Steps: []resource.TestStep{
			{
				Config: testAccAzureRMHDInsightMLServicesCluster_allMetastores(data),
				Check: resource.ComposeTestCheckFunc(
					testCheckAzureRMHDInsightClusterExists(data.ResourceName),
					resource.TestCheckResourceAttrSet(data.ResourceName, "edge_ssh_endpoint"),
					resource.TestCheckResourceAttrSet(data.ResourceName, "https_endpoint"),
...
func TestAccAzureRMHDInsightMLServicesCluster_hiveMetastore(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_hdinsight_ml_services_cluster", "test")
	resource.ParallelTest(t, resource.TestCase{
		PreCheck:     func() { acceptance.PreCheck(t) },
		Providers:    acceptance.SupportedProviders,
		...
		Steps: []resource.TestStep{
			{
				Config: testAccAzureRMHDInsightMLServicesCluster_hiveMetastore(data),
				Check: resource.ComposeTestCheckFunc(
					testCheckAzureRMHDInsightClusterExists(data.ResourceName),
					resource.TestCheckResourceAttrSet(data.ResourceName, "edge_ssh_endpoint"),
					resource.TestCheckResourceAttrSet(data.ResourceName, "https_endpoint"),
...
func TestAccAzureRMHDInsightMLServicesCluster_updateMetastore(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_hdinsight_ml_services_cluster", "test")
	resource.ParallelTest(t, resource.TestCase{
		PreCheck:     func() { acceptance.PreCheck(t) },
		Providers:    acceptance.SupportedProviders,
...
func testAccAzureRMHDInsightMLServicesCluster_allMetastores(data acceptance.TestData) string {
	template := testAccAzureRMHDInsightMLServicesCluster_template(data)
	return fmt.Sprintf(`
%s
...
func testAccAzureRMHDInsightMLServicesCluster_hiveMetastore(data acceptance.TestData) string {
	template := testAccAzureRMHDInsightMLServicesCluster_template(data)
	return fmt.Sprintf(`
%s
resource "azurerm_sql_server" "test" {
