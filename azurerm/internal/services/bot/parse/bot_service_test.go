...
var _ resourceid.Formatter = BotServiceId{}

func TestBotServiceIDFormatter(t *testing.T) {
	actual := NewBotServiceID("12345678-1234-9876-4563-123456789012", "resGroup1", "botService1").ID("")
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.BotService/botServices/botService1"
	if actual != expected {
...
func TestBotServiceID(t *testing.T) {
	...
	for _, v := range testData {
		...
		actual, err := BotServiceID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
