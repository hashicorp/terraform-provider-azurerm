...
func (t BotChannelMsTeamsResource) Exists(ctx context.Context, clients *clients.Client, state *terraform.InstanceState) (*bool, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("retrieving Bot Channel MS Teams (%s): %v", id.String(), err)
	}
