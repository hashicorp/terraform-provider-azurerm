...
import (
	...
	servicebusValidate "github.com/terraform-providers/terraform-provider-azurerm/azurerm/internal/services/servicebus/validate"
	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"namespace_name": {
				...
				Required:     true,
				ForceNew:     true,
				ValidateFunc: servicebusValidate.ServiceBusNamespaceName,
			},
