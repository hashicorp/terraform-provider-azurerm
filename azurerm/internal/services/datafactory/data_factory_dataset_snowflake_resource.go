...
func resourceDataFactoryDatasetSnowflake() *schema.Resource {
...
func resourceDataFactoryDatasetSnowflakeCreateUpdate(d *schema.ResourceData, meta interface{}) error {
...
func resourceDataFactoryDatasetSnowflakeRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*clients.Client).DataFactory.DatasetClient
...
func resourceDataFactoryDatasetSnowflakeDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*clients.Client).DataFactory.DatasetClient
