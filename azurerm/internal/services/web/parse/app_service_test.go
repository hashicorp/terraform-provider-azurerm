...
var _ resourceid.Formatter = AppServiceId{}

func TestAppServiceIDFormatter(t *testing.T) {
	actual := NewAppServiceID("12345678-1234-9876-4563-123456789012", "resGroup1", "site1").ID()
