...
func (r Registration) SupportedResources() map[string]*schema.Resource {
	return map[string]*schema.Resource{
		...
		"azurerm_automation_connection_certificate":         resourceArmAutomationConnectionCertificate(),
		"azurerm_automation_connection_classic_certificate": resourceArmAutomationConnectionClassicCertificate(),
		"azurerm_automation_connection_service_principal":   resourceArmAutomationConnectionServicePrincipal(),
