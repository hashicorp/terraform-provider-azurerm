...
func TestNodePoolIDFormatter(t *testing.T) {
	actual := NewNodePoolID("00000000-0000-0000-0000-000000000000", "resGroup1", "cluster1", "pool1").ID()
	expected := "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/resGroup1/providers/Microsoft.ContainerService/managedClusters/cluster1/agentPools/pool1"
	if actual != expected {
...
func TestNodePoolID(t *testing.T) {
	testData := []struct {
...

		{
			...
			Input: "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/resGroup1/providers/Microsoft.ContainerService/managedClusters/cluster1/agentPools/",
			Error: true,
		},

		{
			// valid
			Input: "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/resGroup1/providers/Microsoft.ContainerService/managedClusters/cluster1/agentPools/pool1",
			Expected: &NodePoolId{
