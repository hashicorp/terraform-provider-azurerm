...
func TestComputeIDFormatter(t *testing.T) {
	...
	expected := "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/resGroup1/providers/Microsoft.MachineLearningServices/workspaces/workspace1/computes/compute1"
	if actual != expected {
...
func TestComputeID(t *testing.T) {
	testData := []struct {
		...
		{
			// valid
			Input: "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/resGroup1/providers/Microsoft.MachineLearningServices/workspaces/workspace1/computes/compute1",
			Expected: &ComputeId{
