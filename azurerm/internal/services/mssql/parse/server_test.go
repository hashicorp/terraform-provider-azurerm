...
func TestServerIDFormatter(t *testing.T) {
	actual := NewServerID("12345678-1234-9876-4563-123456789012", "group1", "server1").ID("")
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/group1/providers/Microsoft.Sql/servers/server1"
	if actual != expected {
