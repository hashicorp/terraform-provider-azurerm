...
func TestMsSqlVmGroupID(t *testing.T) {
	testData := []struct {
		Name     string
		Input    string
		Expected *MssqlVmGroupId
	}{
		{
			Name:     "Empty",
			Input:    "",
		...
		{
			Name:     "Missing Ms Sql VM group Value",
			Input:    "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/resGroup1/providers/Microsoft.SqlVirtualMachine/sqlVirtualMachines/",
			Expected: nil,
		},
		{
			Name:  "Mssql VM Group ID",
			Input: "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/resGroup1/providers/Microsoft.SqlVirtualMachine/sqlVirtualMachineGroups/mssqlvmGroup1",
			Expected: &MssqlVmGroupId{
				Name:          "mssqlvmGroup1",
				ResourceGroup: "resGroup1",
			},
	...
	for _, v := range testData {
		...
		actual, err := MssqlVmGroupID(v.Input)
		if err != nil {
			if v.Expected == nil {
				continue
			}
