	...
	data.ResourceTest(t, r, []resource.TestStep{
		{
			...
			Check: resource.ComposeTestCheckFunc(
				...
				check.That(data.ResourceName).Key("credentials.0.header.header1").HasValue("header1,value1"),
				check.That(data.ResourceName).Key("credentials.0.header.header2").HasValue("header2,value1"),
				check.That(data.ResourceName).Key("credentials.0.query.query1").HasValue("query1,value1"),
				check.That(data.ResourceName).Key("credentials.0.query.query2").HasValue("query2,value1"),
