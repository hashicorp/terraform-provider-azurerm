...
func TestAccAzureRMVirtualMachineScaleSet_extension_with_settings(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_virtual_machine_scale_set", "test")
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccAzureRMVirtualMachineScaleSetExtensionTemplateOnlySettings(data),
				Check: resource.ComposeTestCheckFunc(
					testCheckAzureRMVirtualMachineScaleSetExists(data.ResourceName),
					testCheckAzureRMVirtualMachineScaleSetExtension(data.ResourceName),
				),
...
func TestAccAzureRMVirtualMachineScaleSet_extension_with_protected_settings(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_virtual_machine_scale_set", "test")
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccAzureRMVirtualMachineScaleSetExtensionTemplateOnlyProtectedSettings(data),
				Check: resource.ComposeTestCheckFunc(
					testCheckAzureRMVirtualMachineScaleSetExists(data.ResourceName),
					testCheckAzureRMVirtualMachineScaleSetExtension(data.ResourceName),
				),
...
func testAccAzureRMVirtualMachineScaleSetExtensionTemplateOnlySettings(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {}
}
...
func testAccAzureRMVirtualMachineScaleSetExtensionTemplateOnlyProtectedSettings(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {}
}
