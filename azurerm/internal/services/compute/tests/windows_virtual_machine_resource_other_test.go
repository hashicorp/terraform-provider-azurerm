		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					checkWindowsVirtualMachineExists(data.ResourceName),
					resource.TestCheckResourceAttr(data.ResourceName, "additional_capabilities.ultra_ssd_enabled", "false"),
				),
			},
			data.ImportStep(
				"admin_password",
...
func TestAccWindowsVirtualMachine_otherUltraSsdEnabled(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testWindowsVirtualMachine_otherUltraSsdDisabled(data),
				Check: resource.ComposeTestCheckFunc(
					checkWindowsVirtualMachineExists(data.ResourceName),
					resource.TestCheckResourceAttr(data.ResourceName, "additional_capabilities.ultra_ssd_enabled", "true"),
				),
			},
			data.ImportStep(
				"admin_password",
