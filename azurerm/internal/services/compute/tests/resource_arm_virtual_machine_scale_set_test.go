...
func TestAccAzureRMVirtualMachineScaleSet_basicPublicIP_simpleUpdate(t *testing.T) {
	...
	updatedConfig := testAccAzureRMVirtualMachineScaleSet_basicEmptyPublicIP_updated_tags(data)
...
func TestAccAzureRMVirtualMachineScaleSet_updateNetworkProfile(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_virtual_machine_scale_set", "test")
	config := testAccAzureRMVirtualMachineScaleSet_basicEmptyPublicIP(data)
	updatedConfig := testAccAzureRMVirtualMachineScaleSet_basicEmptyNetworkProfile_true_ipforwarding(data)
...
func TestAccAzureRMVirtualMachineScaleSet_updateNetworkProfile_ipconfiguration_dns_name_label(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_virtual_machine_scale_set", "test")
	config := testAccAzureRMVirtualMachineScaleSet_basicEmptyPublicIP(data)
	updatedConfig := testAccAzureRMVirtualMachineScaleSet_basicEmptyPublicIP_updatedDNS_label(data)
...
func TestAccAzureRMVirtualMachineScaleSet_verify_key_data_changed(t *testing.T) {
	...
	updatedConfig := testAccAzureRMVirtualMachineScaleSet_linuxKeyDataUpdated(data)
...
func TestAccAzureRMVirtualMachineScaleSet_linuxUpdated(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_virtual_machine_scale_set", "test")
	config := testAccAzureRMVirtualMachineScaleSet_linux(data)
	updatedConfig := testAccAzureRMVirtualMachineScaleSet_linuxUpdated(data)
...
func TestAccAzureRMVirtualMachineScaleSet_customDataUpdated(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_virtual_machine_scale_set", "test")
	config := testAccAzureRMVirtualMachineScaleSet_linux(data)
	updatedConfig := testAccAzureRMVirtualMachineScaleSet_linuxCustomDataUpdated(data)
...
func TestAccAzureRMVirtualMachineScaleSet_basicWindows_managedDisk_resize(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_virtual_machine_scale_set", "test")
	preConfig := testAccAzureRMVirtualMachineScaleSet_basicWindows_managedDisk(data, "Standard_D1_v2")
	postConfig := testAccAzureRMVirtualMachineScaleSet_basicWindows_managedDisk(data, "Standard_D2_v2")
	resource.ParallelTest(t, resource.TestCase{
		PreCheck:     func() { acceptance.PreCheck(t) },
		Providers:    acceptance.SupportedProviders,
		CheckDestroy: testCheckAzureRMVirtualMachineScaleSetDestroy,
...
func TestAccAzureRMVirtualMachineScaleSet_extensionUpdate(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_virtual_machine_scale_set", "test")
	config := testAccAzureRMVirtualMachineScaleSetExtensionTemplate(data)
	updatedConfig := testAccAzureRMVirtualMachineScaleSetExtensionTemplateUpdated(data)
	resource.ParallelTest(t, resource.TestCase{
		PreCheck:     func() { acceptance.PreCheck(t) },
		Providers:    acceptance.SupportedProviders,
		CheckDestroy: testCheckAzureRMVirtualMachineScaleSetDestroy,
...
func TestAccAzureRMVirtualMachineScaleSet_upgradeModeUpdate(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_virtual_machine_scale_set", "test")
	manualConfig := testAccAzureRMVirtualMachineScaleSet_upgradeModeUpdate(data, "Manual")
	automaticConfig := testAccAzureRMVirtualMachineScaleSet_upgradeModeUpdate(data, "Automatic")
	rollingConfig := testAccAzureRMVirtualMachineScaleSet_upgradeModeUpdate(data, "Rolling")
