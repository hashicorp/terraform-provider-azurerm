...
func TestAccWindowsVirtualMachine_scalingDedicatedHostGroup(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testWindowsVirtualMachine_scalingDedicatedHostGroup(data),
				Check: resource.ComposeTestCheckFunc(
					checkWindowsVirtualMachineExists(data.ResourceName),
				),
			},
...
func TestAccWindowsVirtualMachine_scalingDedicatedHostGroupUpdate(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testWindowsVirtualMachine_scalingDedicatedHostGroupUpdate(data),
				Check: resource.ComposeTestCheckFunc(
					checkWindowsVirtualMachineExists(data.ResourceName),
				),
			},
...
func testWindowsVirtualMachine_scalingDedicatedHostGroup(data acceptance.TestData) string {
	template := testWindowsVirtualMachine_template(data)
	return fmt.Sprintf(`
%s
...
func testWindowsVirtualMachine_scalingDedicatedHostGroupUpdate(data acceptance.TestData) string {
	template := testWindowsVirtualMachine_template(data)
	return fmt.Sprintf(`
%s
