...
func TestAccLinuxVirtualMachine_scalingDedicatedHostGroup(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testLinuxVirtualMachine_scalingDedicatedHostGroup(data),
				Check: resource.ComposeTestCheckFunc(
					checkLinuxVirtualMachineExists(data.ResourceName),
				),
			},
...
func TestAccLinuxVirtualMachine_scalingDedicatedHostGroupUpdate(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			data.ImportStep(),
			{
				Config: testLinuxVirtualMachine_scalingDedicatedHostGroupUpdate(data),
				Check: resource.ComposeTestCheckFunc(
					checkLinuxVirtualMachineExists(data.ResourceName),
				),
			},
...
func testLinuxVirtualMachine_scalingDedicatedHostGroup(data acceptance.TestData) string {
	template := testLinuxVirtualMachine_template(data)
	return fmt.Sprintf(`
%s
...
func testLinuxVirtualMachine_scalingDedicatedHostGroupUpdate(data acceptance.TestData) string {
	template := testLinuxVirtualMachine_template(data)
	return fmt.Sprintf(`
%s
