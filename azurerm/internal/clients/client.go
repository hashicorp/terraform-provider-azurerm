...
import (
	...
	managementpartner "github.com/terraform-providers/terraform-provider-azurerm/azurerm/internal/services/managementpartner/client"
...
type Client struct {
	...
	ManagementPartner *managementpartner.Client
	Maps              *maps.Client
...
func (client *Client) Build(ctx context.Context, o *common.ClientOptions) error {
	...
	client.ManagementPartner = managementpartner.NewClient(o)
