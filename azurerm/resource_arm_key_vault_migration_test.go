	...
	cases := map[string]struct {
		...
		"v0_1_read_only": {
			...
			Attributes: map[string]string{
				...
				"access_policy.0.storage_permissions.#":     "1",
				"access_policy.0.storage_permissions.0":     "Get",
			},
			Expected: map[string]string{
				"access_policy.#":                           "1",
				"access_policy.0.tenant_id":                 "abc123",
		...
		"v0_1_storage": {
			...
			Attributes: map[string]string{
				...
				"access_policy.0.secret_permissions.0":      "get",
				"access_policy.0.storage_permissions.#":     "1",
				"access_policy.0.storage_permissions.0":     "All",
			},
			Expected: map[string]string{
				"access_policy.#":                           "1",
				"access_policy.0.application_id":            "",
				...
				"access_policy.0.secret_permissions.#":      "1",
				"access_policy.0.secret_permissions.0":      "get",
				"access_policy.0.storage_permissions.#":     "14",
				"access_policy.0.storage_permissions.0":     "backup",
				"access_policy.0.storage_permissions.1":     "delete",
				"access_policy.0.storage_permissions.2":     "deletesas",
				"access_policy.0.storage_permissions.3":     "get",
				"access_policy.0.storage_permissions.4":     "getsas",
				"access_policy.0.storage_permissions.5":     "list",
				"access_policy.0.storage_permissions.6":     "listsas",
				"access_policy.0.storage_permissions.7":     "purge",
				"access_policy.0.storage_permissions.8":     "recover",
				"access_policy.0.storage_permissions.9":     "regeneratekey",
		...
		"v0_1_storage_multiple": {
			...
			Attributes: map[string]string{
				...
				"access_policy.0.secret_permissions.#":      "1",
				"access_policy.0.secret_permissions.0":      "get",
				"access_policy.0.storage_permissions.#":     "2",
				"access_policy.0.storage_permissions.0":     "all",
				"access_policy.0.storage_permissions.1":     "get",
			},
			Expected: map[string]string{
				"access_policy.#":                           "1",
				"access_policy.0.application_id":            "",
