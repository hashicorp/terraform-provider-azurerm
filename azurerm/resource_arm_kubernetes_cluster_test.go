...
func TestAccAzureRMKubernetesCluster_addonProfileOMSDisabled(t *testing.T) {
	resourceName := "azurerm_kubernetes_cluster.test"
	ri := tf.AccRandTimeInt()
	clientId := os.Getenv("ARM_CLIENT_ID")
	clientSecret := os.Getenv("ARM_CLIENT_SECRET")
	config := testAccAzureRMKubernetesCluster_addonProfileOMSDisabled(ri, clientId, clientSecret, testLocation())
