		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(resourceName, "kube_config.0.password"),
					resource.TestCheckResourceAttrSet(resourceName, "agent_pool_profile.0.max_pods"),
					resource.TestCheckResourceAttrSet(resourceName, "linux_pool_profile.0.admin_username"),
					resource.TestCheckResourceAttrSet(resourceName, "linux_pool_profile.0.ssh_key"),
				),
			},
		},
	})
