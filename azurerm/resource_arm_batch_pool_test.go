		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "container_configuration.0.container_registries.1857543351.registry_server", "myContainerRegistry.azurecr.io"),
					resource.TestCheckResourceAttr(resourceName, "container_configuration.0.container_registries.1857543351.user_name", "myUserName"),
					resource.TestCheckResourceAttr(resourceName, "container_configuration.0.container_registries.1857543351.password", "myPassword"),
				),
