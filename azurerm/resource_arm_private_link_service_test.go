		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "ip_configuration.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "ip_configuration.0.private_ip_address", "10.5.1.17"),
					resource.TestCheckResourceAttr(resourceName, "ip_configuration.0.private_ip_address_version", "IPv4"),
					resource.TestCheckResourceAttr(resourceName, "ip_configuration.0.private_ip_allocation_method", "Static"),
					resource.TestCheckResourceAttr(resourceName, "load_balancer_frontend_ip_configuration.#", "1"),
				),
			},
			{
