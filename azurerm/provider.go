...
func Provider() terraform.ResourceProvider {
	...
	dataSources := map[string]*schema.Resource{
		...
		"azurerm_mssql_server_blob_auditing_policies":          dataSourceArmMsSqlServerBlobAuditingPolicies(),
		"azurerm_mssql_server_blob_extended_auditing_policies": dataSourceArmMsSqlServerBlobExtendedAuditingPolicies(),
	...
	resources := map[string]*schema.Resource{
		...
		"azurerm_mssql_server_blob_auditing_policies":                                    resourceArmMsSqlServerBlobAuditingPolicies(),
		"azurerm_mssql_server_blob_extended_auditing_policies":                           resourceArmMsSqlServerBlobExtendedAuditingPolicies(),
