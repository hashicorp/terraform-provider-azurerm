...
func Provider() terraform.ResourceProvider {
	p := &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"azurerm_automation_bool_variable":              dataSourceArmAutomationBoolVariable(),
			"azurerm_automation_datetime_variable":          dataSourceArmAutomationDatetimeVariable(),
			"azurerm_automation_int_variable":               dataSourceArmAutomationIntVariable(),
			"azurerm_automation_string_variable":            dataSourceArmAutomationStringVariable(),
