...
* The `WEBSITE_VNET_ROUTE_ALL` app setting no longer controls `site_config.vnet_route_all_enabled`; use `vnet_application_traffic_enabled` to configure application traffic routing instead.
