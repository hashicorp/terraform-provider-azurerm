...
* The deprecated `inbound_network_dependencies` attribute has been removed because inboundNetworkDependenciesEndpoints is not supported for App Service Environment v3.
