...
* `principal_id` - (Required) The ID of the Principal (User, Group, Service Principal) to assign the Role Definition to. Changing this forces a new resource to be created.
