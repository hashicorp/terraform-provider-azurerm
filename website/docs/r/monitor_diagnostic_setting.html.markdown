...
-> **NOTE:** If this isn't specified then the default Event Hub will be used. While please note, if you do not specify this name, an event hub is created for each log category. 
