...
* `private_static_ip_address` - (Optional) The Static IP Address to assign to the Redis Cache when hosted inside the Virtual Network. This argument implies the use of the `subnet_id`. Changing this forces a new resource to be created.
