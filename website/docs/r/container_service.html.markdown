...
* `os_disk_size_gb` - (Optional) Specifies the size of the os disk in gigabytes. To be able to use this, you'll have to deploy to RPv2 regions, such as UK West, UK South, West Central US, West US 2,Canada East, Canada Central, West India, South India, Central India, Japan West.
