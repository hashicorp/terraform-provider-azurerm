...
!> **Note:** The errors returned from the Azure API when a Resource Provider is unregistered may be unclear (example `API version '2019-01-01' was not found for 'Microsoft.Foo'`) - please ensure that all the necessary Resource Providers you're using are registered
