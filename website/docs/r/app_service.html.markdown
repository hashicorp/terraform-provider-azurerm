...
~> **NOTE:** When you use third party tools to update your Docker Compose definitions, you can tell Terraform not to worry about those changes with this snippet :
