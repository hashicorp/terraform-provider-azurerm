...
* `sku` - (Optional) The SKU of the Public IP. Accepted values are `Basic`, `Standard` and `StandardV2`. Defaults to `Standard`. Changing this forces a new resource to be created.
