...
layout: "azurerm"
page_title: "Azure Resource Manager: azurerm_cognitive_account_project_connection_custom_keys"
description: |-
  Manages a Cognitive Account Project Connection with Custom Keys authentication.
---

# azurerm_cognitive_account_project_connection_custom_keys
...
resource "azurerm_cognitive_account_project_connection_custom_keys" "example" {
...
```shell
terraform import azurerm_cognitive_account_project_connection_custom_keys.example /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/group1/providers/Microsoft.CognitiveServices/accounts/account1/projects/project1/connections/connection1
```
