...
* `namespace_name` - (Required) Specifies the name of the EventHub Namespace to replicate. Changing this forces a new resource to be created.
...
* `alternate_name` - (Optional) An alternate name to use when name and the namespace names are same. 
