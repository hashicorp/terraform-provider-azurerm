...
* `recovery_vault_id` - (Required) The ID of the Recovery Services Vault where the network mapping should be created. Changing this forces a new resource to be created.
