...
layout: "azurerm"
page_title: "Azure Resource Manager: azurerm_data_protection_backup_policy_cosmosdb_database_account"
description: |-
  Manages a Data Protection Backup Policy for Cosmos DB Database Accounts.
---

# azurerm_data_protection_backup_policy_cosmosdb_database_account
...
-> **Note:** The only possible value is `VaultStore`.
...
```shell
terraform import azurerm_data_protection_backup_policy_cosmosdb_database_account.example /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/resourceGroup1/providers/Microsoft.DataProtection/backupVaults/backupVault1/backupPolicies/backupPolicy1
```
