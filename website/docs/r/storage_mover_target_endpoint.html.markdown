...
-> **Note:** To target an **SMB** file share on Azure Files instead, use [`azurerm_storage_mover_smb_file_share_target_endpoint`](storage_mover_smb_file_share_target_endpoint.html).
