...
* `data_storage_size_in_gbs` - (Optional) The maximum storage that can be allocated for the database, in gigabytes. Exactly one of `data_storage_size_in_gbs` and `data_storage_size_in_tbs` must be specified.

* `data_storage_size_in_tbs` - (Optional) The maximum storage that can be allocated for the database, in terabytes. Exactly one of `data_storage_size_in_gbs` and `data_storage_size_in_tbs` must be specified.
