...
Manages a Storage Mover **SMB Mount Source Endpoint** (as shown under **Endpoints** in the Azure portal) for migrating from on-premises Windows file servers to Azure.
