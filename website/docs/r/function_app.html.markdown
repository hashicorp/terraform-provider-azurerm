...
* `min_tls_version` - (Optional) The minimum supported TLS version for the function app. Possible values are `1.0`, `1.1`, `1.2` and `1.3`. Defaults to `1.2` for new function apps.
