...
-> **Note:** `managed_disk_type` of type `UltraSSD_LRS` requires `additional_capabilities.ultra_ssd_enabled` to be set to `true`.
...
* `Microsoft.Compute` - 2025-04-01, 2023-04-02
