...
sidebar_current: "docs-azurerm-resource-database-sql-server_blob_auditing_policies"
description: |-
  Manages a SQL Azure Database Server Blob Auditing Policies.

---

# azurerm_sql_server_blob_auditing_policies
