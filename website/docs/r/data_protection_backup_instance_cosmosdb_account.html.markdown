...
layout: "azurerm"
page_title: "Azure Resource Manager: azurerm_data_protection_backup_instance_cosmosdb_account"
description: |-
  Manages a Data Protection Backup Instance for a Cosmos DB Database Account.
---

# azurerm_data_protection_backup_instance_cosmosdb_account
...
```shell
terraform import azurerm_data_protection_backup_instance_cosmosdb_account.example /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/resourceGroup1/providers/Microsoft.DataProtection/backupVaults/backupVault1/backupInstances/backupInstance1
```
