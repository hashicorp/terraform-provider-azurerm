...
`azurerm_storage_account_local_user` resources can be imported using one of the following methods:

* The `terraform import` CLI command with an `id` string:

  ```shell
  terraform import azurerm_storage_account_local_user.example /subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{storageAccountName}/localUsers/{localUserName}
  ```
...
* An `import` block with an `id` argument:
  ...
  ```hcl
  import {
    to = azurerm_storage_account_local_user.example
    id = "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{storageAccountName}/localUsers/{localUserName}"
  }
  ```
