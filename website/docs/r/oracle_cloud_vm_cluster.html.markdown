...
* `exascale_database_storage_vault_id` - (Optional) Identifier of the Cloud Exadata Database Storage Vault in Azure. Changing this forces a new Cloud VM Cluster to be created.
