...
* `public_access_behind_virtual_network_enabled` - (Optional) Allow public access when this Machine Learning Workspace is behind a VNet.

* `public_network_access_enabled` - (Optional) Allow public access when this Machine Learning Workspace is behind VNet.

~> **NOTE:** `public_access_behind_virtual_network_enabled` is deprecated and will be removed in favour of the `public_network_access_enabled` property in version 4.0 of the AzureRM Provider.
