...
* `certificate_information` - (Optional) A `certificate_information` block as defined below.
...
The `certificate_information` block supports the following:

* `expiry` - (Required) The expiration date of the certificate in RFC3339 format: `2000-01-02T03:04:05Z`.
