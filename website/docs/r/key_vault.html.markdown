...
* `soft_delete_enabled` - (Optional) Must be true. 

!> **Note:** [Soft Delete is now required on Azure Key Vault.](https://docs.microsoft.com/en-us/azure/key-vault/general/soft-delete-change)
