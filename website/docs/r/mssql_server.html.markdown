...
~> **NOTE:**  To use `key_vault_customer_managed_key_id` a User Assigned identity must be specified in `primary_user_assigned_identity_id`. System Assigned Identities are not supported.
