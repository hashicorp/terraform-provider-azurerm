...
* `local_authentication_enabled` - (Optional) Specifies if the log Analytics workspace should allow authentication methods other than Microsoft Entra (Azure AD). Defaults to `true`.
