...
* `create_mode` - (Optional) Specifies how to create the database. Defaults to `Default`, ie. create a new database.  This can also be set to `PointInTimeRestore` to restore from a snapshot.
