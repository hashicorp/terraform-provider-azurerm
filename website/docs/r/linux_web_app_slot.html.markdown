...
* `ip_access_enabled` - (Optional)  Should the ip access be enabled for the main site of the Web App Slot. Defaults to `true`.
...
* `scm_ip_access_enabled` - (Optional)  Should the ip access be enabled for the scm site of the Web App Slot. Defaults to `true`.
