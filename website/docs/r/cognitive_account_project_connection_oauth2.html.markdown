...
layout: "azurerm"
page_title: "Azure Resource Manager: azurerm_cognitive_account_project_connection_oauth2"
description: |-
  Manages a Cognitive Account Project Connection with OAuth2 authentication.
---

# azurerm_cognitive_account_project_connection_oauth2
...
resource "azurerm_cognitive_account_project_connection_oauth2" "example" {
...
```shell
terraform import azurerm_cognitive_account_project_connection_oauth2.example /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/group1/providers/Microsoft.CognitiveServices/accounts/account1/projects/project1/connections/connection1
```
