...
layout: "azurerm"
page_title: "Azure Resource Manager: azurerm_storage_mover_smb_file_share_target_endpoint"
description: |-
  Manages a Storage Mover SMB File Share Target Endpoint.
---

# azurerm_storage_mover_smb_file_share_target_endpoint
...
resource "azurerm_storage_mover_smb_file_share_target_endpoint" "example" {
  name               = "example-smbfse"
...
```shell
terraform import azurerm_storage_mover_smb_file_share_target_endpoint.example /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/resourceGroup1/providers/Microsoft.StorageMover/storageMovers/storageMover1/endpoints/endpoint1
```
