...
* `kube_admin_config` - A list of `kube_admin_config` blocks as defined below. This is only available when Role Based Access Control with Azure Active Directory is enabled and local accounts enabled.
