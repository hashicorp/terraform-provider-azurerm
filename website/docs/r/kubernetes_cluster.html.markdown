...
* `node_os_channel_upgrade` - (Optional) The upgrade channel for this Kubernetes Cluster Nodes OS Image. Possible values are `Unmanaged`, `SecurityPatch`, and `NodeImage`. Omitting this field sets this value to `None`.
