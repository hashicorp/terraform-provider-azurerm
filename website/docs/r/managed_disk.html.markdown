...
* `hyper_v_generation` - (Optional) The HyperV Generation of the Disk, which can only be set for OS Disks. Possible values are `V1` and `V2`. Changing this forces a new resource to be created.
