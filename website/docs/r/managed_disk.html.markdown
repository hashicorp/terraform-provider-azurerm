...
* `hyper_v_generation_version` - (Optional) The generation of HyperV of the Disk. Applicable to OS disks only. Possible values are `V1` and `V2`. Changing this forces a new resource to be created.
