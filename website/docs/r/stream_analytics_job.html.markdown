...
* `type` - (Required) Specifies the type of Managed Service Identity that should be configured on this Stream Analytics Job. Only possible value is `SystemAssigned`.
