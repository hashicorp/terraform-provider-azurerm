...
subcategory: "NGINX"
layout: "azurerm"
page_title: "Azure Resource Manager: Data Source: azurerm_nginx_dataplane_apikey"
description: |-
  Gets information about an existing NGINX Dataplane API Key.
---

# Data Source: azurerm_nginx_dataplane_apikey
...
```hcl
data "azurerm_nginx_dataplane_apikey" "example" {
  name                = "existing"
  nginx_deployment_id = azurerm_nginx_deployment.example.id
}

output "id" {
  value = data.azurerm_nginx_dataplane_apikey.example.id
}
```
