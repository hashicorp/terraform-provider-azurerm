...
* `soft_delete_enabled` - Must be true.  [Soft Delete is now required on Azure Key Vault.](https://docs.microsoft.com/en-us/azure/key-vault/general/soft-delete-change)
