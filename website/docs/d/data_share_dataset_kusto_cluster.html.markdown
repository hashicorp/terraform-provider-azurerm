...
* `share_id` - (Required) The ID of the Data Share in which this Data Share Kusto Cluster Dataset should be created.
...
* `kusto_cluster_id` - The ID of the Kusto Cluster to be shared with the receiver.
