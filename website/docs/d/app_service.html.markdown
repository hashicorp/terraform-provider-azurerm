...
* `acr_use_managed_identity_creds` - Are Managed Identity Credentials used for Azure Container Registry pull.

* `acr_user_managed_identity_id` - The User Managed Identity Client Id.
