...
The `site_config.ip_restriction.subnet_mask` field has been removed as it is not longer used.

The `site_config.virtual_network_name` field has been removed as it it no longer used
...
The `forwarding_protocol` property now defaults to `HttpsOnly`
...
The `azurerm_metric_alertrule` resource will be deprecated in favour of the resource: `azurerm_monitor_metric_alert`.


### Resource: `azurerm_monitor_metric_alertrule`

The `azurerm_monitor_metric_alertrule` resource will be deprecated in favour of the resource: `azurerm_monitor_metric_alert`.
...
This resource was deprecated in favor of `azurerm_site_recovery_replicated_vm` and has been removed.

### Resource `azurerm_recovery_services_fabric`

The resource was deprecated in favor of `azurerm_site_recovery_fabric` and has been removed.

### Resource `azurerm_recovery_services_network_mapping`

This resource was deprecated in favor of `azurerm_site_recovery_network_mapping` and has been removed.

### Resource `azurerm_recovery_services_protected_vm`

This resource was deprecated in favor of `azurerm_backup_protected_vm` and has been removed.

### Resource `azurerm_recovery_services_protection_container`

This resource was deprecated in favor of `azurerm_site_recovery_protection_container` and has been removed.

### Resource `azurerm_recovery_services_protection_container_mapping`

This resource was deprecated in favor of `azurerm_site_recovery_protection_container_mapping` and has been removed.

### Resource `azurerm_recovery_services_protection_policy_vm`

This resource was deprecated in favor of `azurerm_backup_policy_vm` and has been removed.

### Resource `azurerm_recovery_services_replication_policy`

This resource was deprecated in favor of `azurerm_site_recovery_replication_policy` and has been removed.
...
The deprecated `virtual_machine_name`, `location`, and `resource_group_name` field will be removed in favor of `virtual_machine_id`.
