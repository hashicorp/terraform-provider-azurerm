...
### Data Soure: `azurerm_automation_account`

The data source has been deprecated in favour of the correctly named version `azurerm_automation_account_registration_info`.
