...
The field `auth_key_1` will be removed in favour of the `authorization_key_primary` property

The field `auth_key_2` will be removed in favour of the `authorization_key_secondary` property
