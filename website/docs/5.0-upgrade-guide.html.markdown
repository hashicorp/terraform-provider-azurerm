...
* The `automanage_configuration_id` property has been removed and superseded by the `azurerm_stack_hci_cluster_automanage_configuration_assignment` resource.
