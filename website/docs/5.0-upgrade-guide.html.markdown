...
* The deprecated `registry_credential.custom.identity` property has been removed in favour of the `registry_credential.custom.user_assigned_identity_id` property.
