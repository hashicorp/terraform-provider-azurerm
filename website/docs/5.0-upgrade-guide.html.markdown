...
* The deprecated `storage_container_type` property has been removed in favour of the `deployment_storage_container_type` property.
* The deprecated `storage_container_endpoint` property has been removed in favour of the `deployment_storage_container_endpoint` property.
* The deprecated `storage_authentication_type` property has been removed in favour of the `deployment_storage_authentication_type` property.
* The deprecated `storage_access_key` property has been removed in favour of the `deployment_storage_access_key` property.
* The deprecated `storage_user_assigned_identity_id` property has been removed in favour of the `deployment_storage_user_assigned_identity_id` property.
>>>>>>> origin/flex-consumption/storage-setting
