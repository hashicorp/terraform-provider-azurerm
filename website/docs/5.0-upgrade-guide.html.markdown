...
* The `zone_redundancy_enabled` property has been removed since it is now enabled by default in regions that support availability zones.
* The `georeplications.*.zone_redundancy_enabled` property has been removed since it is now enabled by default in regions that support availability zones.
