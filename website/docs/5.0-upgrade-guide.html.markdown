...
* The deprecated `storage_account.storage_resource_id` has been removed in favour of the `storage_account.storage_account_id` property.
* The deprecated `storage_account_gen2.storage_resource_id` has been removed in favour of the `storage_account_gen2.storage_account_id` property.
* The deprecated `storage_account_gen2.managed_identity_resource_id` has been removed in favour of the `storage_account_gen2.user_assigned_identity_id` property.
