...
* The `storage_mb` property no longer accepts `4194304` as a value.
...
* The `storage_mb` property no longer accepts `4194304` for new servers or when resizing existing servers.
