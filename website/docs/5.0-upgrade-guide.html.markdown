...
* The deprecated `enable_floating_ip` and `enable_tcp_reset` properties have been removed in favour of the `floating_up_enabled` and `tcp_reset_enabled` properties.
