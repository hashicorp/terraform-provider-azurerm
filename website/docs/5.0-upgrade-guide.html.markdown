...
* This deperecated resource has been superseded by `azurerm_managed_redis_cluster` and has been removed from the Azure Provider.
...
* This deperecated resource has been superseded by `azurerm_managed_redis_database` and has been removed from the Azure Provider.
...
* This deperecated data source has been superseded by `azurerm_managed_redis_database` and has been removed from the Azure Provider.
