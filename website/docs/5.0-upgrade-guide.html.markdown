...
* The deprecated `hostname_configuration.developer_portal.key_vault_id` property has been removed in favour of the ``hostname_configuration.developer_portal.key_vault_key_id`` property. 
* The deprecated `hostname_configuration.management.key_vault_id` property has been removed in favour of the ``hostname_configuration.management.key_vault_key_id`` property. 
* The deprecated `hostname_configuration.portal.key_vault_id` property has been removed in favour of the ``hostname_configuration.portal.key_vault_key_id`` property. 
* The deprecated `hostname_configuration.proxy.key_vault_id` property has been removed in favour of the ``hostname_configuration.proxy.key_vault_key_id`` property. 
* The deprecated `hostname_configuration.scm.key_vault_id` property has been removed in favour of the ``hostname_configuration.scm.key_vault_key_id`` property.
...
* The deprecated `developer_portal.key_vault_id` property has been removed in favour of the `developer_portal.key_vault_key_id` property.
* The deprecated `gateway.key_vault_id` property has been removed in favour of the `gateway.key_vault_key_id` property.
* The deprecated `management.key_vault_id` property has been removed in favour of the `management.key_vault_key_id` property.
* The deprecated `portal.key_vault_id` property has been removed in favour of the `portal.key_vault_key_id` property.
* The deprecated `scm.key_vault_id` property has been removed in favour of the `scm.key_vault_key_id` property.
