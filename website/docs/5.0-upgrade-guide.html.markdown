...
* This deperecated resource has been superseded by `azurerm_managed_redis_cluster`.
...
* This deperecated resource has been superseded by `azurerm_managed_redis_database`.
...
* This deperecated data source has been superseded by `azurerm_managed_redis_database`.
