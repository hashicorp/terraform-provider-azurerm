...
* This deprecated resource has been removed in favour of `azurerm_artifacts_signing_account`.
...
* This deprecated data source has been retired and has been removed in favour of `azurerm_artifacts_signing_account`.
