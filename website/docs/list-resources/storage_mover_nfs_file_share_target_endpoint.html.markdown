...
description: |-
  Lists Storage Mover NFS File Share Target Endpoint resources.
---

# List resource: azurerm_storage_mover_nfs_file_share_target_endpoint

Lists Storage Mover NFS File Share Target Endpoint resources.

## Example Usage

### List NFS File Share Target Endpoints in a Storage Mover

```hcl
list "azurerm_storage_mover_nfs_file_share_target_endpoint" "example" {
  provider = azurerm
  config {
