...
list "azurerm_api_management_named_value" "example" {
  provider = azurerm
  config {
    api_management_id = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/example-rg/providers/Microsoft.ApiManagement/service/example-service"
  }
}
```
