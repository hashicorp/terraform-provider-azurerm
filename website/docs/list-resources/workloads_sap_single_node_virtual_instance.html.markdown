...
In addition to the Arguments listed above - the following Attributes are exported for each SAP Single Node Virtual Instance:
...
* `single_server_configuration` - A `single_server_configuration` block as defined in the [azurerm_workloads_sap_single_node_virtual_instance](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/workloads_sap_single_node_virtual_instance) resource documentation.
