...
* dependencies: updating `keyvault` to `2019-09-01` [GH-7822]
...
* `azurerm_key_vault` - support for `soft_delete_retention_days` [GH-7822]
...
* `azurerm_windows_virtual_machine_scale_set` - `upgrade_mode="Automatic"` no longer requires health probe [GH-6667]
