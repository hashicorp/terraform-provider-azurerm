...
* **New Data Source**: `azurerm_private_dns_a_record` [GH-18036]
* **New Data Source**: `azurerm_private_dns_aaaa_record` [GH-18036]
* **New Data Source**: `azurerm_private_dns_cname_record` [GH-18036]
* **New Data Source**: `azurerm_private_dns_mx_record` [GH-18036]
* **New Data Source**: `azurerm_private_dns_ptr_record` [GH-18036]
* **New Data Source**: `azurerm_private_dns_soa_record` [GH-18036]
* **New Data Source**: `azurerm_private_dns_srv_record` [GH-18036]
* **New Data Source**: `azurerm_private_dns_txt_record` [GH-18036]
...
* `azurerm_application_gateway` - support for the `global` block [GH-17651]
...
* `azurerm_spring_cloud_app` - support the `public_endpoint_enabled` property [GH-17630]
* `azurerm_spring_cloud_gateway_route_config` - support for the `open_api;azurerm_spring_cloud_service`  and `log_stream_public_endpoint_enabledread_timeout_seconds` properties [GH-17630]
