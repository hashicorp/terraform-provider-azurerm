...
* `azurerm_netapp_volume` - `service_level` can now be updated [GH-29209]
* `azurerm_orchestrated_virtual_machine_scale_set` - add support for the `upgrade_mode` and `rolling_upgrade_policy` properties [GH-28354]
* `azurerm_static_webapp` - mark `app_settings` sensitive in schema [GH-28689]
