...
* `azurerm_api_management_api` - fix `import` of resources [GH-28193]
...
* `azurerm_private_endpoint_application_security_group_association` - resource is now removed from state if it no longer exist [GH-29601]
