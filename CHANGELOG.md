...
* **New Resource:** `azurerm_cosmosdb_mongo_user_definition` [GH-21914]
...
* **New Resource:** `azurerm_recovery_services_vault_resource_guard_association` [GH-21712]
...
* `appplatform`: updating to API Version `2023-03-01-preview` [GH-21404]
