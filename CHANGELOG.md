...
* **New Data Source:** `azurerm_nat_gateway` [GH-4449]
...
* **New Resource:** `azurerm_nat_gateway` [GH-4449]
...
* `azurerm_application_gateway` - fixes a crash when an empty body for probe match was used [GH-5056]
