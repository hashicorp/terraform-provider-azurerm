...
* `azurerm_linux_function_app` - added support for the `public_network_access_enabled` property [GH-22352]
* `azurerm_linux_function_app_slot` - added support for the `public_network_access_enabled` property [GH-22352]
* `azurerm_linux_web_app` - added support for the `public_network_access_enabled` property [GH-22352]
* `azurerm_linux_web_app_slot`  - added support for the `public_network_access_enabled` property [GH-22352]
* `azurerm_windows_function_app` - added support for the `public_network_access_enabled` property [GH-22352]
* `azurerm_windows_function_app_slot` - added support for the `public_network_access_enabled` property
* `azurerm_windows_web_app` - added support for the `public_network_access_enabled` property [GH-22352]
* `azurerm_windows_web_app_slot` - added support for the `public_network_access_enabled` property [GH-22352]
* `azurerm_stream_analytics_output_blob` - increase the `batch_min_rows` property allowed values to `1000000` [GH-22331]
* `azurerm_spring_cloud_gateway` - support for the the `allowed_origin_patterns` property [GH-22317]

BUG FIXES:

* Data Source `azurerm_virtual_machine_scale_set` - prevent a nil pointer panic during reads [GH-22335]
* `azurerm_application_insights_api_key` - prevent a nil pointer panic [GH-22388]
* `azurerm_linux_function_app` - the `allowed_origins` property in the `cors` block now has a minimum entry count of `1` [GH-22352]
* `azurerm_linux_function_app_slot` - the `allowed_origins` property in the `cors` block now has a minimum entry count of `1` [GH-22352]
* `azurerm_linux_web_app` - the `allowed_origins` property in the `cors` block now has a minimum entry count of `1` [GH-22352]
* `azurerm_linux_web_app` - prevent a nil pointer panic in docker settings processing [GH-22347]
* `azurerm_linux_web_app_slot`  - the `allowed_origins` property in the `cors` block now has a minimum entry count of `1` [GH-22352]
...
* `azurerm_windows_function_app` - the `allowed_origins` property in the `cors` block now has a minimum entry count of `1` [GH-22352]
* `azurerm_windows_function_app_slot` - the `allowed_origins` property in the `cors` block now has a minimum entry count of `1` [GH-22352]
* `azurerm_windows_web_app` - the `allowed_origins` property in the `cors` block now has a minimum entry count of `1` [GH-22352]
* `azurerm_windows_web_app_slot` - the `allowed_origins` property in the `cors` block now has a minimum entry count of `1` [GH-22352]
