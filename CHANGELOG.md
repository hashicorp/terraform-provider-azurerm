...
* **New Resource:** `azurerm_private_dns_txt_record` [GH-6309]
...
* `azurerm_kubernetes_cluster` - support for `outbound_type` within the `network_profile` block [GH-6120]
* `azurerm_linux_virtual_machine` - OS disk encryption settings can no be updated [GH-6230]
* `azurerm_windows_virtual_machine` - OS disk encryption settings can no be updated [GH-6230]
