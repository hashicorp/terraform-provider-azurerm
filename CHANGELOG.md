...
BUG FIXES:
* `appservice` - now checks for deployment service availability before zip deployment  [GH-30066]
...
* `azurerm_mssql_database` - the `max_size_gb` can now support `0.1` and `0.5` [GH-28334]
