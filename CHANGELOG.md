...
* Data Source: `azurerm_route_table` - validate updated to prevent empty and blank `property` values from causing a panic [GH-2467]
...
* `azurerm_route_table` - validate updated to prevent empty and blank `property` values from causing a panic [GH-2467]
