...
* `azurerm_eventgrid_domain` - adding validation to the `name` field [GH-9281]
* `azurerm_eventgrid_domain_topic` - adding validation to the `name` field [GH-9281]
* `azurerm_eventgrid_domain_topic` - adding validation to the `domain_name` field [GH-9281]
* `azurerm_eventgrid_event_subscription` - adding validation to the `name` field [GH-9281]
* `azurerm_eventgrid_topic` - adding validation to the `name` field [GH-9281]
* `azurerm_eventgrid_system_topic` - adding validation to the `name` field [GH-9281]
...
* `azurerm_log_analytics_workspace` - fix the `Free` tier from setting the `daily_quota_gb` property [GH-9228]
