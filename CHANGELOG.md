...
* `azurerm_hdinsight_hadoop_cluster` - add support for the `private_link_configuration` block [GH-25629]
* `azurerm_hdinsight_hbase_cluster` - add support for the `private_link_configuration` block [GH-25629]
* `azurerm_hdinsight_interactive_query_cluster` - add support for the `private_link_configuration` block [GH-25629]
* `azurerm_hdinsight_kafka_cluster` - add support for the `private_link_configuration` block [GH-25629]
