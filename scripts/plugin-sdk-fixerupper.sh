...
function updateTests {
  ...
  find "$SERVICE_DIRECTORY" -type f -iname "*_test.go" -exec sed -i '' -e 's/github\.com\/hashicorp\/terraform-plugin-sdk\/helper\/resource/github\.com\/hashicorp\/terraform-provider-azurerm\/internal\/acceptance/g' {} \;
  ...
  find "$SERVICE_DIRECTORY" -type f -iname "*_test.go" -exec sed -i '' -e 's/github\.com\/hashicorp\/terraform-plugin-sdk\/helper\/acctest/github\.com\/hashicorp\/terraform-provider-azurerm\/internal\/acceptance/g' {} \;
  ...
  find "$SERVICE_DIRECTORY" -type f -iname "*_test.go" -exec sed -i '' -e 's/github\.com\/hashicorp\/terraform-plugin-sdk\/terraform/github\.com\/hashicorp\/terraform-provider-azurerm\/internal\/tf\/pluginsdk/g' {} \;
...
function updateCode {
  ...
  find "$SERVICE_DIRECTORY" -type f -iname "*.go"  -exec sed -i '' -e 's/github\.com\/hashicorp\/terraform-plugin-sdk\/helper\/schema/github\.com\/hashicorp\/terraform-provider-azurerm\/internal\/tf\/pluginsdk/g' {} \;
  find "$SERVICE_DIRECTORY" -type f -iname "*.go"  -exec sed -i '' -e 's/schema\./pluginsdk\./g' {} \;

  # references to `structure.` should be `pluginsdk.`
  find "$SERVICE_DIRECTORY" -type f -iname "*.go"  -exec sed -i '' -e 's/github\.com\/hashicorp\/terraform-plugin-sdk\/helper\/structure/github\.com\/hashicorp\/terraform-provider-azurerm\/internal\/tf\/pluginsdk/g' {} \;
  ...
  find "$SERVICE_DIRECTORY" -type f -iname "*.go"  -exec sed -i '' -e 's/github\.com\/hashicorp\/terraform-plugin-sdk\/helper\/validation/github\.com\/hashicorp\/terraform-provider-azurerm\/internal\/tf\/validation/g' {} \;

  # `resource.` can become `pluginsdk`.
  find "$SERVICE_DIRECTORY" -type f -iname "*.go"  -exec sed -i '' -e 's/github\.com\/hashicorp\/terraform-plugin-sdk\/helper\/resource/github\.com\/hashicorp\/terraform-provider-azurerm\/internal\/tf\/pluginsdk/g' {} \;
