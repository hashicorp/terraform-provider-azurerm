...
fun ParametrizedWithType.ConfigureAzureSpecificTestParameters(environment: String, config: ClientConfiguration, locationsForEnv: LocationConfiguration, useAltSubscription: Boolean = false, useDevTestSubscription: Boolean = false, enableFivePointZeroBeta: Boolean = false) {
    ...
    hiddenVariable("env.ARM_FIVEPOINTZERO_BETA", enableFivePointZeroBeta.toString(), "Opt into the 5.0 beta")
