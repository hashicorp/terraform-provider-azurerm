...
var serviceTestConfigurationOverrides = mapOf(
        ...
        // netapp has a max of 10 accounts per subscription so lets limit it to 5 to account for broken ones, run Monday, Wednesday, Friday
        "netapp" to testConfiguration(parallelism = 5, daysOfWeek = "2,4,6"),
