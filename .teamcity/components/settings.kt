...
var serviceTestConfigurationOverrides = mapOf(
        ...
        // Qumulo asked to use canary env for testing
        "qumulo" to testConfiguration(locationOverride = LocationConfiguration("centraluseuap", "eastus2euap", "westeurope", true)),
        ...
        "mobilenetwork" to testConfiguration(locationOverride = LocationConfiguration("eastus", "westeurope", "centraluseuap", false), useDevTestSubscription = false),
