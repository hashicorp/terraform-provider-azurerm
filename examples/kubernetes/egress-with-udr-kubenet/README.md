...
Managed identities are not currently supported with custom route tables in kubenet. (See Azure AKS [documentation](https://docs.microsoft.com/azure/aks/configure-kubenet#bring-your-own-subnet-and-route-table-with-kubenet))
