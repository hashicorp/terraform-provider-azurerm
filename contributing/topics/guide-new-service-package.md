...
1. [Register the Service Registration](https://github.com/hashicorp/terraform-provider-azurerm/blob/2ff15cca48adc7315f67d8b653409e621963ca64/internal/provider/services.go#L109-L118).
...
3. Re-run the generation to ensure the generated files are up to date (`make generate`).
