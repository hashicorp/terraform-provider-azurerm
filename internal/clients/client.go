...
func (client *Client) Build(ctx context.Context, o *common.ClientOptions) error {
	...
	if client.Connections, err = connections.NewClient(o); err != nil {
		return fmt.Errorf("building clinets for Connections: %+v", err)
	}
	...
	if client.IoTHub, err = iothub.NewClient(o); err != nil {
		return fmt.Errorf("building clinets for IoTHub: %+v", err)
	}
	...
	if client.MySQL, err = mysql.NewClient(o); err != nil {
		return fmt.Errorf("building clinets for MySQL: %+v", err)
	}
	...
	if client.Orbital, err = orbital.NewClient(o); err != nil {
		return fmt.Errorf("building clinets for Orbital: %+v", err)
	}
	...
	if client.PowerBI, err = powerBI.NewClient(o); err != nil {
		return fmt.Errorf("building clinets for PowerBI: %+v", err)
	}
	if client.PrivateDns, err = privatedns.NewClient(o); err != nil {
		return fmt.Errorf("building clinets for PrivateDns: %+v", err)
	}
	...
	if client.Purview, err = purview.NewClient(o); err != nil {
		return fmt.Errorf("building clinets for Purview: %+v", err)
	}
	...
	if client.Relay, err = relay.NewClient(o); err != nil {
		return fmt.Errorf("building clinets for Relay: %+v", err)
	}
