...
import (
	...
	durabletaskscheduler "github.com/hashicorp/terraform-provider-azurerm/internal/services/durabletaskscheduler/client"
...
type Client struct {
	...
	DurableTaskScheduler              *durabletaskscheduler.Client
...
func (client *Client) Build(ctx context.Context, o *common.ClientOptions) error {
	...
	if client.DurableTaskScheduler, err = durabletaskscheduler.NewClient(o); err != nil {
		return fmt.Errorf("building clients for DurableTaskScheduler: %+v", err)
	}
