...
import (
	...
	kubernetesconfiguration "github.com/hashicorp/terraform-provider-azurerm/internal/services/kubernetesconfiguration/client"
...
type Client struct {
	...
	KubernetesConfiguration *kubernetesconfiguration.Client
	Kusto                   *kusto.Client
...
func (client *Client) Build(ctx context.Context, o *common.ClientOptions) error {
	...
	client.KubernetesConfiguration = kubernetesconfiguration.NewClient(o)
