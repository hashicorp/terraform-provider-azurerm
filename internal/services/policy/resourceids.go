...
//go:generate go run ../../tools/generator-resource-id/main.go -path=./ -name=ManagementGroupPolicyRemediation -id=/providers/namespace1/managementGroups/group1/providers/Microsoft.PolicyInsights/remediations/remediation1
// TODO: Remove in 3.0
