...
//go:generate go run ../../tools/generator-resource-id/main.go -path=./ -name=ResourceManagerSecret -id=/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resourceGroup1/providers/Microsoft.KeyVault/vaults/keyVaultName1/secrets/secret1 -rewrite=true
