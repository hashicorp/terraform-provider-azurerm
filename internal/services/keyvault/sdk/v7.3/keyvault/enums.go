...
// CertificateActionType enumerates the values for certificate action type.
type CertificateActionType string

const (
	// AutoRenew ...
	AutoRenew CertificateActionType = "AutoRenew"
	// EmailContacts ...
	EmailContacts CertificateActionType = "EmailContacts"
)

// PossibleCertificateActionTypeValues returns an array of possible values for the CertificateActionType const type.
func PossibleCertificateActionTypeValues() []CertificateActionType {
	return []CertificateActionType{AutoRenew, EmailContacts}
}
...
// LifetimeActionType enumerates the values for lifetime action type.
...
const (
	...
	Notify LifetimeActionType = "notify"
	// Rotate Rotate the key based on the key policy.
	Rotate LifetimeActionType = "rotate"
)

// PossibleLifetimeActionTypeValues returns an array of possible values for the LifetimeActionType const type.
func PossibleLifetimeActionTypeValues() []LifetimeActionType {
	return []LifetimeActionType{Notify, Rotate}
}
