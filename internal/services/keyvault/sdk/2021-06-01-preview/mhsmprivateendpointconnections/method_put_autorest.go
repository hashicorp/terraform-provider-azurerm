...
// Put ...
func (c MHSMPrivateEndpointConnectionsClient) Put(ctx context.Context, id ManagedHSMPrivateEndpointConnectionId, input MHSMPrivateEndpointConnection) (result PutResponse, err error) {
...
func (c MHSMPrivateEndpointConnectionsClient) preparerForPut(ctx context.Context, id ManagedHSMPrivateEndpointConnectionId, input MHSMPrivateEndpointConnection) (*http.Request, error) {
