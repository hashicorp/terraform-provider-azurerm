...
// ListByResourceGroup ...
func (c ManagedHsmsClient) ListByResourceGroup(ctx context.Context, id ResourceGroupId, options ListByResourceGroupOptions) (resp ListByResourceGroupResponse, err error) {
...
func (c ManagedHsmsClient) ListByResourceGroupComplete(ctx context.Context, id ResourceGroupId, options ListByResourceGroupOptions) (ListByResourceGroupCompleteResult, error) {
	return c.ListByResourceGroupCompleteMatchingPredicate(ctx, id, options, ManagedHsmPredicate{})
}

// ListByResourceGroupCompleteMatchingPredicate retrieves all of the results and then applied the predicate
func (c ManagedHsmsClient) ListByResourceGroupCompleteMatchingPredicate(ctx context.Context, id ResourceGroupId, options ListByResourceGroupOptions, predicate ManagedHsmPredicate) (resp ListByResourceGroupCompleteResult, err error) {
...
func (c ManagedHsmsClient) preparerForListByResourceGroup(ctx context.Context, id ResourceGroupId, options ListByResourceGroupOptions) (*http.Request, error) {
...
func (c ManagedHsmsClient) responderForListByResourceGroup(resp *http.Response) (result ListByResourceGroupResponse, err error) {
	type page struct {
