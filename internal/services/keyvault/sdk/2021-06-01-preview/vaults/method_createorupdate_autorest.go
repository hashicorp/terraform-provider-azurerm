...
// CreateOrUpdate ...
func (c VaultsClient) CreateOrUpdate(ctx context.Context, id VaultId, input VaultCreateOrUpdateParameters) (result CreateOrUpdateResponse, err error) {
...
func (c VaultsClient) senderForCreateOrUpdate(ctx context.Context, req *http.Request) (future CreateOrUpdateResponse, err error) {
