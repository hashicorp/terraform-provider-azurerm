...
// List ...
func (c VaultsClient) List(ctx context.Context, id SubscriptionId, options ListOptions) (resp ListResponse, err error) {
...
func (c VaultsClient) ListComplete(ctx context.Context, id SubscriptionId, options ListOptions) (ListCompleteResult, error) {
	return c.ListCompleteMatchingPredicate(ctx, id, options, ResourcePredicate{})
}

// ListCompleteMatchingPredicate retrieves all of the results and then applied the predicate
func (c VaultsClient) ListCompleteMatchingPredicate(ctx context.Context, id SubscriptionId, options ListOptions, predicate ResourcePredicate) (resp ListCompleteResult, err error) {
...
func (c VaultsClient) preparerForList(ctx context.Context, id SubscriptionId, options ListOptions) (*http.Request, error) {
...
func (c VaultsClient) responderForList(resp *http.Response) (result ListResponse, err error) {
	type page struct {
