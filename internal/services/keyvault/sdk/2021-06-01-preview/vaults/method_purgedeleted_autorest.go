...
// PurgeDeleted ...
func (c VaultsClient) PurgeDeleted(ctx context.Context, id DeletedVaultId) (result PurgeDeletedResponse, err error) {
...
func (c VaultsClient) senderForPurgeDeleted(ctx context.Context, req *http.Request) (future PurgeDeletedResponse, err error) {
