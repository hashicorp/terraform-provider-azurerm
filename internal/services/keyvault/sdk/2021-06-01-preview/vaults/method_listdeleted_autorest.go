...
type ListDeletedResponse struct {
	...
	nextLink     *string
	nextPageFunc func(ctx context.Context, nextLink string) (ListDeletedResponse, error)
}
...
func (r ListDeletedResponse) HasMore() bool {
	return r.nextLink != nil
}

func (r ListDeletedResponse) LoadMore(ctx context.Context) (resp ListDeletedResponse, err error) {
	if !r.HasMore() {
...
// ListDeleted ...
func (c VaultsClient) ListDeleted(ctx context.Context, id SubscriptionId) (resp ListDeletedResponse, err error) {
...
func (c VaultsClient) ListDeletedComplete(ctx context.Context, id SubscriptionId) (ListDeletedCompleteResult, error) {
	return c.ListDeletedCompleteMatchingPredicate(ctx, id, DeletedVaultPredicate{})
}

// ListDeletedCompleteMatchingPredicate retrieves all of the results and then applied the predicate
func (c VaultsClient) ListDeletedCompleteMatchingPredicate(ctx context.Context, id SubscriptionId, predicate DeletedVaultPredicate) (resp ListDeletedCompleteResult, err error) {
...
func (c VaultsClient) preparerForListDeleted(ctx context.Context, id SubscriptionId) (*http.Request, error) {
...
func (c VaultsClient) responderForListDeleted(resp *http.Response) (result ListDeletedResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListDeletedResponse, err error) {
