...
// UpdateAccessPolicy ...
func (c VaultsClient) UpdateAccessPolicy(ctx context.Context, id OperationKindId, input VaultAccessPolicyParameters) (result UpdateAccessPolicyResponse, err error) {
...
func (c VaultsClient) responderForUpdateAccessPolicy(resp *http.Response) (result UpdateAccessPolicyResponse, err error) {
