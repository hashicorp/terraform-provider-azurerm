...
// ListByResource ...
func (c PrivateEndpointConnectionsClient) ListByResource(ctx context.Context, id VaultId) (resp ListByResourceResponse, err error) {
...
func (c PrivateEndpointConnectionsClient) ListByResourceComplete(ctx context.Context, id VaultId) (ListByResourceCompleteResult, error) {
	return c.ListByResourceCompleteMatchingPredicate(ctx, id, PrivateEndpointConnectionPredicate{})
}

// ListByResourceCompleteMatchingPredicate retrieves all of the results and then applied the predicate
func (c PrivateEndpointConnectionsClient) ListByResourceCompleteMatchingPredicate(ctx context.Context, id VaultId, predicate PrivateEndpointConnectionPredicate) (resp ListByResourceCompleteResult, err error) {
...
func (c PrivateEndpointConnectionsClient) preparerForListByResource(ctx context.Context, id VaultId) (*http.Request, error) {
