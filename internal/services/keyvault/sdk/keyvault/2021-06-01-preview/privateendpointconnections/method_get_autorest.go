...
// Get ...
func (c PrivateEndpointConnectionsClient) Get(ctx context.Context, id VaultPrivateEndpointConnectionId) (result GetResponse, err error) {
...
func (c PrivateEndpointConnectionsClient) preparerForGet(ctx context.Context, id VaultPrivateEndpointConnectionId) (*http.Request, error) {
