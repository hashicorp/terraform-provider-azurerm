...
// Put ...
func (c PrivateEndpointConnectionsClient) Put(ctx context.Context, id VaultPrivateEndpointConnectionId, input PrivateEndpointConnection) (result PutResponse, err error) {
...
func (c PrivateEndpointConnectionsClient) preparerForPut(ctx context.Context, id VaultPrivateEndpointConnectionId, input PrivateEndpointConnection) (*http.Request, error) {
