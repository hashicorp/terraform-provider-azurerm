...
func PossibleCertificatePolicyActionValues() []CertificatePolicyAction {
	return []CertificatePolicyAction{AutoRenew, EmailContacts}
}
...
const (
	...
	// DownloadHsmSecurityDomainStatus Check status of HSM security domain download.
	DownloadHsmSecurityDomainStatus DataAction = "Microsoft.KeyVault/managedHsm/securitydomain/download/read"
	...
	// RandomNumbersGenerate Generate random numbers.
	RandomNumbersGenerate DataAction = "Microsoft.KeyVault/managedHsm/rng/action"
	...
	// ReleaseKey Release an HSM key using Secure Key Release.
	ReleaseKey DataAction = "Microsoft.KeyVault/managedHsm/keys/release/action"
...
func PossibleDataActionValues() []DataAction {
	return []DataAction{BackupHsmKeys, CreateHsmKey, DecryptHsmKey, DeleteHsmKey, DeleteRoleAssignment, DeleteRoleDefinition, DownloadHsmSecurityDomain, DownloadHsmSecurityDomainStatus, EncryptHsmKey, ExportHsmKey, GetRoleAssignment, ImportHsmKey, PurgeDeletedHsmKey, RandomNumbersGenerate, ReadDeletedHsmKey, ReadHsmBackupStatus, ReadHsmKey, ReadHsmRestoreStatus, ReadHsmSecurityDomainStatus, ReadHsmSecurityDomainTransferKey, ReadRoleDefinition, RecoverDeletedHsmKey, ReleaseKey, RestoreHsmKeys, SignHsmKey, StartHsmBackup, StartHsmRestore, UnwrapHsmKey, UploadHsmSecurityDomain, VerifyHsmKey, WrapHsmKey, WriteHsmKey, WriteRoleAssignment, WriteRoleDefinition}
}
...
const (
	// CKMRSAAESKEYWRAP ...
	CKMRSAAESKEYWRAP KeyEncryptionAlgorithm = "CKM_RSA_AES_KEY_WRAP"
	// RSAAESKEYWRAP256 ...
	RSAAESKEYWRAP256 KeyEncryptionAlgorithm = "RSA_AES_KEY_WRAP_256"
	// RSAAESKEYWRAP384 ...
	RSAAESKEYWRAP384 KeyEncryptionAlgorithm = "RSA_AES_KEY_WRAP_384"
)
...
func PossibleKeyEncryptionAlgorithmValues() []KeyEncryptionAlgorithm {
	return []KeyEncryptionAlgorithm{CKMRSAAESKEYWRAP, RSAAESKEYWRAP256, RSAAESKEYWRAP384}
}
...
const (
	// Notify Trigger event grid events. For preview, the notification time is not configurable and it is
...
func PossibleKeyRotationPolicyActionValues() []KeyRotationPolicyAction {
	return []KeyRotationPolicyAction{Notify, Rotate}
}
...
const (
	// Boolean ...
	Boolean SettingTypeEnum = "boolean"
)
