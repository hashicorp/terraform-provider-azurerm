...
SDK_LOCATION="${AZURERM_LOCATION}/internal/services/keyvault/sdk/v7.4/keyvault"
...
autorest --use=@microsoft.azure/autorest.go@2.1.183 --tag=package-7.4 --go --openapi-type=data-plane --use-onever --version=V2 --go-sdk-folder="${SDK_LOCATION}"
