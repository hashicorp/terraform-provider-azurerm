...
func (r CommunicationService) Exists(ctx context.Context, client *clients.Client, state *pluginsdk.InstanceState) (*bool, error) {
...
func (r CommunicationService) basic(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
func (r CommunicationService) requiresImport(data acceptance.TestData) string {
	config := r.basic(data)
	return fmt.Sprintf(`
%s
...
func (r CommunicationService) complete(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
func (r CommunicationService) update(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
func (r CommunicationService) template(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {}
}
