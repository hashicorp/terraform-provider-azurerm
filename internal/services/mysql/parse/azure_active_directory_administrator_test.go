...
var _ resourceids.Id = AzureActiveDirectoryAdministratorId{}
...
func TestAzureActiveDirectoryAdministratorIDFormatter(t *testing.T) {
	...
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.DBforMySQL/servers/server1/administrators/activeDirectory"
	if actual != expected {
...
func TestAzureActiveDirectoryAdministratorID(t *testing.T) {
	testData := []struct {
...

		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.DBforMySQL/servers/server1/administrators/",
			Error: true,
		},

		{
			// valid
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.DBforMySQL/servers/server1/administrators/activeDirectory",
			Expected: &AzureActiveDirectoryAdministratorId{
