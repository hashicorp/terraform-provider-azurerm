...
func TestAccAutomanageConfigurationProfileHCRPAssignment_CreateorupdateHCRPconfigurationprofileassignment_ci(t *testing.T) {
	...
	data.ResourceTest(t, r, []resource.TestStep{
		{
			Config: r.CreateorupdateHCRPconfigurationprofileassignment_ci(data),
...
func (r AutomanageConfigurationProfileHCRPAssignmentResource) CreateorupdateHCRPconfigurationprofileassignment_ci(data acceptance.TestData) string {
...
func (r AutomanageConfigurationProfileHCRPAssignmentResource) citemplate(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {}
}
