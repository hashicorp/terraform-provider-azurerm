...
func TestAccAutomanageConfigurationProfileHCIAssignment_CreateorupdateaHCIconfigurationprofileassignment_ci(t *testing.T) {
	...
	data.ResourceTest(t, r, []resource.TestStep{
		{
			Config: r.CreateorupdateaHCIconfigurationprofileassignment_ci(data),
...
func (r AutomanageConfigurationProfileHCIAssignmentResource) CreateorupdateaHCIconfigurationprofileassignment_ci(data acceptance.TestData) string {
...
func (r AutomanageConfigurationProfileHCIAssignmentResource) citemplate(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {}
}
