...
func (r AutomanageConfigurationProfileHCRPAssignmentResource) Exists(ctx context.Context, client *clients.Client, state *terraform.InstanceState) (*bool, error) {
	id, err := parse.AutomanageConfigurationProfileHCRPAssignmentID(state.ID)
	if err != nil {
		return nil, err
	}
...
func (r AutomanageConfigurationProfileHCRPAssignmentResource) template(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {}
}
...
func (r AutomanageConfigurationProfileHCRPAssignmentResource) basic(data acceptance.TestData) string {
...
func (r AutomanageConfigurationProfileHCRPAssignmentResource) requiresImport(data acceptance.TestData) string {
	config := r.basic(data)
	return fmt.Sprintf(`
%s
...
func (r AutomanageConfigurationProfileHCRPAssignmentResource) complete(data acceptance.TestData) string {
	template := r.template(data)
	return fmt.Sprintf(`
%s
