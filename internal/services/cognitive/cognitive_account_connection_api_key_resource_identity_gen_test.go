	...
	data.ResourceIdentityTest(t, []acceptance.TestStep{
		{
			...
			ConfigStateChecks: []statecheck.StateCheck{
				...
				statecheck.ExpectIdentityValue("azurerm_cognitive_account_connection_api_key.test", tfjsonpath.New("subscription_id"), knownvalue.StringExact(data.Subscriptions.Primary)),
