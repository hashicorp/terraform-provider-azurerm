	...
	data.ResourceIdentityTest(t, []acceptance.TestStep{
		{
			...
			ConfigStateChecks: []statecheck.StateCheck{
				...
				customstatecheck.ExpectStateContainsIdentityValueAtPath("azurerm_cognitive_account_connection_custom_keys.test", tfjsonpath.New("subscription_id"), tfjsonpath.New("cognitive_account_id")),
			},
		},
