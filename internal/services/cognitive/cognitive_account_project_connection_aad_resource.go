...
var _ sdk.ResourceWithUpdate = CognitiveAccountProjectConnectionAADResource{}

type CognitiveAccountProjectConnectionAADResource struct{}

func (r CognitiveAccountProjectConnectionAADResource) ResourceType() string {
	return "azurerm_cognitive_account_project_connection_aad"
}

func (r CognitiveAccountProjectConnectionAADResource) ModelObject() interface{} {
	return &CognitiveAccountProjectConnectionAADModel{}
}

func (r CognitiveAccountProjectConnectionAADResource) IDValidationFunc() pluginsdk.SchemaValidateFunc {
	return projectconnectionresource.ValidateProjectConnectionID
}

type CognitiveAccountProjectConnectionAADModel struct {
...
func (r CognitiveAccountProjectConnectionAADResource) Arguments() map[string]*pluginsdk.Schema {
...
func (r CognitiveAccountProjectConnectionAADResource) Attributes() map[string]*pluginsdk.Schema {
	return map[string]*pluginsdk.Schema{}
}

func (r CognitiveAccountProjectConnectionAADResource) Create() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		Timeout: 30 * time.Minute,
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			client := metadata.Client.Cognitive.ProjectConnectionResourceClient

			var model CognitiveAccountProjectConnectionAADModel
...
func (r CognitiveAccountProjectConnectionAADResource) Read() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		...
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			...
			var currentState CognitiveAccountProjectConnectionAADModel
			if err := metadata.Decode(&currentState); err != nil {
				return fmt.Errorf("decoding: %+v", err)
			}

			state := CognitiveAccountProjectConnectionAADModel{
...
func (r CognitiveAccountProjectConnectionAADResource) Update() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		Timeout: 30 * time.Minute,
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			client := metadata.Client.Cognitive.ProjectConnectionResourceClient
			...
			props := resp.Model.Properties.(projectconnectionresource.AADAuthTypeConnectionProperties)
...
func (r CognitiveAccountProjectConnectionAADResource) Delete() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		Timeout: 30 * time.Minute,
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			client := metadata.Client.Cognitive.ProjectConnectionResourceClient
