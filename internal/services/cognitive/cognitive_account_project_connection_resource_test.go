...
resource "azurerm_cognitive_account_project_connection" "test" {
...
resource "azurerm_cognitive_account_project_connection" "import" {
  name                 = azurerm_cognitive_account_project_connection.test.name
  cognitive_project_id = azurerm_cognitive_account_project_connection.test.cognitive_project_id
  auth_type            = azurerm_cognitive_account_project_connection.test.auth_type
  category             = azurerm_cognitive_account_project_connection.test.category
  target               = azurerm_cognitive_account_project_connection.test.target
  api_key              = azurerm_cognitive_account_project_connection.test.api_key

  metadata = {
    apiType    = azurerm_cognitive_account_project_connection.test.metadata.apiType
    resourceId = azurerm_cognitive_account_project_connection.test.metadata.resourceId
    location   = azurerm_cognitive_account_project_connection.test.metadata.location
  }
}
`, r.basic(data))
}
