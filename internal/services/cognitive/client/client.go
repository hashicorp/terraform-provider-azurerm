...
func NewClient(o *common.ClientOptions) (*Client, error) {
	...
	raiPoliciesCient, err := raipolicies.NewRaiPoliciesClientWithBaseURI(o.Environment.ResourceManager)
	if err != nil {
		return nil, fmt.Errorf("building Rai Policies client: %+v", err)
	}
	o.Configure(raiPoliciesCient.Client, o.Authorizers.ResourceManager)

	return &Client{
		AccountsClient:    accountsClient,
		DeploymentsClient: deploymentsClient,
		RaiPoliciesClient: raiPoliciesCient,
	}, nil
}
