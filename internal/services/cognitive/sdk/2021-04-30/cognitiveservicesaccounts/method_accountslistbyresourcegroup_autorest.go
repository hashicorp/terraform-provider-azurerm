...
type AccountsListByResourceGroupResponse struct {
	...
	nextLink     *string
	nextPageFunc func(ctx context.Context, nextLink string) (AccountsListByResourceGroupResponse, error)
}
...
func (c CognitiveServicesAccountsClient) AccountsListByResourceGroupComplete(ctx context.Context, id ResourceGroupId) (AccountsListByResourceGroupCompleteResult, error) {
	return c.AccountsListByResourceGroupCompleteMatchingPredicate(ctx, id, AccountPredicate{})
}
...
func (c CognitiveServicesAccountsClient) preparerForAccountsListByResourceGroup(ctx context.Context, id ResourceGroupId) (*http.Request, error) {
...
func (c CognitiveServicesAccountsClient) responderForAccountsListByResourceGroup(resp *http.Response) (result AccountsListByResourceGroupResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result AccountsListByResourceGroupResponse, err error) {
