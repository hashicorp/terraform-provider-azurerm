...
func (c SkusClient) preparerForResourceSkusList(ctx context.Context, id SubscriptionId) (*http.Request, error) {
...
func (c SkusClient) responderForResourceSkusList(resp *http.Response) (result ResourceSkusListResponse, err error) {
	type page struct {
