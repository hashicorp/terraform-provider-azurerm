...
// List ...
func (c PrivateEndpointConnectionsClient) List(ctx context.Context, id AccountId) (result ListResponse, err error) {
...
func (c PrivateEndpointConnectionsClient) preparerForList(ctx context.Context, id AccountId) (*http.Request, error) {
