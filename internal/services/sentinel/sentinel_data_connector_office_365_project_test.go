...
func TestAccAzureRMSentinelDataConnectorOffice365Project_basic(t *testing.T) {
...
func TestAccAzureRMSentinelDataConnectorOffice365Project_complete(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_sentinel_data_connector_office_365_project", "test")
	r := SentinelDataConnectorOffice365ProjectResource{}
...
func TestAccAzureRMSentinelDataConnectorOffice365Project_requiresImport(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_sentinel_data_connector_office_365_project", "test")
	r := SentinelDataConnectorOffice365ProjectResource{}
