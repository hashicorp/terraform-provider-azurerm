...
func (r DataConnectorDynamics365Resource) CustomImporter() sdk.ResourceRunFunc {
	return func(ctx context.Context, metadata sdk.ResourceMetaData) error {
		_, err := importSentinelDataConnector(dataconnectors.DataConnectorKindDynamicsThreeSixFive)(ctx, metadata.ResourceData, metadata.Client)
		return err
	}
}
...
func (r DataConnectorDynamics365Resource) Read() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		...
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			...
			dc, ok := modelPtr.(dataconnectors.Dynamics365DataConnector)
			if !ok {
