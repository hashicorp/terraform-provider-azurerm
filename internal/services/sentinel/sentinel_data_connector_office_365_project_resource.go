...
func (r DataConnectorOffice365ProjectResource) CustomImporter() sdk.ResourceRunFunc {
	return importDataConnectorTyped(dataconnectors.DataConnectorKindOfficeThreeSixFiveProject)
}
...
func (r DataConnectorOffice365ProjectResource) Read() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		...
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			...
			dc, ok := existing.Model.(dataconnectors.Office365ProjectDataConnector)
			if !ok {
