...
//go:generate go run ../../tools/generator-tests resourceidentity -resource-name api_management_product_api -service-package-name apimanagement -properties "api_name:api_id,product_id,api_management_name:service_name,resource_group_name" -known-values "subscription_id:data.Subscriptions.Primary" -test-name basic
