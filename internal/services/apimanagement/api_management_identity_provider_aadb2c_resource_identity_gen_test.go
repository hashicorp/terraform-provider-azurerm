		...
		Steps: []resource.TestStep{
			{
				...
				ConfigStateChecks: []statecheck.StateCheck{
					...
					statecheck.ExpectIdentityValueMatchesStateAtPath("azurerm_api_management_identity_provider_aadb_2_c.test", tfjsonpath.New("api_management_name"), tfjsonpath.New("service_name")),
