		...
		Steps: []resource.TestStep{
			{
				...
				ConfigStateChecks: []statecheck.StateCheck{
					...
					statecheck.ExpectIdentityValueMatchesStateAtPath("azurerm_api_management_api_operation.test", tfjsonpath.New("api_management_name"), tfjsonpath.New("service_name")),
					statecheck.ExpectIdentityValueMatchesStateAtPath("azurerm_api_management_api_operation.test", tfjsonpath.New("api_name"), tfjsonpath.New("api_id")),
