...
func TestProductTagID(t *testing.T) {
	cases := []struct {
		Input string
		Valid bool
	}{
...

		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.ApiManagement/service/service1/products/product1/tags/",
			Valid: false,
		},

		{
			// valid
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.ApiManagement/service/service1/products/product1/tags/tagId1",
			Valid: true,
		},
	...
	for _, tc := range cases {
		...
		_, errors := ProductTagID(tc.Input, "test")
		valid := len(errors) == 0
