		...
		Steps: []resource.TestStep{
			{
				...
				ConfigStateChecks: []statecheck.StateCheck{
					...
					statecheck.ExpectIdentityValueMatchesStateAtPath("azurerm_api_management_named_value.test", tfjsonpath.New("api_management_name"), tfjsonpath.New("service_name")),
					statecheck.ExpectIdentityValueMatchesStateAtPath("azurerm_api_management_named_value.test", tfjsonpath.New("name"), tfjsonpath.New("name")),
