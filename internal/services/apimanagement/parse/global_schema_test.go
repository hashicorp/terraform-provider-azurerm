...
var _ resourceids.Id = GlobalSchemaId{}

func TestGlobalSchemaIDFormatter(t *testing.T) {
	actual := NewGlobalSchemaID("12345678-1234-9876-4563-123456789012", "resGroup1", "service1", "schema1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.ApiManagement/service/service1/schemas/schema1"
	if actual != expected {
		t.Fatalf("Expected %q but got %q", expected, actual)
	}
}

func TestGlobalSchemaID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
...

		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.ApiManagement/service/service1/schemas/",
			Error: true,
		},

		{
			// valid
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.ApiManagement/service/service1/schemas/schema1",
			Expected: &GlobalSchemaId{
	...
	for _, v := range testData {
		...
		actual, err := GlobalSchemaID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
