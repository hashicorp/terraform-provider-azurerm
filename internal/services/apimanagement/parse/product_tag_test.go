...
var _ resourceids.Id = ProductTagId{}

func TestProductTagIDFormatter(t *testing.T) {
	actual := NewProductTagID("12345678-1234-9876-4563-123456789012", "resGroup1", "service1", "product1", "tagId1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.ApiManagement/service/service1/products/product1/tags/tagId1"
	if actual != expected {
...
func TestProductTagID(t *testing.T) {
	...
	for _, v := range testData {
		...
		actual, err := ProductTagID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
