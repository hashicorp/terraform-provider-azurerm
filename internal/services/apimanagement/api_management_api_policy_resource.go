...
func resourceApiManagementApiPolicy() *pluginsdk.Resource {
	return &pluginsdk.Resource{
		Create: resourceApiManagementAPIPolicyCreate,
		Read:   resourceApiManagementAPIPolicyRead,
		Update: resourceApiManagementAPIPolicyUpdate,
...
func resourceApiManagementAPIPolicyCreate(d *pluginsdk.ResourceData, meta interface{}) error {
...
func resourceApiManagementAPIPolicyUpdate(d *pluginsdk.ResourceData, meta interface{}) error {
	client := meta.(*clients.Client).ApiManagement.ApiPoliciesClient
