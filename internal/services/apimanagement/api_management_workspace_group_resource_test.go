...
func (r ApiManagementWorkspaceGroupTestResource) update(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {}
}
...
resource "azurerm_api_management_workspace_group" "test" {
  ...
  external_id                 = azuread_group.test.object_id
  type                        = "external"
}
`, r.template(data), data.RandomInteger, data.RandomInteger)
}

func (r ApiManagementWorkspaceGroupTestResource) complete(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {}
}
...
func (ApiManagementWorkspaceGroupTestResource) template(data acceptance.TestData) string {
	return fmt.Sprintf(`
