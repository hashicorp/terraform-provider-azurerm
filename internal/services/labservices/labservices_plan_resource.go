...
type LabPlanResource struct {
}

var _ sdk.ResourceWithUpdate = LabPlanResource{}

type LabPlanResourceModel struct {
...
func (k LabPlanResource) Arguments() map[string]*pluginsdk.Schema {
