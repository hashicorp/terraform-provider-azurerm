...
// ListByLab ...
func (c UserClient) ListByLab(ctx context.Context, id LabId) (resp ListByLabResponse, err error) {
...
func (c UserClient) ListByLabComplete(ctx context.Context, id LabId) (ListByLabCompleteResult, error) {
	return c.ListByLabCompleteMatchingPredicate(ctx, id, UserPredicate{})
}

// ListByLabCompleteMatchingPredicate retrieves all of the results and then applied the predicate
func (c UserClient) ListByLabCompleteMatchingPredicate(ctx context.Context, id LabId, predicate UserPredicate) (resp ListByLabCompleteResult, err error) {
	items := make([]User, 0)
...
func (c UserClient) responderForListByLab(resp *http.Response) (result ListByLabResponse, err error) {
	type page struct {
