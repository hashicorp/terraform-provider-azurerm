...
// Invite ...
func (c UserClient) Invite(ctx context.Context, id UserId, input InviteBody) (result InviteResponse, err error) {
...
func (c UserClient) senderForInvite(ctx context.Context, req *http.Request) (future InviteResponse, err error) {
