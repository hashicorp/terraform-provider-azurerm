...
// Delete ...
func (c UserClient) Delete(ctx context.Context, id UserId) (result DeleteResponse, err error) {
...
func (c UserClient) senderForDelete(ctx context.Context, req *http.Request) (future DeleteResponse, err error) {
