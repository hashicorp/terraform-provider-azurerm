...
// Redeploy ...
func (c VirtualMachineClient) Redeploy(ctx context.Context, id VirtualMachineId) (result RedeployResponse, err error) {
...
func (c VirtualMachineClient) senderForRedeploy(ctx context.Context, req *http.Request) (future RedeployResponse, err error) {
