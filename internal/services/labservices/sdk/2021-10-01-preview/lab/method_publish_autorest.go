...
// Publish ...
func (c LabClient) Publish(ctx context.Context, id LabId) (result PublishResponse, err error) {
...
func (c LabClient) senderForPublish(ctx context.Context, req *http.Request) (future PublishResponse, err error) {
