...
var (
	...
	_ sdk.ResourceWithCustomizeDiff = StorageDiscoveryWorkspaceResource{}
)
...
func (r StorageDiscoveryWorkspaceResource) Identity() resourceids.ResourceId {
	return &storagediscoveryworkspaces.ProviderStorageDiscoveryWorkspaceId{}
}
					...
					"resource_types": {
						...
						Elem: &pluginsdk.Schema{
							...
							ValidateFunc: validation.StringInSlice(
								storagediscoveryworkspaces.PossibleValuesForStorageDiscoveryResourceType(),
								false,
							),
						},
					},
