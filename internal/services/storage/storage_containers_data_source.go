...
func (r storageContainersDataSource) Read() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		...
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			blobContainersClient := metadata.Client.Storage.ResourceManager.BlobServices
			...
			resp, err := blobContainersClient.BlobContainersListCompleteMatchingPredicate(ctx, *id, blobservices.DefaultBlobContainersListOperationOptions(), blobservices.ListContainerItemOperationPredicate{})
			if err != nil {
