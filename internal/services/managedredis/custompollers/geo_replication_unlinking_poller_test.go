...
func TestGeoReplicationUnlinkingPoller_Success(t *testing.T) {
	...
	pollerType := &geoReplicationUnlinkingPoller{
		client: mockClient,
		id:     id,
...
func TestGeoReplicationUnlinkingPoller_InProgress(t *testing.T) {
	id := databases.NewDatabaseID("00000000-0000-0000-0000-000000000000", "my-rg", "amr1", "default")
...
func TestGeoReplicationUnlinkingPoller_GeoReplicationNil(t *testing.T) {
	id := databases.NewDatabaseID("00000000-0000-0000-0000-000000000000", "my-rg", "amr1", "default")
