...
func (c HybridKubernetesClient) ConnectedClusterCreate(ctx context.Context, id ConnectedClusterId, input ConnectedCluster) (result ConnectedClusterCreateResponse, err error) {
...
func (c HybridKubernetesClient) senderForConnectedClusterCreate(ctx context.Context, req *http.Request) (future ConnectedClusterCreateResponse, err error) {
