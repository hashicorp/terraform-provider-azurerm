	...
	data.ResourceTest(t, r, []acceptance.TestStep{
		{
			...
			Check: acceptance.ComposeTestCheckFunc(
				...
				check.That(data.ResourceName).Key("custom_filter.0.parameters.0.param1").HasValue("123"),
				check.That(data.ResourceName).Key("custom_filter.0.parameters.0.param2").HasValue("321"),
			),
		},
		data.ImportStep(),
	})
