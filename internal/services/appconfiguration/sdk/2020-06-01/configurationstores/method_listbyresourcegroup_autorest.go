...
func (c ConfigurationStoresClient) ListByResourceGroupComplete(ctx context.Context, id ResourceGroupId) (ListByResourceGroupCompleteResult, error) {
	return c.ListByResourceGroupCompleteMatchingPredicate(ctx, id, ConfigurationStorePredicate{})
}
...
func (c ConfigurationStoresClient) preparerForListByResourceGroup(ctx context.Context, id ResourceGroupId) (*http.Request, error) {
...
func (c ConfigurationStoresClient) responderForListByResourceGroup(resp *http.Response) (result ListByResourceGroupResponse, err error) {
	type page struct {
