...
func dataSourcePrivateDnsARecord() *pluginsdk.Resource {
	return &pluginsdk.Resource{
		Read: dataSourcePrivateDnsARecordRead,
...
func dataSourcePrivateDnsARecordRead(d *pluginsdk.ResourceData, meta interface{}) error {
