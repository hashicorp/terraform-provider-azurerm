...
func TestNewPrivateZoneID(t *testing.T) {
	id := NewPrivateZoneID("12345678-1234-9876-4563-123456789012", "example-resource-group", "privateZoneValue", "A")
...
func TestFormatPrivateZoneID(t *testing.T) {
	actual := NewPrivateZoneID("12345678-1234-9876-4563-123456789012", "example-resource-group", "privateZoneValue", "A").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Network/privateDnsZones/privateZoneValue/A"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParsePrivateZoneID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *PrivateZoneId
	}{
		{
			// Incomplete URI
			Input: "",
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Network/privateDnsZones/privateZoneValue/A/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParsePrivateZoneID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParsePrivateZoneIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *PrivateZoneId
	...
	for _, v := range testData {
		...
		actual, err := ParsePrivateZoneIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForPrivateZoneId(t *testing.T) {
	segments := PrivateZoneId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("PrivateZoneId has no segments")
	}
