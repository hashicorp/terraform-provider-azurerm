...
func (c TenantsClient) ListBySubscription(ctx context.Context, id SubscriptionId) (resp ListBySubscriptionResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "tenants.TenantsClient", "ListBySubscription", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "tenants.TenantsClient", "ListBySubscription", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListBySubscription(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "tenants.TenantsClient", "ListBySubscription", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c TenantsClient) ListBySubscriptionComplete(ctx context.Context, id SubscriptionId) (ListBySubscriptionCompleteResult, error) {
	return c.ListBySubscriptionCompleteMatchingPredicate(ctx, id, TenantPredicate{})
}
...
func (c TenantsClient) preparerForListBySubscription(ctx context.Context, id SubscriptionId) (*http.Request, error) {
...
func (c TenantsClient) preparerForListBySubscriptionWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c TenantsClient) responderForListBySubscription(resp *http.Response) (result ListBySubscriptionResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListBySubscriptionResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "tenants.TenantsClient", "ListBySubscription", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListBySubscription(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "tenants.TenantsClient", "ListBySubscription", result.HttpResponse, "Failure responding to request")
				return
			}
