...
func (c TenantsClient) preparerForCheckNameAvailability(ctx context.Context, id SubscriptionId, input CheckNameAvailabilityRequest) (*http.Request, error) {
...
func (c TenantsClient) responderForCheckNameAvailability(resp *http.Response) (result CheckNameAvailabilityResponse, err error) {
