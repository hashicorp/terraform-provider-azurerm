...
func (c TenantsClient) ListByResourceGroupComplete(ctx context.Context, id ResourceGroupId) (ListByResourceGroupCompleteResult, error) {
	return c.ListByResourceGroupCompleteMatchingPredicate(ctx, id, TenantPredicate{})
}
...
func (c TenantsClient) preparerForListByResourceGroup(ctx context.Context, id ResourceGroupId) (*http.Request, error) {
...
func (c TenantsClient) responderForListByResourceGroup(resp *http.Response) (result ListByResourceGroupResponse, err error) {
	type page struct {
