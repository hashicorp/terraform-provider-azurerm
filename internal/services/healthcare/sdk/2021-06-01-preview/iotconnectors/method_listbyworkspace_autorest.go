...
// ListByWorkspace ...
func (c IotConnectorsClient) ListByWorkspace(ctx context.Context, id WorkspaceId) (resp ListByWorkspaceResponse, err error) {
	req, err := c.preparerForListByWorkspace(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "iotconnectors.IotConnectorsClient", "ListByWorkspace", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "iotconnectors.IotConnectorsClient", "ListByWorkspace", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListByWorkspace(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "iotconnectors.IotConnectorsClient", "ListByWorkspace", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c IotConnectorsClient) ListByWorkspaceComplete(ctx context.Context, id WorkspaceId) (ListByWorkspaceCompleteResult, error) {
	return c.ListByWorkspaceCompleteMatchingPredicate(ctx, id, IotConnectorPredicate{})
}

// ListByWorkspaceCompleteMatchingPredicate retrieves all of the results and then applied the predicate
func (c IotConnectorsClient) ListByWorkspaceCompleteMatchingPredicate(ctx context.Context, id WorkspaceId, predicate IotConnectorPredicate) (resp ListByWorkspaceCompleteResult, err error) {
...
func (c IotConnectorsClient) preparerForListByWorkspace(ctx context.Context, id WorkspaceId) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPath(fmt.Sprintf("%s/iotConnectors", id.ID())),
...
func (c IotConnectorsClient) preparerForListByWorkspaceWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c IotConnectorsClient) responderForListByWorkspace(resp *http.Response) (result ListByWorkspaceResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByWorkspaceResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "iotconnectors.IotConnectorsClient", "ListByWorkspace", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListByWorkspace(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "iotconnectors.IotConnectorsClient", "ListByWorkspace", result.HttpResponse, "Failure responding to request")
				return
			}
