...
func (c IotConnectorsClient) IotConnectorFhirDestinationCreateOrUpdate(ctx context.Context, id FhirDestinationId, input IotFhirDestination) (result IotConnectorFhirDestinationCreateOrUpdateResponse, err error) {
...
func (c IotConnectorsClient) senderForIotConnectorFhirDestinationCreateOrUpdate(ctx context.Context, req *http.Request) (future IotConnectorFhirDestinationCreateOrUpdateResponse, err error) {
