...
func (c IotConnectorsClient) IotConnectorFhirDestinationDelete(ctx context.Context, id FhirDestinationId) (result IotConnectorFhirDestinationDeleteResponse, err error) {
...
func (c IotConnectorsClient) senderForIotConnectorFhirDestinationDelete(ctx context.Context, req *http.Request) (future IotConnectorFhirDestinationDeleteResponse, err error) {
