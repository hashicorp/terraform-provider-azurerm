...
type FhirDestinationsListByIotConnectorResponse struct {
	...
	nextLink     *string
	nextPageFunc func(ctx context.Context, nextLink string) (FhirDestinationsListByIotConnectorResponse, error)
}
...
func (r FhirDestinationsListByIotConnectorResponse) HasMore() bool {
	return r.nextLink != nil
}

func (r FhirDestinationsListByIotConnectorResponse) LoadMore(ctx context.Context) (resp FhirDestinationsListByIotConnectorResponse, err error) {
	if !r.HasMore() {
...
func (c IotConnectorsClient) FhirDestinationsListByIotConnector(ctx context.Context, id IotConnectorId) (resp FhirDestinationsListByIotConnectorResponse, err error) {
...
func (c IotConnectorsClient) FhirDestinationsListByIotConnectorComplete(ctx context.Context, id IotConnectorId) (FhirDestinationsListByIotConnectorCompleteResult, error) {
	return c.FhirDestinationsListByIotConnectorCompleteMatchingPredicate(ctx, id, IotFhirDestinationPredicate{})
}

// FhirDestinationsListByIotConnectorCompleteMatchingPredicate retrieves all of the results and then applied the predicate
func (c IotConnectorsClient) FhirDestinationsListByIotConnectorCompleteMatchingPredicate(ctx context.Context, id IotConnectorId, predicate IotFhirDestinationPredicate) (resp FhirDestinationsListByIotConnectorCompleteResult, err error) {
...
func (c IotConnectorsClient) responderForFhirDestinationsListByIotConnector(resp *http.Response) (result FhirDestinationsListByIotConnectorResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result FhirDestinationsListByIotConnectorResponse, err error) {
