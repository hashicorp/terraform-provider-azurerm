...
// ListBySubscription ...
func (c WorkspacesClient) ListBySubscription(ctx context.Context, id commonids.SubscriptionId) (resp ListBySubscriptionResponse, err error) {
...
func (c WorkspacesClient) ListBySubscriptionCompleteMatchingPredicate(ctx context.Context, id commonids.SubscriptionId, predicate WorkspacePredicate) (resp ListBySubscriptionCompleteResult, err error) {
