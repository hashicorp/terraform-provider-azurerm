...
// ServicesUpdate ...
func (c ResourceClient) ServicesUpdate(ctx context.Context, id ServiceId, input ServicesPatchDescription) (result ServicesUpdateResponse, err error) {
...
func (c ResourceClient) senderForServicesUpdate(ctx context.Context, req *http.Request) (future ServicesUpdateResponse, err error) {
