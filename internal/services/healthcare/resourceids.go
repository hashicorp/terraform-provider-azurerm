...
//go:generate go run ../../tools/generator-resource-id/main.go -path=./ -name=IotConnector -id=/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/group1/providers/Microsoft.HealthcareApis/workspaces/workspace1/iotconnectors/iotconnector1
//go:generate go run ../../tools/generator-resource-id/main.go -path=./ -name=IotFhirDestination -id=/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/group1/providers/Microsoft.HealthcareApis/workspaces/workspace1/iotconnectors/iotconnector1/fhirdestinations/destination1
