...
func TestWorkspaceIDFormatter(t *testing.T) {
	actual := NewWorkspaceID("12345678-1234-9876-4563-123456789012", "group1", "workspace1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/group1/providers/Microsoft.HealthcareApis/workspaces/workspace1"
	if actual != expected {
