...
func TestAutoscaleSettingID(t *testing.T) {
	cases := []struct {
		Input string
		Valid bool
	}{
...

		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/group1/providers/Microsoft.Insights/autoscaleSettings/",
			Valid: false,
		},
	...
	for _, tc := range cases {
		...
		_, errors := AutoscaleSettingID(tc.Input, "test")
		valid := len(errors) == 0
