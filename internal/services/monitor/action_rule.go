		...
		Elem: &pluginsdk.Resource{
			Schema: map[string]*pluginsdk.Schema{
				...
				"monitor_service": schemaActionRuleCondition(
					...
					[]string{
						string(alertsmanagement.ActivityLogAdministrative),
						string(alertsmanagement.ActivityLogAutoscale),
						string(alertsmanagement.ActivityLogPolicy),
						string(alertsmanagement.ActivityLogRecommendation),
						string(alertsmanagement.ActivityLogSecurity),
						string(alertsmanagement.ApplicationInsights),
						string(alertsmanagement.LogAnalytics),
						string(alertsmanagement.Nagios),
						string(alertsmanagement.Platform),
						string(alertsmanagement.SCOM),
						string(alertsmanagement.ServiceHealth),
						string(alertsmanagement.SmartDetector),
						string(alertsmanagement.VMInsights),
						string(alertsmanagement.Zabbix),
					},
				),
