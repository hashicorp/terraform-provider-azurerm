...
type WorkspaceHubResource struct{}

func TestAccMachineLearningWorkspaceHub_basic(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_machine_learning_workspace_hub", "test")
	r := WorkspaceHubResource{}
...
func TestAccMachineLearningWorkspaceHub_requiresImport(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_machine_learning_workspace_hub", "test")
	r := WorkspaceHubResource{}
...
func TestAccMachineLearningWorkspaceHub_complete(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_machine_learning_workspace_hub", "test")
	r := WorkspaceHubResource{}
...
func TestAccMachineLearningWorkspaceHub_completeUpdate(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_machine_learning_workspace_hub", "test")
	r := WorkspaceHubResource{}
...
func TestAccMachineLearningWorkspaceHub_userAssignedIdentity(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_machine_learning_workspace_hub", "test")
	r := WorkspaceHubResource{}
...
func TestAccMachineLearningWorkspaceHub_systemAssignedUserAssignedIdentity(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_machine_learning_workspace_hub", "test")
	r := WorkspaceHubResource{}
...
func TestAccMachineLearningWorkspaceHub_identityUpdate(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_machine_learning_workspace_hub", "test")
	r := WorkspaceHubResource{}
...
func TestAccMachineLearningWorkspaceHub_identityTypeUpdate(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_machine_learning_workspace_hub", "test")
	r := WorkspaceHubResource{}
...
func TestAccMachineLearningWorkspaceHub_userAssignedAndCustomManagedKey(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_machine_learning_workspace_hub", "test")
	r := WorkspaceHubResource{}
...
func TestAccMachineLearningWorkspaceHub_systemAssignedAndCustomManagedKey(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_machine_learning_workspace_hub", "test")
	r := WorkspaceHubResource{}
...
func TestAccMachineLearningWorkspaceHub_purgeSoftDelete(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_machine_learning_workspace_hub", "test")
	r := WorkspaceHubResource{}
...
func (r WorkspaceHubResource) Exists(ctx context.Context, client *clients.Client, state *pluginsdk.InstanceState) (*bool, error) {
...
func (r WorkspaceHubResource) template(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {
    key_vault {
...
func (r WorkspaceHubResource) basic(data acceptance.TestData) string {
...
func (r WorkspaceHubResource) complete(data acceptance.TestData) string {
	template := r.template(data)
	return fmt.Sprintf(`
%[1]s
...
func (r WorkspaceHubResource) completeUpdated(data acceptance.TestData) string {
	template := r.template(data)
	return fmt.Sprintf(`
%[1]s
...
func (r WorkspaceHubResource) requiresImport(data acceptance.TestData) string {
...
func (r WorkspaceHubResource) userAssignedIdentity(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {
    key_vault {
...
func (r WorkspaceHubResource) userAssignedIdentityUpdate(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {
    key_vault {
...
func (r WorkspaceHubResource) systemAssignedUserAssignedIdentity(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {
    key_vault {
...
func (r WorkspaceHubResource) systemAssignedIdentity(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {
    key_vault {
...
func (r WorkspaceHubResource) systemAssignedAndCustomManagedKey(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {
    key_vault {
...
func (r WorkspaceHubResource) userAssignedAndCustomManagedKey(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {
    key_vault {
...
func (r WorkspaceHubResource) purgeSoftDelete(data acceptance.TestData) string {
	template := r.template(data)
	return fmt.Sprintf(`
provider "azurerm" {
  features {
