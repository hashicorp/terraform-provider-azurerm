...
func (c WCFRelaysClient) ListAuthorizationRules(ctx context.Context, id WcfRelayId) (resp ListAuthorizationRulesResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "wcfrelays.WCFRelaysClient", "ListAuthorizationRules", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "wcfrelays.WCFRelaysClient", "ListAuthorizationRules", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListAuthorizationRules(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "wcfrelays.WCFRelaysClient", "ListAuthorizationRules", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c WCFRelaysClient) preparerForListAuthorizationRules(ctx context.Context, id WcfRelayId) (*http.Request, error) {
...
func (c WCFRelaysClient) preparerForListAuthorizationRulesWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c WCFRelaysClient) responderForListAuthorizationRules(resp *http.Response) (result ListAuthorizationRulesResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListAuthorizationRulesResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "wcfrelays.WCFRelaysClient", "ListAuthorizationRules", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListAuthorizationRules(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "wcfrelays.WCFRelaysClient", "ListAuthorizationRules", result.HttpResponse, "Failure responding to request")
				return
			}
