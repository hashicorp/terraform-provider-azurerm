...
func (c FrontDoorsClient) ListByResourceGroupComplete(ctx context.Context, id ResourceGroupId) (ListByResourceGroupCompleteResult, error) {
	return c.ListByResourceGroupCompleteMatchingPredicate(ctx, id, FrontDoorPredicate{})
}
...
func (c FrontDoorsClient) preparerForListByResourceGroup(ctx context.Context, id ResourceGroupId) (*http.Request, error) {
...
func (c FrontDoorsClient) responderForListByResourceGroup(resp *http.Response) (result ListByResourceGroupResponse, err error) {
	type page struct {
