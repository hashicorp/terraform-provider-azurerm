...
type RulesEnginesListByFrontDoorResponse struct {
	...
	nextLink     *string
	nextPageFunc func(ctx context.Context, nextLink string) (RulesEnginesListByFrontDoorResponse, error)
}
...
func (c FrontDoorsClient) RulesEnginesListByFrontDoorComplete(ctx context.Context, id FrontDoorId) (RulesEnginesListByFrontDoorCompleteResult, error) {
	return c.RulesEnginesListByFrontDoorCompleteMatchingPredicate(ctx, id, RulesEnginePredicate{})
}
...
func (c FrontDoorsClient) responderForRulesEnginesListByFrontDoor(resp *http.Response) (result RulesEnginesListByFrontDoorResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result RulesEnginesListByFrontDoorResponse, err error) {
