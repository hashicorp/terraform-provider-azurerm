...
type FrontendEndpointsListByFrontDoorResponse struct {
	...
	nextLink     *string
	nextPageFunc func(ctx context.Context, nextLink string) (FrontendEndpointsListByFrontDoorResponse, error)
}
...
func (c FrontDoorsClient) FrontendEndpointsListByFrontDoorComplete(ctx context.Context, id FrontDoorId) (FrontendEndpointsListByFrontDoorCompleteResult, error) {
	return c.FrontendEndpointsListByFrontDoorCompleteMatchingPredicate(ctx, id, FrontendEndpointPredicate{})
}
...
func (c FrontDoorsClient) responderForFrontendEndpointsListByFrontDoor(resp *http.Response) (result FrontendEndpointsListByFrontDoorResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result FrontendEndpointsListByFrontDoorResponse, err error) {
