...
func PossibleCompressionCodecValues() []CompressionCodec {
	return []CompressionCodec{CompressionCodecBzip2, CompressionCodecDeflate, CompressionCodecGzip, CompressionCodecLz4, CompressionCodecSnappy, CompressionCodecTar, CompressionCodecTarGZip, CompressionCodecZipDeflate}
}
...
const (
	...
	// PackageStore ...
	PackageStore SsisPackageLocationType = "PackageStore"
	// SSISDB ...
...
func PossibleSsisPackageLocationTypeValues() []SsisPackageLocationType {
	return []SsisPackageLocationType{File, InlinePackage, PackageStore, SSISDB}
}
