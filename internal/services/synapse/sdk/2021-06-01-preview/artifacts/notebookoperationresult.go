...
// NotebookOperationResultClient is the client for the NotebookOperationResult methods of the Artifacts service.
...
func (client NotebookOperationResultClient) Get(ctx context.Context, operationID string) (result autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "artifacts.NotebookOperationResultClient", "Get", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "artifacts.NotebookOperationResultClient", "Get", resp, "Failure sending request")
		return
	}

	result, err = client.GetResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "artifacts.NotebookOperationResultClient", "Get", resp, "Failure responding to request")
		return
	}
