...
func TestManagedHSMKeyWithVersionIDFormatter(t *testing.T) {
	actual := NewManagedHSMKeyWithVersionID("12345678-1234-9876-4563-123456789012", "resGroup1", "mhsm1", "key1", "version1").ID()
...
func TestManagedHSMKeyWithVersionID(t *testing.T) {
	testData := []struct {
		Input         string
		insensitively bool
		Error         bool
		Expected      *ManagedHSMKeyWithVersionId
	}{
		...
		{
			// invalid insenseitively
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourcegroups/resGroup1/providers/Microsoft.KeyVault/managedhsms/mhsm1/keys/key1/versions/version1",
			Error: true,
		},
		{
			// valid insenseitively
			Input:         "/subscriptions/12345678-1234-9876-4563-123456789012/resourcegroups/resGroup1/providers/Microsoft.KeyVault/managedhsms/mhsm1/keys/key1/versions/version1",
			insensitively: true,
			Expected: &ManagedHSMKeyWithVersionId{
				SubscriptionId: "12345678-1234-9876-4563-123456789012",
	...
	for _, v := range testData {
		...
		var actual *ManagedHSMKeyWithVersionId
		var err error

		if v.insensitively {
			actual, err = ParseManagedHSMKeyWithVersionIDInsensitively(v.Input)
		} else {
			actual, err = ParseManagedHSMKeyWithVersionID(v.Input)
		}
		if err != nil {
			if v.Error {
				continue
