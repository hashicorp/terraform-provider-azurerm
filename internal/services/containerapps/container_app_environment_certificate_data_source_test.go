...
func (d ContainerAppEnvironmentCertificateDataSource) keyVaultUserAssigned(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
`, ContainerAppEnvironmentCertificateResource{}.keyVaultUserAssigned(data))
}
