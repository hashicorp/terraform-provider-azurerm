...
func (r MongoClusterResource) Update() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		...
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			...
			// Set identity to `nil` to avoid schema validation errors from service API side when upgrading API version from `2024-07-01` to `2025-09-01`.
			// The API returns identity with userAssignedIdentities as `nil`, which doesn't match the expected object type in the new schema.
