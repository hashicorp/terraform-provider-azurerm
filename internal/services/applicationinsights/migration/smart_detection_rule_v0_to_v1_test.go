...
func TestSmartDetectionRuleV0ToV1(t *testing.T) {
	testData := []struct {
		name     string
	...
	}{
		{
			...
			expected: pointer.To("/subscriptions/12345678-1234-5678-1234-123456789012/resourceGroups/group1/providers/Microsoft.Insights/components/component1/smartDetectionRule/rule1"),
		},
		{
	...
	for _, test := range testData {
		...
		result, err := SmartDetectionRuleUpgradeV0ToV1{}.UpgradeFunc()(context.TODO(), test.input, nil)
