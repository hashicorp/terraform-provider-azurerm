...
func dataSourceApiConnection() *pluginsdk.Resource {
	return &pluginsdk.Resource{
		Read: dataSourceApiConnectionRead,
...
func dataSourceApiConnectionRead(d *pluginsdk.ResourceData, meta interface{}) error {
