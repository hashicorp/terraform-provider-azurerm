...
func (c ClusterExtensionsClient) ExtensionsCreate(ctx context.Context, id ExtensionId, input Extension) (result ExtensionsCreateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "clusterextensions.ClusterExtensionsClient", "ExtensionsCreate", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForExtensionsCreate(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "clusterextensions.ClusterExtensionsClient", "ExtensionsCreate", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c ClusterExtensionsClient) preparerForExtensionsCreate(ctx context.Context, id ExtensionId, input Extension) (*http.Request, error) {
...
func (c ClusterExtensionsClient) senderForExtensionsCreate(ctx context.Context, req *http.Request) (future ExtensionsCreateOperationResponse, err error) {
