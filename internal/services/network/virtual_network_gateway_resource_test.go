...
func (VirtualNetworkGatewayResource) bgpEnabled(data acceptance.TestData) string {
...
resource "azurerm_virtual_network_gateway" "test" {
  ...
  vpn_type   = "RouteBased"
  sku        = "VpnGw1"
  enable_bgp = true ### This property is being replaced with bgp_enabled
