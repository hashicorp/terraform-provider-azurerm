...
func resourceVirtualMachinePacketCaptureCreate(d *pluginsdk.ResourceData, meta interface{}) error {
	...
	payload := packetcaptures.PacketCapture{
		Properties: packetcaptures.PacketCaptureParameters{
			...
			BytesToCapturePerPacket: pointer.To(int64(int64(bytesToCapturePerPacket))),
			TimeLimitInSeconds:      pointer.To(int64(int64(timeLimitInSeconds))),
			TotalBytesPerSession:    pointer.To(int64(int64(totalBytesPerSession))),
