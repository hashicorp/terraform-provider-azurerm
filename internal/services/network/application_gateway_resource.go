...
func applicationGatewayCustomizeDiff(ctx context.Context, d *pluginsdk.ResourceDiff, _ interface{}) error {
	...
	// When `match` property is set as default by Azure while `match` property is not configured by user in Terraform script, set new value of `match` property (newProbe) be same as default generated by Azure (oldProbe) to ignore the change during plan time
