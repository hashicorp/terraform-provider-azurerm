...
type VirtualHubInboundRouteModel struct {
	...
	RouteMap       []VirtualHubInboundRouteRouteMapModel `tfschema:"route_map"`
}

type VirtualHubInboundRouteRouteMapModel struct {
	Prefix         string `tfschema:"prefix"`
	BgpCommunities string `tfschema:"bgp_communities"`
	AsPath         string `tfschema:"as_path"`
}

var _ sdk.DataSource = VirtualHubInboundRouteDataSource{}

func (v VirtualHubInboundRouteDataSource) Arguments() map[string]*schema.Schema {
...
func (v VirtualHubInboundRouteDataSource) Attributes() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		"route_map": {
...
func (v VirtualHubInboundRouteDataSource) ModelObject() interface{} {
	return &VirtualHubInboundRouteModel{}
}

func (v VirtualHubInboundRouteDataSource) ResourceType() string {
	return "azurerm_virtual_hub_inbound_route"
}

func (v VirtualHubInboundRouteDataSource) Read() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		Timeout: 5 * time.Minute,
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			var model VirtualHubInboundRouteModel
			...
			param := virtualwans.GetInboundRoutesParameters{}
			...
			resp, err := client.VirtualHubsGetInboundRoutes(ctx, *virtualHubId, param)
			if err != nil {
			...
			state := VirtualHubInboundRouteModel{
...
type VirtualHubsInboundRouteResponse struct {
