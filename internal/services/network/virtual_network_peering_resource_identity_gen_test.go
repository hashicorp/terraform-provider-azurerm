	...
	data.ResourceIdentityTest(t, []acceptance.TestStep{
		{
			...
			ConfigStateChecks: []statecheck.StateCheck{
				...
				customstatecheck.ExpectStateContainsIdentityValueAtPath("azurerm_virtual_network_peering.test", tfjsonpath.New("resource_group_name"), tfjsonpath.New("id")),
				customstatecheck.ExpectStateContainsIdentityValueAtPath("azurerm_virtual_network_peering.test", tfjsonpath.New("virtual_network_name"), tfjsonpath.New("id")),
			},
		},
