...
func TestVirtualNetworkPeeringIDFormatter(t *testing.T) {
	actual := NewVirtualNetworkPeeringID("12345678-1234-9876-4563-123456789012", "resGroup1", "network1", "virtualNetworkPeering1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.Network/virtualNetworks/network1/virtualNetworkPeerings/virtualNetworkPeering1"
	if actual != expected {
