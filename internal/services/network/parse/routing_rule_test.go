...
func TestRoutingRuleIDFormatter(t *testing.T) {
	actual := NewRoutingRuleID("12345678-1234-9876-4563-123456789012", "group1", "applicationGateway1", "routingRule1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/group1/providers/Microsoft.Network/applicationGateways/applicationGateway1/routingRules/routingRule1"
	if actual != expected {
...
func TestRoutingRuleID(t *testing.T) {
	testData := []struct {
...

		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/group1/providers/Microsoft.Network/applicationGateways/applicationGateway1/routingRules/",
			Error: true,
		},

		{
			// valid
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/group1/providers/Microsoft.Network/applicationGateways/applicationGateway1/routingRules/routingRule1",
			Expected: &RoutingRuleId{
