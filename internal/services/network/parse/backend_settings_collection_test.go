...
func TestBackendSettingsCollectionIDFormatter(t *testing.T) {
	actual := NewBackendSettingsCollectionID("12345678-1234-9876-4563-123456789012", "group1", "applicationGateway1", "backendSettingsCollection1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/group1/providers/Microsoft.Network/applicationGateways/applicationGateway1/backendSettingsCollection/backendSettingsCollection1"
	if actual != expected {
...
func TestBackendSettingsCollectionID(t *testing.T) {
	testData := []struct {
		...
		{
			// valid
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/group1/providers/Microsoft.Network/applicationGateways/applicationGateway1/backendSettingsCollection/backendSettingsCollection1",
			Expected: &BackendSettingsCollectionId{
				SubscriptionId:                "12345678-1234-9876-4563-123456789012",
				ResourceGroup:                 "group1",
				ApplicationGatewayName:        "applicationGateway1",
				BackendSettingsCollectionName: "backendSettingsCollection1",
			},
		},
