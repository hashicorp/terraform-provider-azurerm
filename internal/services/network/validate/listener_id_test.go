...
func TestListenerID(t *testing.T) {
	cases := []struct {
...

		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/group1/providers/Microsoft.Network/applicationGateways/applicationGateway1/listeners/",
			Valid: false,
		},

		{
			// valid
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/group1/providers/Microsoft.Network/applicationGateways/applicationGateway1/listeners/listener1",
			Valid: true,
		},
	...
	for _, tc := range cases {
		...
		_, errors := ListenerID(tc.Input, "test")
		valid := len(errors) == 0
