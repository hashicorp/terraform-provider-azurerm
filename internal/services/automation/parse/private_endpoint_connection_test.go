...
func TestPrivateEndpointConnectionIDFormatter(t *testing.T) {
	actual := NewPrivateEndpointConnectionID("12345678-1234-9876-4563-123456789012", "group1", "account1", "conn1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/group1/providers/Microsoft.Automation/automationAccounts/account1/privateEndpointConnections/conn1"
	if actual != expected {
