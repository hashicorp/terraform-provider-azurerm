...
func NewPython2PackageID(subscriptionId, resourceGroup, automationAccountName, name string) Python2PackageId {
...
func (id Python2PackageId) String() string {
	...
	return fmt.Sprintf("%s: (%s)", "Python2 Package", segmentsStr)
}
...
// Python2PackageID parses a Python2Package ID into an Python2PackageId struct
func Python2PackageID(input string) (*Python2PackageId, error) {
	id, err := resourceids.ParseAzureResourceID(input)
	if err != nil {
		return nil, err
	}

	resourceId := Python2PackageId{
	...
	if resourceId.Name, err = id.PopSegment("python2Packages"); err != nil {
		return nil, err
	}
