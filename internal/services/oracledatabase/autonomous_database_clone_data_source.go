...
func (d AutonomousDatabaseCloneDataSource) Arguments() map[string]*pluginsdk.Schema {
...
func (d AutonomousDatabaseCloneDataSource) Attributes() map[string]*pluginsdk.Schema {
	return map[string]*pluginsdk.Schema{
...
func (d AutonomousDatabaseCloneDataSource) ModelObject() interface{} {
	return nil
}

func (d AutonomousDatabaseCloneDataSource) ResourceType() string {
	return "azurerm_oracledatabase_autonomous_database_clone"
}

func (d AutonomousDatabaseCloneDataSource) IDValidationFunc() pluginsdk.SchemaValidateFunc {
	return cloudvmclusters.ValidateCloudVMClusterID
}

func (d AutonomousDatabaseCloneDataSource) Read() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		...
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			...
			if model := resp.Model; model != nil {
				...
				var output AutonomousDatabaseCloneModel
				prop := model.Properties

				output = AutonomousDatabaseCloneModel{}

				if prop != nil {
					switch adbsPropModel := prop.(type) {
					case autonomousdatabases.AutonomousDatabaseCloneProperties:
						output = AutonomousDatabaseCloneModel{
							CloneType:                                string(adbsPropModel.CloneType),
							IsReconnectCloneEnabled:                  pointer.From(adbsPropModel.IsReconnectCloneEnabled),
							IsRefreshableClone:                       pointer.From(adbsPropModel.IsRefreshableClone),
							RefreshableModel:                         string(pointer.From(adbsPropModel.RefreshableModel)),
							Source:                                   string(pointer.From(adbsPropModel.Source)),
							SourceId:                                 adbsPropModel.SourceId,
							TimeUntilReconnectCloneEnabled:           pointer.From(adbsPropModel.TimeUntilReconnectCloneEnabled),
