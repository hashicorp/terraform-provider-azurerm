...
func (d AdbsNCharSetsDataSource) ResourceType() string {
	return "azurerm_oracledatabase_adbs_national_character_sets"
}
...
func (d AdbsNCharSetsDataSource) Read() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		...
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			client := metadata.Client.OracleDatabase.OracleDatabaseClient.AutonomousDatabaseNationalCharacterSets
