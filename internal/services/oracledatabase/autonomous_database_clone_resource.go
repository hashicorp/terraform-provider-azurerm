...
var _ sdk.Resource = AdbsCloneResource{}

type AdbsCloneResource struct{}

type AdbsCloneResourceModel struct {
...
func (AdbsCloneResource) Arguments() map[string]*pluginsdk.Schema {
...
func (AdbsCloneResource) Attributes() map[string]*pluginsdk.Schema {
	return map[string]*pluginsdk.Schema{}
}
...
func (AdbsCloneResource) ResourceType() string {
	return "azurerm_oracledatabase_autonomous_database_clone"
}

func (r AdbsCloneResource) Create() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		...
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			...
			var model AdbsCloneResourceModel
...
func (r AdbsCloneResource) Update() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		Timeout: 30 * time.Minute,
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
...
func (AdbsCloneResource) Read() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		...
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			...
			case autonomousdatabases.AutonomousDatabaseCloneProperties:
				var output AdbsCloneResourceModel
			...
			default:
				return fmt.Errorf("unexpected Autonomous Database type, must be of type Clone")
			}
		},
	}
}

func (AdbsCloneResource) Delete() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		Timeout: 30 * time.Minute,
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			client := metadata.Client.OracleDatabase.OracleDatabaseClient.AutonomousDatabases
...
func (AdbsCloneResource) IDValidationFunc() pluginsdk.SchemaValidateFunc {
