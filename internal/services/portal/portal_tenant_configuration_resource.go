...
func resourcePortalTenantConfigurationCreateUpdate(d *pluginsdk.ResourceData, meta interface{}) error {
	...
	id := tenantconfigurations.NewTenantConfigurationID("default")
	if d.IsNewResource() {
	...
	parameters := tenantconfigurations.Configuration{
		Properties: &tenantconfigurations.ConfigurationProperties{
...
func resourcePortalTenantConfigurationRead(d *pluginsdk.ResourceData, meta interface{}) error {
	...
	id, err := tenantconfigurations.ParseTenantConfigurationID(d.Id())
	if err != nil {
		return err
	}
