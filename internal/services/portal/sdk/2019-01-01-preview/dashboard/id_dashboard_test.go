...
func TestParseDashboardID(t *testing.T) {
	testData := []struct {
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Portal",
			Error: true,
		},
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.Portal/dashboards",
			Error: true,
		},
		{
			// Valid URI
	...
	for _, v := range testData {
		...
		if actual.DashboardName != v.Expected.DashboardName {
			t.Fatalf("Expected %q but got %q for DashboardName", v.Expected.DashboardName, actual.DashboardName)
		}
