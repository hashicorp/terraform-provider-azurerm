...
func (d DeploymentModel) expandNetworkProfile() *nginxdeployment.NginxNetworkProfile {
...
func (m DeploymentResource) Create() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		...
		Func: func(ctx context.Context, meta sdk.ResourceMetaData) error {
			...
			prop.NetworkProfile = model.expandNetworkProfile()
	...
	return sdk.ResourceFunc{
		...
		Func: func(ctx context.Context, meta sdk.ResourceMetaData) error {
			...
			if meta.ResourceData.HasChanges("frontend_public", "frontend_private", "network_interface") {
				req.Properties.NetworkProfile = model.expandNetworkProfile()
			}
