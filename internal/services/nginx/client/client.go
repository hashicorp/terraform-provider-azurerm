...
func NewClient(o *common.ClientOptions) (*nginx_2024_01_01_preview.Client, error) {
	client, err := nginx_2024_01_01_preview.NewClientWithBaseURI(o.Environment.ResourceManager, func(c *resourcemanager.Client) {
