...
func FlattenExadbDataCollectionOption(dataCollectionOptions *exadbvmclusters.DataCollectionOptions) []ExadbDataCollectionOptionModel {
	output := make([]ExadbDataCollectionOptionModel, 0)
	if dataCollectionOptions != nil {
		return append(output, ExadbDataCollectionOptionModel{
...
func FlattenExadbDataCollectionOptionInterface(input []interface{}) []ExadbDataCollectionOptionModel {
	output := make([]ExadbDataCollectionOptionModel, 0)
	if len(input) == 0 || input[0] == nil {
		return output
	}
	if m, ok := input[0].(map[string]interface{}); ok {
		dataCollection := ExadbDataCollectionOptionModel{
