...
type ExadbVmClusterDataModel struct {
	...
	DataCollectionOption            []ExadbDataCollectionOptionModel `tfschema:"data_collection_option"`
	...
	VirtualMachineFileSystemStorage []ExadbVmClusterStorageModel     `tfschema:"virtual_machine_file_system_storage"`
	VnetId                          string                           `tfschema:"virtual_network_id"`
	ZoneOcid                        string                           `tfschema:"zone_ocid"`
}

type ExadbDataCollectionOptionModel struct {
