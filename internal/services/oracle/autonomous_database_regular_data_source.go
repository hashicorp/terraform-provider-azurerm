...
type AutonomousDatabaseRegularDataModel struct {
	...
	LongTermBackupSchedule                  autonomousdatabases.LongTermBackUpScheduleDetails `tfschema:"long_term_backup_schedule"`
		...
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			...
			if model := resp.Model; model != nil {
				...
				if props := model.Properties; props != nil {
					...
					state.LongTermBackupSchedule = pointer.From(adbsProps.LongTermBackupSchedule)
