...
// ManagedRedisClusterLocationFlashSkuSupport - validates that the passed location supports the flash sku type or not
func ManagedRedisClusterLocationFlashSkuSupport(input string) error {
