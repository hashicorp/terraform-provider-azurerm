...
// ManagedRedisClusterLocationZoneSupport - validates that the passed location supports zones or not
func ManagedRedisClusterLocationZoneSupport(input string) error {
