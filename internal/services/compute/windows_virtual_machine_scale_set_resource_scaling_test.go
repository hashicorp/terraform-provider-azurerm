...
func TestAccWindowsVirtualMachineScaleSet_scalingCapacityReservationGroupId(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_windows_virtual_machine_scale_set", "test")
	r := WindowsVirtualMachineScaleSetResource{}
...
func TestAccWindowsVirtualMachineScaleSet_scalingHostGroupId(t *testing.T) {
	...
	data.ResourceTest(t, r, []acceptance.TestStep{
		{
			Config: r.scalingHostGroupId(data),
			Check: acceptance.ComposeTestCheckFunc(
				check.That(data.ResourceName).ExistsInAzure(r),
			),
		},
...
func (r WindowsVirtualMachineScaleSetResource) scalingCapacityReservationGroupInitial(data acceptance.TestData) string {
	return fmt.Sprintf(`
%[1]s
...
func (r WindowsVirtualMachineScaleSetResource) scalingCapacityReservationGroup(data acceptance.TestData) string {
	return fmt.Sprintf(`
%[1]s
...
func (r WindowsVirtualMachineScaleSetResource) scalingCapacityReservationGroupRemoved(data acceptance.TestData) string {
	return fmt.Sprintf(`
%[1]s
