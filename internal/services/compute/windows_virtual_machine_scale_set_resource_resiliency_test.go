...
func TestAccWindowsVirtualMachineScaleSet_resiliency_Basic(t *testing.T) {
...
func TestAccWindowsVirtualMachineScaleSet_resiliency_Minimal(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_windows_virtual_machine_scale_set", "test")
	r := WindowsVirtualMachineScaleSetResource{}
...
func TestAccWindowsVirtualMachineScaleSet_resiliency_Complete(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_windows_virtual_machine_scale_set", "test")
	r := WindowsVirtualMachineScaleSetResource{}
...
func TestAccWindowsVirtualMachineScaleSet_resiliency_Update(t *testing.T) {
	...
	data.ResourceTest(t, r, []acceptance.TestStep{
		{
			// Start with VM policies only (no zones, no health probe)
		...
		data.ImportStep("admin_password"),
		{
			// Update to complete with both VM policies and zone rebalancing (includes health probe infrastructure)
			Config: r.resiliencyComplete(data),
			Check: acceptance.ComposeTestCheckFunc(
				check.That(data.ResourceName).ExistsInAzure(r),
				check.That(data.ResourceName).Key("resiliency.0.automatic_zone_rebalancing.0.rebalance_behavior").HasValue("CreateBeforeDelete"),
		...
		data.ImportStep("admin_password"),
		{
			// Final step: Update to minimal configuration with zones but without zone rebalancing
			Config: r.resiliencyMinimalWithZones(data),
			Check: acceptance.ComposeTestCheckFunc(
				check.That(data.ResourceName).ExistsInAzure(r),
				check.That(data.ResourceName).Key("resilient_vm_creation_enabled").HasValue("true"),
				check.That(data.ResourceName).Key("resilient_vm_deletion_enabled").HasValue("false"),
...
func TestAccWindowsVirtualMachineScaleSet_resiliency_RequiresImport(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_windows_virtual_machine_scale_set", "test")
	r := WindowsVirtualMachineScaleSetResource{}
...
func TestAccWindowsVirtualMachineScaleSet_resiliency_Removal(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_windows_virtual_machine_scale_set", "test")
	r := WindowsVirtualMachineScaleSetResource{}
...
func TestAccWindowsVirtualMachineScaleSet_resiliency_ZoneRebalancingOnly(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_windows_virtual_machine_scale_set", "test")
	r := WindowsVirtualMachineScaleSetResource{}
...
func TestAccWindowsVirtualMachineScaleSet_resiliency_ZoneRebalancingNonePattern(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_windows_virtual_machine_scale_set", "test")
	r := WindowsVirtualMachineScaleSetResource{}
...
func TestAccWindowsVirtualMachineScaleSet_resiliency_ValidationRebalanceBehavior(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_windows_virtual_machine_scale_set", "test")
	r := WindowsVirtualMachineScaleSetResource{}
...
func TestAccWindowsVirtualMachineScaleSet_resiliency_ValidationRebalanceStrategy(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_windows_virtual_machine_scale_set", "test")
	r := WindowsVirtualMachineScaleSetResource{}
...
func TestAccWindowsVirtualMachineScaleSet_resiliency_customizeDiffResiliencyZoneValidation(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_windows_virtual_machine_scale_set", "test")
	r := WindowsVirtualMachineScaleSetResource{}
...
func TestAccWindowsVirtualMachineScaleSet_resiliency_CustomizeDiffValidation(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_windows_virtual_machine_scale_set", "test")
	r := WindowsVirtualMachineScaleSetResource{}
...
func (r WindowsVirtualMachineScaleSetResource) resiliencyComplete(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
func (r WindowsVirtualMachineScaleSetResource) resiliencyMinimal(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
func (r WindowsVirtualMachineScaleSetResource) resiliencyRequiresImport(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
func (r WindowsVirtualMachineScaleSetResource) resiliencyVMPoliciesOnly(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
func (r WindowsVirtualMachineScaleSetResource) resiliencyInvalidRebalanceStrategy(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
func (r WindowsVirtualMachineScaleSetResource) resiliencyZoneRebalancingSingleZone(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
func (r WindowsVirtualMachineScaleSetResource) resiliencyZoneRebalancingNoZones(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
func (r WindowsVirtualMachineScaleSetResource) resiliencyZoneRebalancingMultipleZones(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
func (r WindowsVirtualMachineScaleSetResource) resiliencyMinimalWithZones(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
func (r WindowsVirtualMachineScaleSetResource) basicWithoutRollingUpgrade(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
func (r WindowsVirtualMachineScaleSetResource) resiliencyVMPoliciesOnlyWithoutRollingUpgrade(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
