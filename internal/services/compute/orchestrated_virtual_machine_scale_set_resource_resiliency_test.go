...
func TestAccOrchestratedVirtualMachineScaleSet_resiliency_automaticZoneRebalancingRequiresZones(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_orchestrated_virtual_machine_scale_set", "test")
	r := OrchestratedVirtualMachineScaleSetResource{}
...
func (r OrchestratedVirtualMachineScaleSetResource) resiliencyAutomaticZoneRebalancingNoZones(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {}
}
