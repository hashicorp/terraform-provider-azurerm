...
var _ securityprofile.Accessor = (*vmssSecurityProfileAccessor)(nil)

type vmssSecurityProfileAccessor virtualmachinescalesets.SecurityProfile

func (a *vmssSecurityProfileAccessor) uefi() *virtualmachinescalesets.UefiSettings {
	if a.UefiSettings == nil {
		a.UefiSettings = &virtualmachinescalesets.UefiSettings{}
	}
	return a.UefiSettings
}

func (a *vmssSecurityProfileAccessor) GetHostEncryption() **bool {
	return &a.EncryptionAtHost
}

func (a *vmssSecurityProfileAccessor) GetSecurityType() *string {
	return (*string)(a.SecurityType)
}

func (a *vmssSecurityProfileAccessor) SetSecurityType(v *string) {
	a.SecurityType = (*virtualmachinescalesets.SecurityTypes)(v)
}

func (a *vmssSecurityProfileAccessor) GetSecureBoot() **bool {
	return &a.uefi().SecureBootEnabled
}

func (a *vmssSecurityProfileAccessor) GetVTPM() **bool {
	return &a.uefi().VTpmEnabled
}
...
func expandVirtualMachineScaleSetSecurityProfile(d *pluginsdk.ResourceData, securityEncryptionType string) (*virtualmachinescalesets.SecurityProfile, error) {
	...
	accessor := (*vmssSecurityProfileAccessor)(profile)
