...
func TestAccLinuxVirtualMachine_otherLicenseTypeDefault(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_linux_virtual_machine", "test")
	r := LinuxVirtualMachineResource{}
...
func (r LinuxVirtualMachineResource) otherLicenseTypeDefault(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
