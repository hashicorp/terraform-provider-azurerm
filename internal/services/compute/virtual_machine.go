...
var _ securityprofile.Accessor = (*vmSecurityProfileAccessor)(nil)

type vmSecurityProfileAccessor virtualmachines.SecurityProfile

func (a *vmSecurityProfileAccessor) uefi() *virtualmachines.UefiSettings {
	if a.UefiSettings == nil {
		a.UefiSettings = &virtualmachines.UefiSettings{}
	}
	return a.UefiSettings
}

func (a *vmSecurityProfileAccessor) GetHostEncryption() **bool {
	return &a.EncryptionAtHost
}

func (a *vmSecurityProfileAccessor) GetSecurityType() *string {
	return (*string)(a.SecurityType)
}

func (a *vmSecurityProfileAccessor) SetSecurityType(v *string) {
	a.SecurityType = (*virtualmachines.SecurityTypes)(v)
}

func (a *vmSecurityProfileAccessor) GetSecureBoot() **bool {
	return &a.uefi().SecureBootEnabled
}

func (a *vmSecurityProfileAccessor) GetVTPM() **bool {
...
func expandVirtualMachineSecurityProfile(d *pluginsdk.ResourceData, securityEncryptionType string) (*virtualmachines.SecurityProfile, error) {
	...
	accessor := (*vmSecurityProfileAccessor)(profile)
