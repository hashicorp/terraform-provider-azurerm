...
func (r WindowsVirtualMachineResource) otherExtendedLocation(data acceptance.TestData) string {
	return fmt.Sprintf(`
locals {
  vm_name = "acctestvm%s"
}
...
`, data.RandomString, data.RandomInteger, data.RandomInteger, data.RandomInteger)
}
