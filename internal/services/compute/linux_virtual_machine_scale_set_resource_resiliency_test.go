...
func TestAccLinuxVirtualMachineScaleSet_resiliency_automaticZoneRebalancingRequiresZones(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_linux_virtual_machine_scale_set", "test")
	r := LinuxVirtualMachineScaleSetResource{}
...
func (r LinuxVirtualMachineScaleSetResource) resiliencyAutomaticZoneRebalancingNoZones(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
