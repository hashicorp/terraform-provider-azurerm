...
func TestAccLinuxVirtualMachineScaleSet_diskOSControllerTypeSCSI(t *testing.T) {
...
func TestAccLinuxVirtualMachineScaleSet_diskOSControllerTypeNVMe(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_linux_virtual_machine_scale_set", "test")
	r := LinuxVirtualMachineScaleSetResource{}
