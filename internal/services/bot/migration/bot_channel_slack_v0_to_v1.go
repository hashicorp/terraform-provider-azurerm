...
var _ pluginsdk.StateUpgrade = BotChannelSlackV0ToV1{}

type BotChannelSlackV0ToV1 struct{}

func (BotChannelSlackV0ToV1) Schema() map[string]*pluginsdk.Schema {
...
func (BotChannelSlackV0ToV1) UpgradeFunc() pluginsdk.StateUpgraderFunc {
