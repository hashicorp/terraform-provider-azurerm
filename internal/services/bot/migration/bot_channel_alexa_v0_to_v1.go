...
var _ pluginsdk.StateUpgrade = BotChannelAlexaV0ToV1{}

type BotChannelAlexaV0ToV1 struct{}

func (BotChannelAlexaV0ToV1) Schema() map[string]*pluginsdk.Schema {
...
func (BotChannelAlexaV0ToV1) UpgradeFunc() pluginsdk.StateUpgraderFunc {
