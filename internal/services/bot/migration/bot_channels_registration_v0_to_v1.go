...
var _ pluginsdk.StateUpgrade = BotChannelsRegistrationV0ToV1{}

type BotChannelsRegistrationV0ToV1 struct{}

func (BotChannelsRegistrationV0ToV1) Schema() map[string]*pluginsdk.Schema {
...
func (BotChannelsRegistrationV0ToV1) UpgradeFunc() pluginsdk.StateUpgraderFunc {
