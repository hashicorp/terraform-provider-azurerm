...
func (r BotChannelsRegistrationResource) basicConfig(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {}
}
...
func (r BotChannelsRegistrationResource) updateConfig(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {
    key_vault {
...
func (r BotChannelsRegistrationResource) withoutCMKKeyVaultURL(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {
    key_vault {
...
func (r BotChannelsRegistrationResource) streamingEndpointEnabled(data acceptance.TestData, streamingEndpointEnabled bool) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {
    key_vault {
...
`, r.template(data), data.RandomInteger, streamingEndpointEnabled)
}

func (BotChannelsRegistrationResource) template(data acceptance.TestData) string {
	return fmt.Sprintf(`
...
func (r BotChannelsRegistrationResource) keyVaultTemplate(data acceptance.TestData) string {
	return fmt.Sprintf(`
%[1]s
...
resource "azurerm_application_insights_api_key" "test2" {
  name                    = "acctestappinsightsapikey2-%[2]d"
