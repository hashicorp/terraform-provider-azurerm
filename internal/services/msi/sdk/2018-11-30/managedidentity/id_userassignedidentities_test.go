...
func TestNewUserAssignedIdentitiesID(t *testing.T) {
	id := NewUserAssignedIdentitiesID("12345678-1234-9876-4563-123456789012", "example-resource-group", "resourceValue")
...
func TestFormatUserAssignedIdentitiesID(t *testing.T) {
	actual := NewUserAssignedIdentitiesID("12345678-1234-9876-4563-123456789012", "example-resource-group", "resourceValue").ID()
...
func TestSegmentsForUserAssignedIdentitiesId(t *testing.T) {
	segments := UserAssignedIdentitiesId{}.Segments()
	if len(segments) == 0 {
