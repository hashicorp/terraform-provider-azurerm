...
func (c ManagedClusterClient) ListBySubscriptionComplete(ctx context.Context, id SubscriptionId) (ListBySubscriptionCompleteResult, error) {
	return c.ListBySubscriptionCompleteMatchingPredicate(ctx, id, ManagedClusterPredicate{})
}
...
func (c ManagedClusterClient) preparerForListBySubscription(ctx context.Context, id SubscriptionId) (*http.Request, error) {
...
func (c ManagedClusterClient) responderForListBySubscription(resp *http.Response) (result ListBySubscriptionResponse, err error) {
	type page struct {
