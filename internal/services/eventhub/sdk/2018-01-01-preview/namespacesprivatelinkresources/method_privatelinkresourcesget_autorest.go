...
func (c NamespacesPrivateLinkResourcesClient) PrivateLinkResourcesGet(ctx context.Context, id NamespaceId) (result PrivateLinkResourcesGetResponse, err error) {
...
func (c NamespacesPrivateLinkResourcesClient) responderForPrivateLinkResourcesGet(resp *http.Response) (result PrivateLinkResourcesGetResponse, err error) {
