...
// ConfigurationPatch ...
func (c EventHubsClustersConfigurationClient) ConfigurationPatch(ctx context.Context, id ClusterId, input ClusterQuotaConfigurationProperties) (result ConfigurationPatchResponse, err error) {
...
func (c EventHubsClustersConfigurationClient) responderForConfigurationPatch(resp *http.Response) (result ConfigurationPatchResponse, err error) {
