...
func (c EventHubsClustersNamespaceClient) responderForClustersListNamespaces(resp *http.Response) (result ClustersListNamespacesOperationResponse, err error) {
