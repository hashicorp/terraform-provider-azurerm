...
type DisasterRecoveryConfigsCheckNameAvailabilityOperationResponse struct {
...
func (c CheckNameAvailabilityDisasterRecoveryConfigsClient) responderForDisasterRecoveryConfigsCheckNameAvailability(resp *http.Response) (result DisasterRecoveryConfigsCheckNameAvailabilityOperationResponse, err error) {
