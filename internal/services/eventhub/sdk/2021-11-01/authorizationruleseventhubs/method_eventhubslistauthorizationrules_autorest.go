...
type EventHubsListAuthorizationRulesOperationResponse struct {
	...
	nextLink     *string
	nextPageFunc func(ctx context.Context, nextLink string) (EventHubsListAuthorizationRulesOperationResponse, error)
}
...
func (r EventHubsListAuthorizationRulesOperationResponse) HasMore() bool {
	return r.nextLink != nil
}

func (r EventHubsListAuthorizationRulesOperationResponse) LoadMore(ctx context.Context) (resp EventHubsListAuthorizationRulesOperationResponse, err error) {
	if !r.HasMore() {
...
func (c AuthorizationRulesEventHubsClient) EventHubsListAuthorizationRules(ctx context.Context, id EventhubId) (resp EventHubsListAuthorizationRulesOperationResponse, err error) {
...
func (c AuthorizationRulesEventHubsClient) responderForEventHubsListAuthorizationRules(resp *http.Response) (result EventHubsListAuthorizationRulesOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result EventHubsListAuthorizationRulesOperationResponse, err error) {
