...
func (c CheckNameAvailabilityNamespacesClient) preparerForNamespacesCheckNameAvailability(ctx context.Context, id commonids.SubscriptionId, input CheckNameAvailabilityParameter) (*http.Request, error) {
...
func (c CheckNameAvailabilityNamespacesClient) responderForNamespacesCheckNameAvailability(resp *http.Response) (result NamespacesCheckNameAvailabilityOperationResponse, err error) {
