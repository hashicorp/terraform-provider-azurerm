...
type DisasterRecoveryConfigsListAuthorizationRulesResponse struct {
	...
	nextLink     *string
	nextPageFunc func(ctx context.Context, nextLink string) (DisasterRecoveryConfigsListAuthorizationRulesResponse, error)
}
...
func (r DisasterRecoveryConfigsListAuthorizationRulesResponse) HasMore() bool {
	return r.nextLink != nil
}

func (r DisasterRecoveryConfigsListAuthorizationRulesResponse) LoadMore(ctx context.Context) (resp DisasterRecoveryConfigsListAuthorizationRulesResponse, err error) {
	if !r.HasMore() {
...
func (c AuthorizationRulesDisasterRecoveryConfigsClient) DisasterRecoveryConfigsListAuthorizationRules(ctx context.Context, id DisasterRecoveryConfigId) (resp DisasterRecoveryConfigsListAuthorizationRulesResponse, err error) {
...
func (c AuthorizationRulesDisasterRecoveryConfigsClient) DisasterRecoveryConfigsListAuthorizationRulesComplete(ctx context.Context, id DisasterRecoveryConfigId) (DisasterRecoveryConfigsListAuthorizationRulesCompleteResult, error) {
	return c.DisasterRecoveryConfigsListAuthorizationRulesCompleteMatchingPredicate(ctx, id, AuthorizationRulePredicate{})
}
...
func (c AuthorizationRulesDisasterRecoveryConfigsClient) DisasterRecoveryConfigsListAuthorizationRulesCompleteMatchingPredicate(ctx context.Context, id DisasterRecoveryConfigId, predicate AuthorizationRulePredicate) (resp DisasterRecoveryConfigsListAuthorizationRulesCompleteResult, err error) {
...
func (c AuthorizationRulesDisasterRecoveryConfigsClient) responderForDisasterRecoveryConfigsListAuthorizationRules(resp *http.Response) (result DisasterRecoveryConfigsListAuthorizationRulesResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result DisasterRecoveryConfigsListAuthorizationRulesResponse, err error) {
