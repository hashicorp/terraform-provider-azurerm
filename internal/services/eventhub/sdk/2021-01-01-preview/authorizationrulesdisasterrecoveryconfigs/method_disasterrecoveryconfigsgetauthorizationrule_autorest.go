...
func (c AuthorizationRulesDisasterRecoveryConfigsClient) DisasterRecoveryConfigsGetAuthorizationRule(ctx context.Context, id DisasterRecoveryConfigAuthorizationRuleId) (result DisasterRecoveryConfigsGetAuthorizationRuleResponse, err error) {
...
func (c AuthorizationRulesDisasterRecoveryConfigsClient) responderForDisasterRecoveryConfigsGetAuthorizationRule(resp *http.Response) (result DisasterRecoveryConfigsGetAuthorizationRuleResponse, err error) {
