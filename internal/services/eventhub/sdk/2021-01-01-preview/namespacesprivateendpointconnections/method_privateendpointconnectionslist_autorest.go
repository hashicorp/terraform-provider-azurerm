...
func (c NamespacesPrivateEndpointConnectionsClient) PrivateEndpointConnectionsList(ctx context.Context, id NamespaceId) (resp PrivateEndpointConnectionsListResponse, err error) {
...
func (c NamespacesPrivateEndpointConnectionsClient) PrivateEndpointConnectionsListCompleteMatchingPredicate(ctx context.Context, id NamespaceId, predicate PrivateEndpointConnectionPredicate) (resp PrivateEndpointConnectionsListCompleteResult, err error) {
...
func (c NamespacesPrivateEndpointConnectionsClient) responderForPrivateEndpointConnectionsList(resp *http.Response) (result PrivateEndpointConnectionsListResponse, err error) {
	type page struct {
