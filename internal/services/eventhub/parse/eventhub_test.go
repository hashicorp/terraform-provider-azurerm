...
func TestEventhubIDFormatter(t *testing.T) {
	actual := NewEventhubID("12345678-1234-9876-4563-123456789012", "group1", "namespace1", "hub1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/group1/providers/Microsoft.EventHub/namespaces/namespace1/eventhubs/hub1"
	if actual != expected {
...
func TestEventhubID(t *testing.T) {
	testData := []struct {
		...
		{
			// valid
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/group1/providers/Microsoft.EventHub/namespaces/namespace1/eventhubs/hub1",
			Expected: &EventhubId{
