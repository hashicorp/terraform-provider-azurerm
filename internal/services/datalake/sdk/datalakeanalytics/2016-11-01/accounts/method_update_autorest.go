...
// Update ...
func (c AccountsClient) Update(ctx context.Context, id AccountId, input UpdateDataLakeAnalyticsAccountParameters) (result UpdateResponse, err error) {
...
func (c AccountsClient) preparerForUpdate(ctx context.Context, id AccountId, input UpdateDataLakeAnalyticsAccountParameters) (*http.Request, error) {
...
func (c AccountsClient) senderForUpdate(ctx context.Context, req *http.Request) (future UpdateResponse, err error) {
