...
func (c FirewallRulesClient) CreateOrUpdate(ctx context.Context, id FirewallRuleId, input CreateOrUpdateFirewallRuleParameters) (result CreateOrUpdateResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "firewallrules.FirewallRulesClient", "CreateOrUpdate", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c FirewallRulesClient) preparerForCreateOrUpdate(ctx context.Context, id FirewallRuleId, input CreateOrUpdateFirewallRuleParameters) (*http.Request, error) {
...
func (c FirewallRulesClient) responderForCreateOrUpdate(resp *http.Response) (result CreateOrUpdateResponse, err error) {
