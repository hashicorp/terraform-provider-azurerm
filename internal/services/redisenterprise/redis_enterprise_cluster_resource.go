...
func resourceRedisEnterpriseCluster() *pluginsdk.Resource {
	resource := &pluginsdk.Resource{
		DeprecationMessage: "The `azurerm_redis_enterprise_cluster` resource has been deprecated in favour of `azurerm_managed_redis_cluster` and will be removed in v5.0 of the AzureRM provider.",
