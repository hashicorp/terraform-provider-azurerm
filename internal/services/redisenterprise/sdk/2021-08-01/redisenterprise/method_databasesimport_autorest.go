...
// DatabasesImport ...
func (c RedisEnterpriseClient) DatabasesImport(ctx context.Context, id DatabaseId, input ImportClusterParameters) (result DatabasesImportResponse, err error) {
...
func (c RedisEnterpriseClient) senderForDatabasesImport(ctx context.Context, req *http.Request) (future DatabasesImportResponse, err error) {
