...
// DatabasesExport ...
func (c RedisEnterpriseClient) DatabasesExport(ctx context.Context, id DatabaseId, input ExportClusterParameters) (result DatabasesExportResponse, err error) {
...
func (c RedisEnterpriseClient) senderForDatabasesExport(ctx context.Context, req *http.Request) (future DatabasesExportResponse, err error) {
