...
// RegenerateKey ...
func (c DatabasesClient) RegenerateKey(ctx context.Context, id DatabaseId, input RegenerateKeyParameters) (result RegenerateKeyResponse, err error) {
...
func (c DatabasesClient) senderForRegenerateKey(ctx context.Context, req *http.Request) (future RegenerateKeyResponse, err error) {
