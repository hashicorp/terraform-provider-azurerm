...
// Get ...
func (c DatabasesClient) Get(ctx context.Context, id DatabaseId) (result GetResponse, err error) {
...
func (c DatabasesClient) responderForGet(resp *http.Response) (result GetResponse, err error) {
