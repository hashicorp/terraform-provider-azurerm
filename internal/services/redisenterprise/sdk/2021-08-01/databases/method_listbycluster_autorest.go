...
type ListByClusterResponse struct {
	...
	nextLink     *string
	nextPageFunc func(ctx context.Context, nextLink string) (ListByClusterResponse, error)
}
...
func (r ListByClusterResponse) HasMore() bool {
	return r.nextLink != nil
}

func (r ListByClusterResponse) LoadMore(ctx context.Context) (resp ListByClusterResponse, err error) {
	if !r.HasMore() {
...
// ListByCluster ...
func (c DatabasesClient) ListByCluster(ctx context.Context, id RedisEnterpriseId) (resp ListByClusterResponse, err error) {
...
func (c DatabasesClient) ListByClusterComplete(ctx context.Context, id RedisEnterpriseId) (ListByClusterCompleteResult, error) {
	return c.ListByClusterCompleteMatchingPredicate(ctx, id, DatabasePredicate{})
}

// ListByClusterCompleteMatchingPredicate retrieves all of the results and then applied the predicate
func (c DatabasesClient) ListByClusterCompleteMatchingPredicate(ctx context.Context, id RedisEnterpriseId, predicate DatabasePredicate) (resp ListByClusterCompleteResult, err error) {
...
func (c DatabasesClient) responderForListByCluster(resp *http.Response) (result ListByClusterResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByClusterResponse, err error) {
