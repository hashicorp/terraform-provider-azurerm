...
// List ...
func (c PrivateEndpointConnectionsClient) List(ctx context.Context, id RedisEnterpriseId) (result ListResponse, err error) {
...
func (c PrivateEndpointConnectionsClient) preparerForList(ctx context.Context, id RedisEnterpriseId) (*http.Request, error) {
