...
// Export ...
func (c DatabasesClient) Export(ctx context.Context, id DatabaseId, input ExportClusterParameters) (result ExportResponse, err error) {
...
func (c DatabasesClient) senderForExport(ctx context.Context, req *http.Request) (future ExportResponse, err error) {
