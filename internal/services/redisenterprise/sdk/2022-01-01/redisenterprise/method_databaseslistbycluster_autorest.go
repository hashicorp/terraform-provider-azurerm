...
type DatabasesListByClusterResponse struct {
	...
	nextLink     *string
	nextPageFunc func(ctx context.Context, nextLink string) (DatabasesListByClusterResponse, error)
}
...
func (r DatabasesListByClusterResponse) HasMore() bool {
	return r.nextLink != nil
}

func (r DatabasesListByClusterResponse) LoadMore(ctx context.Context) (resp DatabasesListByClusterResponse, err error) {
	if !r.HasMore() {
...
func (c RedisEnterpriseClient) DatabasesListByClusterComplete(ctx context.Context, id RedisEnterpriseId) (DatabasesListByClusterCompleteResult, error) {
	return c.DatabasesListByClusterCompleteMatchingPredicate(ctx, id, DatabasePredicate{})
}
...
func (c RedisEnterpriseClient) responderForDatabasesListByCluster(resp *http.Response) (result DatabasesListByClusterResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result DatabasesListByClusterResponse, err error) {
