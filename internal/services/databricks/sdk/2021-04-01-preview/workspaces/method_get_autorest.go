...
// Get ...
func (c WorkspacesClient) Get(ctx context.Context, id WorkspaceId) (result GetResponse, err error) {
...
func (c WorkspacesClient) responderForGet(resp *http.Response) (result GetResponse, err error) {
