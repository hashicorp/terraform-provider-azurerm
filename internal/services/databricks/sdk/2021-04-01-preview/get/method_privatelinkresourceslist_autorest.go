...
func (c GETClient) PrivateLinkResourcesList(ctx context.Context, id WorkspaceId) (resp PrivateLinkResourcesListResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "get.GETClient", "PrivateLinkResourcesList", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "get.GETClient", "PrivateLinkResourcesList", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForPrivateLinkResourcesList(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "get.GETClient", "PrivateLinkResourcesList", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c GETClient) PrivateLinkResourcesListComplete(ctx context.Context, id WorkspaceId) (PrivateLinkResourcesListCompleteResult, error) {
	return c.PrivateLinkResourcesListCompleteMatchingPredicate(ctx, id, GroupIdInformationPredicate{})
}
...
func (c GETClient) preparerForPrivateLinkResourcesList(ctx context.Context, id WorkspaceId) (*http.Request, error) {
...
func (c GETClient) preparerForPrivateLinkResourcesListWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c GETClient) responderForPrivateLinkResourcesList(resp *http.Response) (result PrivateLinkResourcesListResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result PrivateLinkResourcesListResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "get.GETClient", "PrivateLinkResourcesList", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForPrivateLinkResourcesList(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "get.GETClient", "PrivateLinkResourcesList", result.HttpResponse, "Failure responding to request")
				return
			}
