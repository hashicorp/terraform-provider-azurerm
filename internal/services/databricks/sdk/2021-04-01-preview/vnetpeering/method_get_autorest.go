...
// Get ...
func (c VNetPeeringClient) Get(ctx context.Context, id VirtualNetworkPeeringId) (result GetResponse, err error) {
...
func (c VNetPeeringClient) responderForGet(resp *http.Response) (result GetResponse, err error) {
