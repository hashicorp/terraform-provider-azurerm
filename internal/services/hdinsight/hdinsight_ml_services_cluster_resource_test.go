...
func TestAccHDInsightMLServicesCluster_updateTargetInstanceCount(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_hdinsight_ml_services_cluster", "test")
	r := HDInsightMLServicesClusterResource{}
...
func (r HDInsightMLServicesClusterResource) initTargetInstanceCount(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
func (r HDInsightMLServicesClusterResource) removeTargetInstanceCount(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
