...
func (r HDInsightRServerClusterResource) initTargetInstanceCount(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
func (r HDInsightRServerClusterResource) removeTargetInstanceCount(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
