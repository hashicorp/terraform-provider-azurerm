...
var _ resourceids.Id = SpringCloudBuildServiceBuilderId{}

func TestSpringCloudBuildServiceBuilderIDFormatter(t *testing.T) {
	actual := NewSpringCloudBuildServiceBuilderID("12345678-1234-9876-4563-123456789012", "resourceGroup1", "service1", "buildService1", "builder1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resourceGroup1/providers/Microsoft.AppPlatform/spring/service1/buildServices/buildService1/builders/builder1"
	if actual != expected {
		t.Fatalf("Expected %q but got %q", expected, actual)
	}
}

func TestSpringCloudBuildServiceBuilderID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
	...
	for _, v := range testData {
		...
		actual, err := SpringCloudBuildServiceBuilderID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSpringCloudBuildServiceBuilderIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *SpringCloudBuildServiceBuilderId
	...
	for _, v := range testData {
		...
		actual, err := SpringCloudBuildServiceBuilderIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
