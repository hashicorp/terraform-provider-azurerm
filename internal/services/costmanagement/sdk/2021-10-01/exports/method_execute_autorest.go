...
// Execute ...
func (c ExportsClient) Execute(ctx context.Context, id ScopedExportId) (result ExecuteResponse, err error) {
...
func (c ExportsClient) responderForExecute(resp *http.Response) (result ExecuteResponse, err error) {
