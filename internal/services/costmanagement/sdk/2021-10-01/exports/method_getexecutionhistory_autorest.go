...
// GetExecutionHistory ...
func (c ExportsClient) GetExecutionHistory(ctx context.Context, id ScopedExportId) (result GetExecutionHistoryResponse, err error) {
...
func (c ExportsClient) responderForGetExecutionHistory(resp *http.Response) (result GetExecutionHistoryResponse, err error) {
