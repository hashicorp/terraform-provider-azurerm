...
//go:generate go run ../../tools/generator-resource-id/main.go -path=./ -name=SubscriptionCostManagementScheduledAction -id=/subscriptions/12345678-1234-9876-4563-123456789012/providers/Microsoft.CostManagement/scheduledActions/scheduledaction1
