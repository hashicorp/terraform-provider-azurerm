	...
	data.DataSourceTest(t, []acceptance.TestStep{
		{
			...
			Check: acceptance.ComposeTestCheckFunc(
				...
				check.That(data.ResourceName).Key(`network_address_port_translation.0.pinhole_timeouts_in_seconds.0.icmp`).HasValue("30"),
				check.That(data.ResourceName).Key(`network_address_port_translation.0.pinhole_timeouts_in_seconds.0.tcp`).HasValue("100"),
				check.That(data.ResourceName).Key(`network_address_port_translation.0.pinhole_timeouts_in_seconds.0.udp`).HasValue("39"),
				...
				check.That(data.ResourceName).Key(`network_address_port_translation.0.port_reuse_minimum_hold_time_in_seconds.0.tcp`).HasValue("120"),
				check.That(data.ResourceName).Key(`network_address_port_translation.0.port_reuse_minimum_hold_time_in_seconds.0.udp`).HasValue("60"),
