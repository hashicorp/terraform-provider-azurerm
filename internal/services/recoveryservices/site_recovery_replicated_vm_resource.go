...
func resourceSiteRecoveryReplicatedVM() *pluginsdk.Resource {
	return &pluginsdk.Resource{
		...
		CustomizeDiff: pluginsdk.CustomDiffWithAll(
			pluginsdk.CustomizeDiffShim(resourceSiteRecoveryReplicatedVMCustomizeDiff),
			pluginsdk.CustomizeDiffShim(resourceSiteRecoveryReplicatedVMManagedDiskCustomizeDiff),
		),
...
func resourceSiteRecoveryReplicatedVMManagedDiskCustomizeDiff(_ context.Context, d *pluginsdk.ResourceDiff, _ interface{}) error {
