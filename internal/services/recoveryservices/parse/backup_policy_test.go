...
var _ resourceids.Id = BackupPolicyId{}

func TestBackupPolicyIDFormatter(t *testing.T) {
	actual := NewBackupPolicyID("12345678-1234-9876-4563-123456789012", "group1", "vault1", "policy1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/group1/providers/Microsoft.RecoveryServices/vaults/vault1/backupPolicies/policy1"
	if actual != expected {
...
func TestBackupPolicyID(t *testing.T) {
	testData := []struct {
...

		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/group1/providers/Microsoft.RecoveryServices/vaults/vault1/backupPolicies/",
			Error: true,
		},

		{
			// valid
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/group1/providers/Microsoft.RecoveryServices/vaults/vault1/backupPolicies/policy1",
			Expected: &BackupPolicyId{
