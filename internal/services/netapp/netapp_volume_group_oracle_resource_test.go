...
// func TestAccNetAppVolumeGroupOracle_backupVolumeSpecsNfsv3(t *testing.T) {
// 	data := acceptance.BuildTestData(t, "azurerm_netapp_volume_group_oracle", "test")
// 	r := NetAppVolumeGroupOracleResource{}
...
// func (NetAppVolumeGroupOracleResource) backupVolumeSpecsNfsv3(data acceptance.TestData) string {
// 	template := NetAppVolumeGroupOracleResource{}.templatePPG(data)
// 	return fmt.Sprintf(`
// %[1]s
...
// 	template := NetAppVolumeGroupOracleResource{}.templateForAvgCrossRegionReplication(data)
// 	return fmt.Sprintf(`
// %[1]s
...
//   volume {
//     name                         = "acctest-NetAppVolume-Ora2-Primary-%[2]d"
//     volume_path                  = "my-unique-file-ora-path-2-Primary-%[2]d"
//     service_level                = "Standard"
//     capacity_pool_id             = azurerm_netapp_pool.test.id
//     subnet_id                    = azurerm_subnet.test.id
//     zone                         = "1"
...
//   volume {
//     name                         = "acctest-NetAppVolume-Ora3-Primary-%[2]d"
//     volume_path                  = "my-unique-file-ora-path-3-Primary-%[2]d"
//     service_level                = "Standard"
//     capacity_pool_id             = azurerm_netapp_pool.test.id
//     subnet_id                    = azurerm_subnet.test.id
//     zone                         = "1"
...
//   volume {
//     name                       = "acctest-NetAppVolume-Ora4-Primary-%[2]d"
//     volume_path                = "my-unique-file-ora-path-4-Primary-%[2]d"
//     service_level              = "Standard"
//     capacity_pool_id           = azurerm_netapp_pool.test.id
//     subnet_id                  = azurerm_subnet.test.id
//     zone                       = "1"
...
//   volume {
//     name                       = "acctest-NetAppVolume-Ora5-Primary-%[2]d"
//     volume_path                = "my-unique-file-ora-path-5-Primary-%[2]d"
//     service_level              = "Standard"
//     capacity_pool_id           = azurerm_netapp_pool.test.id
//     subnet_id                  = azurerm_subnet.test.id
//     zone                       = "1"
...
//   volume {
//     name                         = "acctest-NetAppVolume-Ora2-Secondary-%[2]d"
//     volume_path                  = "my-unique-file-ora-path-2-Secondary-%[2]d"
//     service_level                = "Standard"
//     capacity_pool_id             = azurerm_netapp_pool.test_secondary.id
//     subnet_id                    = azurerm_subnet.test_secondary.id
//     proximity_placement_group_id = azurerm_proximity_placement_group.test_secondary.id
...
//   volume {
//     name                         = "acctest-NetAppVolume-Ora3-Secondary-%[2]d"
//     volume_path                  = "my-unique-file-ora-path-3-Secondary-%[2]d"
//     service_level                = "Standard"
//     capacity_pool_id             = azurerm_netapp_pool.test_secondary.id
//     subnet_id                    = azurerm_subnet.test_secondary.id
//     proximity_placement_group_id = azurerm_proximity_placement_group.test_secondary.id
...
//       endpoint_type             = "dst"
//       remote_volume_location    = azurerm_netapp_volume_group_oracle.test_primary.location
//       remote_volume_resource_id = azurerm_netapp_volume_group_oracle.test_primary.volume[2].id
//       replication_frequency     = "10minutes"
//     }
...
//   volume {
//     name                       = "acctest-NetAppVolume-Ora4-Secondary-%[2]d"
//     volume_path                = "my-unique-file-ora-path-4-Secondary-%[2]d"
//     service_level              = "Standard"
//     capacity_pool_id           = azurerm_netapp_pool.test_secondary.id
//     subnet_id                  = azurerm_subnet.test_secondary.id
//     volume_spec_name           = "data-backup"
...
//       endpoint_type             = "dst"
//       remote_volume_location    = azurerm_netapp_volume_group_oracle.test_primary.location
//       remote_volume_resource_id = azurerm_netapp_volume_group_oracle.test_primary.volume[3].id
//       replication_frequency     = "10minutes"
//     }
...
//   volume {
//     name                       = "acctest-NetAppVolume-Ora5-Secondary-%[2]d"
//     volume_path                = "my-unique-file-ora-path-5-Secondary-%[2]d"
//     service_level              = "Standard"
//     capacity_pool_id           = azurerm_netapp_pool.test_secondary.id
//     subnet_id                  = azurerm_subnet.test_secondary.id
//     volume_spec_name           = "log-backup"
...
//       endpoint_type             = "dst"
//       remote_volume_location    = azurerm_netapp_volume_group_oracle.test_primary.location
//       remote_volume_resource_id = azurerm_netapp_volume_group_oracle.test_primary.volume[4].id
//       replication_frequency     = "10minutes"
//     }
...
// func (r NetAppVolumeGroupOracleResource) templateForAvgCrossRegionReplication(data acceptance.TestData) string {
// 	template := NetAppVolumeGroupOracleResource{}.templatePPG(data)
// 	return fmt.Sprintf(`
// %[1]s
