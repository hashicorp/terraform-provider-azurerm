...
func dataSourceKubernetesAutomaticCluster() *pluginsdk.Resource {
	resource := &pluginsdk.Resource{
		Read: dataSourceKubernetesAutomaticClusterRead,
...
func dataSourceKubernetesAutomaticClusterRead(d *pluginsdk.ResourceData, meta interface{}) error {
	...
	if model := resp.Model; model != nil {
		...
		if props := model.Properties; props != nil {
			...
			if addonProfiles := props.AddonProfiles; addonProfiles != nil {
				addOns := flattenKubernetesAutomaticClusterDataSourceAddOns(*addonProfiles)
			...
			agentPoolProfiles := flattenKubernetesAutomaticClusterDataSourceAgentPoolProfiles(props.AgentPoolProfiles)
			...
			kubeletIdentity, err := flattenKubernetesAutomaticClusterDataSourceIdentityProfile(props.IdentityProfile)
			if err != nil {
				return err
			}
			...
			linuxProfile := flattenKubernetesAutomaticClusterDataSourceLinuxProfile(props.LinuxProfile)
			if err := d.Set("linux_profile", linuxProfile); err != nil {
				return fmt.Errorf("setting `linux_profile`: %+v", err)
			}

			windowsProfile := flattenKubernetesAutomaticClusterDataSourceWindowsProfile(props.WindowsProfile)
			if err := d.Set("windows_profile", windowsProfile); err != nil {
				return fmt.Errorf("setting `windows_profile`: %+v", err)
			}

			networkProfile := flattenKubernetesAutomaticClusterDataSourceNetworkProfile(props.NetworkProfile)
			...
			storageProfile := flattenKubernetesAutomaticClusterDataSourceStorageProfile(props.StorageProfile)
			...
			microsoftDefender := flattenKubernetesAutomaticClusterDataSourceMicrosoftDefender(props.SecurityProfile)
			if err := d.Set("microsoft_defender", microsoftDefender); err != nil {
				return fmt.Errorf("setting `microsoft_defender`: %+v", err)
			}

			aadRbac := flattenKubernetesAutomaticClusterDataSourceAzureActiveDirectoryRoleBasedAccessControl(props)
			...
			servicePrincipal := flattenKubernetesAutomaticClusterDataSourceServicePrincipalProfile(props.ServicePrincipalProfile)
			...
			if props.AadProfile != nil && (props.DisableLocalAccounts == nil || !*props.DisableLocalAccounts) {
				...
				adminKubeConfigRaw, adminKubeConfig = flattenKubernetesAutomaticClusterCredentials(adminCredentialsResp.Model, "clusterAdmin")
			}
...
func flattenKubernetesAutomaticClusterDataSourceKeyVaultKms(input *managedclusters.ManagedClusterSecurityProfile) []interface{} {
...
func flattenKubernetesAutomaticClusterDataSourceStorageProfile(input *managedclusters.ManagedClusterStorageProfile) []interface{} {
...
func flattenKubernetesAutomaticClusterCredentials(model *managedclusters.CredentialResults, configName string) (*string, []interface{}) {
...
func flattenKubernetesAutomaticClusterDataSourceAddOns(profile map[string]managedclusters.ManagedClusterAddonProfile) map[string]interface{} {
...
func flattenKubernetesAutomaticClusterDataSourceAgentPoolProfiles(input *[]managedclusters.ManagedClusterAgentPoolProfile) []interface{} {
	...
	for _, profile := range *input {
		...
		out := map[string]interface{}{
			...
			"upgrade_settings":         flattenKubernetesAutomaticClusterDataSourceUpgradeSettings(profile.UpgradeSettings),
			"vm_size":                  vmSize,
...
func flattenKubernetesAutomaticClusterDataSourceAzureActiveDirectoryRoleBasedAccessControl(input *managedclusters.ManagedClusterProperties) []interface{} {
...
func flattenKubernetesAutomaticClusterDataSourceIdentityProfile(profile *map[string]managedclusters.UserAssignedIdentity) ([]interface{}, error) {
...
func flattenKubernetesAutomaticClusterDataSourceLinuxProfile(input *managedclusters.ContainerServiceLinuxProfile) []interface{} {
...
func flattenKubernetesAutomaticClusterDataSourceWindowsProfile(input *managedclusters.ManagedClusterWindowsProfile) []interface{} {
	if input == nil {
		return []interface{}{}
	}
	values := make(map[string]interface{})
...
func flattenKubernetesAutomaticClusterDataSourceNetworkProfile(profile *managedclusters.ContainerServiceNetworkProfile) []interface{} {
	values := make(map[string]interface{})
...
func flattenKubernetesAutomaticClusterDataSourceServicePrincipalProfile(profile *managedclusters.ManagedClusterServicePrincipalProfile) []interface{} {
	if profile == nil {
		return []interface{}{}
	}
...
func flattenKubernetesAutomaticClusterDataSourceKubeConfig(config kubernetes.KubeConfig) []interface{} {
	values := make(map[string]interface{})
...
func flattenKubernetesAutomaticClusterDataSourceKubeConfigAAD(config kubernetes.KubeConfigAAD) []interface{} {
	values := make(map[string]interface{})
...
func flattenKubernetesAutomaticClusterDataSourceUpgradeSettings(input *managedclusters.AgentPoolUpgradeSettings) []interface{} {
	if input == nil {
		return []interface{}{}
	}
