...
//go:generate go run ../../tools/generator-resource-id/main.go -path=./ -name=ServiceVersion -id=/subscriptions/12345678-1234-9876-4563-123456789012/providers/Microsoft.ContainerService/locations/location1
