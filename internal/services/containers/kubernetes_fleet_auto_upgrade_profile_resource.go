...
func (r KubernetesFleetAutoUpgradeProfileResource) Identity() resourceids.ResourceId {
	return &autoupgradeprofiles.AutoUpgradeProfileId{}
}
...
func (r KubernetesFleetAutoUpgradeProfileResource) Create() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		...
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			...
			if err := client.CreateOrUpdateCallbackThenPoll(ctx, id, payload, autoupgradeprofiles.DefaultCreateOrUpdateOperationOptions(), metadata.SetIDAndIdentityCallback(&id)); err != nil {
