...
func resourceKubernetesClusterUpdate(d *pluginsdk.ResourceData, meta interface{}) error {
	...
	if d.HasChange("aci_connector_linux") || d.HasChange("azure_policy_enabled") || d.HasChange("confidential_computing_enabled") || d.HasChange("confidential_computing_quote_helper_enabled") || d.HasChange("http_application_routing_enabled") || d.HasChange("oms_agent") || d.HasChange("ingress_application_gateway") || d.HasChange("open_service_mesh_enabled") || d.HasChange("key_vault_secrets_provider") {
		updateCluster = true
		addOns := collectKubernetesAddons(d)
		addonProfiles, err := expandKubernetesAddOns(d, addOns, env)
		if err != nil {
...
func resourceKubernetesClusterRead(d *pluginsdk.ResourceData, meta interface{}) error {
	...
	if props := respModel.Properties; props != nil {
		...
		if props.AddonProfiles != nil {
			...
			d.Set("confidential_computing_quote_helper_enabled", addOns["confidential_computing_quote_helper_enabled"].(bool))
