...
import (
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/containerservice/2023-04-02-preview/trustedaccess"
...
func (r KubernetesClusterTrustedAccessRoleBindingResource) Create() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		...
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			client := metadata.Client.ContainerService.V20230402Preview.TrustedAccess
			...
			id := trustedaccess.NewTrustedAccessRoleBindingID(subscriptionId, config.KubernetesClusterId, config.KubernetesClusterId, config.Name)
	...
	return sdk.ResourceFunc{
		...
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			...
			if model := resp.Model; model != nil {
				schema.KubernetesClusterId = id.ManagedClusterName
				schema.KubernetesClusterId = id.ResourceGroupName
