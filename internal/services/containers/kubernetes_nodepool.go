...
func flattenClusterNodePoolKubeletConfig(input *managedclusters.KubeletConfig) []interface{} {
	...
	return []interface{}{
		map[string]interface{}{
			...
			"allowed_unsafe_sysctls":    helpers.FlattenSlice(input.AllowedUnsafeSysctls),
...
func flattenClusterPoolNetworkProfile(input *managedclusters.AgentPoolNetworkProfile) []interface{} {
	...
	return []interface{}{
		map[string]interface{}{
			...
			"application_security_group_ids": helpers.FlattenSlice(input.ApplicationSecurityGroups),
