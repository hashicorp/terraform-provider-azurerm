...
type Client struct {
	...
	ContainerRegistryClient_v2021_08_01_preview *containerregistry_v2023_06_01_preview.Client
...
func NewContainersClient(o *common.ClientOptions) (*Client, error) {
	...
	containerRegistryClient_v2021_08_01_preview, err := containerregistry_v2023_06_01_preview.NewClientWithBaseURI(o.Environment.ResourceManager, func(c *resourcemanager.Client) {
		o.Configure(c, o.Authorizers.ResourceManager)
	})
	if err != nil {
		return nil, err
