...
type Client struct {
	...
	StandbyContainerGroupPoolsClient            *standbycontainergrouppools.StandbyContainerGroupPoolsClient
...
func NewContainersClient(o *common.ClientOptions) (*Client, error) {
	...
	standbyContainerGroupPoolClient, err := standbycontainergrouppools.NewStandbyContainerGroupPoolsClientWithBaseURI(o.Environment.ResourceManager)
	if err != nil {
		return nil, fmt.Errorf("build Standby Container Group Pool Client: %+v", err)
	}
	o.Configure(standbyContainerGroupPoolClient.Client, o.Authorizers.ResourceManager)
	...
	return &Client{
		...
		StandbyContainerGroupPoolsClient:            standbyContainerGroupPoolClient,
