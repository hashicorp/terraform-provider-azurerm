...
import (
	...
	containerservice_2024_09_01 "github.com/hashicorp/go-azure-sdk/resource-manager/containerservice/2024-09-01"
	"github.com/hashicorp/go-azure-sdk/sdk/client/resourcemanager"
	"github.com/hashicorp/terraform-provider-azurerm/internal/common"
)

type AutoClient struct {
	V20230302Preview containerservice_2024_09_01.Client
	V20231015        containerservice_2024_04_01.Client
}

func NewClient(o *common.ClientOptions) (*AutoClient, error) {
	v20230302PreviewClient, err := containerservice_2024_09_01.NewClientWithBaseURI(o.Environment.ResourceManager, func(c *resourcemanager.Client) {
