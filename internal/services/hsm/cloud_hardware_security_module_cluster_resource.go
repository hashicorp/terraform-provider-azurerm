...
type CloudHardwareSecurityModuleClusterModel struct {
	...
	DomainNameReuse   string                       `tfschema:"domain_name_reuse"`
	Tags              map[string]string            `tfschema:"tags"`

	// Computed
	HardwareSecurityModules []CloudHsmPropertiesModel `tfschema:"hardware_security_module"`
}
		...
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			...
			parameters := cloudhsmclusters.CloudHsmCluster{
				...
				Properties: &cloudhsmclusters.CloudHsmClusterProperties{
					AutoGeneratedDomainNameLabelScope: pointer.ToEnum[cloudhsmclusters.AutoGeneratedDomainNameLabelScope](model.DomainNameReuse),
				},
			}
		...
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			...
			if m := resp.Model; m != nil {
				...
				if props := m.Properties; props != nil {
					model.DomainNameReuse = string(pointer.From(props.AutoGeneratedDomainNameLabelScope))
					...
					if props.Hsms != nil {
						...
						model.HardwareSecurityModules = hsms
					}
				}
			}
