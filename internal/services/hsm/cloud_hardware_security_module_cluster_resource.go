...
func (r CloudHardwareSecurityModuleClusterResource) Update() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		...
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			...
			cluster.Id = nil
			cluster.Properties = &cloudhsmclusters.CloudHsmClusterProperties{
				AutoGeneratedDomainNameLabelScope: cluster.Properties.AutoGeneratedDomainNameLabelScope,
			}
...
func (r CloudHardwareSecurityModuleClusterResource) Delete() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		...
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			...
			if !ok {
				return fmt.Errorf("expected context to have deadline")
			}
