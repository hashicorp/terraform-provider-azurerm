...
func TestAccWorkloadsSAPThreeTierVirtualInstance_transportMount(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_workloads_sap_three_tier_virtual_instance", "test")
	r := WorkloadsSAPThreeTierVirtualInstanceResource{}
	sapVISNameSuffix := RandomInt()
...
func (r WorkloadsSAPThreeTierVirtualInstanceResource) transportMount(data acceptance.TestData, sapVISNameSuffix int) string {
	return fmt.Sprintf(`
%s
