...
func TestAccWorkloadsSAPVirtualInstance_basic(t *testing.T) {
	...
	data.ResourceTest(t, r, []acceptance.TestStep{
		...
		data.ImportStep("deployment_with_os_configuration.0.single_server_configuration.0.virtual_machine_configuration.0.os_profile.0.ssh_key_pair.0.private_key"),
	})
}
