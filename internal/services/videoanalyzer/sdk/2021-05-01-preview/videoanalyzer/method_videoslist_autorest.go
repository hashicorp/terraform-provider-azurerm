...
type VideosListResponse struct {
	...
	nextLink     *string
	nextPageFunc func(ctx context.Context, nextLink string) (VideosListResponse, error)
}
...
func DefaultVideosListOptions() VideosListOptions {
	return VideosListOptions{}
}

func (o VideosListOptions) toQueryString() map[string]interface{} {
...
// VideosList ...
func (c VideoAnalyzerClient) VideosList(ctx context.Context, id VideoAnalyzerId, options VideosListOptions) (resp VideosListResponse, err error) {
...
func (c VideoAnalyzerClient) VideosListComplete(ctx context.Context, id VideoAnalyzerId, options VideosListOptions) (VideosListCompleteResult, error) {
	return c.VideosListCompleteMatchingPredicate(ctx, id, options, VideoEntityPredicate{})
}
...
func (c VideoAnalyzerClient) preparerForVideosList(ctx context.Context, id VideoAnalyzerId, options VideosListOptions) (*http.Request, error) {
...
func (c VideoAnalyzerClient) responderForVideosList(resp *http.Response) (result VideosListResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result VideosListResponse, err error) {
