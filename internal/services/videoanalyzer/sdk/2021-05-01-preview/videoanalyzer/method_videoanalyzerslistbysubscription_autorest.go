...
func (c VideoAnalyzerClient) preparerForVideoAnalyzersListBySubscription(ctx context.Context, id SubscriptionId) (*http.Request, error) {
...
func (c VideoAnalyzerClient) responderForVideoAnalyzersListBySubscription(resp *http.Response) (result VideoAnalyzersListBySubscriptionResponse, err error) {
