...
// ListByResource ...
func (c PrivateEndpointConnectionsClient) ListByResource(ctx context.Context, id ParentTypeId, options ListByResourceOptions) (resp ListByResourceResponse, err error) {
...
func (c PrivateEndpointConnectionsClient) ListByResourceComplete(ctx context.Context, id ParentTypeId, options ListByResourceOptions) (ListByResourceCompleteResult, error) {
	return c.ListByResourceCompleteMatchingPredicate(ctx, id, options, PrivateEndpointConnectionPredicate{})
}

// ListByResourceCompleteMatchingPredicate retrieves all of the results and then applied the predicate
func (c PrivateEndpointConnectionsClient) ListByResourceCompleteMatchingPredicate(ctx context.Context, id ParentTypeId, options ListByResourceOptions, predicate PrivateEndpointConnectionPredicate) (resp ListByResourceCompleteResult, err error) {
...
func (c PrivateEndpointConnectionsClient) preparerForListByResource(ctx context.Context, id ParentTypeId, options ListByResourceOptions) (*http.Request, error) {
...
func (c PrivateEndpointConnectionsClient) responderForListByResource(resp *http.Response) (result ListByResourceResponse, err error) {
	type page struct {
