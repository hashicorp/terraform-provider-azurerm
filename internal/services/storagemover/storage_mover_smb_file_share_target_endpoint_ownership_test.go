...
type smbTargetEndpointOwnershipTransport func(*http.Request) (*http.Response, error)

func (f smbTargetEndpointOwnershipTransport) RoundTrip(r *http.Request) (*http.Response, error) {
	return f(r)
}
