...
func (r StorageMoverSmbMountEndpointResource) listConfig(data acceptance.TestData) string {
...
func (r StorageMoverSmbMountEndpointResource) listQuery() string {
	return `
list "azurerm_storage_mover_smb_mount_endpoint" "list" {
  provider = azurerm
  config {
    storage_mover_id = azurerm_storage_mover.test.id
  }
