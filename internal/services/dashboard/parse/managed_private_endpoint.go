...
func NewManagedPrivateEndpointID(subscriptionId, resourceGroup, grafanaName, name string) ManagedPrivateEndpointId {
...
func (id ManagedPrivateEndpointId) ID() string {
	...
	return fmt.Sprintf(fmtString, id.SubscriptionId, id.ResourceGroup, id.GrafanaName, id.Name)
}
...
func ManagedPrivateEndpointID(input string) (*ManagedPrivateEndpointId, error) {
	...
	if resourceId.GrafanaName, err = id.PopSegment("grafana"); err != nil {
		return nil, err
	}
