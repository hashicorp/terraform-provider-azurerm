...
type DashboardGrafanaModel struct {
	...
	GrafanaIntegrations               []GrafanaIntegrationsModel                        `tfschema:"grafana_integrations"`
...
type GrafanaIntegrationsModel struct {
...
type AzureMonitorWorkspaceIntegrationModel struct {
	AzureMonitorWorkspaceResourceId string `tfschema:"azure_monitor_workspace_resource_id"`
}
		...
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			...
			properties := &grafanaresource.ManagedGrafana{
				...
				Properties: &grafanaresource.ManagedGrafanaProperties{
					...
					GrafanaIntegrations:               expandGrafanaIntegrationsModel(model.GrafanaIntegrations),
...
func (r DashboardGrafanaResource) Update() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		...
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			...
			if metadata.ResourceData.HasChange("grafana_integrations") {
				properties.Properties.GrafanaIntegrations = expandGrafanaIntegrationsModel(model.GrafanaIntegrations)
			}
	...
	return sdk.ResourceFunc{
		...
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			...
			if properties := model.Properties; properties != nil {
				...
				state.GrafanaIntegrations = flattenGrafanaIntegrationsModel(properties.GrafanaIntegrations)
...
func expandGrafanaIntegrationsModel(inputList []GrafanaIntegrationsModel) *grafanaresource.GrafanaIntegrations {
	if len(inputList) == 0 {
		return nil
	}

	input := &inputList[0]
	output := grafanaresource.GrafanaIntegrations{
		AzureMonitorWorkspaceIntegrations: expandAzureMonitorWorkspaceIntegrationModelArray(input.AzureMonitorWorkspaceIntegrations),
	}
...
func expandAzureMonitorWorkspaceIntegrationModelArray(inputList []AzureMonitorWorkspaceIntegrationModel) *[]grafanaresource.AzureMonitorWorkspaceIntegration {
	...
	for _, v := range inputList {
		...
		output := grafanaresource.AzureMonitorWorkspaceIntegration{
			AzureMonitorWorkspaceResourceId: &input.AzureMonitorWorkspaceResourceId,
		}
...
func flattenGrafanaIntegrationsModel(input *grafanaresource.GrafanaIntegrations) []GrafanaIntegrationsModel {
	var outputList []GrafanaIntegrationsModel
	if input == nil {
		return outputList
	}

	output := GrafanaIntegrationsModel{
		AzureMonitorWorkspaceIntegrations: flattenAzureMonitorWorkspaceIntegrationModelArray(input.AzureMonitorWorkspaceIntegrations),
	}
...
func flattenAzureMonitorWorkspaceIntegrationModelArray(inputList *[]grafanaresource.AzureMonitorWorkspaceIntegration) []AzureMonitorWorkspaceIntegrationModel {
	...
	for _, input := range *inputList {
		...
		if input.AzureMonitorWorkspaceResourceId != nil {
			output.AzureMonitorWorkspaceResourceId = *input.AzureMonitorWorkspaceResourceId
		}
