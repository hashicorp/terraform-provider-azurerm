...
func (c MonitoredResourcesClient) List(ctx context.Context, id MonitorId) (resp ListOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "monitoredresources.MonitoredResourcesClient", "List", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForList(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "monitoredresources.MonitoredResourcesClient", "List", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c MonitoredResourcesClient) preparerForList(ctx context.Context, id MonitorId) (*http.Request, error) {
...
func (c MonitoredResourcesClient) preparerForListWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c MonitoredResourcesClient) responderForList(resp *http.Response) (result ListOperationResponse, err error) {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "monitoredresources.MonitoredResourcesClient", "List", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForList(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "monitoredresources.MonitoredResourcesClient", "List", result.HttpResponse, "Failure responding to request")
				return
			}
