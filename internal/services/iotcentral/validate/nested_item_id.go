...
import (
	...
	iotCentralParser "github.com/hashicorp/terraform-provider-azurerm/internal/services/iotcentral/parse"
...
func NestedItemId(i interface{}, k string) (warnings []string, errors []error) {
	...
	if _, err := iotCentralParser.ParseNestedItemID(v); err != nil {
