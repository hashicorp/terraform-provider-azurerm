...
func (c PrivateCloudsClient) preparerForList(ctx context.Context, id ResourceGroupId) (*http.Request, error) {
...
func (c PrivateCloudsClient) responderForList(resp *http.Response) (result ListResponse, err error) {
	type page struct {
