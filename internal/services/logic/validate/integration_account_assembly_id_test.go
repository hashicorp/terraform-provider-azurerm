...
func TestIntegrationAccountAssemblyID(t *testing.T) {
	cases := []struct {
		Input string
		Valid bool
	}{
...

		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/group1/providers/Microsoft.Logic/integrationAccounts/account1/assemblies/",
			Valid: false,
		},

		{
			// valid
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/group1/providers/Microsoft.Logic/integrationAccounts/account1/assemblies/assembly1",
			Valid: true,
		},
	...
	for _, tc := range cases {
		...
		_, errors := IntegrationAccountAssemblyID(tc.Input, "test")
		valid := len(errors) == 0
