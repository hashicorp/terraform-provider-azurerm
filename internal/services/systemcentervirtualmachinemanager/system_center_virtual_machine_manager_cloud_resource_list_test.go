...
func TestAccSystemCenterVirtualMachineManagerCloudListSequential(t *testing.T) {
	...
	acceptance.RunTestsInSequence(t, map[string]map[string]func(t *testing.T){
		"scvmmCloudList": {
			"basic": testAccSystemCenterVirtualMachineManagerCloud_list_basic,
		},
	})
}
...
func testAccSystemCenterVirtualMachineManagerCloud_list_basic(t *testing.T) {
	...
	data := acceptance.BuildTestData(t, "azurerm_system_center_virtual_machine_manager_cloud", "testlist")
...
func (r SystemCenterVirtualMachineManagerCloudResource) basicList(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
resource "azurerm_system_center_virtual_machine_manager_cloud" "test" {
  ...
  name                                                           = "acctest-scvmmc-${count.index}-%d"
...
func (r SystemCenterVirtualMachineManagerCloudResource) basicQuery() string {
	return `
list "azurerm_system_center_virtual_machine_manager_cloud" "list" {
  provider = azurerm
  config {}
}
`
...
func (r SystemCenterVirtualMachineManagerCloudResource) basicQueryByResourceGroupName(data acceptance.TestData) string {
	return fmt.Sprintf(`
list "azurerm_system_center_virtual_machine_manager_cloud" "list" {
  provider = azurerm
  config {
    resource_group_name = "acctestrg-scvmmcloud-%d"
  }
}
`, data.RandomInteger)
}
