...
func TestAccSystemCenterVirtualMachineManagerAvailabilitySetListSequential(t *testing.T) {
	...
	acceptance.RunTestsInSequence(t, map[string]map[string]func(t *testing.T){
		"scvmmAvailabilitySetList": {
			"basic": testAccSystemCenterVirtualMachineManagerAvailabilitySet_list_basic,
		},
	})
}
...
func testAccSystemCenterVirtualMachineManagerAvailabilitySet_list_basic(t *testing.T) {
	...
	data := acceptance.BuildTestData(t, "azurerm_system_center_virtual_machine_manager_availability_set", "testlist")
...
func (r SystemCenterVirtualMachineManagerAvailabilitySetResource) basicList(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
resource "azurerm_system_center_virtual_machine_manager_availability_set" "test" {
  ...
  name                                            = "acctest-scvmmas-${count.index}-%d"
...
func (r SystemCenterVirtualMachineManagerAvailabilitySetResource) basicQuery() string {
	return `
list "azurerm_system_center_virtual_machine_manager_availability_set" "list" {
  provider = azurerm
  config {}
}
`
...
func (r SystemCenterVirtualMachineManagerAvailabilitySetResource) basicQueryByResourceGroupName(data acceptance.TestData) string {
	return fmt.Sprintf(`
list "azurerm_system_center_virtual_machine_manager_availability_set" "list" {
  provider = azurerm
  config {
    resource_group_name = "acctestrg-scvmmas-%d"
  }
}
`, data.RandomInteger)
}
