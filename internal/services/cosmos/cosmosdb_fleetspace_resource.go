...
//go:generate go run ../../tools/generator-tests resourceidentity -resource-name cosmosdb_fleetspace -properties "name,resource_group_name,fleet_name" -known-values "subscription_id:data.Subscriptions.Primary"
