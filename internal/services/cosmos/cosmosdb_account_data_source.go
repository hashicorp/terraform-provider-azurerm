...
func dataSourceCosmosDbAccountRead(d *pluginsdk.ResourceData, meta interface{}) error {
	...
	if err != nil {
		...
		if keysModel := keys.Model; keysModel != nil {
			d.Set("primary_key", keysModel.PrimaryMasterKey)
			d.Set("secondary_key", keysModel.SecondaryMasterKey)
		}
	}
	...
	if err != nil {
		...
		if readOnlyKeysModel := readonlyKeys.Model; readOnlyKeysModel != nil {
			d.Set("primary_readonly_key", readOnlyKeysModel.PrimaryReadonlyMasterKey)
			d.Set("secondary_readonly_key", readOnlyKeysModel.SecondaryReadonlyMasterKey)
		}
	}
