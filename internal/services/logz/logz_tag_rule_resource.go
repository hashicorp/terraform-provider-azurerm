...
func resourceLogzTagRule() *pluginsdk.Resource {
	return &pluginsdk.Resource{
		...
		DeprecationMessage: `Logz REST API is now Deprecated - as such the 'azurerm_logz_tag_rule' resource is deprecated and will be removed in v4.0 of the AzureRM Provider`,
