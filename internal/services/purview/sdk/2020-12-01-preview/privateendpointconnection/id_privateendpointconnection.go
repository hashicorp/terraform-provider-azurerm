...
func NewPrivateEndpointConnectionID(subscriptionId, resourceGroup, accountName, name string) PrivateEndpointConnectionId {
...
func (id PrivateEndpointConnectionId) ID() string {
	fmtString := "/subscriptions/%s/resourceGroups/%s/providers/Microsoft.Purview/accounts/%s/privateEndpointConnections/%s"
