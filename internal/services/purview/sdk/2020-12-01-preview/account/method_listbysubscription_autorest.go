...
// ListBySubscription ...
func (c AccountClient) ListBySubscription(ctx context.Context, id SubscriptionId) (resp ListBySubscriptionResponse, err error) {
...
func (c AccountClient) ListBySubscriptionComplete(ctx context.Context, id SubscriptionId) (ListBySubscriptionCompleteResult, error) {
	return c.ListBySubscriptionCompleteMatchingPredicate(ctx, id, AccountPredicate{})
}

// ListBySubscriptionCompleteMatchingPredicate retrieves all of the results and then applied the predicate
func (c AccountClient) ListBySubscriptionCompleteMatchingPredicate(ctx context.Context, id SubscriptionId, predicate AccountPredicate) (resp ListBySubscriptionCompleteResult, err error) {
...
func (c AccountClient) preparerForListBySubscription(ctx context.Context, id SubscriptionId) (*http.Request, error) {
