...
func (c ProviderClient) AccountsCheckNameAvailability(ctx context.Context, id SubscriptionId, input CheckNameAvailabilityRequest) (result AccountsCheckNameAvailabilityResponse, err error) {
...
func (c ProviderClient) preparerForAccountsCheckNameAvailability(ctx context.Context, id SubscriptionId, input CheckNameAvailabilityRequest) (*http.Request, error) {
