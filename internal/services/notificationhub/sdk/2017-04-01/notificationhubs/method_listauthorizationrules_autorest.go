...
func (c NotificationHubsClient) ListAuthorizationRules(ctx context.Context, id NotificationHubId) (resp ListAuthorizationRulesOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "notificationhubs.NotificationHubsClient", "ListAuthorizationRules", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "notificationhubs.NotificationHubsClient", "ListAuthorizationRules", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListAuthorizationRules(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "notificationhubs.NotificationHubsClient", "ListAuthorizationRules", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c NotificationHubsClient) preparerForListAuthorizationRulesWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c NotificationHubsClient) responderForListAuthorizationRules(resp *http.Response) (result ListAuthorizationRulesOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListAuthorizationRulesOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "notificationhubs.NotificationHubsClient", "ListAuthorizationRules", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListAuthorizationRules(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "notificationhubs.NotificationHubsClient", "ListAuthorizationRules", result.HttpResponse, "Failure responding to request")
				return
			}
