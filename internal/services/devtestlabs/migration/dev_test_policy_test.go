...
func TestDevTestLabPolicyV0ToV1(t *testing.T) {
	testData := []struct {
	...
	}{
		{
			...
			expected: utils.String("/subscriptions/12345678-1234-5678-1234-123456789012/resourceGroups/group1/providers/Microsoft.DevTestLab/labs/lab1/policySets/policyset1/policies/policy1"),
		},
		{
	...
	for _, test := range testData {
		...
		result, err := DevTestLabPolicyUpgradeV0ToV1{}.UpgradeFunc()(context.TODO(), test.input, nil)
