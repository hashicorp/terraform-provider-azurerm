...
// These are the accepted values based on https://learn.microsoft.com/azure/azure-sql/database/elastic-jobs-overview?view=azuresql#concurrent-capacity-tiers
const (
