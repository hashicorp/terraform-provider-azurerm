...
func resourcePostgreSQLAdministrator() *pluginsdk.Resource {
	return &pluginsdk.Resource{
		...
		DeprecationMessage: features.DeprecatedInFivePointOh("Azure Database for PostgreSQL Single Server and its sub resources are scheduled for retirement by 2025-03-28 and will migrate to using Azure Database for PostgreSQL Flexible Server: https://techcommunity.microsoft.com/blog/adforpostgresql/retiring-azure-database-for-postgresql-single-server-in-2025/3783783. The `azurerm_postgresql_active_directory_administrator` resource is deprecated and will be removed in v5.0 of the AzureRM Provider. Please use the `azurerm_postgresql_flexible_server_active_directory_administrator` resource instead"),
