...
var _ resourceid.Formatter = AssetFilterId{}

func TestAssetFilterIDFormatter(t *testing.T) {
	actual := NewAssetFilterID("12345678-1234-9876-4563-123456789012", "resGroup1", "account1", "asset1", "filter1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.Media/mediaservices/account1/assets/asset1/assetFilters/filter1"
	if actual != expected {
		t.Fatalf("Expected %q but got %q", expected, actual)
	}
}

func TestAssetFilterID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
...

		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.Media/mediaservices/account1/assets/asset1/assetFilters/",
			Error: true,
		},

		{
			// valid
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.Media/mediaservices/account1/assets/asset1/assetFilters/filter1",
			Expected: &AssetFilterId{
	...
	for _, v := range testData {
		...
		actual, err := AssetFilterID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
