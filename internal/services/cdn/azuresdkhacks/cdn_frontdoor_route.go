...
type CdnFrontDoorRoutesWorkaroundClient struct {
	sdkClient *sdk.RoutesClient
}

func NewCdnFrontDoorRoutesWorkaroundClient(client *sdk.RoutesClient) CdnFrontDoorRoutesWorkaroundClient {
	return CdnFrontDoorRoutesWorkaroundClient{
		sdkClient: client,
	}
}

func (c *CdnFrontDoorRoutesWorkaroundClient) Update(ctx context.Context, resourceGroupName string, profileName string, endpointName string, routeName string, routeUpdateProperties sdk.RouteUpdateParameters) (result sdk.RoutesUpdateFuture, err error) {
	// TODO: go through and patch this the payload if needed
	req, err := c.sdkClient.UpdatePreparer(ctx, resourceGroupName, profileName, endpointName, routeName, routeUpdateProperties)
	if err != nil {
...
type RouteUpdatePropertiesParameters struct {
	...
	CustomDomains *[]sdk.ActivatedResourceReference `json:"customDomains,omitempty"`
	// OriginGroup - A reference to the origin group.
	OriginGroup *sdk.ResourceReference `json:"originGroup,omitempty"`
	...
	RuleSets *[]sdk.ResourceReference `json:"ruleSets,omitempty"`
	// SupportedProtocols - List of supported protocols for this route.
	SupportedProtocols *[]sdk.AFDEndpointProtocols `json:"supportedProtocols,omitempty"`
	...
	CacheConfiguration *sdk.AfdRouteCacheConfiguration `json:"cacheConfiguration,omitempty"`
	...
	ForwardingProtocol sdk.ForwardingProtocol `json:"forwardingProtocol,omitempty"`
	...
	LinkToDefaultDomain sdk.LinkToDefaultDomain `json:"linkToDefaultDomain,omitempty"`
	...
	HTTPSRedirect sdk.HTTPSRedirect `json:"httpsRedirect,omitempty"`
	...
	EnabledState sdk.EnabledState `json:"enabledState,omitempty"`
}
