...
var _ resourceid.Formatter = AfdEndpointRouteId{}

func TestAfdEndpointRouteIDFormatter(t *testing.T) {
	actual := NewAfdEndpointRouteID("12345678-1234-9876-4563-123456789012", "resGroup1", "profile1", "afdEndpoint1", "route1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.Cdn/profiles/profile1/afdEndpoints/afdEndpoint1/routes/route1"
	if actual != expected {
...
func TestAfdEndpointRouteID(t *testing.T) {
	...
	for _, v := range testData {
		...
		actual, err := AfdEndpointRouteID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
