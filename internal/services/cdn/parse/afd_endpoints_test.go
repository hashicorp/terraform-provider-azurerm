...
var _ resourceid.Formatter = AfdEndpointsId{}

func TestAfdEndpointsIDFormatter(t *testing.T) {
	actual := NewAfdEndpointsID("12345678-1234-9876-4563-123456789012", "resGroup1", "profile1", "afdEndpoint1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.Cdn/profiles/profile1/afdEndpoints/afdEndpoint1"
	if actual != expected {
...
func TestAfdEndpointsID(t *testing.T) {
	...
	for _, v := range testData {
		...
		actual, err := AfdEndpointsID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
