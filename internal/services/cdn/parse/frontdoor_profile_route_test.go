...
var _ resourceids.Id = FrontdoorProfileRouteId{}

func TestFrontdoorProfileRouteIDFormatter(t *testing.T) {
	actual := NewFrontdoorProfileRouteID("12345678-1234-9876-4563-123456789012", "resourceGroup1", "profile1", "endpoint1", "route1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resourceGroup1/providers/Microsoft.Cdn/profiles/profile1/afdEndpoints/endpoint1/routes/route1"
	if actual != expected {
		t.Fatalf("Expected %q but got %q", expected, actual)
	}
}

func TestFrontdoorProfileRouteID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *FrontdoorProfileRouteId
	}{
...

		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resourceGroup1/providers/Microsoft.Cdn/profiles/profile1/afdEndpoints/endpoint1/routes/",
			Error: true,
		},

		{
			// valid
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resourceGroup1/providers/Microsoft.Cdn/profiles/profile1/afdEndpoints/endpoint1/routes/route1",
			Expected: &FrontdoorProfileRouteId{
	...
	for _, v := range testData {
		...
		actual, err := FrontdoorProfileRouteID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
