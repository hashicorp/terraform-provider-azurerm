...
var _ resourceids.Id = OriginGroupId{}

func TestOriginGroupIDFormatter(t *testing.T) {
	actual := NewOriginGroupID("12345678-1234-9876-4563-123456789012", "resGroup1", "profile1", "endpoint1", "originGroup1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.Cdn/profiles/profile1/endpoints/endpoint1/originGroups/originGroup1"
	if actual != expected {
...
func TestOriginGroupID(t *testing.T) {
	testData := []struct {
...

		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.Cdn/profiles/profile1/endpoints/endpoint1/originGroups/",
			Error: true,
		},

		{
			// valid
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.Cdn/profiles/profile1/endpoints/endpoint1/originGroups/originGroup1",
			Expected: &OriginGroupId{
