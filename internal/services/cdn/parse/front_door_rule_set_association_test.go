...
var _ resourceids.Id = FrontDoorRuleSetAssociationId{}

func TestFrontDoorRuleSetAssociationIDFormatter(t *testing.T) {
	actual := NewFrontDoorRuleSetAssociationID("12345678-1234-9876-4563-123456789012", "resGroup1", "profile1", "endpoint1", "assoc1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.Cdn/profiles/profile1/afdEndpoints/endpoint1/associations/assoc1"
	if actual != expected {
		t.Fatalf("Expected %q but got %q", expected, actual)
	}
}

func TestFrontDoorRuleSetAssociationID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *FrontDoorRuleSetAssociationId
	}{
		...
		{
			// valid
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.Cdn/profiles/profile1/afdEndpoints/endpoint1/associations/assoc1",
			Expected: &FrontDoorRuleSetAssociationId{
	...
	for _, v := range testData {
		...
		actual, err := FrontDoorRuleSetAssociationID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
