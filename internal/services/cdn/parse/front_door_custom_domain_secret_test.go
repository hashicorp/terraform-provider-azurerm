...
func TestFrontDoorCustomDomainSecretIDFormatter(t *testing.T) {
	actual := NewFrontDoorCustomDomainSecretID("12345678-1234-9876-4563-123456789012", "resGroup1", "profile1", "customDomain1", "secret1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.Cdn/profiles/profile1/customDomains/customDomain1/secrets/secret1"
	if actual != expected {
