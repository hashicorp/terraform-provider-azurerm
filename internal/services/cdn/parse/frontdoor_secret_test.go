...
func TestFrontdoorSecretIDFormatter(t *testing.T) {
	actual := NewFrontdoorSecretID("12345678-1234-9876-4563-123456789012", "resourceGroup1", "profile1", "secret1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resourceGroup1/providers/Microsoft.Cdn/profiles/profile1/secrets/secret1"
	if actual != expected {
...
func TestFrontdoorSecretID(t *testing.T) {
	testData := []struct {
...

		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resourceGroup1/providers/Microsoft.Cdn/profiles/profile1/secrets/",
			Error: true,
		},

		{
			// valid
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resourceGroup1/providers/Microsoft.Cdn/profiles/profile1/secrets/secret1",
			Expected: &FrontdoorSecretId{
