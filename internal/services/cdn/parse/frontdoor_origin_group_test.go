...
func TestFrontdoorOriginGroupIDFormatter(t *testing.T) {
	actual := NewFrontdoorOriginGroupID("12345678-1234-9876-4563-123456789012", "resourceGroup1", "profile1", "originGroup1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resourceGroup1/providers/Microsoft.Cdn/profiles/profile1/originGroups/originGroup1"
	if actual != expected {
