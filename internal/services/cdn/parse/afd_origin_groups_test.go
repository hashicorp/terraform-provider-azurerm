...
var _ resourceid.Formatter = AfdOriginGroupsId{}

func TestAfdOriginGroupsIDFormatter(t *testing.T) {
	actual := NewAfdOriginGroupsID("12345678-1234-9876-4563-123456789012", "resGroup1", "profile1", "origingroup1").ID()
...
func TestAfdOriginGroupsID(t *testing.T) {
	...
	for _, v := range testData {
		...
		actual, err := AfdOriginGroupsID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
