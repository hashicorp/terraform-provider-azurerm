...
var _ resourceid.Formatter = AfdRuleSetsId{}

func TestAfdRuleSetsIDFormatter(t *testing.T) {
	actual := NewAfdRuleSetsID("12345678-1234-9876-4563-123456789012", "resGroup1", "profile1", "ruleSet1").ID()
...
func TestAfdRuleSetsID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *AfdRuleSetsId
	}{
	...
	for _, v := range testData {
		...
		actual, err := AfdRuleSetsID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
