...
var _ resourceids.Id = FrontdoorProfileSecurityPolicyId{}

func TestFrontdoorProfileSecurityPolicyIDFormatter(t *testing.T) {
	actual := NewFrontdoorProfileSecurityPolicyID("12345678-1234-9876-4563-123456789012", "resourceGroup1", "profile1", "securityPolicy1").ID()
...
func TestFrontdoorProfileSecurityPolicyID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *FrontdoorProfileSecurityPolicyId
	}{
...

		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resourceGroup1/providers/Microsoft.Cdn/profiles/profile1/securityPolicies/",
			Error: true,
		},
	...
	for _, v := range testData {
		...
		actual, err := FrontdoorProfileSecurityPolicyID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
