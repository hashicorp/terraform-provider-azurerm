...
func resourceCdnOrigin() *pluginsdk.Resource {
	resource := &pluginsdk.Resource{
		Create: resourceCdnOriginCreate,
		Read:   resourceCdnOriginRead,
		Update: resourceCdnOriginUpdate,
		Delete: resourceCdnOriginDelete,
...
func resourceCdnOriginCreate(d *pluginsdk.ResourceData, meta interface{}) error {
	...
	d.SetId(id.ID())
	return resourceCdnOriginRead(d, meta)
}

func resourceCdnOriginRead(d *pluginsdk.ResourceData, meta interface{}) error {
	client := meta.(*clients.Client).Cdn.FrontDoorOriginsClient
...
func resourceCdnOriginUpdate(d *pluginsdk.ResourceData, meta interface{}) error {
	client := meta.(*clients.Client).Cdn.FrontDoorOriginsClient
...
func resourceCdnOriginDelete(d *pluginsdk.ResourceData, meta interface{}) error {
	client := meta.(*clients.Client).Cdn.FrontDoorOriginsClient
