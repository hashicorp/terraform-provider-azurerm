...
func (r Registration) SupportedResources() map[string]*pluginsdk.Resource {
	return map[string]*pluginsdk.Resource{
		...
		"azurerm_cdn_frontdoor_route_custom_domain_association": resourceCdnFrontdoorRouteCustomDomainAssociation(),
		"azurerm_cdn_frontdoor_dns_txt_validator":               resourceCdnFrontdoorDnsTxtValidator(),
