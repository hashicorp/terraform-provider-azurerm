...
func (aogupp AFDOriginGroupUpdatePropertiesParameters) MarshalJSON() ([]byte, error) {
	...
	if aogupp.ResponseBasedAfdOriginErrorDetectionSettings != nil {
		objectMap["responseBasedAfdOriginErrorDetectionSettings"] = aogupp.ResponseBasedAfdOriginErrorDetectionSettings
	}
...
func (pp ProfileProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if pp.Identity != nil {
		objectMap["identity"] = pp.Identity
	}
