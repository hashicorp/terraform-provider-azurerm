...
func PossibleAfdCertificateTypeValues() []AfdCertificateType {
	return []AfdCertificateType{AfdCertificateTypeAzureFirstPartyManagedCertificate, AfdCertificateTypeCustomerCertificate, AfdCertificateTypeManagedCertificate}
}
...
func PossibleAfdQueryStringCachingBehaviorValues() []AfdQueryStringCachingBehavior {
	return []AfdQueryStringCachingBehavior{AfdQueryStringCachingBehaviorIgnoreQueryString, AfdQueryStringCachingBehaviorIgnoreSpecifiedQueryStrings, AfdQueryStringCachingBehaviorIncludeSpecifiedQueryStrings, AfdQueryStringCachingBehaviorUseQueryString}
}
...
// ClientPortOperator enumerates the values for client port operator.
...
// PossibleClientPortOperatorValues returns an array of possible values for the ClientPortOperator const type.
...
func PossibleDomainValidationStateValues() []DomainValidationState {
	return []DomainValidationState{DomainValidationStateApproved, DomainValidationStatePending, DomainValidationStatePendingRevalidation, DomainValidationStateRejected, DomainValidationStateSubmitting, DomainValidationStateTimedOut, DomainValidationStateUnknown}
}
...
// HostNameOperator enumerates the values for host name operator.
...
// PossibleHostNameOperatorValues returns an array of possible values for the HostNameOperator const type.
func PossibleHostNameOperatorValues() []HostNameOperator {
	return []HostNameOperator{HostNameOperatorAny, HostNameOperatorBeginsWith, HostNameOperatorContains, HostNameOperatorEndsWith, HostNameOperatorEqual, HostNameOperatorGreaterThan, HostNameOperatorGreaterThanOrEqual, HostNameOperatorLessThan, HostNameOperatorLessThanOrEqual, HostNameOperatorRegEx}
}
...
func PossibleLogMetricsGroupByValues() []LogMetricsGroupBy {
	return []LogMetricsGroupBy{LogMetricsGroupByCacheStatus, LogMetricsGroupByCountryOrRegion, LogMetricsGroupByCustomDomain, LogMetricsGroupByHTTPStatusCode, LogMetricsGroupByProtocol}
}
...
const (
	// NameClientPort ...
	NameClientPort Name = "ClientPort"
	// NameCookies ...
	...
	// NameServerPort ...
	NameServerPort Name = "ServerPort"
	// NameSocketAddr ...
	NameSocketAddr Name = "SocketAddr"
	// NameSslProtocol ...
	NameSslProtocol Name = "SslProtocol"
...
func PossibleNameValues() []Name {
	return []Name{NameClientPort, NameCookies, NameDeliveryRuleCondition, NameHostName, NameHTTPVersion, NameIsDevice, NamePostArgs, NameQueryString, NameRemoteAddress, NameRequestBody, NameRequestHeader, NameRequestMethod, NameRequestScheme, NameRequestURI, NameServerPort, NameSocketAddr, NameSslProtocol, NameURLFileExtension, NameURLFileName, NameURLPath}
}
...
const (
	...
	NameBasicDeliveryRuleActionNameRouteConfigurationOverride NameBasicDeliveryRuleAction = "RouteConfigurationOverride"
...
// RuleCacheBehavior enumerates the values for rule cache behavior.
...
// PossibleRuleCacheBehaviorValues returns an array of possible values for the RuleCacheBehavior const type.
func PossibleRuleCacheBehaviorValues() []RuleCacheBehavior {
	return []RuleCacheBehavior{RuleCacheBehaviorHonorOrigin, RuleCacheBehaviorOverrideAlways, RuleCacheBehaviorOverrideIfOriginMissing}
}

// RuleIsCompressionEnabled enumerates the values for rule is compression enabled.
...
// PossibleRuleIsCompressionEnabledValues returns an array of possible values for the RuleIsCompressionEnabled const type.
func PossibleRuleIsCompressionEnabledValues() []RuleIsCompressionEnabled {
	return []RuleIsCompressionEnabled{RuleIsCompressionEnabledDisabled, RuleIsCompressionEnabledEnabled}
}

// RuleQueryStringCachingBehavior enumerates the values for rule query string caching behavior.
...
// PossibleRuleQueryStringCachingBehaviorValues returns an array of possible values for the RuleQueryStringCachingBehavior const type.
func PossibleRuleQueryStringCachingBehaviorValues() []RuleQueryStringCachingBehavior {
	return []RuleQueryStringCachingBehavior{RuleQueryStringCachingBehaviorIgnoreQueryString, RuleQueryStringCachingBehaviorIgnoreSpecifiedQueryStrings, RuleQueryStringCachingBehaviorIncludeSpecifiedQueryStrings, RuleQueryStringCachingBehaviorUseQueryString}
}
...
func PossibleSecretTypeValues() []SecretType {
	return []SecretType{SecretTypeAzureFirstPartyManagedCertificate, SecretTypeCustomerCertificate, SecretTypeManagedCertificate, SecretTypeURLSigningKey}
}

// ServerPortOperator enumerates the values for server port operator.
...
// PossibleServerPortOperatorValues returns an array of possible values for the ServerPortOperator const type.
func PossibleServerPortOperatorValues() []ServerPortOperator {
	return []ServerPortOperator{ServerPortOperatorAny, ServerPortOperatorBeginsWith, ServerPortOperatorContains, ServerPortOperatorEndsWith, ServerPortOperatorEqual, ServerPortOperatorGreaterThan, ServerPortOperatorGreaterThanOrEqual, ServerPortOperatorLessThan, ServerPortOperatorLessThanOrEqual, ServerPortOperatorRegEx}
}
...
// SocketAddrOperator enumerates the values for socket addr operator.
...
// PossibleSocketAddrOperatorValues returns an array of possible values for the SocketAddrOperator const type.
func PossibleSocketAddrOperatorValues() []SocketAddrOperator {
	return []SocketAddrOperator{SocketAddrOperatorAny, SocketAddrOperatorIPMatch}
}
...
func PossibleSslProtocolValues() []SslProtocol {
	return []SslProtocol{SslProtocolTLSv1, SslProtocolTLSv11, SslProtocolTLSv12}
}
...
const (
	...
	TypeSecurityPolicyPropertiesParameters Type = "SecurityPolicyPropertiesParameters"
...
func PossibleTypeValues() []Type {
	return []Type{TypeSecurityPolicyPropertiesParameters, TypeWebApplicationFirewall}
}
...
const (
	...
	TypeBasicSecretParametersTypeAzureFirstPartyManagedCertificate TypeBasicSecretParameters = "AzureFirstPartyManagedCertificate"
...
func PossibleTypeBasicSecretParametersValues() []TypeBasicSecretParameters {
	return []TypeBasicSecretParameters{TypeBasicSecretParametersTypeAzureFirstPartyManagedCertificate, TypeBasicSecretParametersTypeCustomerCertificate, TypeBasicSecretParametersTypeManagedCertificate, TypeBasicSecretParametersTypeSecretParameters, TypeBasicSecretParametersTypeURLSigningKey}
}
...
func PossibleUnitValues() []Unit {
	return []Unit{UnitBitsPerSecond, UnitBytes, UnitCount, UnitMilliSeconds}
}
...
// WafMatchVariable enumerates the values for waf match variable.
...
// PossibleWafMatchVariableValues returns an array of possible values for the WafMatchVariable const type.
func PossibleWafMatchVariableValues() []WafMatchVariable {
	return []WafMatchVariable{WafMatchVariableCookies, WafMatchVariablePostArgs, WafMatchVariableQueryString, WafMatchVariableRemoteAddr, WafMatchVariableRequestBody, WafMatchVariableRequestHeader, WafMatchVariableRequestMethod, WafMatchVariableRequestURI, WafMatchVariableSocketAddr}
}
...
func PossibleWafRankingTypeValues() []WafRankingType {
	return []WafRankingType{WafRankingTypeAction, WafRankingTypeClientIP, WafRankingTypeCountryOrRegion, WafRankingTypeRuleGroup, WafRankingTypeRuleID, WafRankingTypeRuleType, WafRankingTypeURL, WafRankingTypeUserAgent}
}
