...
// ListResourceUsage ...
func (c AFDProfilesClient) ListResourceUsage(ctx context.Context, id ProfileId) (resp ListResourceUsageResponse, err error) {
	req, err := c.preparerForListResourceUsage(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "afdprofiles.AFDProfilesClient", "ListResourceUsage", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "afdprofiles.AFDProfilesClient", "ListResourceUsage", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListResourceUsage(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "afdprofiles.AFDProfilesClient", "ListResourceUsage", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c AFDProfilesClient) ListResourceUsageCompleteMatchingPredicate(ctx context.Context, id ProfileId, predicate UsagePredicate) (resp ListResourceUsageCompleteResult, err error) {
	items := make([]Usage, 0)
...
func (c AFDProfilesClient) preparerForListResourceUsage(ctx context.Context, id ProfileId) (*http.Request, error) {
...
func (c AFDProfilesClient) preparerForListResourceUsageWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c AFDProfilesClient) responderForListResourceUsage(resp *http.Response) (result ListResourceUsageResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListResourceUsageResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "afdprofiles.AFDProfilesClient", "ListResourceUsage", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListResourceUsage(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "afdprofiles.AFDProfilesClient", "ListResourceUsage", result.HttpResponse, "Failure responding to request")
				return
			}
