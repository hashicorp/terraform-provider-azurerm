...
// ListByEndpoint ...
func (c OriginsClient) ListByEndpoint(ctx context.Context, id EndpointId) (resp ListByEndpointResponse, err error) {
	req, err := c.preparerForListByEndpoint(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "origins.OriginsClient", "ListByEndpoint", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "origins.OriginsClient", "ListByEndpoint", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListByEndpoint(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "origins.OriginsClient", "ListByEndpoint", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c OriginsClient) ListByEndpointComplete(ctx context.Context, id EndpointId) (ListByEndpointCompleteResult, error) {
	return c.ListByEndpointCompleteMatchingPredicate(ctx, id, OriginPredicate{})
}

// ListByEndpointCompleteMatchingPredicate retrieves all of the results and then applied the predicate
func (c OriginsClient) ListByEndpointCompleteMatchingPredicate(ctx context.Context, id EndpointId, predicate OriginPredicate) (resp ListByEndpointCompleteResult, err error) {
	items := make([]Origin, 0)
...
func (c OriginsClient) preparerForListByEndpoint(ctx context.Context, id EndpointId) (*http.Request, error) {
...
func (c OriginsClient) preparerForListByEndpointWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c OriginsClient) responderForListByEndpoint(resp *http.Response) (result ListByEndpointResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByEndpointResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "origins.OriginsClient", "ListByEndpoint", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListByEndpoint(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "origins.OriginsClient", "ListByEndpoint", result.HttpResponse, "Failure responding to request")
				return
			}
