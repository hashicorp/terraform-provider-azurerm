...
func TestNewOriginID(t *testing.T) {
	id := NewOriginID("12345678-1234-9876-4563-123456789012", "example-resource-group", "profileValue", "endpointValue", "originValue")
	...
	if id.OriginName != "originValue" {
		t.Fatalf("Expected %q but got %q for Segment 'OriginName'", id.OriginName, "originValue")
	}
}

func TestFormatOriginID(t *testing.T) {
	actual := NewOriginID("12345678-1234-9876-4563-123456789012", "example-resource-group", "profileValue", "endpointValue", "originValue").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.CDN/profiles/profileValue/endpoints/endpointValue/origins/originValue"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseOriginID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *OriginId
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.CDN/profiles/profileValue/endpoints/endpointValue/origins",
			Error: true,
		},
		{
			// Valid URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.CDN/profiles/profileValue/endpoints/endpointValue/origins/originValue",
			Expected: &OriginId{
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.CDN/profiles/profileValue/endpoints/endpointValue/origins/originValue/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseOriginID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseOriginIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *OriginId
	...
	for _, v := range testData {
		...
		actual, err := ParseOriginIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForOriginId(t *testing.T) {
	segments := OriginId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("OriginId has no segments")
	}
