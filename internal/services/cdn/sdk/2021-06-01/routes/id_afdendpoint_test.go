...
func TestNewAfdEndpointID(t *testing.T) {
	id := NewAfdEndpointID("12345678-1234-9876-4563-123456789012", "example-resource-group", "profileValue", "endpointValue")
...
func TestFormatAfdEndpointID(t *testing.T) {
	actual := NewAfdEndpointID("12345678-1234-9876-4563-123456789012", "example-resource-group", "profileValue", "endpointValue").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.CDN/profiles/profileValue/afdEndpoints/endpointValue"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseAfdEndpointID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.CDN/profiles/profileValue/afdEndpoints/endpointValue/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseAfdEndpointID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseAfdEndpointIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *AfdEndpointId
	...
	for _, v := range testData {
		...
		actual, err := ParseAfdEndpointIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForAfdEndpointId(t *testing.T) {
	segments := AfdEndpointId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("AfdEndpointId has no segments")
	}
