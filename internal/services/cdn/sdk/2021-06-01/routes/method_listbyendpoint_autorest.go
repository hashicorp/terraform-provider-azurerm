...
// ListByEndpoint ...
func (c RoutesClient) ListByEndpoint(ctx context.Context, id AfdEndpointId) (resp ListByEndpointResponse, err error) {
	req, err := c.preparerForListByEndpoint(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "routes.RoutesClient", "ListByEndpoint", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "routes.RoutesClient", "ListByEndpoint", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListByEndpoint(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "routes.RoutesClient", "ListByEndpoint", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c RoutesClient) ListByEndpointComplete(ctx context.Context, id AfdEndpointId) (ListByEndpointCompleteResult, error) {
	return c.ListByEndpointCompleteMatchingPredicate(ctx, id, RoutePredicate{})
}

// ListByEndpointCompleteMatchingPredicate retrieves all of the results and then applied the predicate
func (c RoutesClient) ListByEndpointCompleteMatchingPredicate(ctx context.Context, id AfdEndpointId, predicate RoutePredicate) (resp ListByEndpointCompleteResult, err error) {
	items := make([]Route, 0)
...
func (c RoutesClient) preparerForListByEndpoint(ctx context.Context, id AfdEndpointId) (*http.Request, error) {
...
func (c RoutesClient) preparerForListByEndpointWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c RoutesClient) responderForListByEndpoint(resp *http.Response) (result ListByEndpointResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByEndpointResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "routes.RoutesClient", "ListByEndpoint", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListByEndpoint(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "routes.RoutesClient", "ListByEndpoint", result.HttpResponse, "Failure responding to request")
				return
			}
