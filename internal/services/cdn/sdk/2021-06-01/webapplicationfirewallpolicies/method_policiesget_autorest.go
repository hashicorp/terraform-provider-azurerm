...
// PoliciesGet ...
func (c WebApplicationFirewallPoliciesClient) PoliciesGet(ctx context.Context, id CdnWebApplicationFirewallPoliciesId) (result PoliciesGetResponse, err error) {
...
func (c WebApplicationFirewallPoliciesClient) preparerForPoliciesGet(ctx context.Context, id CdnWebApplicationFirewallPoliciesId) (*http.Request, error) {
