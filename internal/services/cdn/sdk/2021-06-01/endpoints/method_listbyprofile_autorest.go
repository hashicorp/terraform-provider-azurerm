...
// ListByProfile ...
func (c EndpointsClient) ListByProfile(ctx context.Context, id ProfileId) (resp ListByProfileResponse, err error) {
	req, err := c.preparerForListByProfile(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "endpoints.EndpointsClient", "ListByProfile", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "endpoints.EndpointsClient", "ListByProfile", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListByProfile(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "endpoints.EndpointsClient", "ListByProfile", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c EndpointsClient) ListByProfileComplete(ctx context.Context, id ProfileId) (ListByProfileCompleteResult, error) {
	return c.ListByProfileCompleteMatchingPredicate(ctx, id, EndpointPredicate{})
}

// ListByProfileCompleteMatchingPredicate retrieves all of the results and then applied the predicate
func (c EndpointsClient) ListByProfileCompleteMatchingPredicate(ctx context.Context, id ProfileId, predicate EndpointPredicate) (resp ListByProfileCompleteResult, err error) {
...
func (c EndpointsClient) preparerForListByProfile(ctx context.Context, id ProfileId) (*http.Request, error) {
...
func (c EndpointsClient) preparerForListByProfileWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c EndpointsClient) responderForListByProfile(resp *http.Response) (result ListByProfileResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByProfileResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "endpoints.EndpointsClient", "ListByProfile", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListByProfile(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "endpoints.EndpointsClient", "ListByProfile", result.HttpResponse, "Failure responding to request")
				return
			}
