...
// ListResourceUsage ...
func (c AFDEndpointsClient) ListResourceUsage(ctx context.Context, id AfdEndpointId) (resp ListResourceUsageResponse, err error) {
	req, err := c.preparerForListResourceUsage(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "afdendpoints.AFDEndpointsClient", "ListResourceUsage", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "afdendpoints.AFDEndpointsClient", "ListResourceUsage", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListResourceUsage(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "afdendpoints.AFDEndpointsClient", "ListResourceUsage", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c AFDEndpointsClient) ListResourceUsageCompleteMatchingPredicate(ctx context.Context, id AfdEndpointId, predicate UsagePredicate) (resp ListResourceUsageCompleteResult, err error) {
	items := make([]Usage, 0)
...
func (c AFDEndpointsClient) preparerForListResourceUsage(ctx context.Context, id AfdEndpointId) (*http.Request, error) {
...
func (c AFDEndpointsClient) preparerForListResourceUsageWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c AFDEndpointsClient) responderForListResourceUsage(resp *http.Response) (result ListResourceUsageResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListResourceUsageResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "afdendpoints.AFDEndpointsClient", "ListResourceUsage", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListResourceUsage(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "afdendpoints.AFDEndpointsClient", "ListResourceUsage", result.HttpResponse, "Failure responding to request")
				return
			}
