...
func TestNewEndpointID(t *testing.T) {
	id := NewEndpointID("12345678-1234-9876-4563-123456789012", "example-resource-group", "profileValue", "endpointValue")
...
func TestFormatEndpointID(t *testing.T) {
	actual := NewEndpointID("12345678-1234-9876-4563-123456789012", "example-resource-group", "profileValue", "endpointValue").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.CDN/profiles/profileValue/endpoints/endpointValue"
	if actual != expected {
...
func TestParseEndpointID(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.CDN/profiles/profileValue/endpoints/endpointValue/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseEndpointID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseEndpointIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *EndpointId
	...
	for _, v := range testData {
		...
		actual, err := ParseEndpointIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForEndpointId(t *testing.T) {
	segments := EndpointId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("EndpointId has no segments")
	}
