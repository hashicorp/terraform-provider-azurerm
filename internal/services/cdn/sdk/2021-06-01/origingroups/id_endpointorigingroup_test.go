...
func TestNewEndpointOriginGroupID(t *testing.T) {
	id := NewEndpointOriginGroupID("12345678-1234-9876-4563-123456789012", "example-resource-group", "profileValue", "endpointValue", "originGroupValue")
...
func TestFormatEndpointOriginGroupID(t *testing.T) {
	actual := NewEndpointOriginGroupID("12345678-1234-9876-4563-123456789012", "example-resource-group", "profileValue", "endpointValue", "originGroupValue").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.CDN/profiles/profileValue/endpoints/endpointValue/originGroups/originGroupValue"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseEndpointOriginGroupID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *EndpointOriginGroupId
	}{
		{
			// Incomplete URI
			Input: "",
		...
		{
			// Incomplete URI
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.CDN/profiles/profileValue/endpoints/endpointValue/originGroups",
			Error: true,
		},
		{
			// Valid URI
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.CDN/profiles/profileValue/endpoints/endpointValue/originGroups/originGroupValue/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseEndpointOriginGroupID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseEndpointOriginGroupIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *EndpointOriginGroupId
	...
	for _, v := range testData {
		...
		actual, err := ParseEndpointOriginGroupIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForEndpointOriginGroupId(t *testing.T) {
	segments := EndpointOriginGroupId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("EndpointOriginGroupId has no segments")
	}
