...
func TestAccCdnFrontdoorCustomDomainSecretValidator_basic(t *testing.T) {
...
func TestAccCdnFrontdoorCustomDomainSecretValidator_requiresImport(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_cdn_frontdoor_custom_domain", "test")
	r := CdnFrontdoorCustomDomainSecretValidatorResource{}
	data.ResourceTest(t, r, []acceptance.TestStep{
		{
...
func TestAccCdnFrontdoorCustomDomainSecretValidator_update(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_cdn_frontdoor_custom_domain", "test")
	r := CdnFrontdoorCustomDomainSecretValidatorResource{}
	data.ResourceTest(t, r, []acceptance.TestStep{
		{
...
func (r CdnFrontdoorCustomDomainSecretValidatorResource) basic(data acceptance.TestData) string {
...
func (r CdnFrontdoorCustomDomainSecretValidatorResource) requiresImport(data acceptance.TestData) string {
	config := r.basic(data)
	return fmt.Sprintf(`
			%s
...
func (r CdnFrontdoorCustomDomainSecretValidatorResource) update(data acceptance.TestData) string {
	template := r.template(data)
	return fmt.Sprintf(`
			%s
