...
func TestFrontDoorCustomDomainTxtID(t *testing.T) {
	cases := []struct {
		Input string
		Valid bool
	}{
...

		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.Cdn/profiles/profile1/customDomains/customDomain1/dnsTxt/",
			Valid: false,
		},

		{
			// valid
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.Cdn/profiles/profile1/customDomains/customDomain1/dnsTxt/txt1",
			Valid: true,
		},
	...
	for _, tc := range cases {
		...
		_, errors := FrontDoorCustomDomainTxtID(tc.Input, "test")
		valid := len(errors) == 0
