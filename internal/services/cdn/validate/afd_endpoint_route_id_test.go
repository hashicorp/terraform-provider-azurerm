...
func TestAfdEndpointRouteID(t *testing.T) {
	cases := []struct {
		Input string
		Valid bool
	}{
		...
		{
			// missing RouteName
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.Cdn/profiles/profile1/afdEndpoints/afdEndpoint1/",
			Valid: false,
		},

		{
			// missing value for RouteName
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.Cdn/profiles/profile1/afdEndpoints/afdEndpoint1/routes/",
			Valid: false,
		},

		{
			// valid
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.Cdn/profiles/profile1/afdEndpoints/afdEndpoint1/routes/route1",
			Valid: true,
		},
	...
	for _, tc := range cases {
		...
		_, errors := AfdEndpointRouteID(tc.Input, "test")
		valid := len(errors) == 0
