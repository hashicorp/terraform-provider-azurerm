...
//go:generate go run ../../tools/generator-resource-id/main.go -path=./ -name=Origin -id=/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.Cdn/profiles/profile1/endpoints/endpoint1/origins/origin1
//go:generate go run ../../tools/generator-resource-id/main.go -path=./ -name=OriginGroup -id=/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.Cdn/profiles/profile1/endpoints/endpoint1/originGroups/originGroup1
