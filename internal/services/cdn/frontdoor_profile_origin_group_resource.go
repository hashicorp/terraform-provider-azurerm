...
func resourceFrontdoorProfileOriginGroup() *pluginsdk.Resource {
	return &pluginsdk.Resource{
		Create: resourceFrontdoorProfileOriginGroupCreate,
		Read:   resourceFrontdoorProfileOriginGroupRead,
		Update: resourceFrontdoorProfileOriginGroupUpdate,
		Delete: resourceFrontdoorProfileOriginGroupDelete,
		...
		Importer: pluginsdk.ImporterValidatingResourceId(func(id string) error {
			_, err := parse.FrontdoorProfileOriginGroupID(id)
			return err
		}),
...
func resourceFrontdoorProfileOriginGroupCreate(d *pluginsdk.ResourceData, meta interface{}) error {
	client := meta.(*clients.Client).Cdn.FrontDoorProfileOriginGroupsClient
	...
	id := parse.NewFrontdoorProfileOriginGroupID(profileId.SubscriptionId, profileId.ResourceGroupName, profileId.ProfileName, d.Get("name").(string))
	...
	if d.IsNewResource() {
		...
		if !response.WasNotFound(existing.HttpResponse) {
			return tf.ImportAsExistsError("azurerm_frontdoor_profile_origin_group", id.ID())
		}
	}
	...
	d.SetId(id.ID())
	return resourceFrontdoorProfileOriginGroupRead(d, meta)
}

func resourceFrontdoorProfileOriginGroupRead(d *pluginsdk.ResourceData, meta interface{}) error {
	client := meta.(*clients.Client).Cdn.FrontDoorProfileOriginGroupsClient
	...
	id, err := parse.FrontdoorProfileOriginGroupID(d.Id())
	if err != nil {
		return err
	}
...
func resourceFrontdoorProfileOriginGroupUpdate(d *pluginsdk.ResourceData, meta interface{}) error {
	client := meta.(*clients.Client).Cdn.FrontDoorProfileOriginGroupsClient
...
func resourceFrontdoorProfileOriginGroupDelete(d *pluginsdk.ResourceData, meta interface{}) error {
	client := meta.(*clients.Client).Cdn.FrontDoorProfileOriginGroupsClient
