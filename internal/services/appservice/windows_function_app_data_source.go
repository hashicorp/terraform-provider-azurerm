...
func (d WindowsFunctionAppDataSource) Read() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		...
		Func: func(ctx context.Context, metadata sdk.ResourceMetaData) error {
			...
			dotnetcore := metadata.ResourceData.Get("site_config.0.application_stack.0.dotnet_version").(string)
			siteConfig, err := helpers.FlattenSiteConfigWindowsFunctionApp(configResp.SiteConfig, appSettingsResp, dotnetcore)
			if err != nil {
