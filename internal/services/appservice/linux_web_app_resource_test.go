...
func TestAccLinuxWebApp_withAutoHealRulesStatusCode(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_linux_web_app", "test")
	r := LinuxWebAppResource{}
...
func (r LinuxWebAppResource) autoHealRulesStatusCode(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {}
}
    ...
    auto_heal_setting {
      trigger {
        status_code {
          ...
          interval          = "00:01:00"
          count             = 10
          path              = "./terraformteststatuscode.aspx"
          win32_status      = "30"
          sub_status        = 202
        }
      }
