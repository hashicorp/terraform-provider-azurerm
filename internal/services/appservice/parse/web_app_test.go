...
var _ resourceid.Formatter = WebAppId{}

func TestWebAppIDFormatter(t *testing.T) {
	actual := NewWebAppID("12345678-1234-9876-4563-123456789012", "resGroup1", "site1").ID()
