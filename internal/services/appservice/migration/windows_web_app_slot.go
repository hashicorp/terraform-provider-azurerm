...
type WindowsWebAppSlotV0toV1 struct{}

var _ pluginsdk.StateUpgrade = WindowsWebAppSlotV0toV1{}

func (w WindowsWebAppSlotV0toV1) Schema() map[string]*pluginsdk.Schema {
