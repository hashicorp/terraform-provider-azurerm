...
type WindowsFunctionAppSlotV0toV1 struct{}

var _ pluginsdk.StateUpgrade = WindowsFunctionAppSlotV0toV1{}

func (w WindowsFunctionAppSlotV0toV1) Schema() map[string]*pluginsdk.Schema {
