...
type WindowsFunctionAppV0toV1 struct{}

var _ pluginsdk.StateUpgrade = WindowsFunctionAppV0toV1{}

func (w WindowsFunctionAppV0toV1) Schema() map[string]*pluginsdk.Schema {
