...
func (r WindowsWebAppResource) vNetIntegrationWebAppSlot_basic(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {}
}
...
func (r WindowsWebAppResource) vNetIntegrationWebAppSlot_withSubnetId(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {}
}
