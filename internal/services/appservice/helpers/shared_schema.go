...
func FlattenPushSetting(pushSettingData *webapps.PushSettings, metaData sdk.ResourceMetaData) ([]PushSetting, error) {
	result := make([]PushSetting, 0)
	if pushSettingData == nil || pushSettingData.Properties == nil {
		return result, nil
	}
