		...
		Elem: &pluginsdk.Resource{
			Schema: map[string]*pluginsdk.Schema{
				...
				"default_provider": {
					...
					Description: "The Default Authentication Provider to use when the `unauthenticated_action` is set to `RedirectToLoginPage`. Possible values include the standard providers (`apple`, `azureactivedirectory`, `facebook`, `github`, `google`, `twitter`) and the `name` of your `custom_oidc_v2` provider.",
				},
