...
func TestAccServicePlan_linuxPremiumV4(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_service_plan", "test")
	r := ServicePlanResource{}

	data.ResourceTest(t, r, []acceptance.TestStep{
		{
			Config: r.linuxPremiumV4(data),
			Check: acceptance.ComposeTestCheckFunc(
				check.That(data.ResourceName).ExistsInAzure(r),
			),
		},
...
func TestAccServicePlan_linuxPremiumV4P0(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_service_plan", "test")
	r := ServicePlanResource{}

	data.ResourceTest(t, r, []acceptance.TestStep{
		{
			Config: r.linuxPremiumV4P0(data),
			Check: acceptance.ComposeTestCheckFunc(
				check.That(data.ResourceName).ExistsInAzure(r),
			),
		},
...
func TestAccServicePlan_linuxPremiumV4MemoryOptimized(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_service_plan", "test")
	r := ServicePlanResource{}

	data.ResourceTest(t, r, []acceptance.TestStep{
		{
			Config: r.linuxPremiumV4MemoryOptimized(data),
			Check: acceptance.ComposeTestCheckFunc(
				check.That(data.ResourceName).ExistsInAzure(r),
			),
		},
...
func TestAccServicePlanIsolated_appServiceEnvironmentV3memoryIntensive(t *testing.T) {
	...
	data.ResourceTest(t, r, []acceptance.TestStep{
		{
			Config: r.aseV3memoryIntensive(data),
			Check: acceptance.ComposeTestCheckFunc(
				check.That(data.ResourceName).ExistsInAzure(r),
			),
		},
...
func (r ServicePlanResource) linuxPremiumV4(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {}
}
...
func (r ServicePlanResource) linuxPremiumV4P0(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {}
}
...
func (r ServicePlanResource) linuxPremiumV4MemoryOptimized(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {}
}
...
func (r ServicePlanResource) aseV3memoryIntensive(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {}
}
