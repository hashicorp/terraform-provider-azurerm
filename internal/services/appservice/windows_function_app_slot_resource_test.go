...
func TestAccWindowsFunctionAppSlot_vNetRoutingUpdate(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_windows_function_app_slot", "test")
	r := WindowsFunctionAppSlotResource{}
...
func TestAccWindowsFunctionAppSlot_e2eEncryption(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_windows_function_app_slot", "test")
	r := WindowsFunctionAppSlotResource{}
...
func TestAccWindowsFunctionAppSlot_e2eEncryptionUpdate(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_windows_function_app_slot", "test")
	r := WindowsFunctionAppSlotResource{}
...
func (r WindowsFunctionAppSlotResource) vNetRoutingEnabled(data acceptance.TestData, planSku string) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {}
}
