...
func TestAccLinuxFunctionAppSlot_authV2AzureActiveDirectory(t *testing.T) {
...
func TestAccLinuxFunctionAppSlot_authV2AppleCustomSettingName(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_linux_function_app_slot", "test")
	r := LinuxFunctionAppSlotResource{}
...
func TestAccLinuxFunctionAppSlot_authV2CustomOIDC(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_linux_function_app_slot", "test")
	r := LinuxFunctionAppSlotResource{}
...
func TestAccLinuxFunctionAppSlot_authV2Facebook(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_linux_function_app_slot", "test")
	r := LinuxFunctionAppSlotResource{}
...
func TestAccLinuxFunctionAppSlot_authV2Github(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_linux_function_app_slot", "test")
	r := LinuxFunctionAppSlotResource{}
...
func TestAccLinuxFunctionAppSlot_authV2Google(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_linux_function_app_slot", "test")
	r := LinuxFunctionAppSlotResource{}
...
func TestAccLinuxFunctionAppSlot_authV2Microsoft(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_linux_function_app_slot", "test")
	r := LinuxFunctionAppSlotResource{}
...
func TestAccLinuxFunctionAppSlot_authV2Twitter(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_linux_function_app_slot", "test")
	r := LinuxFunctionAppSlotResource{}
...
func TestAccLinuxFunctionAppSlot_authV2MultipleAuths(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_linux_function_app_slot", "test")
	r := LinuxFunctionAppSlotResource{}
...
func TestAccLinuxFunctionAppSlot_authV2Update(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_linux_function_app_slot", "test")
	r := LinuxFunctionAppSlotResource{}
...
func TestAccLinuxFunctionAppSlot_authV2UpgradeFromV1(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_linux_function_app_slot", "test")
	r := LinuxFunctionAppSlotResource{}
...
func (r LinuxFunctionAppSlotResource) authV2AzureActiveDirectory(data acceptance.TestData, planSku string) string {
...
func (r LinuxFunctionAppSlotResource) authV2AppleCustomSetting(data acceptance.TestData, planSku string) string {
...
func (r LinuxFunctionAppSlotResource) authV2CustomOIDC(data acceptance.TestData, planSku string) string {
...
func (r LinuxFunctionAppSlotResource) authV2Facebook(data acceptance.TestData, planSku string) string {
...
func (r LinuxFunctionAppSlotResource) authV2Github(data acceptance.TestData, planSku string) string {
...
func (r LinuxFunctionAppSlotResource) authV2Google(data acceptance.TestData, planSku string) string {
...
func (r LinuxFunctionAppSlotResource) authV2Microsoft(data acceptance.TestData, planSku string) string {
	secretSettingName := "MICROSOFT_PROVIDER_AUTHENTICATION_SECRET"
	secretSettingValue := "902D17F6-FD6B-4E44-BABB-58E788DCD907"
	return fmt.Sprintf(`
provider "azurerm" {
...
func (r LinuxFunctionAppSlotResource) authV2Twitter(data acceptance.TestData, planSku string) string {
...
func (r LinuxFunctionAppSlotResource) authV2Multi(data acceptance.TestData, planSku string) string {
	secretSettingValue := "902D17F6-FD6B-4E44-BABB-58E788DCD907"
	return fmt.Sprintf(`
provider "azurerm" {
  features {}
...
func (r LinuxFunctionAppSlotResource) completeAuthV2(data acceptance.TestData, planSku string) string {
	secretSettingValue := "902D17F6-FD6B-4E44-BABB-58E788DCD907"
	return fmt.Sprintf(`
provider "azurerm" {
  features {}
