...
func TestAccWindowsFunctionApp_authV2AzureActiveDirectory(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_windows_function_app", "test")
	r := WindowsFunctionAppResource{}

	data.ResourceTest(t, r, []acceptance.TestStep{
		{
			Config: r.authV2AzureActiveDirectory(data, SkuStandardPlan),
...
func TestAccWindowsFunctionApp_authV2AzureActiveDirectoryNoSecretName(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_windows_function_app", "test")
	r := WindowsFunctionAppResource{}
...
func TestAccWindowsFunctionApp_authV2Apple(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_windows_function_app", "test")
	r := WindowsFunctionAppResource{}

	data.ResourceTest(t, r, []acceptance.TestStep{
		{
			Config: r.authV2Apple(data, SkuStandardPlan),
			Check: acceptance.ComposeTestCheckFunc(
				check.That(data.ResourceName).ExistsInAzure(r),
			),
		},
...
func TestAccWindowsFunctionApp_authV2AppleCustomSettingName(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_windows_function_app", "test")
	r := WindowsFunctionAppResource{}

	data.ResourceTest(t, r, []acceptance.TestStep{
		{
			Config: r.authV2AppleCustomSetting(data, SkuStandardPlan),
			Check: acceptance.ComposeTestCheckFunc(
				check.That(data.ResourceName).ExistsInAzure(r),
			),
		},
...
func TestAccWindowsFunctionApp_authV2CustomOIDC(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_windows_function_app", "test")
	r := WindowsFunctionAppResource{}

	data.ResourceTest(t, r, []acceptance.TestStep{
		{
			Config: r.authV2CustomOIDC(data, SkuStandardPlan),
			Check: acceptance.ComposeTestCheckFunc(
				check.That(data.ResourceName).ExistsInAzure(r),
			),
		},
...
func TestAccWindowsFunctionApp_authV2Facebook(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_windows_function_app", "test")
	r := WindowsFunctionAppResource{}
...
func TestAccWindowsFunctionApp_authV2Github(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_windows_function_app", "test")
	r := WindowsFunctionAppResource{}

	data.ResourceTest(t, r, []acceptance.TestStep{
		{
			Config: r.authV2Github(data, SkuStandardPlan),
			Check: acceptance.ComposeTestCheckFunc(
				check.That(data.ResourceName).ExistsInAzure(r),
			),
		},
...
func TestAccWindowsFunctionApp_authV2Google(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_windows_function_app", "test")
	r := WindowsFunctionAppResource{}
...
func TestAccWindowsFunctionApp_authV2Microsoft(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_windows_function_app", "test")
	r := WindowsFunctionAppResource{}

	data.ResourceTest(t, r, []acceptance.TestStep{
		{
			Config: r.authV2Microsoft(data, SkuStandardPlan),
			Check: acceptance.ComposeTestCheckFunc(
				check.That(data.ResourceName).ExistsInAzure(r),
			),
		},
...
func TestAccWindowsFunctionApp_authV2Twitter(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_windows_function_app", "test")
	r := WindowsFunctionAppResource{}
...
func TestAccWindowsFunctionApp_authV2MultipleAuths(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_windows_function_app", "test")
	r := WindowsFunctionAppResource{}

	data.ResourceTest(t, r, []acceptance.TestStep{
		{
			Config: r.authV2Multi(data, SkuStandardPlan),
			Check: acceptance.ComposeTestCheckFunc(
				check.That(data.ResourceName).ExistsInAzure(r),
			),
		},
...
func TestAccWindowsFunctionApp_authV2Update(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_windows_function_app", "test")
	r := WindowsFunctionAppResource{}
...
func TestAccWindowsFunctionApp_authV2UpgradeFromV1(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_windows_function_app", "test")
	r := WindowsFunctionAppResource{}
...
func (r WindowsFunctionAppResource) authV2AzureActiveDirectory(data acceptance.TestData, planSku string) string {
...
func (r WindowsFunctionAppResource) authV2AzureActiveDirectoryNoSecretName(data acceptance.TestData, planSku string) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {}
}
...
func (r WindowsFunctionAppResource) authV2Apple(data acceptance.TestData, planSku string) string {
...
func (r WindowsFunctionAppResource) authV2AppleCustomSetting(data acceptance.TestData, planSku string) string {
...
func (r WindowsFunctionAppResource) authV2CustomOIDC(data acceptance.TestData, planSku string) string {
...
func (r WindowsFunctionAppResource) authV2Facebook(data acceptance.TestData, planSku string) string {
...
func (r WindowsFunctionAppResource) authV2Google(data acceptance.TestData, planSku string) string {
...
func (r WindowsFunctionAppResource) authV2Microsoft(data acceptance.TestData, planSku string) string {
	secretSettingName := "MICROSOFT_PROVIDER_AUTHENTICATION_SECRET"
	secretSettingValue := "902D17F6-FD6B-4E44-BABB-58E788DCD907"
	return fmt.Sprintf(`
provider "azurerm" {
...
func (r WindowsFunctionAppResource) authV2Twitter(data acceptance.TestData, planSku string) string {
...
func (r WindowsFunctionAppResource) authV2Multi(data acceptance.TestData, planSku string) string {
	secretSettingValue := "902D17F6-FD6B-4E44-BABB-58E788DCD907"
	return fmt.Sprintf(`
provider "azurerm" {
  features {}
...
func (r WindowsFunctionAppResource) completeAuthV2(data acceptance.TestData, planSku string) string {
	secretSettingValue := "902D17F6-FD6B-4E44-BABB-58E788DCD907"
	return fmt.Sprintf(`
provider "azurerm" {
  features {}
