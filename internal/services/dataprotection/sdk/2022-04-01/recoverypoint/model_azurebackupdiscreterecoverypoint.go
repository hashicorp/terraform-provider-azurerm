...
func (o *AzureBackupDiscreteRecoveryPoint) GetRecoveryPointTimeAsTime() (*time.Time, error) {
	return dates.ParseAsFormat(&o.RecoveryPointTime, "2006-01-02T15:04:05Z07:00")
}

func (o *AzureBackupDiscreteRecoveryPoint) SetRecoveryPointTimeAsTime(input time.Time) {
