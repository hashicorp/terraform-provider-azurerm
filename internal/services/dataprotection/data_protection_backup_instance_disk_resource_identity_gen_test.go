	...
	data.ResourceIdentityTest(t, []acceptance.TestStep{
		{
			...
			ConfigStateChecks: []statecheck.StateCheck{
				customstatecheck.ExpectAllIdentityFieldsAreChecked("azurerm_data_protection_backup_instance_disk.test", checkedFields),
				...
				customstatecheck.ExpectStateContainsIdentityValueAtPath("azurerm_data_protection_backup_instance_disk.test", tfjsonpath.New("subscription_id"), tfjsonpath.New("vault_id")),
			},
		},
