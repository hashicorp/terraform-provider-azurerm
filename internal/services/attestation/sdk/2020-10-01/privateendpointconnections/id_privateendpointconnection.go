...
func NewPrivateEndpointConnectionID(subscriptionId, resourceGroup, attestationProviderName, name string) PrivateEndpointConnectionId {
...
func (id PrivateEndpointConnectionId) ID() string {
	...
	return fmt.Sprintf(fmtString, id.SubscriptionId, id.ResourceGroup, id.AttestationProviderName, id.Name)
}
