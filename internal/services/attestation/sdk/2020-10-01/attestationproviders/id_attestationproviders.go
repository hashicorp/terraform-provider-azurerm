...
func (id AttestationProvidersId) Segments() []resourceids.Segment {
	return []resourceids.Segment{
		...
		resourceids.ResourceProviderSegment("microsoftAttestation", "Microsoft.Attestation", "Microsoft.Attestation"),
		resourceids.StaticSegment("attestationProviders", "attestationProviders", "attestationProviders"),
