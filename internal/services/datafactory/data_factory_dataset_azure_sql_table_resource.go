...
func resourceDataFactoryDatasetAzureSQLTable() *pluginsdk.Resource {
	return &pluginsdk.Resource{
		Create: resourceDataFactoryDatasetAzureSQLTableCreateUpdate,
		Read:   resourceDataFactoryDatasetAzureSQLTableRead,
		Update: resourceDataFactoryDatasetAzureSQLTableCreateUpdate,
		Delete: resourceDataFactoryDatasetAzureSQLTableDelete,
...
func resourceDataFactoryDatasetAzureSQLTableCreateUpdate(d *pluginsdk.ResourceData, meta interface{}) error {
	...
	return resourceDataFactoryDatasetAzureSQLTableRead(d, meta)
}

func resourceDataFactoryDatasetAzureSQLTableRead(d *pluginsdk.ResourceData, meta interface{}) error {
	client := meta.(*clients.Client).DataFactory.DatasetClient
	...
	if !ok {
		return fmt.Errorf("classifying Data Factory Dataset SQL Server Table %s: Expected: %q Received: %T", *id, datafactory.TypeBasicDatasetTypeAzureSQLTable, resp.Properties)
	}
...
func resourceDataFactoryDatasetAzureSQLTableDelete(d *pluginsdk.ResourceData, meta interface{}) error {
	client := meta.(*clients.Client).DataFactory.DatasetClient
