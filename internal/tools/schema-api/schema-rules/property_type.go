...
func (propertyType) Check(base providerschema.SchemaJSON, current providerschema.SchemaJSON, propertyName string) *string {
	if (base.Type != "" && current.Type != "" && base.Type != providerschema.SchemaTypeSet) && base.Type != current.Type {
