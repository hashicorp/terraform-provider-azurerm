...
type RecoveryService struct {
	...
	FileShareBackupSuspendProtectionAndRetainDataOnDestroy types.Bool `tfsdk:"file_share_backup_suspend_protection_and_retain_data_on_destroy"`
	FileShareBackupStopProtectionAndRetainDataOnDestroy    types.Bool `tfsdk:"file_share_backup_stop_protection_and_retain_data_on_destroy"`
...
var RecoveryServiceAttributes = map[string]attr.Type{
	...
	"file_share_backup_suspend_protection_and_retain_data_on_destroy": types.BoolType,
	"file_share_backup_stop_protection_and_retain_data_on_destroy":    types.BoolType,
