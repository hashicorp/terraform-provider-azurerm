...
type RecoveryService struct {
	...
	VMWorkloadSAPAseDatabaseBackupStopProtectionAndRetainDataOnDestroy types.Bool `tfsdk:"vm_workload_sap_ase_database_backup_stop_protection_and_retain_data_on_destroy"`
...
var RecoveryServiceAttributes = map[string]attr.Type{
	...
	"vm_workload_sap_ase_database_backup_stop_protection_and_retain_data_on_destroy": types.BoolType,
