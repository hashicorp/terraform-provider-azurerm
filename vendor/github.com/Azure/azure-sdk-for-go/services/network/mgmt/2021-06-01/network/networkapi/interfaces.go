...
import (
    ...
    "github.com/Azure/azure-sdk-for-go/services/network/mgmt/2021-06-01/network"
        ...
        type BastionHostsClientAPI interface {
            ...
            UpdateTags(ctx context.Context, resourceGroupName string, bastionHostName string, parameters network.TagsObject) (result network.BastionHostsUpdateTagsFuture, err error)
        }
        ...
        // FirewallPolicyIdpsSignaturesClientAPI contains the set of methods on the FirewallPolicyIdpsSignaturesClient type.
        type FirewallPolicyIdpsSignaturesClientAPI interface {
            List(ctx context.Context, resourceGroupName string, firewallPolicyName string, parameters network.IDPSQueryObject) (result network.QueryResults, err error)
        }

        var _ FirewallPolicyIdpsSignaturesClientAPI = (*network.FirewallPolicyIdpsSignaturesClient)(nil)
        // FirewallPolicyIdpsSignaturesOverridesClientAPI contains the set of methods on the FirewallPolicyIdpsSignaturesOverridesClient type.
        type FirewallPolicyIdpsSignaturesOverridesClientAPI interface {
            Get(ctx context.Context, resourceGroupName string, firewallPolicyName string) (result network.SignaturesOverrides, err error)
            List(ctx context.Context, resourceGroupName string, firewallPolicyName string) (result network.SignaturesOverridesList, err error)
            Patch(ctx context.Context, parameters network.SignaturesOverrides, resourceGroupName string, firewallPolicyName string) (result network.SignaturesOverrides, err error)
            Put(ctx context.Context, parameters network.SignaturesOverrides, resourceGroupName string, firewallPolicyName string) (result network.SignaturesOverrides, err error)
        }

        var _ FirewallPolicyIdpsSignaturesOverridesClientAPI = (*network.FirewallPolicyIdpsSignaturesOverridesClient)(nil)
        // FirewallPolicyIdpsSignaturesFilterValuesClientAPI contains the set of methods on the FirewallPolicyIdpsSignaturesFilterValuesClient type.
        type FirewallPolicyIdpsSignaturesFilterValuesClientAPI interface {
            List(ctx context.Context, parameters network.SignatureOverridesFilterValuesQuery, resourceGroupName string, firewallPolicyName string) (result network.SignatureOverridesFilterValuesResponse, err error)
        }

        var _ FirewallPolicyIdpsSignaturesFilterValuesClientAPI = (*network.FirewallPolicyIdpsSignaturesFilterValuesClient)(nil)
        ...
        type LoadBalancersClientAPI interface {
            ...
            ListInboundNatRulePortMappings(ctx context.Context, groupName string, loadBalancerName string, backendPoolName string, parameters network.QueryInboundNatRulePortMappingRequest) (result network.LoadBalancersListInboundNatRulePortMappingsFuture, err error)
            SwapPublicIPAddresses(ctx context.Context, location string, parameters network.LoadBalancerVipSwapRequest) (result network.LoadBalancersSwapPublicIPAddressesFuture, err error)
        ...
        // ServiceTagInformationClientAPI contains the set of methods on the ServiceTagInformationClient type.
        type ServiceTagInformationClientAPI interface {
            List(ctx context.Context, location string, noAddressPrefixes *bool, tagName string) (result network.ServiceTagInformationListResultPage, err error)
                ListComplete(ctx context.Context, location string, noAddressPrefixes *bool, tagName string) (result network.ServiceTagInformationListResultIterator, err error)
        }

        var _ ServiceTagInformationClientAPI = (*network.ServiceTagInformationClient)(nil)
        ...
        // VirtualNetworkGatewayNatRulesClientAPI contains the set of methods on the VirtualNetworkGatewayNatRulesClient type.
        type VirtualNetworkGatewayNatRulesClientAPI interface {
            CreateOrUpdate(ctx context.Context, resourceGroupName string, virtualNetworkGatewayName string, natRuleName string, natRuleParameters network.VirtualNetworkGatewayNatRule) (result network.VirtualNetworkGatewayNatRulesCreateOrUpdateFuture, err error)
            Delete(ctx context.Context, resourceGroupName string, virtualNetworkGatewayName string, natRuleName string) (result network.VirtualNetworkGatewayNatRulesDeleteFuture, err error)
            Get(ctx context.Context, resourceGroupName string, virtualNetworkGatewayName string, natRuleName string) (result network.VirtualNetworkGatewayNatRule, err error)
            ListByVirtualNetworkGateway(ctx context.Context, resourceGroupName string, virtualNetworkGatewayName string) (result network.ListVirtualNetworkGatewayNatRulesResultPage, err error)
                ListByVirtualNetworkGatewayComplete(ctx context.Context, resourceGroupName string, virtualNetworkGatewayName string) (result network.ListVirtualNetworkGatewayNatRulesResultIterator, err error)
        }

        var _ VirtualNetworkGatewayNatRulesClientAPI = (*network.VirtualNetworkGatewayNatRulesClient)(nil)
        ...
        // RoutingIntentClientAPI contains the set of methods on the RoutingIntentClient type.
        type RoutingIntentClientAPI interface {
            CreateOrUpdate(ctx context.Context, resourceGroupName string, virtualHubName string, routingIntentName string, routingIntentParameters network.RoutingIntent) (result network.RoutingIntentCreateOrUpdateFuture, err error)
            Delete(ctx context.Context, resourceGroupName string, virtualHubName string, routingIntentName string) (result network.RoutingIntentDeleteFuture, err error)
            Get(ctx context.Context, resourceGroupName string, virtualHubName string, routingIntentName string) (result network.RoutingIntent, err error)
            List(ctx context.Context, resourceGroupName string, virtualHubName string) (result network.ListRoutingIntentResultPage, err error)
                ListComplete(ctx context.Context, resourceGroupName string, virtualHubName string) (result network.ListRoutingIntentResultIterator, err error)
        }

        var _ RoutingIntentClientAPI = (*network.RoutingIntentClient)(nil)
