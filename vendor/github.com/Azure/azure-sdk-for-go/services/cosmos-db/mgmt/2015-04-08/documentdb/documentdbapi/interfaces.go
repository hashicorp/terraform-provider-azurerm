...
type DatabaseAccountsClientAPI interface {
	...
	CreateUpdateCassandraKeyspace(ctx context.Context, resourceGroupName string, accountName string, keyspaceRid string, createUpdateCassandraKeyspaceParameters documentdb.CassandraKeyspaceCreateUpdateParameters) (result documentdb.DatabaseAccountsCreateUpdateCassandraKeyspaceFuture, err error)
	CreateUpdateCassandraTable(ctx context.Context, resourceGroupName string, accountName string, keyspaceRid string, tableRid string, createUpdateCassandraTableParameters documentdb.CassandraTableCreateUpdateParameters) (result documentdb.DatabaseAccountsCreateUpdateCassandraTableFuture, err error)
	CreateUpdateGremlinContainer(ctx context.Context, resourceGroupName string, accountName string, databaseRid string, containerRid string, createUpdateGremlinContainerParameters documentdb.ContainerCreateUpdateParameters) (result documentdb.DatabaseAccountsCreateUpdateGremlinContainerFuture, err error)
	CreateUpdateGremlinDatabase(ctx context.Context, resourceGroupName string, accountName string, databaseRid string, createUpdateGremlinDatabaseParameters documentdb.GremlinDatabaseCreateUpdateParameters) (result documentdb.DatabaseAccountsCreateUpdateGremlinDatabaseFuture, err error)
	CreateUpdateMongoCollection(ctx context.Context, resourceGroupName string, accountName string, databaseRid string, collectionRid string, createUpdateMongoCollectionParameters documentdb.MongoCollectionCreateUpdateParameters) (result documentdb.DatabaseAccountsCreateUpdateMongoCollectionFuture, err error)
	CreateUpdateMongoDatabase(ctx context.Context, resourceGroupName string, accountName string, databaseRid string, createUpdateMongoDatabaseParameters documentdb.MongoDatabaseCreateUpdateParameters) (result documentdb.DatabaseAccountsCreateUpdateMongoDatabaseFuture, err error)
	CreateUpdateSQLContainer(ctx context.Context, resourceGroupName string, accountName string, databaseRid string, containerRid string, createUpdateSQLContainerParameters documentdb.ContainerCreateUpdateParameters) (result documentdb.DatabaseAccountsCreateUpdateSQLContainerFuture, err error)
	CreateUpdateSQLDatabase(ctx context.Context, resourceGroupName string, accountName string, databaseRid string, createUpdateSQLDatabaseParameters documentdb.SQLDatabaseCreateUpdateParameters) (result documentdb.DatabaseAccountsCreateUpdateSQLDatabaseFuture, err error)
	CreateUpdateTable(ctx context.Context, resourceGroupName string, accountName string, tableRid string, createUpdateTableParameters documentdb.TableCreateUpdateParameters) (result documentdb.DatabaseAccountsCreateUpdateTableFuture, err error)
	...
	DeleteGremlinContainer(ctx context.Context, resourceGroupName string, accountName string, databaseRid string, containerRid string) (result documentdb.DatabaseAccountsDeleteGremlinContainerFuture, err error)
	DeleteGremlinDatabase(ctx context.Context, resourceGroupName string, accountName string, databaseRid string) (result documentdb.DatabaseAccountsDeleteGremlinDatabaseFuture, err error)
	...
	GetGremlinContainer(ctx context.Context, resourceGroupName string, accountName string, databaseRid string, containerRid string) (result documentdb.Container, err error)
	GetGremlinDatabase(ctx context.Context, resourceGroupName string, accountName string, databaseRid string) (result documentdb.GremlinDatabase, err error)
	...
	GetSQLContainer(ctx context.Context, resourceGroupName string, accountName string, databaseRid string, containerRid string) (result documentdb.Container, err error)
	...
	ListGremlinContainers(ctx context.Context, resourceGroupName string, accountName string, databaseRid string) (result documentdb.ContainerListResult, err error)
	...
	ListSQLContainers(ctx context.Context, resourceGroupName string, accountName string, databaseRid string) (result documentdb.ContainerListResult, err error)
