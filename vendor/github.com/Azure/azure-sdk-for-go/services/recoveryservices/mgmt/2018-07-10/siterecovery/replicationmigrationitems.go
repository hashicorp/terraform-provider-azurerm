...
<<<<<<< HEAD:vendor/github.com/Azure/azure-sdk-for-go/services/recoveryservices/mgmt/2018-01-10/siterecovery/replicationmigrationitems.go
			}
		}
		return
	}
...
func (client ReplicationMigrationItemsClient) Resync(ctx context.Context, fabricName string, protectionContainerName string, migrationItemName string, input ResyncInput) (result ReplicationMigrationItemsResyncFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "siterecovery.ReplicationMigrationItemsClient", "Resync", nil, "Failure sending request")
		return
	}
...
func (client ReplicationMigrationItemsClient) ResyncSender(req *http.Request) (future ReplicationMigrationItemsResyncFuture, err error) {
	...
	future.Result = func(client ReplicationMigrationItemsClient) (mi MigrationItem, err error) {
		...
		mi.Response.Response, err = future.GetResult(sender)
		if mi.Response.Response == nil && err == nil {
			err = autorest.NewErrorWithError(err, "siterecovery.ReplicationMigrationItemsResyncFuture", "Result", nil, "received nil response and error")
		}
		if err == nil && mi.Response.Response.StatusCode != http.StatusNoContent {
...
>>>>>>> 27a321623799575d164becab56ceb30586e6ed06:vendor/github.com/Azure/azure-sdk-for-go/services/recoveryservices/mgmt/2018-07-10/siterecovery/replicationmigrationitems.go
	return
}
