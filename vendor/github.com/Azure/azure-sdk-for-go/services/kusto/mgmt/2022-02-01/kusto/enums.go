...
// DatabaseRouting enumerates the values for database routing.
...
// PossibleDatabaseRoutingValues returns an array of possible values for the DatabaseRouting const type.
func PossibleDatabaseRoutingValues() []DatabaseRouting {
	return []DatabaseRouting{DatabaseRoutingMulti, DatabaseRoutingSingle}
}
...
// PublicIPType enumerates the values for public ip type.
...
// PossiblePublicIPTypeValues returns an array of possible values for the PublicIPType const type.
func PossiblePublicIPTypeValues() []PublicIPType {
	return []PublicIPType{PublicIPTypeDualStack, PublicIPTypeIPv4}
}
