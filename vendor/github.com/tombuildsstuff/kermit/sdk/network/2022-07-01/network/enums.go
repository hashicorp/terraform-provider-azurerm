...
func PossibleApplicationGatewayClientRevocationOptionsValues() []ApplicationGatewayClientRevocationOptions {
	return []ApplicationGatewayClientRevocationOptions{ApplicationGatewayClientRevocationOptionsNone, ApplicationGatewayClientRevocationOptionsOCSP}
}
...
func PossibleApplicationGatewayProtocolValues() []ApplicationGatewayProtocol {
	return []ApplicationGatewayProtocol{ApplicationGatewayProtocolHTTP, ApplicationGatewayProtocolHTTPS, ApplicationGatewayProtocolTCP, ApplicationGatewayProtocolTLS}
}
...
func PossibleCommissionedStateValues() []CommissionedState {
	return []CommissionedState{CommissionedStateCommissioned, CommissionedStateCommissionedNoInternetAdvertise, CommissionedStateCommissioning, CommissionedStateDecommissioning, CommissionedStateDeprovisioned, CommissionedStateDeprovisioning, CommissionedStateProvisioned, CommissionedStateProvisioning}
}
...
func PossibleCustomIPPrefixTypeValues() []CustomIPPrefixType {
	return []CustomIPPrefixType{CustomIPPrefixTypeChild, CustomIPPrefixTypeParent, CustomIPPrefixTypeSingular}
}
...
func PossibleFirewallPolicyIDPSQuerySortOrderValues() []FirewallPolicyIDPSQuerySortOrder {
	return []FirewallPolicyIDPSQuerySortOrder{FirewallPolicyIDPSQuerySortOrderAscending, FirewallPolicyIDPSQuerySortOrderDescending}
}
...
func PossibleGeoValues() []Geo {
	return []Geo{GeoAFRI, GeoAPAC, GeoAQ, GeoEURO, GeoGLOBAL, GeoLATAM, GeoME, GeoNAM, GeoOCEANIA}
}
...
func PossibleSlotTypeValues() []SlotType {
	return []SlotType{SlotTypeProduction, SlotTypeStaging}
}
...
func PossibleVirtualNetworkGatewayConnectionTypeValues() []VirtualNetworkGatewayConnectionType {
	return []VirtualNetworkGatewayConnectionType{VirtualNetworkGatewayConnectionTypeExpressRoute, VirtualNetworkGatewayConnectionTypeIPsec, VirtualNetworkGatewayConnectionTypeVPNClient, VirtualNetworkGatewayConnectionTypeVnet2Vnet}
}
...
func PossibleVpnPolicyMemberAttributeTypeValues() []VpnPolicyMemberAttributeType {
	return []VpnPolicyMemberAttributeType{VpnPolicyMemberAttributeTypeAADGroupID, VpnPolicyMemberAttributeTypeCertificateGroupID, VpnPolicyMemberAttributeTypeRadiusAzureGroupID}
}
