...
func (client VpnGatewaysClient) Reset(ctx context.Context, resourceGroupName string, gatewayName string, IPConfigurationID string) (result VpnGatewaysResetFuture, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.ResetPreparer(ctx, resourceGroupName, gatewayName, IPConfigurationID)
	if err != nil {
...
func (client VpnGatewaysClient) ResetPreparer(ctx context.Context, resourceGroupName string, gatewayName string, IPConfigurationID string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"gatewayName":       autorest.Encode("path", gatewayName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
	...
	if len(IPConfigurationID) > 0 {
		queryParameters["ipConfigurationId"] = autorest.Encode("query", IPConfigurationID)
	}
