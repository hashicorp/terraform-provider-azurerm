...
func PossibleApplicationGatewayCustomErrorStatusCodeValues() []ApplicationGatewayCustomErrorStatusCode {
	return []ApplicationGatewayCustomErrorStatusCode{ApplicationGatewayCustomErrorStatusCodeHTTPStatus400, ApplicationGatewayCustomErrorStatusCodeHTTPStatus403, ApplicationGatewayCustomErrorStatusCodeHTTPStatus404, ApplicationGatewayCustomErrorStatusCodeHTTPStatus405, ApplicationGatewayCustomErrorStatusCodeHTTPStatus408, ApplicationGatewayCustomErrorStatusCodeHTTPStatus499, ApplicationGatewayCustomErrorStatusCodeHTTPStatus500, ApplicationGatewayCustomErrorStatusCodeHTTPStatus502, ApplicationGatewayCustomErrorStatusCodeHTTPStatus503, ApplicationGatewayCustomErrorStatusCodeHTTPStatus504}
}
...
// ApplicationGatewayFirewallRateLimitDuration enumerates the values for application gateway firewall rate
// limit duration.
...
// PossibleApplicationGatewayFirewallRateLimitDurationValues returns an array of possible values for the ApplicationGatewayFirewallRateLimitDuration const type.
...
// ApplicationGatewayFirewallUserSessionVariable enumerates the values for application gateway firewall user
// session variable.
...
// PossibleApplicationGatewayFirewallUserSessionVariableValues returns an array of possible values for the ApplicationGatewayFirewallUserSessionVariable const type.
func PossibleApplicationGatewayFirewallUserSessionVariableValues() []ApplicationGatewayFirewallUserSessionVariable {
	return []ApplicationGatewayFirewallUserSessionVariable{ApplicationGatewayFirewallUserSessionVariableClientAddr, ApplicationGatewayFirewallUserSessionVariableGeoLocation, ApplicationGatewayFirewallUserSessionVariableNone}
}
...
// AzureFirewallPacketCaptureFlagsType enumerates the values for azure firewall packet capture flags type.
...
// PossibleAzureFirewallPacketCaptureFlagsTypeValues returns an array of possible values for the AzureFirewallPacketCaptureFlagsType const type.
func PossibleAzureFirewallPacketCaptureFlagsTypeValues() []AzureFirewallPacketCaptureFlagsType {
	return []AzureFirewallPacketCaptureFlagsType{AzureFirewallPacketCaptureFlagsTypeAck, AzureFirewallPacketCaptureFlagsTypeFin, AzureFirewallPacketCaptureFlagsTypePush, AzureFirewallPacketCaptureFlagsTypeRst, AzureFirewallPacketCaptureFlagsTypeSyn, AzureFirewallPacketCaptureFlagsTypeUrg}
}
...
func PossibleInterfaceAuxiliaryModeValues() []InterfaceAuxiliaryMode {
	return []InterfaceAuxiliaryMode{InterfaceAuxiliaryModeAcceleratedConnections, InterfaceAuxiliaryModeFloating, InterfaceAuxiliaryModeMaxConnections, InterfaceAuxiliaryModeNone}
}

// InterfaceAuxiliarySku enumerates the values for interface auxiliary sku.
...
// PossibleInterfaceAuxiliarySkuValues returns an array of possible values for the InterfaceAuxiliarySku const type.
func PossibleInterfaceAuxiliarySkuValues() []InterfaceAuxiliarySku {
	return []InterfaceAuxiliarySku{InterfaceAuxiliarySkuA1, InterfaceAuxiliarySkuA2, InterfaceAuxiliarySkuA4, InterfaceAuxiliarySkuA8, InterfaceAuxiliarySkuNone}
}
...
func PossibleLoadBalancerBackendAddressAdminStateValues() []LoadBalancerBackendAddressAdminState {
	return []LoadBalancerBackendAddressAdminState{LoadBalancerBackendAddressAdminStateDown, LoadBalancerBackendAddressAdminStateNone, LoadBalancerBackendAddressAdminStateUp}
}
...
// PublicIPAddressDNSSettingsDomainNameLabelScope enumerates the values for public ip address dns settings
...
// PossiblePublicIPAddressDNSSettingsDomainNameLabelScopeValues returns an array of possible values for the PublicIPAddressDNSSettingsDomainNameLabelScope const type.
func PossiblePublicIPAddressDNSSettingsDomainNameLabelScopeValues() []PublicIPAddressDNSSettingsDomainNameLabelScope {
	return []PublicIPAddressDNSSettingsDomainNameLabelScope{PublicIPAddressDNSSettingsDomainNameLabelScopeNoReuse, PublicIPAddressDNSSettingsDomainNameLabelScopeResourceGroupReuse, PublicIPAddressDNSSettingsDomainNameLabelScopeSubscriptionReuse, PublicIPAddressDNSSettingsDomainNameLabelScopeTenantReuse}
}
...
// ScrubbingRuleEntryMatchOperator enumerates the values for scrubbing rule entry match operator.
...
// PossibleScrubbingRuleEntryMatchOperatorValues returns an array of possible values for the ScrubbingRuleEntryMatchOperator const type.
func PossibleScrubbingRuleEntryMatchOperatorValues() []ScrubbingRuleEntryMatchOperator {
	return []ScrubbingRuleEntryMatchOperator{ScrubbingRuleEntryMatchOperatorEquals, ScrubbingRuleEntryMatchOperatorEqualsAny}
}

// ScrubbingRuleEntryMatchVariable enumerates the values for scrubbing rule entry match variable.
...
// PossibleScrubbingRuleEntryMatchVariableValues returns an array of possible values for the ScrubbingRuleEntryMatchVariable const type.
...
// ScrubbingRuleEntryState enumerates the values for scrubbing rule entry state.
...
// PossibleScrubbingRuleEntryStateValues returns an array of possible values for the ScrubbingRuleEntryState const type.
func PossibleScrubbingRuleEntryStateValues() []ScrubbingRuleEntryState {
	return []ScrubbingRuleEntryState{ScrubbingRuleEntryStateDisabled, ScrubbingRuleEntryStateEnabled}
}
...
func PossibleWebApplicationFirewallRuleTypeValues() []WebApplicationFirewallRuleType {
	return []WebApplicationFirewallRuleType{WebApplicationFirewallRuleTypeInvalid, WebApplicationFirewallRuleTypeMatchRule, WebApplicationFirewallRuleTypeRateLimitRule}
}

// WebApplicationFirewallScrubbingState enumerates the values for web application firewall scrubbing state.
...
// PossibleWebApplicationFirewallScrubbingStateValues returns an array of possible values for the WebApplicationFirewallScrubbingState const type.
func PossibleWebApplicationFirewallScrubbingStateValues() []WebApplicationFirewallScrubbingState {
	return []WebApplicationFirewallScrubbingState{WebApplicationFirewallScrubbingStateDisabled, WebApplicationFirewallScrubbingStateEnabled}
}

// WebApplicationFirewallState enumerates the values for web application firewall state.
...
// PossibleWebApplicationFirewallStateValues returns an array of possible values for the WebApplicationFirewallState const type.
func PossibleWebApplicationFirewallStateValues() []WebApplicationFirewallState {
	return []WebApplicationFirewallState{WebApplicationFirewallStateDisabled, WebApplicationFirewallStateEnabled}
}
