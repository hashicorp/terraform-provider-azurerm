...
// closes the http.Response Body.
func (client VirtualHubBgpConnectionsClient) ListAdvertisedRoutesResponder(resp *http.Response) (result SetListPeerRoute, err error) {
	err = autorest.Respond(
		resp,
...
// closes the http.Response Body.
func (client VirtualHubBgpConnectionsClient) ListLearnedRoutesResponder(resp *http.Response) (result SetListPeerRoute, err error) {
	err = autorest.Respond(
		resp,
		azure.WithErrorUnlessStatusCode(http.StatusOK, http.StatusAccepted),
		autorest.ByUnmarshallingJSON(&result.Value),
