...
// AlternativeType enumerates the values for alternative type.
...
// PossibleAlternativeTypeValues returns an array of possible values for the AlternativeType const type.
func PossibleAlternativeTypeValues() []AlternativeType {
	return []AlternativeType{AlternativeTypeNone, AlternativeTypeOffer, AlternativeTypePlan}
}
...
func PossibleCloudServiceSlotTypeValues() []CloudServiceSlotType {
	return []CloudServiceSlotType{CloudServiceSlotTypeProduction, CloudServiceSlotTypeStaging}
}
...
func PossibleDiskControllerTypesValues() []DiskControllerTypes {
	return []DiskControllerTypes{DiskControllerTypesNVMe, DiskControllerTypesSCSI}
}
...
const (
	...
	// DiskStorageAccountTypesPremiumV2LRS Premium SSD v2 locally redundant storage. Best for production and
	// performance-sensitive workloads that consistently require low latency and high IOPS and throughput.
...
func PossibleDiskStorageAccountTypesValues() []DiskStorageAccountTypes {
	return []DiskStorageAccountTypes{DiskStorageAccountTypesPremiumLRS, DiskStorageAccountTypesPremiumV2LRS, DiskStorageAccountTypesPremiumZRS, DiskStorageAccountTypesStandardLRS, DiskStorageAccountTypesStandardSSDLRS, DiskStorageAccountTypesStandardSSDZRS, DiskStorageAccountTypesUltraSSDLRS}
}

// EdgeZoneStorageAccountType enumerates the values for edge zone storage account type.
...
// PossibleEdgeZoneStorageAccountTypeValues returns an array of possible values for the EdgeZoneStorageAccountType const type.
func PossibleEdgeZoneStorageAccountTypeValues() []EdgeZoneStorageAccountType {
	return []EdgeZoneStorageAccountType{EdgeZoneStorageAccountTypePremiumLRS, EdgeZoneStorageAccountTypeStandardLRS, EdgeZoneStorageAccountTypeStandardSSDLRS, EdgeZoneStorageAccountTypeStandardZRS}
}
...
// ExpandTypeForListVMs enumerates the values for expand type for list v ms.
...
// PossibleExpandTypeForListVMsValues returns an array of possible values for the ExpandTypeForListVMs const type.
func PossibleExpandTypeForListVMsValues() []ExpandTypeForListVMs {
	return []ExpandTypeForListVMs{ExpandTypeForListVMsInstanceView}
}
...
// ExpandTypesForListVMs enumerates the values for expand types for list v ms.
...
// PossibleExpandTypesForListVMsValues returns an array of possible values for the ExpandTypesForListVMs const type.
...
func PossibleGalleryApplicationCustomActionParameterTypeValues() []GalleryApplicationCustomActionParameterType {
	return []GalleryApplicationCustomActionParameterType{GalleryApplicationCustomActionParameterTypeConfigurationDataBlob, GalleryApplicationCustomActionParameterTypeLogOutputBlob, GalleryApplicationCustomActionParameterTypeString}
}
...
// ImageState enumerates the values for image state.
...
// PossibleImageStateValues returns an array of possible values for the ImageState const type.
func PossibleImageStateValues() []ImageState {
	return []ImageState{ImageStateActive, ImageStateDeprecated, ImageStateScheduledForDeprecation}
}
...
func PossiblePolicyViolationCategoryValues() []PolicyViolationCategory {
	return []PolicyViolationCategory{PolicyViolationCategoryCopyrightValidation, PolicyViolationCategoryIPTheft, PolicyViolationCategoryImageFlaggedUnsafe, PolicyViolationCategoryOther}
}
...
// RestorePointEncryptionType enumerates the values for restore point encryption type.
type RestorePointEncryptionType string

const (
	// RestorePointEncryptionTypeEncryptionAtRestWithCustomerKey Disk Restore Point is encrypted at rest with
	...
	// RestorePointEncryptionTypeEncryptionAtRestWithPlatformAndCustomerKeys Disk Restore Point is encrypted at
	// rest with 2 layers of encryption. One of the keys is Customer managed and the other key is Platform
	// managed.
	...
	// RestorePointEncryptionTypeEncryptionAtRestWithPlatformKey Disk Restore Point is encrypted at rest with
	// Platform managed key.
	RestorePointEncryptionTypeEncryptionAtRestWithPlatformKey RestorePointEncryptionType = "EncryptionAtRestWithPlatformKey"
)

// PossibleRestorePointEncryptionTypeValues returns an array of possible values for the RestorePointEncryptionType const type.
func PossibleRestorePointEncryptionTypeValues() []RestorePointEncryptionType {
	return []RestorePointEncryptionType{RestorePointEncryptionTypeEncryptionAtRestWithCustomerKey, RestorePointEncryptionTypeEncryptionAtRestWithPlatformAndCustomerKeys, RestorePointEncryptionTypeEncryptionAtRestWithPlatformKey}
}
