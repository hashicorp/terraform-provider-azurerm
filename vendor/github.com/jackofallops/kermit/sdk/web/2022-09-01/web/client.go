// Package web implements the Azure ARM Web service API version 2022-09-01.
//
...
func (client BaseClient) ListCustomHostNameSites(ctx context.Context, hostname string) (result CustomHostnameSitesCollectionPage, err error) {
	if tracing.IsEnabled() {
	...
	req, err := client.ListCustomHostNameSitesPreparer(ctx, hostname)
	if err != nil {
...
func (client BaseClient) ListCustomHostNameSitesPreparer(ctx context.Context, hostname string) (*http.Request, error) {
	pathParameters := map[string]interface{}{
		"subscriptionId": autorest.Encode("path", client.SubscriptionID),
	}
...
func (client BaseClient) ListCustomHostNameSitesComplete(ctx context.Context, hostname string) (result CustomHostnameSitesCollectionIterator, err error) {
	if tracing.IsEnabled() {
		ctx = tracing.StartSpan(ctx, fqdn+"/BaseClient.ListCustomHostNameSites")
		defer func() {
			sc := -1
	...
	result.page, err = client.ListCustomHostNameSites(ctx, hostname)
	return
}
