...
// DataFlowDebugSessionClient is the client for the DataFlowDebugSession methods of the Synapse service.
...
func (client DataFlowDebugSessionClient) AddDataFlow(ctx context.Context, request DataFlowDebugPackage) (result AddDataFlowToDebugSessionResponse, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("synapse.DataFlowDebugSessionClient", "AddDataFlow", err.Error())
	}

	req, err := client.AddDataFlowPreparer(ctx, request)
	if err != nil {
		err = autorest.NewErrorWithError(err, "synapse.DataFlowDebugSessionClient", "AddDataFlow", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "synapse.DataFlowDebugSessionClient", "AddDataFlow", resp, "Failure sending request")
		return
	}

	result, err = client.AddDataFlowResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "synapse.DataFlowDebugSessionClient", "AddDataFlow", resp, "Failure responding to request")
		return
	}
...
func (client DataFlowDebugSessionClient) CreateDataFlowDebugSession(ctx context.Context, request CreateDataFlowDebugSessionRequest) (result DataFlowDebugSessionCreateDataFlowDebugSessionFuture, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "synapse.DataFlowDebugSessionClient", "CreateDataFlowDebugSession", nil, "Failure preparing request")
		return
	}

	result, err = client.CreateDataFlowDebugSessionSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "synapse.DataFlowDebugSessionClient", "CreateDataFlowDebugSession", result.Response(), "Failure sending request")
		return
	}
...
func (client DataFlowDebugSessionClient) DeleteDataFlowDebugSession(ctx context.Context, request DeleteDataFlowDebugSessionRequest) (result autorest.Response, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "synapse.DataFlowDebugSessionClient", "DeleteDataFlowDebugSession", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "synapse.DataFlowDebugSessionClient", "DeleteDataFlowDebugSession", resp, "Failure sending request")
		return
	}

	result, err = client.DeleteDataFlowDebugSessionResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "synapse.DataFlowDebugSessionClient", "DeleteDataFlowDebugSession", resp, "Failure responding to request")
		return
	}
...
func (client DataFlowDebugSessionClient) ExecuteCommand(ctx context.Context, request DataFlowDebugCommandRequest) (result DataFlowDebugSessionExecuteCommandFuture, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("synapse.DataFlowDebugSessionClient", "ExecuteCommand", err.Error())
	}

	req, err := client.ExecuteCommandPreparer(ctx, request)
	if err != nil {
		err = autorest.NewErrorWithError(err, "synapse.DataFlowDebugSessionClient", "ExecuteCommand", nil, "Failure preparing request")
		return
	}

	result, err = client.ExecuteCommandSender(req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "synapse.DataFlowDebugSessionClient", "ExecuteCommand", result.Response(), "Failure sending request")
		return
	}
...
func (client DataFlowDebugSessionClient) QueryDataFlowDebugSessionsByWorkspace(ctx context.Context) (result QueryDataFlowDebugSessionsResponsePage, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "synapse.DataFlowDebugSessionClient", "QueryDataFlowDebugSessionsByWorkspace", nil, "Failure preparing request")
		return
	}
	...
	if err != nil {
		...
		err = autorest.NewErrorWithError(err, "synapse.DataFlowDebugSessionClient", "QueryDataFlowDebugSessionsByWorkspace", resp, "Failure sending request")
		return
	}

	result.qdfdsr, err = client.QueryDataFlowDebugSessionsByWorkspaceResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "synapse.DataFlowDebugSessionClient", "QueryDataFlowDebugSessionsByWorkspace", resp, "Failure responding to request")
		return
	}
...
func (client DataFlowDebugSessionClient) queryDataFlowDebugSessionsByWorkspaceNextResults(ctx context.Context, lastResults QueryDataFlowDebugSessionsResponse) (result QueryDataFlowDebugSessionsResponse, err error) {
	...
	if err != nil {
		return result, autorest.NewErrorWithError(err, "synapse.DataFlowDebugSessionClient", "queryDataFlowDebugSessionsByWorkspaceNextResults", nil, "Failure preparing next results request")
	}
	if req == nil {
		return
	}
	...
	if err != nil {
		result.Response = autorest.Response{Response: resp}
		return result, autorest.NewErrorWithError(err, "synapse.DataFlowDebugSessionClient", "queryDataFlowDebugSessionsByWorkspaceNextResults", resp, "Failure sending next results request")
	}
	result, err = client.QueryDataFlowDebugSessionsByWorkspaceResponder(resp)
	if err != nil {
		err = autorest.NewErrorWithError(err, "synapse.DataFlowDebugSessionClient", "queryDataFlowDebugSessionsByWorkspaceNextResults", resp, "Failure responding to next results request")
	}
	return
}
