...
type JobEnableOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

type JobEnableOperationOptions struct {
...
func DefaultJobEnableOperationOptions() JobEnableOperationOptions {
	return JobEnableOperationOptions{}
}

func (o JobEnableOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
...
func (o JobEnableOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}

	return &out
}

func (o JobEnableOperationOptions) ToQuery() *client.QueryParams {
...
// JobEnable ...
func (c JobsClient) JobEnable(ctx context.Context, id JobId, options JobEnableOperationOptions) (result JobEnableOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:          fmt.Sprintf("%s/enable", id.Path()),
	}
