...
type JobDeleteOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

type JobDeleteOperationOptions struct {
...
func DefaultJobDeleteOperationOptions() JobDeleteOperationOptions {
	return JobDeleteOperationOptions{}
}

func (o JobDeleteOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
...
func (o JobDeleteOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}

	return &out
}

func (o JobDeleteOperationOptions) ToQuery() *client.QueryParams {
...
// JobDelete ...
func (c JobsClient) JobDelete(ctx context.Context, id JobId, options JobDeleteOperationOptions) (result JobDeleteOperationResponse, err error) {
