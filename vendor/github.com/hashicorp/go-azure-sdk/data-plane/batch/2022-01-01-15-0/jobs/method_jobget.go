...
type JobGetOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *CloudJob
}

type JobGetOperationOptions struct {
...
func DefaultJobGetOperationOptions() JobGetOperationOptions {
	return JobGetOperationOptions{}
}

func (o JobGetOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
...
func (o JobGetOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}

	return &out
}

func (o JobGetOperationOptions) ToQuery() *client.QueryParams {
...
// JobGet ...
func (c JobsClient) JobGet(ctx context.Context, id JobId, options JobGetOperationOptions) (result JobGetOperationResponse, err error) {
