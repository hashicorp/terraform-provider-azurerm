...
type JobUpdateOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

type JobUpdateOperationOptions struct {
...
func DefaultJobUpdateOperationOptions() JobUpdateOperationOptions {
	return JobUpdateOperationOptions{}
}

func (o JobUpdateOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
...
func (o JobUpdateOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}

	return &out
}

func (o JobUpdateOperationOptions) ToQuery() *client.QueryParams {
...
// JobUpdate ...
func (c JobsClient) JobUpdate(ctx context.Context, id JobId, input JobUpdateParameter, options JobUpdateOperationOptions) (result JobUpdateOperationResponse, err error) {
