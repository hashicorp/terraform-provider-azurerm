...
type JobDisableOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
}

type JobDisableOperationOptions struct {
...
func DefaultJobDisableOperationOptions() JobDisableOperationOptions {
	return JobDisableOperationOptions{}
}

func (o JobDisableOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
...
func (o JobDisableOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}

	return &out
}

func (o JobDisableOperationOptions) ToQuery() *client.QueryParams {
...
// JobDisable ...
func (c JobsClient) JobDisable(ctx context.Context, id JobId, input JobDisableParameter, options JobDisableOperationOptions) (result JobDisableOperationResponse, err error) {
