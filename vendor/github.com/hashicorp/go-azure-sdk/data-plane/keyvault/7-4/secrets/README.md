...
## `github.com/hashicorp/go-azure-sdk/data-plane/keyvault/7.4/secrets` Documentation

The `secrets` SDK allows for interaction with <unknown source data type> `keyvault` (API Version `7.4`).
...
```go
import "github.com/hashicorp/go-azure-sdk/data-plane/keyvault/7.4/secrets"
```
...
read, err := client.GetSecret(ctx, id)
if err != nil {
	// handle the error
}
if model := read.Model; model != nil {
