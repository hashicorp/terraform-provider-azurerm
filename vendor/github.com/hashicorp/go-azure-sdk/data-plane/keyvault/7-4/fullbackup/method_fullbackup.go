...
// FullBackup ...
func (c FullBackupClient) FullBackup(ctx context.Context, input SASTokenParameter) (result FullBackupOperationResponse, err error) {
...
func (c FullBackupClient) FullBackupThenPoll(ctx context.Context, input SASTokenParameter) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after FullBackup: %+v", err)
	}
