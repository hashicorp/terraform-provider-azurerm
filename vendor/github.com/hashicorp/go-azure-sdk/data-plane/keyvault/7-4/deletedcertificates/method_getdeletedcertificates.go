...
func (c DeletedCertificatesClient) GetDeletedCertificates(ctx context.Context, options GetDeletedCertificatesOperationOptions) (result GetDeletedCertificatesOperationResponse, err error) {
...
func (c DeletedCertificatesClient) GetDeletedCertificatesComplete(ctx context.Context, options GetDeletedCertificatesOperationOptions) (GetDeletedCertificatesCompleteResult, error) {
...
func (c DeletedCertificatesClient) GetDeletedCertificatesCompleteMatchingPredicate(ctx context.Context, options GetDeletedCertificatesOperationOptions, predicate DeletedCertificateItemOperationPredicate) (result GetDeletedCertificatesCompleteResult, err error) {
