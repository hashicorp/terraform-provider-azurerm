...
// GetDeletedKeys ...
func (c DeletedKeysClient) GetDeletedKeys(ctx context.Context, options GetDeletedKeysOperationOptions) (result GetDeletedKeysOperationResponse, err error) {
...
func (c DeletedKeysClient) GetDeletedKeysComplete(ctx context.Context, options GetDeletedKeysOperationOptions) (GetDeletedKeysCompleteResult, error) {
...
func (c DeletedKeysClient) GetDeletedKeysCompleteMatchingPredicate(ctx context.Context, options GetDeletedKeysOperationOptions, predicate DeletedKeyItemOperationPredicate) (result GetDeletedKeysCompleteResult, err error) {
