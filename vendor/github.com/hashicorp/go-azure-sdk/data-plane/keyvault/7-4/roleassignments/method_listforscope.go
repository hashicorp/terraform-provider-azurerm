...
// ListForScope ...
func (c RoleAssignmentsClient) ListForScope(ctx context.Context, id ScopeId, options ListForScopeOperationOptions) (result ListForScopeOperationResponse, err error) {
...
func (c RoleAssignmentsClient) ListForScopeComplete(ctx context.Context, id ScopeId, options ListForScopeOperationOptions) (ListForScopeCompleteResult, error) {
...
func (c RoleAssignmentsClient) ListForScopeCompleteMatchingPredicate(ctx context.Context, id ScopeId, options ListForScopeOperationOptions, predicate RoleAssignmentOperationPredicate) (result ListForScopeCompleteResult, err error) {
