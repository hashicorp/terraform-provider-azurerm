...
## `github.com/hashicorp/go-azure-sdk/data-plane/keyvault/7.4/keys` Documentation

The `keys` SDK allows for interaction with <unknown source data type> `keyvault` (API Version `7.4`).
...
```go
import "github.com/hashicorp/go-azure-sdk/data-plane/keyvault/7.4/keys"
```
...
### Example Usage: `KeysClient.SelectiveKeyRestoreOperation`

```go
ctx := context.TODO()
id := keys.NewKeyID("keyName")

payload := keys.SelectiveKeyRestoreOperationParameters{
	// ...
}
