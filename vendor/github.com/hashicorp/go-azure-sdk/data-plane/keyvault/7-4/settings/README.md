...
## `github.com/hashicorp/go-azure-sdk/data-plane/keyvault/7.4/settings` Documentation

The `settings` SDK allows for interaction with <unknown source data type> `keyvault` (API Version `7.4`).
...
```go
import "github.com/hashicorp/go-azure-sdk/data-plane/keyvault/7.4/settings"
```
