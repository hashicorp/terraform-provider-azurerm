...
// GetDeletedSecrets ...
func (c DeletedSecretsClient) GetDeletedSecrets(ctx context.Context, options GetDeletedSecretsOperationOptions) (result GetDeletedSecretsOperationResponse, err error) {
...
func (c DeletedSecretsClient) GetDeletedSecretsComplete(ctx context.Context, options GetDeletedSecretsOperationOptions) (GetDeletedSecretsCompleteResult, error) {
...
func (c DeletedSecretsClient) GetDeletedSecretsCompleteMatchingPredicate(ctx context.Context, options GetDeletedSecretsOperationOptions, predicate DeletedSecretItemOperationPredicate) (result GetDeletedSecretsCompleteResult, err error) {
