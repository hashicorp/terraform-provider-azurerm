...
type RoleDefinitionsListOperationResponse struct {
	HttpResponse *http.Response
	OData        *odata.OData
	Model        *[]RoleDefinition
}

type RoleDefinitionsListCompleteResult struct {
	LatestHttpResponse *http.Response
	Items              []RoleDefinition
}

type RoleDefinitionsListOperationOptions struct {
	Filter *string
}

func DefaultRoleDefinitionsListOperationOptions() RoleDefinitionsListOperationOptions {
	return RoleDefinitionsListOperationOptions{}
}

func (o RoleDefinitionsListOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}

	return &out
}

func (o RoleDefinitionsListOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}

	return &out
}

func (o RoleDefinitionsListOperationOptions) ToQuery() *client.QueryParams {
...
type RoleDefinitionsListCustomPager struct {
	NextLink *odata.Link `json:"nextLink"`
}

func (p *RoleDefinitionsListCustomPager) NextPageLink() *odata.Link {
	defer func() {
		p.NextLink = nil
	}()
...
func (c RbacsClient) RoleDefinitionsListCompleteMatchingPredicate(ctx context.Context, id ScopeId, options RoleDefinitionsListOperationOptions, predicate RoleDefinitionOperationPredicate) (result RoleDefinitionsListCompleteResult, err error) {
	...
	result = RoleDefinitionsListCompleteResult{
