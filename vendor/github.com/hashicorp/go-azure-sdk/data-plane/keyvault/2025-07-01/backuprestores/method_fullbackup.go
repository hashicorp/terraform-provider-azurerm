...
// FullBackup ...
func (c BackuprestoresClient) FullBackup(ctx context.Context, input SASTokenParameter) (result FullBackupOperationResponse, err error) {
...
func (c BackuprestoresClient) FullBackupThenPoll(ctx context.Context, input SASTokenParameter) error {
