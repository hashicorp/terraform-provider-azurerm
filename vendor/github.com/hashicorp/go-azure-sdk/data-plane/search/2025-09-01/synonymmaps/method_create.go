...
// Create ...
func (c SynonymMapsClient) Create(ctx context.Context, input SynonymMap, options CreateOperationOptions) (result CreateOperationResponse, err error) {
