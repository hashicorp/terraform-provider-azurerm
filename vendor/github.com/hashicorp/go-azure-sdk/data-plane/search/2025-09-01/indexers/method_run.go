...
type RunOperationOptions struct {
	XMsClientRequestId *string
}

func DefaultRunOperationOptions() RunOperationOptions {
	return RunOperationOptions{}
}

func (o RunOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
...
func (o RunOperationOptions) ToOData() *odata.Query {
	out := odata.Query{}

	return &out
}

func (o RunOperationOptions) ToQuery() *client.QueryParams {
