...
// Create ...
func (c IndexersClient) Create(ctx context.Context, input SearchIndexer, options CreateOperationOptions) (result CreateOperationResponse, err error) {
