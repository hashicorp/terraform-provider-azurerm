...
// Create ...
func (c DataSourcesClient) Create(ctx context.Context, input SearchIndexerDataSource, options CreateOperationOptions) (result CreateOperationResponse, err error) {
