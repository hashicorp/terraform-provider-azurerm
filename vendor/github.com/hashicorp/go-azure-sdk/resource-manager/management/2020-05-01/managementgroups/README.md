...
## `github.com/hashicorp/go-azure-sdk/resource-manager/management/2020-05-01/managementgroups` Documentation

The `managementgroups` SDK allows for interaction with Azure Resource Manager `management` (API Version `2020-05-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/management/2020-05-01/managementgroups"
```
