...
func (c ManagementGroupsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id commonids.ManagementGroupId, input CreateManagementGroupRequest, options CreateOrUpdateOperationOptions, callback func() error) error {
