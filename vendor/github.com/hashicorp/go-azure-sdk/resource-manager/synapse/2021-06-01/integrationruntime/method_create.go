...
func (c IntegrationRuntimeClient) CreateCallbackThenPoll(ctx context.Context, id IntegrationRuntimeId, input IntegrationRuntimeResource, options CreateOperationOptions, callback func() error) error {
