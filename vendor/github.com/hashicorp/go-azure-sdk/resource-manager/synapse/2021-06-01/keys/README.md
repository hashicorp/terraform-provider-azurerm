...
```go
ctx := context.TODO()
id := keys.NewKeyID("12345678-1234-9876-4563-123456789012", "example-resource-group", "workspaceName", "keyName")
...
```go
ctx := context.TODO()
id := keys.NewWorkspaceID("12345678-1234-9876-4563-123456789012", "example-resource-group", "workspaceName")
