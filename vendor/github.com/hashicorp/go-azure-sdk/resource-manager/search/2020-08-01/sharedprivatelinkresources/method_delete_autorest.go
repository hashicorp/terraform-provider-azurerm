...
func (c SharedPrivateLinkResourcesClient) Delete(ctx context.Context, id SharedPrivateLinkResourceId, options DeleteOperationOptions) (result DeleteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "sharedprivatelinkresources.SharedPrivateLinkResourcesClient", "Delete", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForDelete(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "sharedprivatelinkresources.SharedPrivateLinkResourcesClient", "Delete", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c SharedPrivateLinkResourcesClient) preparerForDelete(ctx context.Context, id SharedPrivateLinkResourceId, options DeleteOperationOptions) (*http.Request, error) {
...
func (c SharedPrivateLinkResourcesClient) senderForDelete(ctx context.Context, req *http.Request) (future DeleteOperationResponse, err error) {
