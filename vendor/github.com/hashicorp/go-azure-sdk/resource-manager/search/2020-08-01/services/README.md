...
## `github.com/hashicorp/go-azure-sdk/resource-manager/search/2020-08-01/services` Documentation

The `services` SDK allows for interaction with the Azure Resource Manager Service `search` (API Version `2020-08-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/search/2020-08-01/services"
```
