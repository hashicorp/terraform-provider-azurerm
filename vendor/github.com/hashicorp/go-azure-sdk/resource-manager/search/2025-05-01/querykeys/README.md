...
## `github.com/hashicorp/go-azure-sdk/resource-manager/search/2025-05-01/querykeys` Documentation

The `querykeys` SDK allows for interaction with Azure Resource Manager `search` (API Version `2025-05-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/search/2025-05-01/querykeys"
```
