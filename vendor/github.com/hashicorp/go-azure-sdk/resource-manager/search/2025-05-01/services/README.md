...
## `github.com/hashicorp/go-azure-sdk/resource-manager/search/2025-05-01/services` Documentation

The `services` SDK allows for interaction with Azure Resource Manager `search` (API Version `2025-05-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/search/2025-05-01/services"
```
...
### Example Usage: `ServicesClient.Upgrade`
