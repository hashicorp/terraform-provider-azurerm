...
## `github.com/hashicorp/go-azure-sdk/resource-manager/voiceservices/2023-01-31/testlines` Documentation

The `testlines` SDK allows for interaction with the Azure Resource Manager Service `voiceservices` (API Version `2023-01-31`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/voiceservices/2023-01-31/testlines"
```
