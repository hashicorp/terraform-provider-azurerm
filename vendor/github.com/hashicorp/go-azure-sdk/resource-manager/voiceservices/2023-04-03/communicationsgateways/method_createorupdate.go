...
func (c CommunicationsGatewaysClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id CommunicationsGatewayId, input CommunicationsGateway, callback func() error) error {
