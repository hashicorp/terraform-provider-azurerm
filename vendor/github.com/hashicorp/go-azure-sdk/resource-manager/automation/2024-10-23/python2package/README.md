...
## `github.com/hashicorp/go-azure-sdk/resource-manager/automation/2024-10-23/python2package` Documentation

The `python2package` SDK allows for interaction with Azure Resource Manager `automation` (API Version `2024-10-23`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/automation/2024-10-23/python2package"
```
