...
func (c DscNodeConfigurationClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id NodeConfigurationId, input DscNodeConfigurationCreateOrUpdateParameters, callback func() error) error {
