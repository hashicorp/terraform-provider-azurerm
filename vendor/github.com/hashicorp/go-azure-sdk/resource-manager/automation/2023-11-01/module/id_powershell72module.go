...
func ParsePowerShell72ModuleID(input string) (*PowerShell72ModuleId, error) {
	...
	if id.PowerShell72ModuleName, ok = parsed.Parsed["powerShell72ModuleName"]; !ok {
		return nil, resourceids.NewSegmentNotSpecifiedError(id, "powerShell72ModuleName", *parsed)
	}
