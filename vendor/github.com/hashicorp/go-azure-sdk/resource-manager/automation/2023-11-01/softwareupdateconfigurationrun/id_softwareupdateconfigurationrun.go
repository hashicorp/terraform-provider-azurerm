...
func init() {
	recaser.RegisterResourceId(&SoftwareUpdateConfigurationRunId{})
}
...
func (id *SoftwareUpdateConfigurationRunId) FromParseResult(input resourceids.ParseResult) error {
	...
	if id.SoftwareUpdateConfigurationRunId, ok = input.Parsed["softwareUpdateConfigurationRunId"]; !ok {
		return resourceids.NewSegmentNotSpecifiedError(id, "softwareUpdateConfigurationRunId", input)
	}
