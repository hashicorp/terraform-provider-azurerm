...
func (c ServiceResourceClient) ServicesStop(ctx context.Context, id ServiceId) (result ServicesStopOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "serviceresource.ServiceResourceClient", "ServicesStop", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForServicesStop(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "serviceresource.ServiceResourceClient", "ServicesStop", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c ServiceResourceClient) preparerForServicesStop(ctx context.Context, id ServiceId) (*http.Request, error) {
...
func (c ServiceResourceClient) senderForServicesStop(ctx context.Context, req *http.Request) (future ServicesStopOperationResponse, err error) {
