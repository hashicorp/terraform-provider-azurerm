...
func (c ServiceResourceClient) ServicesCreateOrUpdateCallbackThenPoll(ctx context.Context, id ServiceId, input DataMigrationService, callback func() error) error {
