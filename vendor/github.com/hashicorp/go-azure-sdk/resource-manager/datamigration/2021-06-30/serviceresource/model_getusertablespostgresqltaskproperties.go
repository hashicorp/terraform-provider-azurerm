...
var _ ProjectTaskProperties = GetUserTablesPostgreSqlTaskProperties{}
...
var _ json.Marshaler = GetUserTablesPostgreSqlTaskProperties{}

func (s GetUserTablesPostgreSqlTaskProperties) MarshalJSON() ([]byte, error) {
	type wrapper GetUserTablesPostgreSqlTaskProperties
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling GetUserTablesPostgreSqlTaskProperties: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling GetUserTablesPostgreSqlTaskProperties: %+v", err)
	}

	decoded["taskType"] = "GetUserTablesPostgreSql"

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling GetUserTablesPostgreSqlTaskProperties: %+v", err)
	}

	return encoded, nil
}

var _ json.Unmarshaler = &GetUserTablesPostgreSqlTaskProperties{}
...
func (s *GetUserTablesPostgreSqlTaskProperties) UnmarshalJSON(bytes []byte) error {
	...
	if err := json.Unmarshal(bytes, &temp); err != nil {
		return fmt.Errorf("unmarshaling GetUserTablesPostgreSqlTaskProperties into map[string]json.RawMessage: %+v", err)
	}
	...
	if v, ok := temp["commands"]; ok {
		...
		for i, val := range listTemp {
			...
			if err != nil {
				return fmt.Errorf("unmarshaling index %d field 'Commands' for 'GetUserTablesPostgreSqlTaskProperties': %+v", i, err)
			}
