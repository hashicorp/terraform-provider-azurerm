...
// ListByLab ...
func (c ScheduleClient) ListByLab(ctx context.Context, id LabId) (resp ListByLabOperationResponse, err error) {
	req, err := c.preparerForListByLab(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "schedule.ScheduleClient", "ListByLab", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "schedule.ScheduleClient", "ListByLab", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListByLab(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "schedule.ScheduleClient", "ListByLab", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c ScheduleClient) preparerForListByLab(ctx context.Context, id LabId) (*http.Request, error) {
...
func (c ScheduleClient) preparerForListByLabWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c ScheduleClient) responderForListByLab(resp *http.Response) (result ListByLabOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByLabOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "schedule.ScheduleClient", "ListByLab", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListByLab(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "schedule.ScheduleClient", "ListByLab", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c ScheduleClient) ListByLabCompleteMatchingPredicate(ctx context.Context, id LabId, predicate ScheduleOperationPredicate) (resp ListByLabCompleteResult, err error) {
