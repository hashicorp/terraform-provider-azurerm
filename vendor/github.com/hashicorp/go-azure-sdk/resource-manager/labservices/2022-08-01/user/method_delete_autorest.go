...
func (c UserClient) preparerForDelete(ctx context.Context, id UserId) (*http.Request, error) {
...
func (c UserClient) senderForDelete(ctx context.Context, req *http.Request) (future DeleteOperationResponse, err error) {
