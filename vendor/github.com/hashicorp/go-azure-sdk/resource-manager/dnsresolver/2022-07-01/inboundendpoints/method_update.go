...
func (c InboundEndpointsClient) UpdateCallbackThenPoll(ctx context.Context, id InboundEndpointId, input InboundEndpointPatch, options UpdateOperationOptions, callback func() error) error {
