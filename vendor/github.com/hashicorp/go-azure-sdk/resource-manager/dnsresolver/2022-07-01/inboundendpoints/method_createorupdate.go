...
func (c InboundEndpointsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id InboundEndpointId, input InboundEndpoint, options CreateOrUpdateOperationOptions, callback func() error) error {
