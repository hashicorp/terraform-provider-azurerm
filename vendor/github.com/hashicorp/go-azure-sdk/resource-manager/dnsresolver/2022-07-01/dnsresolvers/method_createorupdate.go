...
func (c DnsResolversClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id DnsResolverId, input DnsResolver, options CreateOrUpdateOperationOptions, callback func() error) error {
