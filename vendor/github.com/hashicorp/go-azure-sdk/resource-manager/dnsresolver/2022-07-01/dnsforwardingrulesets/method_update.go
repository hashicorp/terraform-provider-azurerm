...
func (c DnsForwardingRulesetsClient) UpdateCallbackThenPoll(ctx context.Context, id DnsForwardingRulesetId, input DnsForwardingRulesetPatch, options UpdateOperationOptions, callback func() error) error {
