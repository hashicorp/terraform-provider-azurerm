...
func (c OutboundEndpointsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id OutboundEndpointId, input OutboundEndpoint, options CreateOrUpdateOperationOptions, callback func() error) error {
