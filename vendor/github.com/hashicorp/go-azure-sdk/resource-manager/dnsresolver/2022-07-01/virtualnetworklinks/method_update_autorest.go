...
func (c VirtualNetworkLinksClient) preparerForUpdate(ctx context.Context, id VirtualNetworkLinkId, input VirtualNetworkLinkPatch, options UpdateOperationOptions) (*http.Request, error) {
