...
func (c VirtualNetworkLinksClient) UpdateCallbackThenPoll(ctx context.Context, id VirtualNetworkLinkId, input VirtualNetworkLinkPatch, options UpdateOperationOptions, callback func() error) error {
