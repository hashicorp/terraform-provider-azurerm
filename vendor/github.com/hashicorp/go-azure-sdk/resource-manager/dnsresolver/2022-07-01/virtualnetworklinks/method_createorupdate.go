...
func (c VirtualNetworkLinksClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id VirtualNetworkLinkId, input VirtualNetworkLink, options CreateOrUpdateOperationOptions, callback func() error) error {
