...
func (c AppServiceEnvironmentsClient) ApproveOrRejectPrivateEndpointConnectionThenPoll(ctx context.Context, id HostingEnvironmentPrivateEndpointConnectionId, input RemotePrivateEndpointConnectionARMResource) error {
	return c.ApproveOrRejectPrivateEndpointConnectionCallbackThenPoll(ctx, id, input, nil)
}

// ApproveOrRejectPrivateEndpointConnectionCallbackThenPoll performs ApproveOrRejectPrivateEndpointConnection, runs the optional callback function, then polls until it's completed
func (c AppServiceEnvironmentsClient) ApproveOrRejectPrivateEndpointConnectionCallbackThenPoll(ctx context.Context, id HostingEnvironmentPrivateEndpointConnectionId, input RemotePrivateEndpointConnectionARMResource, callback func() error) error {
