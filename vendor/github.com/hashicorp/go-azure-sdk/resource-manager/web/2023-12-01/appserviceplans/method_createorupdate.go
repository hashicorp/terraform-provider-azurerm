...
func (c AppServicePlansClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id commonids.AppServicePlanId, input AppServicePlan, callback func() error) error {
