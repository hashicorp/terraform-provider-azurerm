...
func PossibleValuesForInstallScriptType() []string {
	return []string{
		string(InstallScriptTypePlatformStorage),
		string(InstallScriptTypeRemoteAzureBlob),
	}
}

func (s *InstallScriptType) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseInstallScriptType(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseInstallScriptType(input string) (*InstallScriptType, error) {
	vals := map[string]InstallScriptType{
		"platformstorage": InstallScriptTypePlatformStorage,
		"remoteazureblob": InstallScriptTypeRemoteAzureBlob,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
...
func PossibleValuesForRegistryAdapterType() []string {
	return []string{
		string(RegistryAdapterTypeBinary),
		string(RegistryAdapterTypeDWord),
		string(RegistryAdapterTypeExpandString),
		string(RegistryAdapterTypeMultiString),
		string(RegistryAdapterTypeQWord),
		string(RegistryAdapterTypeString),
	}
}

func (s *RegistryAdapterType) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseRegistryAdapterType(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseRegistryAdapterType(input string) (*RegistryAdapterType, error) {
	vals := map[string]RegistryAdapterType{
		"binary":        RegistryAdapterTypeBinary,
		"dword":         RegistryAdapterTypeDWord,
		"expand_string": RegistryAdapterTypeExpandString,
		"multi_string":  RegistryAdapterTypeMultiString,
		"qword":         RegistryAdapterTypeQWord,
		"string":        RegistryAdapterTypeString,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
...
func PossibleValuesForStorageMountType() []string {
	return []string{
		string(StorageMountTypeAzureFiles),
		string(StorageMountTypeFileShare),
		string(StorageMountTypeLocalStorage),
	}
}

func (s *StorageMountType) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseStorageMountType(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseStorageMountType(input string) (*StorageMountType, error) {
	vals := map[string]StorageMountType{
		"azurefiles":   StorageMountTypeAzureFiles,
		"fileshare":    StorageMountTypeFileShare,
		"localstorage": StorageMountTypeLocalStorage,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
