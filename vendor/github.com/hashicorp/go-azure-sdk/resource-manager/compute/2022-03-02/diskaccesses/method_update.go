...
// Update ...
func (c DiskAccessesClient) Update(ctx context.Context, id DiskAccessId, input DiskAccessUpdate) (result UpdateOperationResponse, err error) {
...
func (c DiskAccessesClient) UpdateCallbackThenPoll(ctx context.Context, id DiskAccessId, input DiskAccessUpdate, callback func() error) error {
