...
func (c DiskEncryptionSetsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id commonids.DiskEncryptionSetId, input DiskEncryptionSet, callback func() error) error {
