...
func (c DedicatedHostsClient) UpdateCallbackThenPoll(ctx context.Context, id commonids.DedicatedHostId, input DedicatedHostUpdate, callback func() error) error {
