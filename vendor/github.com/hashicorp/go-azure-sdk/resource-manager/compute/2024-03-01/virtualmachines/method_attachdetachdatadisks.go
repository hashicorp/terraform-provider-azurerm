...
func (c VirtualMachinesClient) AttachDetachDataDisksCallbackThenPoll(ctx context.Context, id VirtualMachineId, input AttachDetachDataDisksRequest, callback func() error) error {
