...
func (c VirtualMachinesClient) ReimageCallbackThenPoll(ctx context.Context, id VirtualMachineId, input VirtualMachineReimageParameters, callback func() error) error {
