...
func (c VirtualMachineExtensionsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id ExtensionId, input VirtualMachineExtension, callback func() error) error {
