...
func (c VirtualMachineExtensionsClient) UpdateCallbackThenPoll(ctx context.Context, id ExtensionId, input VirtualMachineExtensionUpdate, callback func() error) error {
