...
func (c VirtualMachineScaleSetVMsClient) PowerOffThenPoll(ctx context.Context, id VirtualMachineScaleSetVirtualMachineId, options PowerOffOperationOptions) error {
	return c.PowerOffCallbackThenPoll(ctx, id, options, nil)
}

// PowerOffCallbackThenPoll performs PowerOff, runs the optional callback function, then polls until it's completed
func (c VirtualMachineScaleSetVMsClient) PowerOffCallbackThenPoll(ctx context.Context, id VirtualMachineScaleSetVirtualMachineId, options PowerOffOperationOptions, callback func() error) error {
