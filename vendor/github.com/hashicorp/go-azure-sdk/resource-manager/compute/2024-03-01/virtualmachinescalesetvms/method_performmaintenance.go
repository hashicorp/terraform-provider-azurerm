...
func (c VirtualMachineScaleSetVMsClient) PerformMaintenanceCallbackThenPoll(ctx context.Context, id VirtualMachineScaleSetVirtualMachineId, callback func() error) error {
