...
func (c VirtualMachineScaleSetExtensionsClient) UpdateCallbackThenPoll(ctx context.Context, id VirtualMachineScaleSetExtensionId, input VirtualMachineScaleSetExtensionUpdate, callback func() error) error {
