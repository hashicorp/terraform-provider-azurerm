...
func (c VirtualMachineScaleSetExtensionsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id VirtualMachineScaleSetExtensionId, input VirtualMachineScaleSetExtension, callback func() error) error {
