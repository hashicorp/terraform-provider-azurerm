...
func (c GalleryImageVersionsClient) UpdateCallbackThenPoll(ctx context.Context, id ImageVersionId, input GalleryImageVersionUpdate, callback func() error) error {
