...
func (c GalleryImageVersionsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id ImageVersionId, input GalleryImageVersion, callback func() error) error {
