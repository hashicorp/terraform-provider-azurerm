...
func (c VirtualMachineScaleSetsClient) ReimageCallbackThenPoll(ctx context.Context, id VirtualMachineScaleSetId, input VirtualMachineScaleSetReimageParameters, callback func() error) error {
