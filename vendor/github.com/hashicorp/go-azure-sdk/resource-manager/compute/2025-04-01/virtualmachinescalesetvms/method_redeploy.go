...
func (c VirtualMachineScaleSetVMsClient) RedeployCallbackThenPoll(ctx context.Context, id VirtualMachineScaleSetVirtualMachineId, callback func() error) error {
