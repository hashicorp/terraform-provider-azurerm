...
func (c VirtualMachineScaleSetVMsClient) RestartCallbackThenPoll(ctx context.Context, id VirtualMachineScaleSetVirtualMachineId, callback func() error) error {
