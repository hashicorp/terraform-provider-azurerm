...
type MigrateToVMScaleSetOperationResponse struct {
...
// MigrateToVMScaleSet ...
func (c VirtualMachinesClient) MigrateToVMScaleSet(ctx context.Context, id VirtualMachineId, input MigrateVMToVirtualMachineScaleSetInput) (result MigrateToVMScaleSetOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:       fmt.Sprintf("%s/migrateToVirtualMachineScaleSet", id.ID()),
	}
...
func (c VirtualMachinesClient) MigrateToVMScaleSetCallbackThenPoll(ctx context.Context, id VirtualMachineId, input MigrateVMToVirtualMachineScaleSetInput, callback func() error) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after MigrateToVMScaleSet: %+v", err)
	}
