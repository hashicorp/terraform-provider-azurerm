...
func (c VirtualMachineRunCommandsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id VirtualMachineRunCommandId, input VirtualMachineRunCommand, callback func() error) error {
