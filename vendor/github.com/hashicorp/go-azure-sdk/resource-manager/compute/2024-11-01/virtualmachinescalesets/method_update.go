...
func (c VirtualMachineScaleSetsClient) UpdateCallbackThenPoll(ctx context.Context, id VirtualMachineScaleSetId, input VirtualMachineScaleSetUpdate, options UpdateOperationOptions, callback func() error) error {
