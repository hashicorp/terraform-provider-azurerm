...
func (c VirtualMachineScaleSetsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id VirtualMachineScaleSetId, input VirtualMachineScaleSet, options CreateOrUpdateOperationOptions, callback func() error) error {
