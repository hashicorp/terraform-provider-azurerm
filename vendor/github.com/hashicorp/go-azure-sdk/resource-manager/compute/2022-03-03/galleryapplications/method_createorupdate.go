...
func (c GalleryApplicationsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id ApplicationId, input GalleryApplication, callback func() error) error {
