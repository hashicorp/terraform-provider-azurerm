...
func (c GalleryApplicationVersionsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id ApplicationVersionId, input GalleryApplicationVersion, callback func() error) error {
