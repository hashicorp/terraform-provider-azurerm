...
func (c GalleryApplicationVersionsClient) UpdateCallbackThenPoll(ctx context.Context, id ApplicationVersionId, input GalleryApplicationVersionUpdate, callback func() error) error {
