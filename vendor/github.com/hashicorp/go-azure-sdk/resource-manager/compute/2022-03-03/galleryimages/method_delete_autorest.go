...
func (c GalleryImagesClient) Delete(ctx context.Context, id GalleryImageId) (result DeleteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "galleryimages.GalleryImagesClient", "Delete", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c GalleryImagesClient) senderForDelete(ctx context.Context, req *http.Request) (future DeleteOperationResponse, err error) {
