...
func (c VirtualMachinesClient) Delete(ctx context.Context, id VirtualMachineId, options DeleteOperationOptions) (result DeleteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "virtualmachines.VirtualMachinesClient", "Delete", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForDelete(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "virtualmachines.VirtualMachinesClient", "Delete", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c VirtualMachinesClient) preparerForDelete(ctx context.Context, id VirtualMachineId, options DeleteOperationOptions) (*http.Request, error) {
...
func (c VirtualMachinesClient) senderForDelete(ctx context.Context, req *http.Request) (future DeleteOperationResponse, err error) {
