...
// List ...
func (c VirtualMachinesClient) List(ctx context.Context, id commonids.ResourceGroupId, options ListOperationOptions) (resp ListOperationResponse, err error) {
...
func (c VirtualMachinesClient) preparerForList(ctx context.Context, id commonids.ResourceGroupId, options ListOperationOptions) (*http.Request, error) {
...
func (c VirtualMachinesClient) ListCompleteMatchingPredicate(ctx context.Context, id commonids.ResourceGroupId, options ListOperationOptions, predicate VirtualMachineOperationPredicate) (resp ListCompleteResult, err error) {
