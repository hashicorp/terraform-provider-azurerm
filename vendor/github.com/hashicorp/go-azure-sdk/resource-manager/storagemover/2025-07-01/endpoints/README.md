...
## `github.com/hashicorp/go-azure-sdk/resource-manager/storagemover/2025-07-01/endpoints` Documentation

The `endpoints` SDK allows for interaction with Azure Resource Manager `storagemover` (API Version `2025-07-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/storagemover/2025-07-01/endpoints"
```
