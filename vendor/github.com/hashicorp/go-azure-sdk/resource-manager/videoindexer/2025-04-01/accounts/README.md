...
## `github.com/hashicorp/go-azure-sdk/resource-manager/videoindexer/2025-04-01/accounts` Documentation

The `accounts` SDK allows for interaction with Azure Resource Manager `videoindexer` (API Version `2025-04-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/videoindexer/2025-04-01/accounts"
```
