...
func (c AppServiceCertificateOrdersClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id CertificateOrderId, input AppServiceCertificateOrder, callback func() error) error {
