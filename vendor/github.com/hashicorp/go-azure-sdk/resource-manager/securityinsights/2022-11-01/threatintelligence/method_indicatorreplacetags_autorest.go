...
func (c ThreatIntelligenceClient) preparerForIndicatorReplaceTags(ctx context.Context, id IndicatorId, input ThreatIntelligenceIndicatorModel) (*http.Request, error) {
