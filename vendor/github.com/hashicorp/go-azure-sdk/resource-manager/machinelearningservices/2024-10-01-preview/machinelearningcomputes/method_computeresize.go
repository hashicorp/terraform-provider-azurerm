...
// ComputeResize ...
func (c MachineLearningComputesClient) ComputeResize(ctx context.Context, id ComputeId, input ResizeSchema) (result ComputeResizeOperationResponse, err error) {
...
func (c MachineLearningComputesClient) ComputeResizeThenPoll(ctx context.Context, id ComputeId, input ResizeSchema) error {
