...
func PossibleValuesForComputeInstanceState() []string {
	return []string{
		...
		string(ComputeInstanceStateResizing),
...
func parseComputeInstanceState(input string) (*ComputeInstanceState, error) {
	vals := map[string]ComputeInstanceState{
		...
		"resizing":        ComputeInstanceStateResizing,
...
func PossibleValuesForMlflowAutologger() []string {
	return []string{
		string(MlflowAutologgerDisabled),
		string(MlflowAutologgerEnabled),
	}
}

func (s *MlflowAutologger) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseMlflowAutologger(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseMlflowAutologger(input string) (*MlflowAutologger, error) {
	vals := map[string]MlflowAutologger{
		"disabled": MlflowAutologgerDisabled,
		"enabled":  MlflowAutologgerEnabled,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
...
func PossibleValuesForMountMode() []string {
	return []string{
		string(MountModeReadOnly),
		string(MountModeReadWrite),
	}
}

func (s *MountMode) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseMountMode(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseMountMode(input string) (*MountMode, error) {
	vals := map[string]MountMode{
		"readonly":  MountModeReadOnly,
		"readwrite": MountModeReadWrite,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
...
func PossibleValuesForOperationStatus() []string {
	return []string{
		...
		string(OperationStatusResizeFailed),
...
func parseOperationStatus(input string) (*OperationStatus, error) {
	vals := map[string]OperationStatus{
		...
		"resizefailed":  OperationStatusResizeFailed,
...
func PossibleValuesForPatchStatus() []string {
	return []string{
		string(PatchStatusCompletedWithWarnings),
		string(PatchStatusFailed),
		string(PatchStatusInProgress),
		string(PatchStatusSucceeded),
		string(PatchStatusUnknown),
	}
}

func (s *PatchStatus) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parsePatchStatus(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parsePatchStatus(input string) (*PatchStatus, error) {
	vals := map[string]PatchStatus{
		"completedwithwarnings": PatchStatusCompletedWithWarnings,
		"failed":                PatchStatusFailed,
		"inprogress":            PatchStatusInProgress,
		"succeeded":             PatchStatusSucceeded,
		"unknown":               PatchStatusUnknown,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
