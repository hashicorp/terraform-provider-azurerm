...
func (id *ComputeId) FromParseResult(input resourceids.ParseResult) error {
	...
	if id.ComputeName, ok = input.Parsed["computeName"]; !ok {
		return resourceids.NewSegmentNotSpecifiedError(id, "computeName", input)
	}
...
func (id ComputeId) Segments() []resourceids.Segment {
	return []resourceids.Segment{
		...
		resourceids.UserSpecifiedSegment("computeName", "computeName"),
	}
}
