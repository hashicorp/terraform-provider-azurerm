...
var _ WorkloadProtectableItem = AzureVMWorkloadProtectableItem{}
...
func (s AzureVMWorkloadProtectableItem) WorkloadProtectableItem() BaseWorkloadProtectableItemImpl {
...
var _ json.Marshaler = AzureVMWorkloadProtectableItem{}

func (s AzureVMWorkloadProtectableItem) MarshalJSON() ([]byte, error) {
	type wrapper AzureVMWorkloadProtectableItem
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling AzureVMWorkloadProtectableItem: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling AzureVMWorkloadProtectableItem: %+v", err)
	}

	decoded["protectableItemType"] = "AzureVmWorkloadProtectableItem"

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling AzureVMWorkloadProtectableItem: %+v", err)
	}
