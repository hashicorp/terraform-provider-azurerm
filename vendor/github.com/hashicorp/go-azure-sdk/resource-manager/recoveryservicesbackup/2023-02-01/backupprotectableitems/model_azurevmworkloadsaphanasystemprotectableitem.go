...
var _ WorkloadProtectableItem = AzureVMWorkloadSAPHanaSystemProtectableItem{}
...
func (s AzureVMWorkloadSAPHanaSystemProtectableItem) WorkloadProtectableItem() BaseWorkloadProtectableItemImpl {
...
var _ json.Marshaler = AzureVMWorkloadSAPHanaSystemProtectableItem{}

func (s AzureVMWorkloadSAPHanaSystemProtectableItem) MarshalJSON() ([]byte, error) {
	type wrapper AzureVMWorkloadSAPHanaSystemProtectableItem
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling AzureVMWorkloadSAPHanaSystemProtectableItem: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling AzureVMWorkloadSAPHanaSystemProtectableItem: %+v", err)
	}

	decoded["protectableItemType"] = "SAPHanaSystem"

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling AzureVMWorkloadSAPHanaSystemProtectableItem: %+v", err)
	}
