...
var _ WorkloadProtectableItem = AzureVMWorkloadSQLAvailabilityGroupProtectableItem{}
...
func (s AzureVMWorkloadSQLAvailabilityGroupProtectableItem) MarshalJSON() ([]byte, error) {
	type wrapper AzureVMWorkloadSQLAvailabilityGroupProtectableItem
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling AzureVMWorkloadSQLAvailabilityGroupProtectableItem: %+v", err)
	}
	...
	if err != nil {
		return nil, fmt.Errorf("re-marshaling AzureVMWorkloadSQLAvailabilityGroupProtectableItem: %+v", err)
	}
