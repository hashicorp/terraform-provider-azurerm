...
func (c ProtectedItemsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id ProtectedItemId, input ProtectedItemResource, options CreateOrUpdateOperationOptions, callback func() error) error {
