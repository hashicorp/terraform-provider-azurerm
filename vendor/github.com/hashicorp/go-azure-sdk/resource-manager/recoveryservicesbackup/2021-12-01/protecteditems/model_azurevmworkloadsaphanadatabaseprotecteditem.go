...
var _ ProtectedItem = AzureVMWorkloadSAPHanaDatabaseProtectedItem{}
...
var _ json.Marshaler = AzureVMWorkloadSAPHanaDatabaseProtectedItem{}

func (s AzureVMWorkloadSAPHanaDatabaseProtectedItem) MarshalJSON() ([]byte, error) {
	type wrapper AzureVMWorkloadSAPHanaDatabaseProtectedItem
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling AzureVMWorkloadSAPHanaDatabaseProtectedItem: %+v", err)
	}
	...
	if err != nil {
		return nil, fmt.Errorf("re-marshaling AzureVMWorkloadSAPHanaDatabaseProtectedItem: %+v", err)
	}
