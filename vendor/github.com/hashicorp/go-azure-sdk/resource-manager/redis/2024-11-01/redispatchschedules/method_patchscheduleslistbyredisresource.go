...
func (c RedisPatchSchedulesClient) PatchSchedulesListByRedisResource(ctx context.Context, id RediId) (result PatchSchedulesListByRedisResourceOperationResponse, err error) {
...
func (c RedisPatchSchedulesClient) PatchSchedulesListByRedisResourceComplete(ctx context.Context, id RediId) (PatchSchedulesListByRedisResourceCompleteResult, error) {
...
func (c RedisPatchSchedulesClient) PatchSchedulesListByRedisResourceCompleteMatchingPredicate(ctx context.Context, id RediId, predicate RedisPatchScheduleOperationPredicate) (result PatchSchedulesListByRedisResourceCompleteResult, err error) {
