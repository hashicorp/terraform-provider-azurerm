...
## `github.com/hashicorp/go-azure-sdk/resource-manager/redis/2024-11-01/firewallrules` Documentation

The `firewallrules` SDK allows for interaction with Azure Resource Manager `redis` (API Version `2024-11-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/redis/2024-11-01/firewallrules"
```
