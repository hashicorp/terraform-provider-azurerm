...
type RedisCreateOperationResponse struct {
...
// RedisCreate ...
func (c RedisResourcesClient) RedisCreate(ctx context.Context, id RediId, input RedisCreateParameters) (result RedisCreateOperationResponse, err error) {
...
func (c RedisResourcesClient) RedisCreateThenPoll(ctx context.Context, id RediId, input RedisCreateParameters) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after RedisCreate: %+v", err)
	}
