...
type RedisImportDataOperationResponse struct {
...
// RedisImportData ...
func (c RedisResourcesClient) RedisImportData(ctx context.Context, id RediId, input ImportRDBParameters) (result RedisImportDataOperationResponse, err error) {
...
func (c RedisResourcesClient) RedisImportDataThenPoll(ctx context.Context, id RediId, input ImportRDBParameters) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after RedisImportData: %+v", err)
	}
