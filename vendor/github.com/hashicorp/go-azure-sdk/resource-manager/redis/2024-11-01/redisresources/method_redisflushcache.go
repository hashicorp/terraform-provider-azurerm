...
type RedisFlushCacheOperationResponse struct {
...
// RedisFlushCache ...
func (c RedisResourcesClient) RedisFlushCache(ctx context.Context, id RediId) (result RedisFlushCacheOperationResponse, err error) {
...
func (c RedisResourcesClient) RedisFlushCacheThenPoll(ctx context.Context, id RediId) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after RedisFlushCache: %+v", err)
	}
