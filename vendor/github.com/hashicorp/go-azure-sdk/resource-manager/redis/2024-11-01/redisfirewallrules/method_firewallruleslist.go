...
// FirewallRulesList ...
func (c RedisFirewallRulesClient) FirewallRulesList(ctx context.Context, id RediId) (result FirewallRulesListOperationResponse, err error) {
...
func (c RedisFirewallRulesClient) FirewallRulesListComplete(ctx context.Context, id RediId) (FirewallRulesListCompleteResult, error) {
...
func (c RedisFirewallRulesClient) FirewallRulesListCompleteMatchingPredicate(ctx context.Context, id RediId, predicate RedisFirewallRuleOperationPredicate) (result FirewallRulesListCompleteResult, err error) {
