...
// AccessPolicyList ...
func (c RedisCacheAccessPoliciesClient) AccessPolicyList(ctx context.Context, id RediId) (result AccessPolicyListOperationResponse, err error) {
...
func (c RedisCacheAccessPoliciesClient) AccessPolicyListComplete(ctx context.Context, id RediId) (AccessPolicyListCompleteResult, error) {
...
func (c RedisCacheAccessPoliciesClient) AccessPolicyListCompleteMatchingPredicate(ctx context.Context, id RediId, predicate RedisCacheAccessPolicyOperationPredicate) (result AccessPolicyListCompleteResult, err error) {
