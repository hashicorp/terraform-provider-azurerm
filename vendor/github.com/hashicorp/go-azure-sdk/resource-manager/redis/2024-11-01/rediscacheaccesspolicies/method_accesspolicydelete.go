...
// AccessPolicyDelete ...
func (c RedisCacheAccessPoliciesClient) AccessPolicyDelete(ctx context.Context, id AccessPolicyId) (result AccessPolicyDeleteOperationResponse, err error) {
...
func (c RedisCacheAccessPoliciesClient) AccessPolicyDeleteThenPoll(ctx context.Context, id AccessPolicyId) error {
