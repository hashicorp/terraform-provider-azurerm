...
func (c RedisCacheAccessPoliciesClient) AccessPolicyCreateUpdate(ctx context.Context, id AccessPolicyId, input RedisCacheAccessPolicy) (result AccessPolicyCreateUpdateOperationResponse, err error) {
...
func (c RedisCacheAccessPoliciesClient) AccessPolicyCreateUpdateThenPoll(ctx context.Context, id AccessPolicyId, input RedisCacheAccessPolicy) error {
...
func (c RedisCacheAccessPoliciesClient) AccessPolicyCreateUpdateCallbackThenPoll(ctx context.Context, id AccessPolicyId, input RedisCacheAccessPolicy, callback func() error) error {
