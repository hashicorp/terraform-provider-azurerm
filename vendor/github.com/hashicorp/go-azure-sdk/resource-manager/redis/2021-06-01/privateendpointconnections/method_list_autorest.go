...
// List ...
func (c PrivateEndpointConnectionsClient) List(ctx context.Context, id RediId) (result ListOperationResponse, err error) {
...
func (c PrivateEndpointConnectionsClient) preparerForList(ctx context.Context, id RediId) (*http.Request, error) {
...
func (c PrivateEndpointConnectionsClient) responderForList(resp *http.Response) (result ListOperationResponse, err error) {
