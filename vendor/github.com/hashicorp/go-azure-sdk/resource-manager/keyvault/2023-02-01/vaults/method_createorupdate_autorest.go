...
func (c VaultsClient) CreateOrUpdate(ctx context.Context, id commonids.KeyVaultId, input VaultCreateOrUpdateParameters) (result CreateOrUpdateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "vaults.VaultsClient", "CreateOrUpdate", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c VaultsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id commonids.KeyVaultId, input VaultCreateOrUpdateParameters, callback func() error) error {
...
func (c VaultsClient) senderForCreateOrUpdate(ctx context.Context, req *http.Request) (future CreateOrUpdateOperationResponse, err error) {
