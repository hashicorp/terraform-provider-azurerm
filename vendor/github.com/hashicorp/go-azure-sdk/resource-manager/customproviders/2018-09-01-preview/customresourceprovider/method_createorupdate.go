...
func (c CustomResourceProviderClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id ResourceProviderId, input CustomRPManifest, callback func() error) error {
