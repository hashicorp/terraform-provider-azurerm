...
func (c CustomLocationsClient) ListBySubscription(ctx context.Context, id commonids.SubscriptionId) (resp ListBySubscriptionOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "customlocations.CustomLocationsClient", "ListBySubscription", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "customlocations.CustomLocationsClient", "ListBySubscription", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListBySubscription(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "customlocations.CustomLocationsClient", "ListBySubscription", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c CustomLocationsClient) preparerForListBySubscription(ctx context.Context, id commonids.SubscriptionId) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPath(fmt.Sprintf("%s/providers/Microsoft.ExtendedLocation/customLocations", id.ID())),
...
func (c CustomLocationsClient) preparerForListBySubscriptionWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c CustomLocationsClient) responderForListBySubscription(resp *http.Response) (result ListBySubscriptionOperationResponse, err error) {
	type page struct {
		Values   []CustomLocation `json:"value"`
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListBySubscriptionOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "customlocations.CustomLocationsClient", "ListBySubscription", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListBySubscription(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "customlocations.CustomLocationsClient", "ListBySubscription", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c CustomLocationsClient) ListBySubscriptionComplete(ctx context.Context, id commonids.SubscriptionId) (ListBySubscriptionCompleteResult, error) {
	return c.ListBySubscriptionCompleteMatchingPredicate(ctx, id, CustomLocationOperationPredicate{})
}
