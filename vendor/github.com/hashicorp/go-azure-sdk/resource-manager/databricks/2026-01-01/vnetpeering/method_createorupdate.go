...
func (c VNetPeeringClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id VirtualNetworkPeeringId, input VirtualNetworkPeering, callback func() error) error {
