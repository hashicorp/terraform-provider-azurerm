...
var _ ConnectionPropertiesV2 = PATAuthTypeConnectionProperties{}

type PATAuthTypeConnectionProperties struct {
	Credentials *ConnectionPersonalAccessToken `json:"credentials,omitempty"`
...
func (s PATAuthTypeConnectionProperties) ConnectionPropertiesV2() BaseConnectionPropertiesV2Impl {
...
func (o *PATAuthTypeConnectionProperties) GetExpiryTimeAsTime() (*time.Time, error) {
	if o.ExpiryTime == nil {
		return nil, nil
	}
...
func (o *PATAuthTypeConnectionProperties) SetExpiryTimeAsTime(input time.Time) {
	formatted := input.Format("2006-01-02T15:04:05Z07:00")
	o.ExpiryTime = &formatted
}

var _ json.Marshaler = PATAuthTypeConnectionProperties{}

func (s PATAuthTypeConnectionProperties) MarshalJSON() ([]byte, error) {
	type wrapper PATAuthTypeConnectionProperties
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling PATAuthTypeConnectionProperties: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling PATAuthTypeConnectionProperties: %+v", err)
	}
	...
	if err != nil {
		return nil, fmt.Errorf("re-marshaling PATAuthTypeConnectionProperties: %+v", err)
	}
