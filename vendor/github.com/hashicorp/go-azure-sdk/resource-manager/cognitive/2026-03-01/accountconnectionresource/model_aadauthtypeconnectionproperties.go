...
var _ ConnectionPropertiesV2 = AADAuthTypeConnectionProperties{}
...
func (s AADAuthTypeConnectionProperties) ConnectionPropertiesV2() BaseConnectionPropertiesV2Impl {
...
func (o *AADAuthTypeConnectionProperties) GetExpiryTimeAsTime() (*time.Time, error) {
	if o.ExpiryTime == nil {
		return nil, nil
	}
...
func (o *AADAuthTypeConnectionProperties) SetExpiryTimeAsTime(input time.Time) {
	formatted := input.Format("2006-01-02T15:04:05Z07:00")
	o.ExpiryTime = &formatted
}

var _ json.Marshaler = AADAuthTypeConnectionProperties{}

func (s AADAuthTypeConnectionProperties) MarshalJSON() ([]byte, error) {
	type wrapper AADAuthTypeConnectionProperties
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling AADAuthTypeConnectionProperties: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling AADAuthTypeConnectionProperties: %+v", err)
	}
	...
	if err != nil {
		return nil, fmt.Errorf("re-marshaling AADAuthTypeConnectionProperties: %+v", err)
	}
