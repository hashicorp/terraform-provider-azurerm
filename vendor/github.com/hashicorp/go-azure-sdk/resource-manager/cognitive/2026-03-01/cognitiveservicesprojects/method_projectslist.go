...
// ProjectsList ...
func (c CognitiveServicesProjectsClient) ProjectsList(ctx context.Context, id AccountId) (result ProjectsListOperationResponse, err error) {
...
func (c CognitiveServicesProjectsClient) ProjectsListComplete(ctx context.Context, id AccountId) (ProjectsListCompleteResult, error) {
...
func (c CognitiveServicesProjectsClient) ProjectsListCompleteMatchingPredicate(ctx context.Context, id AccountId, predicate ProjectOperationPredicate) (result ProjectsListCompleteResult, err error) {
