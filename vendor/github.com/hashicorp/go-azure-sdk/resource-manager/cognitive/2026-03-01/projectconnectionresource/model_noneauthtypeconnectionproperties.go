...
var _ ConnectionPropertiesV2 = NoneAuthTypeConnectionProperties{}
...
func (s NoneAuthTypeConnectionProperties) ConnectionPropertiesV2() BaseConnectionPropertiesV2Impl {
...
func (o *NoneAuthTypeConnectionProperties) GetExpiryTimeAsTime() (*time.Time, error) {
	if o.ExpiryTime == nil {
		return nil, nil
	}
...
func (o *NoneAuthTypeConnectionProperties) SetExpiryTimeAsTime(input time.Time) {
	formatted := input.Format("2006-01-02T15:04:05Z07:00")
	o.ExpiryTime = &formatted
}

var _ json.Marshaler = NoneAuthTypeConnectionProperties{}

func (s NoneAuthTypeConnectionProperties) MarshalJSON() ([]byte, error) {
	type wrapper NoneAuthTypeConnectionProperties
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling NoneAuthTypeConnectionProperties: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling NoneAuthTypeConnectionProperties: %+v", err)
	}
	...
	if err != nil {
		return nil, fmt.Errorf("re-marshaling NoneAuthTypeConnectionProperties: %+v", err)
	}
