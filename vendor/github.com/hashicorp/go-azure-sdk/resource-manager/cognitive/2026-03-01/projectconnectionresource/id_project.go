...
func NewProjectID(subscriptionId string, resourceGroupName string, accountName string, projectName string) ProjectId {
	return ProjectId{
...
func (id ProjectId) ID() string {
	fmtString := "/subscriptions/%s/resourceGroups/%s/providers/Microsoft.CognitiveServices/accounts/%s/projects/%s"
	return fmt.Sprintf(fmtString, id.SubscriptionId, id.ResourceGroupName, id.AccountName, id.ProjectName)
}
