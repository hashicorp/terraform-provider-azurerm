...
## `github.com/hashicorp/go-azure-sdk/resource-manager/cognitive/2026-03-01/deployments` Documentation

The `deployments` SDK allows for interaction with Azure Resource Manager `cognitive` (API Version `2026-03-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/cognitive/2026-03-01/deployments"
```
