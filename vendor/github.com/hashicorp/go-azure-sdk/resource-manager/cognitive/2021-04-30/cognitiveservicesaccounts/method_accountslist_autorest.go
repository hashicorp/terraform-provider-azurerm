...
// AccountsList ...
func (c CognitiveServicesAccountsClient) AccountsList(ctx context.Context, id commonids.SubscriptionId) (resp AccountsListOperationResponse, err error) {
...
func (c CognitiveServicesAccountsClient) responderForAccountsList(resp *http.Response) (result AccountsListOperationResponse, err error) {
	type page struct {
