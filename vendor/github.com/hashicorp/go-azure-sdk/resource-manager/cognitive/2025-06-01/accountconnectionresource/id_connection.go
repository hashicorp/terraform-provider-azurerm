...
func NewConnectionID(subscriptionId string, resourceGroupName string, accountName string, connectionName string) ConnectionId {
	return ConnectionId{
...
func (id ConnectionId) ID() string {
	fmtString := "/subscriptions/%s/resourceGroups/%s/providers/Microsoft.CognitiveServices/accounts/%s/connections/%s"
	return fmt.Sprintf(fmtString, id.SubscriptionId, id.ResourceGroupName, id.AccountName, id.ConnectionName)
}
