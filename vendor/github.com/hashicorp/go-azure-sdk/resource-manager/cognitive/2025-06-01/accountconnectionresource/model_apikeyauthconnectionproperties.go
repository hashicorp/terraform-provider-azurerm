...
var _ ConnectionPropertiesV2 = ApiKeyAuthConnectionProperties{}

type ApiKeyAuthConnectionProperties struct {
	Credentials *ConnectionApiKey `json:"credentials,omitempty"`
...
func (s ApiKeyAuthConnectionProperties) ConnectionPropertiesV2() BaseConnectionPropertiesV2Impl {
...
func (o *ApiKeyAuthConnectionProperties) GetExpiryTimeAsTime() (*time.Time, error) {
	if o.ExpiryTime == nil {
		return nil, nil
	}
...
func (o *ApiKeyAuthConnectionProperties) SetExpiryTimeAsTime(input time.Time) {
	formatted := input.Format("2006-01-02T15:04:05Z07:00")
	o.ExpiryTime = &formatted
}

var _ json.Marshaler = ApiKeyAuthConnectionProperties{}

func (s ApiKeyAuthConnectionProperties) MarshalJSON() ([]byte, error) {
	type wrapper ApiKeyAuthConnectionProperties
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling ApiKeyAuthConnectionProperties: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling ApiKeyAuthConnectionProperties: %+v", err)
	}
	...
	if err != nil {
		return nil, fmt.Errorf("re-marshaling ApiKeyAuthConnectionProperties: %+v", err)
	}
