...
var _ ConnectionPropertiesV2 = AccountKeyAuthTypeConnectionProperties{}

type AccountKeyAuthTypeConnectionProperties struct {
	Credentials *ConnectionAccountKey `json:"credentials,omitempty"`
...
func (s AccountKeyAuthTypeConnectionProperties) ConnectionPropertiesV2() BaseConnectionPropertiesV2Impl {
...
func (o *AccountKeyAuthTypeConnectionProperties) GetExpiryTimeAsTime() (*time.Time, error) {
	if o.ExpiryTime == nil {
		return nil, nil
	}
...
func (o *AccountKeyAuthTypeConnectionProperties) SetExpiryTimeAsTime(input time.Time) {
	formatted := input.Format("2006-01-02T15:04:05Z07:00")
	o.ExpiryTime = &formatted
}

var _ json.Marshaler = AccountKeyAuthTypeConnectionProperties{}

func (s AccountKeyAuthTypeConnectionProperties) MarshalJSON() ([]byte, error) {
	type wrapper AccountKeyAuthTypeConnectionProperties
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling AccountKeyAuthTypeConnectionProperties: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling AccountKeyAuthTypeConnectionProperties: %+v", err)
	}
	...
	if err != nil {
		return nil, fmt.Errorf("re-marshaling AccountKeyAuthTypeConnectionProperties: %+v", err)
	}
