...
var _ ConnectionPropertiesV2 = ServicePrincipalAuthTypeConnectionProperties{}

type ServicePrincipalAuthTypeConnectionProperties struct {
	Credentials *ConnectionServicePrincipal `json:"credentials,omitempty"`
...
func (s ServicePrincipalAuthTypeConnectionProperties) ConnectionPropertiesV2() BaseConnectionPropertiesV2Impl {
...
func (o *ServicePrincipalAuthTypeConnectionProperties) GetExpiryTimeAsTime() (*time.Time, error) {
	if o.ExpiryTime == nil {
		return nil, nil
	}
...
func (o *ServicePrincipalAuthTypeConnectionProperties) SetExpiryTimeAsTime(input time.Time) {
	formatted := input.Format("2006-01-02T15:04:05Z07:00")
	o.ExpiryTime = &formatted
}

var _ json.Marshaler = ServicePrincipalAuthTypeConnectionProperties{}

func (s ServicePrincipalAuthTypeConnectionProperties) MarshalJSON() ([]byte, error) {
	type wrapper ServicePrincipalAuthTypeConnectionProperties
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling ServicePrincipalAuthTypeConnectionProperties: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling ServicePrincipalAuthTypeConnectionProperties: %+v", err)
	}
	...
	if err != nil {
		return nil, fmt.Errorf("re-marshaling ServicePrincipalAuthTypeConnectionProperties: %+v", err)
	}
