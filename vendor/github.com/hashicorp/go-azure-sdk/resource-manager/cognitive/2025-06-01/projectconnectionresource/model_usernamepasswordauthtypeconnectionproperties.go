...
var _ ConnectionPropertiesV2 = UsernamePasswordAuthTypeConnectionProperties{}

type UsernamePasswordAuthTypeConnectionProperties struct {
	Credentials *ConnectionUsernamePassword `json:"credentials,omitempty"`
...
func (s UsernamePasswordAuthTypeConnectionProperties) ConnectionPropertiesV2() BaseConnectionPropertiesV2Impl {
...
func (o *UsernamePasswordAuthTypeConnectionProperties) GetExpiryTimeAsTime() (*time.Time, error) {
	if o.ExpiryTime == nil {
		return nil, nil
	}
...
func (o *UsernamePasswordAuthTypeConnectionProperties) SetExpiryTimeAsTime(input time.Time) {
	formatted := input.Format("2006-01-02T15:04:05Z07:00")
	o.ExpiryTime = &formatted
}

var _ json.Marshaler = UsernamePasswordAuthTypeConnectionProperties{}

func (s UsernamePasswordAuthTypeConnectionProperties) MarshalJSON() ([]byte, error) {
	type wrapper UsernamePasswordAuthTypeConnectionProperties
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling UsernamePasswordAuthTypeConnectionProperties: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling UsernamePasswordAuthTypeConnectionProperties: %+v", err)
	}
	...
	if err != nil {
		return nil, fmt.Errorf("re-marshaling UsernamePasswordAuthTypeConnectionProperties: %+v", err)
	}
