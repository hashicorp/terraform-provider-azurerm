...
type DeletedAccountsListOperationResponse struct {
	...
	nextLink     *string
	nextPageFunc func(ctx context.Context, nextLink string) (DeletedAccountsListOperationResponse, error)
}
...
func (r DeletedAccountsListOperationResponse) HasMore() bool {
	return r.nextLink != nil
}

func (r DeletedAccountsListOperationResponse) LoadMore(ctx context.Context) (resp DeletedAccountsListOperationResponse, err error) {
	if !r.HasMore() {
...
// DeletedAccountsList ...
func (c CognitiveServicesAccountsClient) DeletedAccountsList(ctx context.Context, id commonids.SubscriptionId) (resp DeletedAccountsListOperationResponse, err error) {
...
func (c CognitiveServicesAccountsClient) preparerForDeletedAccountsList(ctx context.Context, id commonids.SubscriptionId) (*http.Request, error) {
...
func (c CognitiveServicesAccountsClient) responderForDeletedAccountsList(resp *http.Response) (result DeletedAccountsListOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result DeletedAccountsListOperationResponse, err error) {
...
func (c CognitiveServicesAccountsClient) DeletedAccountsListCompleteMatchingPredicate(ctx context.Context, id commonids.SubscriptionId, predicate AccountOperationPredicate) (resp DeletedAccountsListCompleteResult, err error) {
