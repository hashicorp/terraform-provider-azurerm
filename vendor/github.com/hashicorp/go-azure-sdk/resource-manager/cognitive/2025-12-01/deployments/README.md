...
## `github.com/hashicorp/go-azure-sdk/resource-manager/cognitive/2025-12-01/deployments` Documentation

The `deployments` SDK allows for interaction with Azure Resource Manager `cognitive` (API Version `2025-12-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/cognitive/2025-12-01/deployments"
```
...
### Example Usage: `DeploymentsClient.Pause`
...
### Example Usage: `DeploymentsClient.Resume`
