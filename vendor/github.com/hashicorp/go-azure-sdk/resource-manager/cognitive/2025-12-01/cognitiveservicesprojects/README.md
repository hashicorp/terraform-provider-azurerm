...
## `github.com/hashicorp/go-azure-sdk/resource-manager/cognitive/2025-12-01/cognitiveservicesprojects` Documentation

The `cognitiveservicesprojects` SDK allows for interaction with Azure Resource Manager `cognitive` (API Version `2025-12-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/cognitive/2025-12-01/cognitiveservicesprojects"
```
