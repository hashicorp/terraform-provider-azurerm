...
## `github.com/hashicorp/go-azure-sdk/resource-manager/cognitive/2025-12-01/cognitiveservicesaccounts` Documentation

The `cognitiveservicesaccounts` SDK allows for interaction with Azure Resource Manager `cognitive` (API Version `2025-12-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/cognitive/2025-12-01/cognitiveservicesaccounts"
```
