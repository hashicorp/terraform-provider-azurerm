...
func (c RemediationsClient) RemediationsListForManagementGroup(ctx context.Context, id ManagementGroupId, options RemediationsListForManagementGroupOperationOptions) (resp RemediationsListForManagementGroupOperationResponse, err error) {
	req, err := c.preparerForRemediationsListForManagementGroup(ctx, id, options)
	if err != nil {
		err = autorest.NewErrorWithError(err, "remediations.RemediationsClient", "RemediationsListForManagementGroup", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "remediations.RemediationsClient", "RemediationsListForManagementGroup", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForRemediationsListForManagementGroup(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "remediations.RemediationsClient", "RemediationsListForManagementGroup", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c RemediationsClient) preparerForRemediationsListForManagementGroup(ctx context.Context, id ManagementGroupId, options RemediationsListForManagementGroupOperationOptions) (*http.Request, error) {
...
func (c RemediationsClient) preparerForRemediationsListForManagementGroupWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c RemediationsClient) responderForRemediationsListForManagementGroup(resp *http.Response) (result RemediationsListForManagementGroupOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result RemediationsListForManagementGroupOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "remediations.RemediationsClient", "RemediationsListForManagementGroup", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForRemediationsListForManagementGroup(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "remediations.RemediationsClient", "RemediationsListForManagementGroup", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c RemediationsClient) RemediationsListForManagementGroupCompleteMatchingPredicate(ctx context.Context, id ManagementGroupId, options RemediationsListForManagementGroupOperationOptions, predicate RemediationOperationPredicate) (resp RemediationsListForManagementGroupCompleteResult, err error) {
