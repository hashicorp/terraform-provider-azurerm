...
func (c RemediationsClient) RemediationsListDeploymentsAtResource(ctx context.Context, id ScopedRemediationId, options RemediationsListDeploymentsAtResourceOperationOptions) (resp RemediationsListDeploymentsAtResourceOperationResponse, err error) {
	req, err := c.preparerForRemediationsListDeploymentsAtResource(ctx, id, options)
	if err != nil {
		err = autorest.NewErrorWithError(err, "remediations.RemediationsClient", "RemediationsListDeploymentsAtResource", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "remediations.RemediationsClient", "RemediationsListDeploymentsAtResource", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForRemediationsListDeploymentsAtResource(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "remediations.RemediationsClient", "RemediationsListDeploymentsAtResource", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c RemediationsClient) preparerForRemediationsListDeploymentsAtResource(ctx context.Context, id ScopedRemediationId, options RemediationsListDeploymentsAtResourceOperationOptions) (*http.Request, error) {
...
func (c RemediationsClient) preparerForRemediationsListDeploymentsAtResourceWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c RemediationsClient) responderForRemediationsListDeploymentsAtResource(resp *http.Response) (result RemediationsListDeploymentsAtResourceOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result RemediationsListDeploymentsAtResourceOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "remediations.RemediationsClient", "RemediationsListDeploymentsAtResource", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForRemediationsListDeploymentsAtResource(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "remediations.RemediationsClient", "RemediationsListDeploymentsAtResource", result.HttpResponse, "Failure responding to request")
				return
			}
