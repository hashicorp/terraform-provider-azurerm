...
func (c RemediationsClient) RemediationsListDeploymentsAtManagementGroup(ctx context.Context, id Providers2RemediationId, options RemediationsListDeploymentsAtManagementGroupOperationOptions) (resp RemediationsListDeploymentsAtManagementGroupOperationResponse, err error) {
	req, err := c.preparerForRemediationsListDeploymentsAtManagementGroup(ctx, id, options)
	if err != nil {
		err = autorest.NewErrorWithError(err, "remediations.RemediationsClient", "RemediationsListDeploymentsAtManagementGroup", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "remediations.RemediationsClient", "RemediationsListDeploymentsAtManagementGroup", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForRemediationsListDeploymentsAtManagementGroup(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "remediations.RemediationsClient", "RemediationsListDeploymentsAtManagementGroup", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c RemediationsClient) preparerForRemediationsListDeploymentsAtManagementGroup(ctx context.Context, id Providers2RemediationId, options RemediationsListDeploymentsAtManagementGroupOperationOptions) (*http.Request, error) {
...
func (c RemediationsClient) preparerForRemediationsListDeploymentsAtManagementGroupWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c RemediationsClient) responderForRemediationsListDeploymentsAtManagementGroup(resp *http.Response) (result RemediationsListDeploymentsAtManagementGroupOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result RemediationsListDeploymentsAtManagementGroupOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "remediations.RemediationsClient", "RemediationsListDeploymentsAtManagementGroup", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForRemediationsListDeploymentsAtManagementGroup(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "remediations.RemediationsClient", "RemediationsListDeploymentsAtManagementGroup", result.HttpResponse, "Failure responding to request")
				return
			}
