...
// List ...
func (c NamespacesClient) List(ctx context.Context, id commonids.ResourceGroupId) (resp ListOperationResponse, err error) {
...
func (c NamespacesClient) ListComplete(ctx context.Context, id commonids.ResourceGroupId) (ListCompleteResult, error) {
	return c.ListCompleteMatchingPredicate(ctx, id, NamespaceResourceOperationPredicate{})
}

// ListCompleteMatchingPredicate retrieves all of the results and then applied the predicate
func (c NamespacesClient) ListCompleteMatchingPredicate(ctx context.Context, id commonids.ResourceGroupId, predicate NamespaceResourceOperationPredicate) (resp ListCompleteResult, err error) {
...
func (c NamespacesClient) preparerForList(ctx context.Context, id commonids.ResourceGroupId) (*http.Request, error) {
...
func (c NamespacesClient) responderForList(resp *http.Response) (result ListOperationResponse, err error) {
	type page struct {
