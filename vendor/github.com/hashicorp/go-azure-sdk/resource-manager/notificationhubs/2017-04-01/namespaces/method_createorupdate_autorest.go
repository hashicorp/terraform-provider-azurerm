...
func (c NamespacesClient) CreateOrUpdate(ctx context.Context, id NamespaceId, input NamespaceCreateOrUpdateParameters) (result CreateOrUpdateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "namespaces.NamespacesClient", "CreateOrUpdate", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c NamespacesClient) preparerForCreateOrUpdate(ctx context.Context, id NamespaceId, input NamespaceCreateOrUpdateParameters) (*http.Request, error) {
...
func (c NamespacesClient) responderForCreateOrUpdate(resp *http.Response) (result CreateOrUpdateOperationResponse, err error) {
