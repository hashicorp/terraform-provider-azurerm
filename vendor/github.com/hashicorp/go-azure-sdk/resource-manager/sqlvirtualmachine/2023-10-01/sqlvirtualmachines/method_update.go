...
func (c SqlVirtualMachinesClient) UpdateCallbackThenPoll(ctx context.Context, id SqlVirtualMachineId, input SqlVirtualMachineUpdate, callback func() error) error {
