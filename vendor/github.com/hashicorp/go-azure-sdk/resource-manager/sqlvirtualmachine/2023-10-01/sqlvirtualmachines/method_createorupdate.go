...
func (c SqlVirtualMachinesClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id SqlVirtualMachineId, input SqlVirtualMachine, callback func() error) error {
