...
func (c SqlVirtualMachineGroupsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id SqlVirtualMachineGroupId, input SqlVirtualMachineGroup, callback func() error) error {
