...
func (c AvailabilityGroupListenersClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id AvailabilityGroupListenerId, input AvailabilityGroupListener, callback func() error) error {
