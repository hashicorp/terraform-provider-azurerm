...
type GlobalRulestackCreateOrUpdateOperationResponse struct {
...
// GlobalRulestackCreateOrUpdate ...
func (c GlobalRulestackResourcesClient) GlobalRulestackCreateOrUpdate(ctx context.Context, id GlobalRulestackId, input GlobalRulestackResource) (result GlobalRulestackCreateOrUpdateOperationResponse, err error) {
...
func (c GlobalRulestackResourcesClient) GlobalRulestackCreateOrUpdateThenPoll(ctx context.Context, id GlobalRulestackId, input GlobalRulestackResource) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after GlobalRulestackCreateOrUpdate: %+v", err)
	}
