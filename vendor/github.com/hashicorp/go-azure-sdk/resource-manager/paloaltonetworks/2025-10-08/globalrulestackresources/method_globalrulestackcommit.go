...
type GlobalRulestackcommitOperationResponse struct {
	Poller       pollers.Poller
	HttpResponse *http.Response
	OData        *odata.OData
}

// GlobalRulestackcommit ...
func (c GlobalRulestackResourcesClient) GlobalRulestackcommit(ctx context.Context, id GlobalRulestackId) (result GlobalRulestackcommitOperationResponse, err error) {
...
func (c GlobalRulestackResourcesClient) GlobalRulestackcommitThenPoll(ctx context.Context, id GlobalRulestackId) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after GlobalRulestackcommit: %+v", err)
	}
