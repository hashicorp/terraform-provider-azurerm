...
type PostRulesCreateOrUpdateOperationResponse struct {
...
// PostRulesCreateOrUpdate ...
func (c PostRulesResourcesClient) PostRulesCreateOrUpdate(ctx context.Context, id PostRuleId, input PostRulesResource) (result PostRulesCreateOrUpdateOperationResponse, err error) {
...
func (c PostRulesResourcesClient) PostRulesCreateOrUpdateThenPoll(ctx context.Context, id PostRuleId, input PostRulesResource) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after PostRulesCreateOrUpdate: %+v", err)
	}
