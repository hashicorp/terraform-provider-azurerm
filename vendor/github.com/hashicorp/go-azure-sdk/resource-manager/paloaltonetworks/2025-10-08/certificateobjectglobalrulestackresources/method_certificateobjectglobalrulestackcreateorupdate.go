...
type CertificateObjectGlobalRulestackCreateOrUpdateOperationResponse struct {
...
// CertificateObjectGlobalRulestackCreateOrUpdate ...
func (c CertificateObjectGlobalRulestackResourcesClient) CertificateObjectGlobalRulestackCreateOrUpdate(ctx context.Context, id CertificateId, input CertificateObjectGlobalRulestackResource) (result CertificateObjectGlobalRulestackCreateOrUpdateOperationResponse, err error) {
...
func (c CertificateObjectGlobalRulestackResourcesClient) CertificateObjectGlobalRulestackCreateOrUpdateThenPoll(ctx context.Context, id CertificateId, input CertificateObjectGlobalRulestackResource) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after CertificateObjectGlobalRulestackCreateOrUpdate: %+v", err)
	}
