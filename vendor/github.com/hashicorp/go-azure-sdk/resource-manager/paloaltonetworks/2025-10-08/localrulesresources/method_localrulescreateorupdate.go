...
type LocalRulesCreateOrUpdateOperationResponse struct {
...
// LocalRulesCreateOrUpdate ...
func (c LocalRulesResourcesClient) LocalRulesCreateOrUpdate(ctx context.Context, id LocalRuleId, input LocalRulesResource) (result LocalRulesCreateOrUpdateOperationResponse, err error) {
...
func (c LocalRulesResourcesClient) LocalRulesCreateOrUpdateThenPoll(ctx context.Context, id LocalRuleId, input LocalRulesResource) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after LocalRulesCreateOrUpdate: %+v", err)
	}
