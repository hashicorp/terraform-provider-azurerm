...
type FqdnListLocalRulestackCreateOrUpdateOperationResponse struct {
...
// FqdnListLocalRulestackCreateOrUpdate ...
func (c FqdnListLocalRulestackResourcesClient) FqdnListLocalRulestackCreateOrUpdate(ctx context.Context, id LocalRulestackFqdnListId, input FqdnListLocalRulestackResource) (result FqdnListLocalRulestackCreateOrUpdateOperationResponse, err error) {
...
func (c FqdnListLocalRulestackResourcesClient) FqdnListLocalRulestackCreateOrUpdateThenPoll(ctx context.Context, id LocalRulestackFqdnListId, input FqdnListLocalRulestackResource) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after FqdnListLocalRulestackCreateOrUpdate: %+v", err)
	}
