...
type LocalRulestackscommitOperationResponse struct {
	Poller       pollers.Poller
	HttpResponse *http.Response
	OData        *odata.OData
}

// LocalRulestackscommit ...
func (c LocalRulestackResourcesClient) LocalRulestackscommit(ctx context.Context, id LocalRulestackId) (result LocalRulestackscommitOperationResponse, err error) {
...
func (c LocalRulestackResourcesClient) LocalRulestackscommitThenPoll(ctx context.Context, id LocalRulestackId) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after LocalRulestackscommit: %+v", err)
	}
