...
func (c PrivateEndpointConnectionsClient) ListByPrivateLinkScope(ctx context.Context, id ProviderPrivateLinkScopeId) (resp ListByPrivateLinkScopeOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "privateendpointconnections.PrivateEndpointConnectionsClient", "ListByPrivateLinkScope", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListByPrivateLinkScope(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "privateendpointconnections.PrivateEndpointConnectionsClient", "ListByPrivateLinkScope", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c PrivateEndpointConnectionsClient) preparerForListByPrivateLinkScope(ctx context.Context, id ProviderPrivateLinkScopeId) (*http.Request, error) {
...
func (c PrivateEndpointConnectionsClient) preparerForListByPrivateLinkScopeWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c PrivateEndpointConnectionsClient) ListByPrivateLinkScopeCompleteMatchingPredicate(ctx context.Context, id ProviderPrivateLinkScopeId, predicate PrivateEndpointConnectionOperationPredicate) (resp ListByPrivateLinkScopeCompleteResult, err error) {
