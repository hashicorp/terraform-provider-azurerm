...
func (c ResourceClient) RemoteRenderingAccountsListBySubscription(ctx context.Context, id commonids.SubscriptionId) (resp RemoteRenderingAccountsListBySubscriptionOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "resource.ResourceClient", "RemoteRenderingAccountsListBySubscription", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "resource.ResourceClient", "RemoteRenderingAccountsListBySubscription", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForRemoteRenderingAccountsListBySubscription(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "resource.ResourceClient", "RemoteRenderingAccountsListBySubscription", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c ResourceClient) preparerForRemoteRenderingAccountsListBySubscription(ctx context.Context, id commonids.SubscriptionId) (*http.Request, error) {
...
func (c ResourceClient) preparerForRemoteRenderingAccountsListBySubscriptionWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c ResourceClient) responderForRemoteRenderingAccountsListBySubscription(resp *http.Response) (result RemoteRenderingAccountsListBySubscriptionOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result RemoteRenderingAccountsListBySubscriptionOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "resource.ResourceClient", "RemoteRenderingAccountsListBySubscription", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForRemoteRenderingAccountsListBySubscription(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "resource.ResourceClient", "RemoteRenderingAccountsListBySubscription", result.HttpResponse, "Failure responding to request")
				return
			}
