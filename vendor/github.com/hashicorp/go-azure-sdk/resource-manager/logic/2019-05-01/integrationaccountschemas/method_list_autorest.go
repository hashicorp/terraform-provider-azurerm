...
func (c IntegrationAccountSchemasClient) List(ctx context.Context, id IntegrationAccountId, options ListOperationOptions) (resp ListOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "integrationaccountschemas.IntegrationAccountSchemasClient", "List", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "integrationaccountschemas.IntegrationAccountSchemasClient", "List", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForList(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "integrationaccountschemas.IntegrationAccountSchemasClient", "List", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c IntegrationAccountSchemasClient) preparerForList(ctx context.Context, id IntegrationAccountId, options ListOperationOptions) (*http.Request, error) {
...
func (c IntegrationAccountSchemasClient) preparerForListWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c IntegrationAccountSchemasClient) responderForList(resp *http.Response) (result ListOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "integrationaccountschemas.IntegrationAccountSchemasClient", "List", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForList(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "integrationaccountschemas.IntegrationAccountSchemasClient", "List", result.HttpResponse, "Failure responding to request")
				return
			}
