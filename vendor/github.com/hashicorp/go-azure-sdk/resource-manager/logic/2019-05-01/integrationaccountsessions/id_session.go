...
func (id *SessionId) FromParseResult(input resourceids.ParseResult) error {
	var ok bool
	...
	if id.SessionName, ok = input.Parsed["sessionName"]; !ok {
		return resourceids.NewSegmentNotSpecifiedError(id, "sessionName", input)
	}
...
func (id SessionId) Segments() []resourceids.Segment {
	return []resourceids.Segment{
		...
		resourceids.UserSpecifiedSegment("sessionName", "sessionName"),
	}
}
