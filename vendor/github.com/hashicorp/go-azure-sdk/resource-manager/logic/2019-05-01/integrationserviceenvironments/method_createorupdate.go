...
func (c IntegrationServiceEnvironmentsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id IntegrationServiceEnvironmentId, input IntegrationServiceEnvironment, callback func() error) error {
