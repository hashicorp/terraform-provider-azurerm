...
## `github.com/hashicorp/go-azure-sdk/resource-manager/cosmosdb/2025-10-15/cosmosdb` Documentation

The `cosmosdb` SDK allows for interaction with Azure Resource Manager `cosmosdb` (API Version `2025-10-15`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/cosmosdb/2025-10-15/cosmosdb"
```
