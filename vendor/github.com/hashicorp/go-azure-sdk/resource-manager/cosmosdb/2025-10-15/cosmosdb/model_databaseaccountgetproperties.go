...
type DatabaseAccountGetProperties struct {
	...
	DefaultPriorityLevel                 *DefaultPriorityLevel           `json:"defaultPriorityLevel,omitempty"`
	...
	EnablePerRegionPerPartitionAutoscale *bool                           `json:"enablePerRegionPerPartitionAutoscale,omitempty"`
	EnablePriorityBasedExecution         *bool                           `json:"enablePriorityBasedExecution,omitempty"`
	...
	KeyVaultKeyUriVersion                *string                         `json:"keyVaultKeyUriVersion,omitempty"`
...
func (s *DatabaseAccountGetProperties) UnmarshalJSON(bytes []byte) error {
	...
	s.DefaultPriorityLevel = decoded.DefaultPriorityLevel
	...
	s.EnablePerRegionPerPartitionAutoscale = decoded.EnablePerRegionPerPartitionAutoscale
	s.EnablePriorityBasedExecution = decoded.EnablePriorityBasedExecution
	...
	s.KeyVaultKeyUriVersion = decoded.KeyVaultKeyUriVersion
