...
func (c FleetsClient) FleetspaceAccountCreate(ctx context.Context, id FleetspaceAccountId, input FleetspaceAccountResource) (result FleetspaceAccountCreateOperationResponse, err error) {
