...
func (o CollectionPartitionListMetricsOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
...
func (o CollectionPartitionListMetricsOperationOptions) ToQuery() *client.QueryParams {
