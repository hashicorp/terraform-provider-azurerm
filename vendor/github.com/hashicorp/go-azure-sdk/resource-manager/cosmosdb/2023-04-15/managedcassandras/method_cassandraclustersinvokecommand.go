...
func (c ManagedCassandrasClient) CassandraClustersInvokeCommandCallbackThenPoll(ctx context.Context, id CassandraClusterId, input CommandPostBody, callback func() error) error {
