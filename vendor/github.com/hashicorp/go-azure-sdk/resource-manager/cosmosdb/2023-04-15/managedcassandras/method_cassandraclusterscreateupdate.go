...
func (c ManagedCassandrasClient) CassandraClustersCreateUpdateCallbackThenPoll(ctx context.Context, id CassandraClusterId, input ClusterResource, callback func() error) error {
