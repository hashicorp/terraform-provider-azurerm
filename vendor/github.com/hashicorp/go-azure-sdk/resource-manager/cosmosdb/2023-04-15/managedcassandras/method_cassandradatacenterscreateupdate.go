...
func (c ManagedCassandrasClient) CassandraDataCentersCreateUpdateCallbackThenPoll(ctx context.Context, id DataCenterId, input DataCenterResource, callback func() error) error {
