...
## `github.com/hashicorp/go-azure-sdk/resource-manager/cosmosdb/2025-04-15/managedcassandras` Documentation

The `managedcassandras` SDK allows for interaction with Azure Resource Manager `cosmosdb` (API Version `2025-04-15`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/cosmosdb/2025-04-15/managedcassandras"
```
