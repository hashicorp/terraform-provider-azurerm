...
## `github.com/hashicorp/go-azure-sdk/resource-manager/cosmosdb/2025-04-15/sqldedicatedgateway` Documentation

The `sqldedicatedgateway` SDK allows for interaction with Azure Resource Manager `cosmosdb` (API Version `2025-04-15`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/cosmosdb/2025-04-15/sqldedicatedgateway"
```
