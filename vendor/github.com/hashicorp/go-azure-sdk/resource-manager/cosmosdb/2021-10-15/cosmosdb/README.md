...
## `github.com/hashicorp/go-azure-sdk/resource-manager/cosmosdb/2021-10-15/cosmosdb` Documentation

The `cosmosdb` SDK allows for interaction with the Azure Resource Manager Service `cosmosdb` (API Version `2021-10-15`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/cosmosdb/2021-10-15/cosmosdb"
```
