...
## `github.com/hashicorp/go-azure-sdk/resource-manager/cosmosdb/2024-05-15/mongorbacs` Documentation

The `mongorbacs` SDK allows for interaction with the Azure Resource Manager Service `cosmosdb` (API Version `2024-05-15`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/cosmosdb/2024-05-15/mongorbacs"
```
