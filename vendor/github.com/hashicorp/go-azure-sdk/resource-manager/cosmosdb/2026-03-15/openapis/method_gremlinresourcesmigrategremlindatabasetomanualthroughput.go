...
func (c OpenapisClient) GremlinResourcesMigrateGremlinDatabaseToManualThroughput(ctx context.Context, id GremlinDatabaseId) (result GremlinResourcesMigrateGremlinDatabaseToManualThroughputOperationResponse, err error) {
...
func (c OpenapisClient) GremlinResourcesMigrateGremlinDatabaseToManualThroughputThenPoll(ctx context.Context, id GremlinDatabaseId) error {
...
func (c OpenapisClient) GremlinResourcesMigrateGremlinDatabaseToManualThroughputCallbackThenPoll(ctx context.Context, id GremlinDatabaseId, callback func() error) error {
