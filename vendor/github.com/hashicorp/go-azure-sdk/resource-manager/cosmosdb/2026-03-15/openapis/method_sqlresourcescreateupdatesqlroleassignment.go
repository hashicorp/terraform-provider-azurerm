...
func (c OpenapisClient) SqlResourcesCreateUpdateSqlRoleAssignment(ctx context.Context, id SqlRoleAssignmentId, input SqlRoleAssignmentCreateUpdateParameters) (result SqlResourcesCreateUpdateSqlRoleAssignmentOperationResponse, err error) {
...
func (c OpenapisClient) SqlResourcesCreateUpdateSqlRoleAssignmentThenPoll(ctx context.Context, id SqlRoleAssignmentId, input SqlRoleAssignmentCreateUpdateParameters) error {
...
func (c OpenapisClient) SqlResourcesCreateUpdateSqlRoleAssignmentCallbackThenPoll(ctx context.Context, id SqlRoleAssignmentId, input SqlRoleAssignmentCreateUpdateParameters, callback func() error) error {
