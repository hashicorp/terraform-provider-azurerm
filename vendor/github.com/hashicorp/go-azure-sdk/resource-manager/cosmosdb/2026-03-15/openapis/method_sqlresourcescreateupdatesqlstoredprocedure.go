...
func (c OpenapisClient) SqlResourcesCreateUpdateSqlStoredProcedure(ctx context.Context, id StoredProcedureId, input SqlStoredProcedureCreateUpdateParameters) (result SqlResourcesCreateUpdateSqlStoredProcedureOperationResponse, err error) {
...
func (c OpenapisClient) SqlResourcesCreateUpdateSqlStoredProcedureThenPoll(ctx context.Context, id StoredProcedureId, input SqlStoredProcedureCreateUpdateParameters) error {
...
func (c OpenapisClient) SqlResourcesCreateUpdateSqlStoredProcedureCallbackThenPoll(ctx context.Context, id StoredProcedureId, input SqlStoredProcedureCreateUpdateParameters, callback func() error) error {
