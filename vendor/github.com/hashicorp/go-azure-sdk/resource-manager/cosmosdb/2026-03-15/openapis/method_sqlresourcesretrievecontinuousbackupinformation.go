...
func (c OpenapisClient) SqlResourcesRetrieveContinuousBackupInformation(ctx context.Context, id ContainerId, input ContinuousBackupRestoreLocation) (result SqlResourcesRetrieveContinuousBackupInformationOperationResponse, err error) {
...
func (c OpenapisClient) SqlResourcesRetrieveContinuousBackupInformationThenPoll(ctx context.Context, id ContainerId, input ContinuousBackupRestoreLocation) error {
...
func (c OpenapisClient) SqlResourcesRetrieveContinuousBackupInformationCallbackThenPoll(ctx context.Context, id ContainerId, input ContinuousBackupRestoreLocation, callback func() error) error {
