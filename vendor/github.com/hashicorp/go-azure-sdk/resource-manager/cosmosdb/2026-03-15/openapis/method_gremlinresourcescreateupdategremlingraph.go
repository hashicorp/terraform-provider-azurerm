...
func (c OpenapisClient) GremlinResourcesCreateUpdateGremlinGraph(ctx context.Context, id GraphId, input GremlinGraphCreateUpdateParameters) (result GremlinResourcesCreateUpdateGremlinGraphOperationResponse, err error) {
...
func (c OpenapisClient) GremlinResourcesCreateUpdateGremlinGraphThenPoll(ctx context.Context, id GraphId, input GremlinGraphCreateUpdateParameters) error {
...
func (c OpenapisClient) GremlinResourcesCreateUpdateGremlinGraphCallbackThenPoll(ctx context.Context, id GraphId, input GremlinGraphCreateUpdateParameters, callback func() error) error {
