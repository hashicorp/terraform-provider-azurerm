...
func (c OpenapisClient) CassandraClustersUpdate(ctx context.Context, id CassandraClusterId, input ClusterResource) (result CassandraClustersUpdateOperationResponse, err error) {
...
func (c OpenapisClient) CassandraClustersUpdateThenPoll(ctx context.Context, id CassandraClusterId, input ClusterResource) error {
...
func (c OpenapisClient) CassandraClustersUpdateCallbackThenPoll(ctx context.Context, id CassandraClusterId, input ClusterResource, callback func() error) error {
