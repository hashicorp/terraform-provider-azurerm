...
func (c OpenapisClient) FleetspaceAccountList(ctx context.Context, id FleetspaceId) (result FleetspaceAccountListOperationResponse, err error) {
...
func (c OpenapisClient) FleetspaceAccountListComplete(ctx context.Context, id FleetspaceId) (FleetspaceAccountListCompleteResult, error) {
...
func (c OpenapisClient) FleetspaceAccountListCompleteMatchingPredicate(ctx context.Context, id FleetspaceId, predicate FleetspaceAccountResourceOperationPredicate) (result FleetspaceAccountListCompleteResult, err error) {
