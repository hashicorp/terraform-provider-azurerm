...
func (c OpenapisClient) SqlResourcesMigrateSqlDatabaseToManualThroughput(ctx context.Context, id SqlDatabaseId) (result SqlResourcesMigrateSqlDatabaseToManualThroughputOperationResponse, err error) {
...
func (c OpenapisClient) SqlResourcesMigrateSqlDatabaseToManualThroughputThenPoll(ctx context.Context, id SqlDatabaseId) error {
...
func (c OpenapisClient) SqlResourcesMigrateSqlDatabaseToManualThroughputCallbackThenPoll(ctx context.Context, id SqlDatabaseId, callback func() error) error {
