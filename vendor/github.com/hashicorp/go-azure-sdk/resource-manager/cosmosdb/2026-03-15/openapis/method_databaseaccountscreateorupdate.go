...
func (c OpenapisClient) DatabaseAccountsCreateOrUpdate(ctx context.Context, id DatabaseAccountId, input DatabaseAccountCreateUpdateParameters) (result DatabaseAccountsCreateOrUpdateOperationResponse, err error) {
...
func (c OpenapisClient) DatabaseAccountsCreateOrUpdateThenPoll(ctx context.Context, id DatabaseAccountId, input DatabaseAccountCreateUpdateParameters) error {
...
func (c OpenapisClient) DatabaseAccountsCreateOrUpdateCallbackThenPoll(ctx context.Context, id DatabaseAccountId, input DatabaseAccountCreateUpdateParameters, callback func() error) error {
