...
func (c OpenapisClient) TableResourcesMigrateTableToAutoscale(ctx context.Context, id TableId) (result TableResourcesMigrateTableToAutoscaleOperationResponse, err error) {
...
func (c OpenapisClient) TableResourcesMigrateTableToAutoscaleThenPoll(ctx context.Context, id TableId) error {
...
func (c OpenapisClient) TableResourcesMigrateTableToAutoscaleCallbackThenPoll(ctx context.Context, id TableId, callback func() error) error {
