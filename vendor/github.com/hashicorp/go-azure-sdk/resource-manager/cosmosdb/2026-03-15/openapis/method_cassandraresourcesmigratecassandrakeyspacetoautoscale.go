...
func (c OpenapisClient) CassandraResourcesMigrateCassandraKeyspaceToAutoscale(ctx context.Context, id CassandraKeyspaceId) (result CassandraResourcesMigrateCassandraKeyspaceToAutoscaleOperationResponse, err error) {
...
func (c OpenapisClient) CassandraResourcesMigrateCassandraKeyspaceToAutoscaleThenPoll(ctx context.Context, id CassandraKeyspaceId) error {
...
func (c OpenapisClient) CassandraResourcesMigrateCassandraKeyspaceToAutoscaleCallbackThenPoll(ctx context.Context, id CassandraKeyspaceId, callback func() error) error {
