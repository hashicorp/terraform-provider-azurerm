...
func (c OpenapisClient) SqlResourcesDeleteSqlTrigger(ctx context.Context, id TriggerId) (result SqlResourcesDeleteSqlTriggerOperationResponse, err error) {
...
func (c OpenapisClient) SqlResourcesDeleteSqlTriggerThenPoll(ctx context.Context, id TriggerId) error {
