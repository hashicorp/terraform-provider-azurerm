...
func (c OpenapisClient) MongoDBResourcesMigrateMongoDBCollectionToManualThroughput(ctx context.Context, id MongodbDatabaseCollectionId) (result MongoDBResourcesMigrateMongoDBCollectionToManualThroughputOperationResponse, err error) {
...
func (c OpenapisClient) MongoDBResourcesMigrateMongoDBCollectionToManualThroughputThenPoll(ctx context.Context, id MongodbDatabaseCollectionId) error {
...
func (c OpenapisClient) MongoDBResourcesMigrateMongoDBCollectionToManualThroughputCallbackThenPoll(ctx context.Context, id MongodbDatabaseCollectionId, callback func() error) error {
