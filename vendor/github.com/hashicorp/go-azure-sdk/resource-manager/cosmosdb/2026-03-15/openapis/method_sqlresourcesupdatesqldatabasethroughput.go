...
func (c OpenapisClient) SqlResourcesUpdateSqlDatabaseThroughput(ctx context.Context, id SqlDatabaseId, input ThroughputSettingsUpdateParameters) (result SqlResourcesUpdateSqlDatabaseThroughputOperationResponse, err error) {
...
func (c OpenapisClient) SqlResourcesUpdateSqlDatabaseThroughputThenPoll(ctx context.Context, id SqlDatabaseId, input ThroughputSettingsUpdateParameters) error {
...
func (c OpenapisClient) SqlResourcesUpdateSqlDatabaseThroughputCallbackThenPoll(ctx context.Context, id SqlDatabaseId, input ThroughputSettingsUpdateParameters, callback func() error) error {
