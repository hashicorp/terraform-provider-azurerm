...
func (c OpenapisClient) CassandraResourcesMigrateCassandraKeyspaceToManualThroughput(ctx context.Context, id CassandraKeyspaceId) (result CassandraResourcesMigrateCassandraKeyspaceToManualThroughputOperationResponse, err error) {
...
func (c OpenapisClient) CassandraResourcesMigrateCassandraKeyspaceToManualThroughputThenPoll(ctx context.Context, id CassandraKeyspaceId) error {
...
func (c OpenapisClient) CassandraResourcesMigrateCassandraKeyspaceToManualThroughputCallbackThenPoll(ctx context.Context, id CassandraKeyspaceId, callback func() error) error {
