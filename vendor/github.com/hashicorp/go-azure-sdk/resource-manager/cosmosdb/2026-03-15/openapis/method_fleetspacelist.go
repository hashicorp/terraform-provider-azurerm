...
// FleetspaceList ...
func (c OpenapisClient) FleetspaceList(ctx context.Context, id FleetId) (result FleetspaceListOperationResponse, err error) {
...
func (c OpenapisClient) FleetspaceListComplete(ctx context.Context, id FleetId) (FleetspaceListCompleteResult, error) {
...
func (c OpenapisClient) FleetspaceListCompleteMatchingPredicate(ctx context.Context, id FleetId, predicate FleetspaceResourceOperationPredicate) (result FleetspaceListCompleteResult, err error) {
