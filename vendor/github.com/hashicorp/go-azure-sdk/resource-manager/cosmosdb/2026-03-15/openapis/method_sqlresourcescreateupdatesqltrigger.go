...
func (c OpenapisClient) SqlResourcesCreateUpdateSqlTrigger(ctx context.Context, id TriggerId, input SqlTriggerCreateUpdateParameters) (result SqlResourcesCreateUpdateSqlTriggerOperationResponse, err error) {
...
func (c OpenapisClient) SqlResourcesCreateUpdateSqlTriggerThenPoll(ctx context.Context, id TriggerId, input SqlTriggerCreateUpdateParameters) error {
...
func (c OpenapisClient) SqlResourcesCreateUpdateSqlTriggerCallbackThenPoll(ctx context.Context, id TriggerId, input SqlTriggerCreateUpdateParameters, callback func() error) error {
