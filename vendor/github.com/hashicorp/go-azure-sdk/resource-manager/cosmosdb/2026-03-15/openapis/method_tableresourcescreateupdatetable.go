...
func (c OpenapisClient) TableResourcesCreateUpdateTable(ctx context.Context, id TableId, input TableCreateUpdateParameters) (result TableResourcesCreateUpdateTableOperationResponse, err error) {
...
func (c OpenapisClient) TableResourcesCreateUpdateTableThenPoll(ctx context.Context, id TableId, input TableCreateUpdateParameters) error {
...
func (c OpenapisClient) TableResourcesCreateUpdateTableCallbackThenPoll(ctx context.Context, id TableId, input TableCreateUpdateParameters, callback func() error) error {
