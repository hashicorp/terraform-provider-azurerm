...
func (c OpenapisClient) CassandraResourcesMigrateCassandraTableToAutoscale(ctx context.Context, id CassandraKeyspaceTableId) (result CassandraResourcesMigrateCassandraTableToAutoscaleOperationResponse, err error) {
...
func (c OpenapisClient) CassandraResourcesMigrateCassandraTableToAutoscaleThenPoll(ctx context.Context, id CassandraKeyspaceTableId) error {
...
func (c OpenapisClient) CassandraResourcesMigrateCassandraTableToAutoscaleCallbackThenPoll(ctx context.Context, id CassandraKeyspaceTableId, callback func() error) error {
