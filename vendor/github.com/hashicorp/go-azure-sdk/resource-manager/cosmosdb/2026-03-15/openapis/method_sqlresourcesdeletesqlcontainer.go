...
func (c OpenapisClient) SqlResourcesDeleteSqlContainer(ctx context.Context, id ContainerId) (result SqlResourcesDeleteSqlContainerOperationResponse, err error) {
...
func (c OpenapisClient) SqlResourcesDeleteSqlContainerThenPoll(ctx context.Context, id ContainerId) error {
