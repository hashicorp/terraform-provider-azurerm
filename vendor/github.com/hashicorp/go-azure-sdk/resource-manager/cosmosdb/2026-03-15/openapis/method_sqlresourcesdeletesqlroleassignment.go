...
func (c OpenapisClient) SqlResourcesDeleteSqlRoleAssignment(ctx context.Context, id SqlRoleAssignmentId) (result SqlResourcesDeleteSqlRoleAssignmentOperationResponse, err error) {
...
func (c OpenapisClient) SqlResourcesDeleteSqlRoleAssignmentThenPoll(ctx context.Context, id SqlRoleAssignmentId) error {
