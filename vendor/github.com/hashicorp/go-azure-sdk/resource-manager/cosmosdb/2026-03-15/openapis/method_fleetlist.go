...
// FleetList ...
func (c OpenapisClient) FleetList(ctx context.Context, id commonids.SubscriptionId) (result FleetListOperationResponse, err error) {
...
func (c OpenapisClient) FleetListComplete(ctx context.Context, id commonids.SubscriptionId) (FleetListCompleteResult, error) {
...
func (c OpenapisClient) FleetListCompleteMatchingPredicate(ctx context.Context, id commonids.SubscriptionId, predicate FleetResourceOperationPredicate) (result FleetListCompleteResult, err error) {
