...
func (c OpenapisClient) DatabaseAccountsRegenerateKey(ctx context.Context, id DatabaseAccountId, input DatabaseAccountRegenerateKeyParameters) (result DatabaseAccountsRegenerateKeyOperationResponse, err error) {
...
func (c OpenapisClient) DatabaseAccountsRegenerateKeyThenPoll(ctx context.Context, id DatabaseAccountId, input DatabaseAccountRegenerateKeyParameters) error {
...
func (c OpenapisClient) DatabaseAccountsRegenerateKeyCallbackThenPoll(ctx context.Context, id DatabaseAccountId, input DatabaseAccountRegenerateKeyParameters, callback func() error) error {
