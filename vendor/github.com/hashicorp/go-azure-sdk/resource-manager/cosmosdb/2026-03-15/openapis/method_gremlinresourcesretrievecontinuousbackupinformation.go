...
func (c OpenapisClient) GremlinResourcesRetrieveContinuousBackupInformation(ctx context.Context, id GraphId, input ContinuousBackupRestoreLocation) (result GremlinResourcesRetrieveContinuousBackupInformationOperationResponse, err error) {
...
func (c OpenapisClient) GremlinResourcesRetrieveContinuousBackupInformationThenPoll(ctx context.Context, id GraphId, input ContinuousBackupRestoreLocation) error {
...
func (c OpenapisClient) GremlinResourcesRetrieveContinuousBackupInformationCallbackThenPoll(ctx context.Context, id GraphId, input ContinuousBackupRestoreLocation, callback func() error) error {
