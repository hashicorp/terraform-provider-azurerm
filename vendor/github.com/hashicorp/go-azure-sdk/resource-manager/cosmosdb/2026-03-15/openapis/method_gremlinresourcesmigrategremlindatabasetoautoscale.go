...
func (c OpenapisClient) GremlinResourcesMigrateGremlinDatabaseToAutoscale(ctx context.Context, id GremlinDatabaseId) (result GremlinResourcesMigrateGremlinDatabaseToAutoscaleOperationResponse, err error) {
...
func (c OpenapisClient) GremlinResourcesMigrateGremlinDatabaseToAutoscaleThenPoll(ctx context.Context, id GremlinDatabaseId) error {
...
func (c OpenapisClient) GremlinResourcesMigrateGremlinDatabaseToAutoscaleCallbackThenPoll(ctx context.Context, id GremlinDatabaseId, callback func() error) error {
