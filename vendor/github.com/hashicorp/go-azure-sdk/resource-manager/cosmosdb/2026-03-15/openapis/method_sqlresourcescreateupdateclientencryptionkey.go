...
func (c OpenapisClient) SqlResourcesCreateUpdateClientEncryptionKey(ctx context.Context, id ClientEncryptionKeyId, input ClientEncryptionKeyCreateUpdateParameters) (result SqlResourcesCreateUpdateClientEncryptionKeyOperationResponse, err error) {
...
func (c OpenapisClient) SqlResourcesCreateUpdateClientEncryptionKeyThenPoll(ctx context.Context, id ClientEncryptionKeyId, input ClientEncryptionKeyCreateUpdateParameters) error {
...
func (c OpenapisClient) SqlResourcesCreateUpdateClientEncryptionKeyCallbackThenPoll(ctx context.Context, id ClientEncryptionKeyId, input ClientEncryptionKeyCreateUpdateParameters, callback func() error) error {
