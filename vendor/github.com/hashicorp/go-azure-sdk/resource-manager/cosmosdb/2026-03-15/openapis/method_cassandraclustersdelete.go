...
func (c OpenapisClient) CassandraClustersDelete(ctx context.Context, id CassandraClusterId) (result CassandraClustersDeleteOperationResponse, err error) {
...
func (c OpenapisClient) CassandraClustersDeleteThenPoll(ctx context.Context, id CassandraClusterId) error {
