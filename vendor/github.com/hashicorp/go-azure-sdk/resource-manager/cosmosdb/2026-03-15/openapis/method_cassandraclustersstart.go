...
func (c OpenapisClient) CassandraClustersStart(ctx context.Context, id CassandraClusterId) (result CassandraClustersStartOperationResponse, err error) {
...
func (c OpenapisClient) CassandraClustersStartThenPoll(ctx context.Context, id CassandraClusterId) error {
...
func (c OpenapisClient) CassandraClustersStartCallbackThenPoll(ctx context.Context, id CassandraClusterId, callback func() error) error {
