...
func (c OpenapisClient) DatabaseAccountsDelete(ctx context.Context, id DatabaseAccountId) (result DatabaseAccountsDeleteOperationResponse, err error) {
...
func (c OpenapisClient) DatabaseAccountsDeleteThenPoll(ctx context.Context, id DatabaseAccountId) error {
