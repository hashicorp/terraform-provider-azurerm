...
func (c OpenapisClient) TableResourcesRetrieveContinuousBackupInformation(ctx context.Context, id TableId, input ContinuousBackupRestoreLocation) (result TableResourcesRetrieveContinuousBackupInformationOperationResponse, err error) {
...
func (c OpenapisClient) TableResourcesRetrieveContinuousBackupInformationThenPoll(ctx context.Context, id TableId, input ContinuousBackupRestoreLocation) error {
...
func (c OpenapisClient) TableResourcesRetrieveContinuousBackupInformationCallbackThenPoll(ctx context.Context, id TableId, input ContinuousBackupRestoreLocation, callback func() error) error {
