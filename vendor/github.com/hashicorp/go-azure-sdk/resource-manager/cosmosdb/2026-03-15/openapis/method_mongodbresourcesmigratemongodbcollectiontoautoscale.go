...
func (c OpenapisClient) MongoDBResourcesMigrateMongoDBCollectionToAutoscale(ctx context.Context, id MongodbDatabaseCollectionId) (result MongoDBResourcesMigrateMongoDBCollectionToAutoscaleOperationResponse, err error) {
...
func (c OpenapisClient) MongoDBResourcesMigrateMongoDBCollectionToAutoscaleThenPoll(ctx context.Context, id MongodbDatabaseCollectionId) error {
...
func (c OpenapisClient) MongoDBResourcesMigrateMongoDBCollectionToAutoscaleCallbackThenPoll(ctx context.Context, id MongodbDatabaseCollectionId, callback func() error) error {
