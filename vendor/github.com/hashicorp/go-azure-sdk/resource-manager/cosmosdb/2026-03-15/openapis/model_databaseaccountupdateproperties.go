...
type DatabaseAccountUpdateProperties struct {
	...
	EnforceHierarchicalPartitionKeyIdLastLevel *bool                           `json:"enforceHierarchicalPartitionKeyIdLastLevel,omitempty"`
...
func (s *DatabaseAccountUpdateProperties) UnmarshalJSON(bytes []byte) error {
	...
	s.EnforceHierarchicalPartitionKeyIdLastLevel = decoded.EnforceHierarchicalPartitionKeyIdLastLevel
