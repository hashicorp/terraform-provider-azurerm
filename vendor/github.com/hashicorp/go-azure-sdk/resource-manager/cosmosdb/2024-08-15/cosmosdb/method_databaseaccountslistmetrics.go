...
func (o DatabaseAccountsListMetricsOperationOptions) ToHeaders() *client.Headers {
	out := client.Headers{}
...
func (o DatabaseAccountsListMetricsOperationOptions) ToQuery() *client.QueryParams {
