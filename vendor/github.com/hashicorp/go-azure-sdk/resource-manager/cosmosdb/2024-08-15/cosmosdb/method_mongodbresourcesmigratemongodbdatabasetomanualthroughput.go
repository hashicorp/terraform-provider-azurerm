...
func (c CosmosDBClient) MongoDBResourcesMigrateMongoDBDatabaseToManualThroughputCallbackThenPoll(ctx context.Context, id MongodbDatabaseId, callback func() error) error {
