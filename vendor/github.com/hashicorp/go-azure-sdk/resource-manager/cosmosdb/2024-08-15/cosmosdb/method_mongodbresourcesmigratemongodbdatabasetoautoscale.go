...
func (c CosmosDBClient) MongoDBResourcesMigrateMongoDBDatabaseToAutoscaleCallbackThenPoll(ctx context.Context, id MongodbDatabaseId, callback func() error) error {
