...
func (c RbacsClient) SqlResourcesCreateUpdateSqlRoleAssignmentCallbackThenPoll(ctx context.Context, id AccountId, input SqlRoleAssignmentCreateUpdateParameters, callback func() error) error {
