...
func (c CosmosDBClient) CassandraResourcesMigrateCassandraTableToManualThroughputCallbackThenPoll(ctx context.Context, id CassandraKeyspaceTableId, callback func() error) error {
