...
func (c CosmosDBClient) SqlResourcesCreateUpdateSqlDatabaseCallbackThenPoll(ctx context.Context, id SqlDatabaseId, input SqlDatabaseCreateUpdateParameters, callback func() error) error {
