...
func (c CosmosDBClient) DatabaseAccountsUpdateCallbackThenPoll(ctx context.Context, id DatabaseAccountId, input DatabaseAccountUpdateParameters, callback func() error) error {
