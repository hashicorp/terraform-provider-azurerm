...
func (c CosmosDBClient) GremlinResourcesCreateUpdateGremlinDatabaseCallbackThenPoll(ctx context.Context, id GremlinDatabaseId, input GremlinDatabaseCreateUpdateParameters, callback func() error) error {
