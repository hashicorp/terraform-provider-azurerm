...
func (c ManagedEnvironmentsClient) ManagedEnvironmentPrivateEndpointConnectionsCreateOrUpdateCallbackThenPoll(ctx context.Context, id PrivateEndpointConnectionId, input PrivateEndpointConnection, callback func() error) error {
