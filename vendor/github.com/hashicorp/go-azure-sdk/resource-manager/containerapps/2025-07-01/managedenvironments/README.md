...
## `github.com/hashicorp/go-azure-sdk/resource-manager/containerapps/2025-07-01/managedenvironments` Documentation

The `managedenvironments` SDK allows for interaction with Azure Resource Manager `containerapps` (API Version `2025-07-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/containerapps/2025-07-01/managedenvironments"
```
...
### Example Usage: `ManagedEnvironmentsClient.ManagedEnvironmentPrivateEndpointConnectionsCreateOrUpdate`

```go
ctx := context.TODO()
id := managedenvironments.NewPrivateEndpointConnectionID("12345678-1234-9876-4563-123456789012", "example-resource-group", "managedEnvironmentName", "privateEndpointConnectionName")

payload := managedenvironments.PrivateEndpointConnection{
	// ...
}
...
### Example Usage: `ManagedEnvironmentsClient.ManagedEnvironmentPrivateEndpointConnectionsDelete`
...
### Example Usage: `ManagedEnvironmentsClient.ManagedEnvironmentPrivateEndpointConnectionsGet`
...
### Example Usage: `ManagedEnvironmentsClient.ManagedEnvironmentPrivateEndpointConnectionsList`
...
### Example Usage: `ManagedEnvironmentsClient.ManagedEnvironmentPrivateLinkResourcesList`
