...
func (c ManagedEnvironmentsClient) UpdateCallbackThenPoll(ctx context.Context, id ManagedEnvironmentId, input ManagedEnvironment, callback func() error) error {
