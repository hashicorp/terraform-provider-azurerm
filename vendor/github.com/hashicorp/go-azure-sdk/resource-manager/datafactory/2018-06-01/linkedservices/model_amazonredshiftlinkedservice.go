...
var _ LinkedService = AmazonRedshiftLinkedService{}
...
func (s AmazonRedshiftLinkedService) MarshalJSON() ([]byte, error) {
	type wrapper AmazonRedshiftLinkedService
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling AmazonRedshiftLinkedService: %+v", err)
	}
	...
	if err != nil {
		return nil, fmt.Errorf("re-marshaling AmazonRedshiftLinkedService: %+v", err)
	}
