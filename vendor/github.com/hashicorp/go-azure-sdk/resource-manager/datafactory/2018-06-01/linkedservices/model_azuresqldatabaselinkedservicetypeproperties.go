...
var _ json.Unmarshaler = &AzureSqlDatabaseLinkedServiceTypeProperties{}
...
func (s *AzureSqlDatabaseLinkedServiceTypeProperties) UnmarshalJSON(bytes []byte) error {
	...
	if err := json.Unmarshal(bytes, &temp); err != nil {
		return fmt.Errorf("unmarshaling AzureSqlDatabaseLinkedServiceTypeProperties into map[string]json.RawMessage: %+v", err)
	}
