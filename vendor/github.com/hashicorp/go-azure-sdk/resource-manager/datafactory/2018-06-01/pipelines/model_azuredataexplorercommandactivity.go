...
var _ Activity = AzureDataExplorerCommandActivity{}
...
func (s AzureDataExplorerCommandActivity) Activity() BaseActivityImpl {
...
var _ json.Marshaler = AzureDataExplorerCommandActivity{}

func (s AzureDataExplorerCommandActivity) MarshalJSON() ([]byte, error) {
	type wrapper AzureDataExplorerCommandActivity
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling AzureDataExplorerCommandActivity: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling AzureDataExplorerCommandActivity: %+v", err)
	}

	decoded["type"] = "AzureDataExplorerCommand"

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling AzureDataExplorerCommandActivity: %+v", err)
	}
