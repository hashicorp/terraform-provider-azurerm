...
var _ Activity = AzureMLExecutePipelineActivity{}
...
func (s AzureMLExecutePipelineActivity) Activity() BaseActivityImpl {
...
var _ json.Marshaler = AzureMLExecutePipelineActivity{}

func (s AzureMLExecutePipelineActivity) MarshalJSON() ([]byte, error) {
	type wrapper AzureMLExecutePipelineActivity
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling AzureMLExecutePipelineActivity: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling AzureMLExecutePipelineActivity: %+v", err)
	}

	decoded["type"] = "AzureMLExecutePipeline"

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling AzureMLExecutePipelineActivity: %+v", err)
	}
