...
var _ Activity = HDInsightHiveActivity{}
...
func (s HDInsightHiveActivity) Activity() BaseActivityImpl {
...
var _ json.Marshaler = HDInsightHiveActivity{}

func (s HDInsightHiveActivity) MarshalJSON() ([]byte, error) {
	type wrapper HDInsightHiveActivity
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling HDInsightHiveActivity: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling HDInsightHiveActivity: %+v", err)
	}

	decoded["type"] = "HDInsightHive"

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling HDInsightHiveActivity: %+v", err)
	}
