...
var _ Activity = HDInsightPigActivity{}
...
func (s HDInsightPigActivity) Activity() BaseActivityImpl {
...
var _ json.Marshaler = HDInsightPigActivity{}

func (s HDInsightPigActivity) MarshalJSON() ([]byte, error) {
	type wrapper HDInsightPigActivity
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling HDInsightPigActivity: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling HDInsightPigActivity: %+v", err)
	}

	decoded["type"] = "HDInsightPig"

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling HDInsightPigActivity: %+v", err)
	}
