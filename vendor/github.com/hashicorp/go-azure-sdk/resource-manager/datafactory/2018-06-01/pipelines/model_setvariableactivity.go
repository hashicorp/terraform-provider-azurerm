...
var _ Activity = SetVariableActivity{}
...
func (s SetVariableActivity) Activity() BaseActivityImpl {
...
var _ json.Marshaler = SetVariableActivity{}

func (s SetVariableActivity) MarshalJSON() ([]byte, error) {
	type wrapper SetVariableActivity
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling SetVariableActivity: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling SetVariableActivity: %+v", err)
	}

	decoded["type"] = "SetVariable"

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling SetVariableActivity: %+v", err)
	}
