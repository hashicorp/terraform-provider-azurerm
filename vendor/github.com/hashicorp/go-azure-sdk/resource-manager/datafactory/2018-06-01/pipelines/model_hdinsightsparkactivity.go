...
var _ Activity = HDInsightSparkActivity{}
...
func (s HDInsightSparkActivity) Activity() BaseActivityImpl {
...
var _ json.Marshaler = HDInsightSparkActivity{}

func (s HDInsightSparkActivity) MarshalJSON() ([]byte, error) {
	type wrapper HDInsightSparkActivity
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling HDInsightSparkActivity: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling HDInsightSparkActivity: %+v", err)
	}

	decoded["type"] = "HDInsightSpark"

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling HDInsightSparkActivity: %+v", err)
	}
