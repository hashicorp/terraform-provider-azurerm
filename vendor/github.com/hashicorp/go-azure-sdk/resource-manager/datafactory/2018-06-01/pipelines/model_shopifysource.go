...
var _ CopySource = ShopifySource{}
...
func (s ShopifySource) MarshalJSON() ([]byte, error) {
	type wrapper ShopifySource
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling ShopifySource: %+v", err)
	}
	...
	if err != nil {
		return nil, fmt.Errorf("re-marshaling ShopifySource: %+v", err)
	}
