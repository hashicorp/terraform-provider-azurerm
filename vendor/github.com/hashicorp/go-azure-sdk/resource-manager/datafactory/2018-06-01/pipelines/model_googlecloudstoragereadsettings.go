...
func (s GoogleCloudStorageReadSettings) StoreReadSettings() BaseStoreReadSettingsImpl {
...
var _ json.Marshaler = GoogleCloudStorageReadSettings{}

func (s GoogleCloudStorageReadSettings) MarshalJSON() ([]byte, error) {
	type wrapper GoogleCloudStorageReadSettings
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling GoogleCloudStorageReadSettings: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling GoogleCloudStorageReadSettings: %+v", err)
	}

	decoded["type"] = "GoogleCloudStorageReadSettings"

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling GoogleCloudStorageReadSettings: %+v", err)
	}
