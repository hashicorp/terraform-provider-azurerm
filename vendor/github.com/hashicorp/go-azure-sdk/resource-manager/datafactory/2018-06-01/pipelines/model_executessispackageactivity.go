...
var _ Activity = ExecuteSSISPackageActivity{}
...
func (s ExecuteSSISPackageActivity) Activity() BaseActivityImpl {
...
var _ json.Marshaler = ExecuteSSISPackageActivity{}

func (s ExecuteSSISPackageActivity) MarshalJSON() ([]byte, error) {
	type wrapper ExecuteSSISPackageActivity
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling ExecuteSSISPackageActivity: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling ExecuteSSISPackageActivity: %+v", err)
	}

	decoded["type"] = "ExecuteSSISPackage"

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling ExecuteSSISPackageActivity: %+v", err)
	}
