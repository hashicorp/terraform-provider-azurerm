...
var _ Activity = DatabricksSparkPythonActivity{}
...
func (s DatabricksSparkPythonActivity) Activity() BaseActivityImpl {
...
var _ json.Marshaler = DatabricksSparkPythonActivity{}

func (s DatabricksSparkPythonActivity) MarshalJSON() ([]byte, error) {
	type wrapper DatabricksSparkPythonActivity
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling DatabricksSparkPythonActivity: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling DatabricksSparkPythonActivity: %+v", err)
	}

	decoded["type"] = "DatabricksSparkPython"

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling DatabricksSparkPythonActivity: %+v", err)
	}
