...
var _ Activity = SynapseSparkJobDefinitionActivity{}
...
func (s SynapseSparkJobDefinitionActivity) Activity() BaseActivityImpl {
...
var _ json.Marshaler = SynapseSparkJobDefinitionActivity{}

func (s SynapseSparkJobDefinitionActivity) MarshalJSON() ([]byte, error) {
	type wrapper SynapseSparkJobDefinitionActivity
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling SynapseSparkJobDefinitionActivity: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling SynapseSparkJobDefinitionActivity: %+v", err)
	}

	decoded["type"] = "SparkJob"

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling SynapseSparkJobDefinitionActivity: %+v", err)
	}
