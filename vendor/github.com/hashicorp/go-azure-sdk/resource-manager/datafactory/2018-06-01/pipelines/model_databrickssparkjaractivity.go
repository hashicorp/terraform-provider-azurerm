...
var _ Activity = DatabricksSparkJarActivity{}
...
func (s DatabricksSparkJarActivity) Activity() BaseActivityImpl {
...
var _ json.Marshaler = DatabricksSparkJarActivity{}

func (s DatabricksSparkJarActivity) MarshalJSON() ([]byte, error) {
	type wrapper DatabricksSparkJarActivity
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling DatabricksSparkJarActivity: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling DatabricksSparkJarActivity: %+v", err)
	}

	decoded["type"] = "DatabricksSparkJar"

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling DatabricksSparkJarActivity: %+v", err)
	}
