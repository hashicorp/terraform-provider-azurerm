...
var _ Activity = AzureMLBatchExecutionActivity{}
...
func (s AzureMLBatchExecutionActivity) Activity() BaseActivityImpl {
...
var _ json.Marshaler = AzureMLBatchExecutionActivity{}

func (s AzureMLBatchExecutionActivity) MarshalJSON() ([]byte, error) {
	type wrapper AzureMLBatchExecutionActivity
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling AzureMLBatchExecutionActivity: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling AzureMLBatchExecutionActivity: %+v", err)
	}

	decoded["type"] = "AzureMLBatchExecution"

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling AzureMLBatchExecutionActivity: %+v", err)
	}
