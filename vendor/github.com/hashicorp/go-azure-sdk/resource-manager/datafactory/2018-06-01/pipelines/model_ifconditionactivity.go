...
var _ Activity = IfConditionActivity{}
...
func (s IfConditionActivity) Activity() BaseActivityImpl {
...
var _ json.Marshaler = IfConditionActivity{}

func (s IfConditionActivity) MarshalJSON() ([]byte, error) {
	type wrapper IfConditionActivity
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling IfConditionActivity: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling IfConditionActivity: %+v", err)
	}

	decoded["type"] = "IfCondition"

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling IfConditionActivity: %+v", err)
	}
