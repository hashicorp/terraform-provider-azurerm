...
var _ Activity = AppendVariableActivity{}
...
func (s AppendVariableActivity) Activity() BaseActivityImpl {
...
var _ json.Marshaler = AppendVariableActivity{}

func (s AppendVariableActivity) MarshalJSON() ([]byte, error) {
	type wrapper AppendVariableActivity
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling AppendVariableActivity: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling AppendVariableActivity: %+v", err)
	}

	decoded["type"] = "AppendVariable"

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling AppendVariableActivity: %+v", err)
	}
