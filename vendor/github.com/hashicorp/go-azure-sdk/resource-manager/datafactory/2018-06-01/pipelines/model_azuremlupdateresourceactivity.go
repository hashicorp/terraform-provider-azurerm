...
var _ Activity = AzureMLUpdateResourceActivity{}
...
func (s AzureMLUpdateResourceActivity) Activity() BaseActivityImpl {
...
var _ json.Marshaler = AzureMLUpdateResourceActivity{}

func (s AzureMLUpdateResourceActivity) MarshalJSON() ([]byte, error) {
	type wrapper AzureMLUpdateResourceActivity
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling AzureMLUpdateResourceActivity: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling AzureMLUpdateResourceActivity: %+v", err)
	}

	decoded["type"] = "AzureMLUpdateResource"

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling AzureMLUpdateResourceActivity: %+v", err)
	}
