...
var _ Activity = DataLakeAnalyticsUSQLActivity{}
...
func (s DataLakeAnalyticsUSQLActivity) Activity() BaseActivityImpl {
...
var _ json.Marshaler = DataLakeAnalyticsUSQLActivity{}

func (s DataLakeAnalyticsUSQLActivity) MarshalJSON() ([]byte, error) {
	type wrapper DataLakeAnalyticsUSQLActivity
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling DataLakeAnalyticsUSQLActivity: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling DataLakeAnalyticsUSQLActivity: %+v", err)
	}

	decoded["type"] = "DataLakeAnalyticsU-SQL"

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling DataLakeAnalyticsUSQLActivity: %+v", err)
	}
