...
var _ CopySink = SalesforceServiceCloudSink{}
...
func (s SalesforceServiceCloudSink) CopySink() BaseCopySinkImpl {
...
var _ json.Marshaler = SalesforceServiceCloudSink{}

func (s SalesforceServiceCloudSink) MarshalJSON() ([]byte, error) {
	type wrapper SalesforceServiceCloudSink
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling SalesforceServiceCloudSink: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling SalesforceServiceCloudSink: %+v", err)
	}

	decoded["type"] = "SalesforceServiceCloudSink"

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling SalesforceServiceCloudSink: %+v", err)
	}
