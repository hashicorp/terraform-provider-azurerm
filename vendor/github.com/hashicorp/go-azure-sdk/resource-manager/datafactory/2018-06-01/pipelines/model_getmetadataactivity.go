...
var _ Activity = GetMetadataActivity{}
...
func (s GetMetadataActivity) Activity() BaseActivityImpl {
...
var _ json.Marshaler = GetMetadataActivity{}

func (s GetMetadataActivity) MarshalJSON() ([]byte, error) {
	type wrapper GetMetadataActivity
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling GetMetadataActivity: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling GetMetadataActivity: %+v", err)
	}

	decoded["type"] = "GetMetadata"

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling GetMetadataActivity: %+v", err)
	}
