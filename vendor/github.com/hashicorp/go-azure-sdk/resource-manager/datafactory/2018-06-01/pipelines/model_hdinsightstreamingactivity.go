...
var _ Activity = HDInsightStreamingActivity{}
...
func (s HDInsightStreamingActivity) Activity() BaseActivityImpl {
...
var _ json.Marshaler = HDInsightStreamingActivity{}

func (s HDInsightStreamingActivity) MarshalJSON() ([]byte, error) {
	type wrapper HDInsightStreamingActivity
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling HDInsightStreamingActivity: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling HDInsightStreamingActivity: %+v", err)
	}

	decoded["type"] = "HDInsightStreaming"

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling HDInsightStreamingActivity: %+v", err)
	}
