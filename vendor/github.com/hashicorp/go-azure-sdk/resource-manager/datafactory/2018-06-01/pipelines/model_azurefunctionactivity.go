...
var _ Activity = AzureFunctionActivity{}
...
func (s AzureFunctionActivity) Activity() BaseActivityImpl {
...
var _ json.Marshaler = AzureFunctionActivity{}

func (s AzureFunctionActivity) MarshalJSON() ([]byte, error) {
	type wrapper AzureFunctionActivity
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling AzureFunctionActivity: %+v", err)
	}

	var decoded map[string]interface{}
	if err = json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling AzureFunctionActivity: %+v", err)
	}

	decoded["type"] = "AzureFunctionActivity"

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling AzureFunctionActivity: %+v", err)
	}
