...
type IntegrationRuntimeEnableInteractiveQueryOperationResponse struct {
...
func (c IntegrationRuntimeEnableInteractiveQueryClient) IntegrationRuntimeEnableInteractiveQuery(ctx context.Context, id IntegrationRuntimeId, input EnableInteractiveQueryRequest) (result IntegrationRuntimeEnableInteractiveQueryOperationResponse, err error) {
...
func (c IntegrationRuntimeEnableInteractiveQueryClient) IntegrationRuntimeEnableInteractiveQueryThenPoll(ctx context.Context, id IntegrationRuntimeId, input EnableInteractiveQueryRequest) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after IntegrationRuntimeEnableInteractiveQuery: %+v", err)
	}
