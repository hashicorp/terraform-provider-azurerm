...
var _ Dataset = SapBwCubeDataset{}
...
func (s SapBwCubeDataset) MarshalJSON() ([]byte, error) {
	type wrapper SapBwCubeDataset
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling SapBwCubeDataset: %+v", err)
	}
	...
	if err != nil {
		return nil, fmt.Errorf("re-marshaling SapBwCubeDataset: %+v", err)
	}
