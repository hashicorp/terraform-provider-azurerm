...
func (c SubscriptionQuotaAllocationClient) GroupQuotaSubscriptionAllocationRequestUpdateCallbackThenPoll(ctx context.Context, id QuotaAllocationId, input SubscriptionQuotaAllocationsList, callback func() error) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after GroupQuotaSubscriptionAllocationRequestUpdate: %+v", err)
	}
