...
func (c SecurityPoliciesClient) PatchCallbackThenPoll(ctx context.Context, id SecurityPolicyId, input SecurityPolicyUpdateParameters, callback func() error) error {
