...
## `github.com/hashicorp/go-azure-sdk/resource-manager/cdn/2025-12-01/afdendpoints` Documentation

The `afdendpoints` SDK allows for interaction with Azure Resource Manager `cdn` (API Version `2025-12-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/cdn/2025-12-01/afdendpoints"
```
