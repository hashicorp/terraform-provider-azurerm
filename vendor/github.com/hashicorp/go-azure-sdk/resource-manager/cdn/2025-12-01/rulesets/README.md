...
## `github.com/hashicorp/go-azure-sdk/resource-manager/cdn/2025-12-01/rulesets` Documentation

The `rulesets` SDK allows for interaction with Azure Resource Manager `cdn` (API Version `2025-12-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/cdn/2025-12-01/rulesets"
```
