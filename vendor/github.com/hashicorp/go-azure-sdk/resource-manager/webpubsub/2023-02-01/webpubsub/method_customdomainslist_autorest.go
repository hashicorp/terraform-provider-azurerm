...
// CustomDomainsList ...
func (c WebPubSubClient) CustomDomainsList(ctx context.Context, id WebPubSubId) (resp CustomDomainsListOperationResponse, err error) {
	req, err := c.preparerForCustomDomainsList(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "webpubsub.WebPubSubClient", "CustomDomainsList", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "webpubsub.WebPubSubClient", "CustomDomainsList", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForCustomDomainsList(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "webpubsub.WebPubSubClient", "CustomDomainsList", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c WebPubSubClient) preparerForCustomDomainsList(ctx context.Context, id WebPubSubId) (*http.Request, error) {
...
func (c WebPubSubClient) preparerForCustomDomainsListWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c WebPubSubClient) responderForCustomDomainsList(resp *http.Response) (result CustomDomainsListOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result CustomDomainsListOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "webpubsub.WebPubSubClient", "CustomDomainsList", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForCustomDomainsList(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "webpubsub.WebPubSubClient", "CustomDomainsList", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c WebPubSubClient) CustomDomainsListCompleteMatchingPredicate(ctx context.Context, id WebPubSubId, predicate CustomDomainOperationPredicate) (resp CustomDomainsListCompleteResult, err error) {
