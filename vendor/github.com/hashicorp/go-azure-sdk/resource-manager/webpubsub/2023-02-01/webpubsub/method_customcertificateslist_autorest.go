...
func (c WebPubSubClient) CustomCertificatesList(ctx context.Context, id WebPubSubId) (resp CustomCertificatesListOperationResponse, err error) {
	req, err := c.preparerForCustomCertificatesList(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "webpubsub.WebPubSubClient", "CustomCertificatesList", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "webpubsub.WebPubSubClient", "CustomCertificatesList", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForCustomCertificatesList(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "webpubsub.WebPubSubClient", "CustomCertificatesList", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c WebPubSubClient) preparerForCustomCertificatesList(ctx context.Context, id WebPubSubId) (*http.Request, error) {
...
func (c WebPubSubClient) preparerForCustomCertificatesListWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c WebPubSubClient) responderForCustomCertificatesList(resp *http.Response) (result CustomCertificatesListOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result CustomCertificatesListOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "webpubsub.WebPubSubClient", "CustomCertificatesList", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForCustomCertificatesList(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "webpubsub.WebPubSubClient", "CustomCertificatesList", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c WebPubSubClient) CustomCertificatesListCompleteMatchingPredicate(ctx context.Context, id WebPubSubId, predicate CustomCertificateOperationPredicate) (resp CustomCertificatesListCompleteResult, err error) {
