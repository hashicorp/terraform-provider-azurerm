...
func (c WebPubSubClient) PrivateLinkResourcesList(ctx context.Context, id WebPubSubId) (resp PrivateLinkResourcesListOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "webpubsub.WebPubSubClient", "PrivateLinkResourcesList", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "webpubsub.WebPubSubClient", "PrivateLinkResourcesList", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForPrivateLinkResourcesList(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "webpubsub.WebPubSubClient", "PrivateLinkResourcesList", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c WebPubSubClient) preparerForPrivateLinkResourcesList(ctx context.Context, id WebPubSubId) (*http.Request, error) {
...
func (c WebPubSubClient) preparerForPrivateLinkResourcesListWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c WebPubSubClient) responderForPrivateLinkResourcesList(resp *http.Response) (result PrivateLinkResourcesListOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result PrivateLinkResourcesListOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "webpubsub.WebPubSubClient", "PrivateLinkResourcesList", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForPrivateLinkResourcesList(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "webpubsub.WebPubSubClient", "PrivateLinkResourcesList", result.HttpResponse, "Failure responding to request")
				return
			}
