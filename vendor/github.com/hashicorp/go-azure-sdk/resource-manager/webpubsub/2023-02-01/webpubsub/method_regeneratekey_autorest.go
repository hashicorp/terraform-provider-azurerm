...
func (c WebPubSubClient) RegenerateKey(ctx context.Context, id WebPubSubId, input RegenerateKeyParameters) (result RegenerateKeyOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "webpubsub.WebPubSubClient", "RegenerateKey", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForRegenerateKey(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "webpubsub.WebPubSubClient", "RegenerateKey", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c WebPubSubClient) preparerForRegenerateKey(ctx context.Context, id WebPubSubId, input RegenerateKeyParameters) (*http.Request, error) {
...
func (c WebPubSubClient) senderForRegenerateKey(ctx context.Context, req *http.Request) (future RegenerateKeyOperationResponse, err error) {
