...
func (c WebPubSubClient) PrivateEndpointConnectionsDelete(ctx context.Context, id PrivateEndpointConnectionId) (result PrivateEndpointConnectionsDeleteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "webpubsub.WebPubSubClient", "PrivateEndpointConnectionsDelete", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForPrivateEndpointConnectionsDelete(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "webpubsub.WebPubSubClient", "PrivateEndpointConnectionsDelete", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c WebPubSubClient) preparerForPrivateEndpointConnectionsDelete(ctx context.Context, id PrivateEndpointConnectionId) (*http.Request, error) {
...
func (c WebPubSubClient) senderForPrivateEndpointConnectionsDelete(ctx context.Context, req *http.Request) (future PrivateEndpointConnectionsDeleteOperationResponse, err error) {
