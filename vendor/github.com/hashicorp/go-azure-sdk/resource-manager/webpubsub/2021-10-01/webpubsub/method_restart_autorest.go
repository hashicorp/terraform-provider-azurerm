...
func (c WebPubSubClient) Restart(ctx context.Context, id WebPubSubId) (result RestartOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "webpubsub.WebPubSubClient", "Restart", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForRestart(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "webpubsub.WebPubSubClient", "Restart", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c WebPubSubClient) preparerForRestart(ctx context.Context, id WebPubSubId) (*http.Request, error) {
...
func (c WebPubSubClient) senderForRestart(ctx context.Context, req *http.Request) (future RestartOperationResponse, err error) {
