...
func (c WebPubSubClient) SharedPrivateLinkResourcesDelete(ctx context.Context, id SharedPrivateLinkResourceId) (result SharedPrivateLinkResourcesDeleteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "webpubsub.WebPubSubClient", "SharedPrivateLinkResourcesDelete", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForSharedPrivateLinkResourcesDelete(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "webpubsub.WebPubSubClient", "SharedPrivateLinkResourcesDelete", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c WebPubSubClient) preparerForSharedPrivateLinkResourcesDelete(ctx context.Context, id SharedPrivateLinkResourceId) (*http.Request, error) {
...
func (c WebPubSubClient) senderForSharedPrivateLinkResourcesDelete(ctx context.Context, req *http.Request) (future SharedPrivateLinkResourcesDeleteOperationResponse, err error) {
