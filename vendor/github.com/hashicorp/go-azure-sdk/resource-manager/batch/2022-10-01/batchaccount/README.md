...
## `github.com/hashicorp/go-azure-sdk/resource-manager/batch/2022-10-01/batchaccount` Documentation

The `batchaccount` SDK allows for interaction with the Azure Resource Manager Service `batch` (API Version `2022-10-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/batch/2022-10-01/batchaccount"
```
