...
func (c BatchAccountClient) Create(ctx context.Context, id BatchAccountId, input BatchAccountCreateParameters) (result CreateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "batchaccount.BatchAccountClient", "Create", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForCreate(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "batchaccount.BatchAccountClient", "Create", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c BatchAccountClient) preparerForCreate(ctx context.Context, id BatchAccountId, input BatchAccountCreateParameters) (*http.Request, error) {
...
func (c BatchAccountClient) senderForCreate(ctx context.Context, req *http.Request) (future CreateOperationResponse, err error) {
