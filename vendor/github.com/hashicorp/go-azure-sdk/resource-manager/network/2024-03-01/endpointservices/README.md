...
## `github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/endpointservices` Documentation

The `endpointservices` SDK allows for interaction with Azure Resource Manager `network` (API Version `2024-03-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/endpointservices"
```
