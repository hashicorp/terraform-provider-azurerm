...
## `github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/virtualnetworkgateways` Documentation

The `virtualnetworkgateways` SDK allows for interaction with Azure Resource Manager `network` (API Version `2024-03-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/virtualnetworkgateways"
```
