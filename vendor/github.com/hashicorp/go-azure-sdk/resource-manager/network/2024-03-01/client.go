...
import (
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/applicationgatewayprivateendpointconnections"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/applicationgatewayprivatelinkresources"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/applicationgateways"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/applicationgatewaywafdynamicmanifests"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/applicationsecuritygroups"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/availabledelegations"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/availableservicealiases"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/azurefirewalls"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/bastionhosts"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/bastionshareablelink"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/bgpservicecommunities"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/checkdnsavailabilities"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/cloudservicepublicipaddresses"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/ddoscustompolicies"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/ddosprotectionplans"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/dscpconfiguration"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/dscpconfigurations"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/endpointservices"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/expressroutecircuitarptable"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/expressroutecircuitauthorizations"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/expressroutecircuitconnections"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/expressroutecircuitpeerings"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/expressroutecircuitroutestable"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/expressroutecircuitroutestablesummary"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/expressroutecircuits"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/expressroutecircuitstats"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/expressrouteconnections"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/expressroutecrossconnectionarptable"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/expressroutecrossconnectionpeerings"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/expressroutecrossconnectionroutetable"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/expressroutecrossconnectionroutetablesummary"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/expressroutecrossconnections"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/expressroutegateways"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/expressroutelinks"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/expressrouteportauthorizations"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/expressrouteports"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/expressrouteportslocations"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/expressrouteproviderports"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/expressrouteserviceproviders"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/ipallocations"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/ipgroups"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/loadbalancers"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/networkgroups"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/networkinterfaces"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/networkmanageractiveconfigurations"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/networkmanageractiveconnectivityconfigurations"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/networkmanagerconnections"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/networkmanagereffectiveconnectivityconfiguration"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/networkmanagereffectivesecurityadminrules"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/networkvirtualappliances"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/networkwatchers"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/p2svpngateways"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/packetcaptures"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/peerexpressroutecircuitconnections"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/privatelinkservices"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/routefilterrules"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/routefilters"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/routes"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/routetables"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/routingrulecollections"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/routingrules"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/scopeconnections"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/securityadminconfigurations"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/securitypartnerproviders"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/securityrules"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/securityuserconfigurations"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/securityuserrulecollections"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/securityuserrules"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/serviceendpointpolicies"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/serviceendpointpolicydefinitions"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/servicetags"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/staticmembers"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/subnets"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/trafficanalytics"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/usages"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/vipswap"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/virtualappliancesites"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/virtualapplianceskus"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/virtualnetworktap"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/virtualnetworktaps"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/virtualrouterpeerings"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/virtualrouters"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/virtualwans"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/vmsspublicipaddresses"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/vpngateways"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/vpnlinkconnections"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/vpnserverconfigurations"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/vpnsites"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/webapplicationfirewallpolicies"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-03-01/webcategories"
