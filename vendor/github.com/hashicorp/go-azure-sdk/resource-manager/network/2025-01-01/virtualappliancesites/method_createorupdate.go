...
func (c VirtualApplianceSitesClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id VirtualApplianceSiteId, input VirtualApplianceSite, callback func() error) error {
