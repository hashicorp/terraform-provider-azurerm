...
func (c VirtualNetworkGatewaysClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id VirtualNetworkGatewayId, input VirtualNetworkGateway, callback func() error) error {
