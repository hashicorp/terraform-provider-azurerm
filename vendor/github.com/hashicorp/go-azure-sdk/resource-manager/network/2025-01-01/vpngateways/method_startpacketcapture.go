...
func (c VpnGatewaysClient) StartPacketCaptureCallbackThenPoll(ctx context.Context, id VpnGatewayId, input VpnGatewayPacketCaptureStartParameters, callback func() error) error {
