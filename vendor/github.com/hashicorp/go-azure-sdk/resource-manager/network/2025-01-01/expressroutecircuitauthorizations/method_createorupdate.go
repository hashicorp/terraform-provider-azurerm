...
func (c ExpressRouteCircuitAuthorizationsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id AuthorizationId, input ExpressRouteCircuitAuthorization, callback func() error) error {
