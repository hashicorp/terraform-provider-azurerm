...
## `github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-01-01/vipswap` Documentation

The `vipswap` SDK allows for interaction with Azure Resource Manager `network` (API Version `2025-01-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-01-01/vipswap"
```
