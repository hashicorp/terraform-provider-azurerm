...
func (c ExpressRoutePortsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id ExpressRoutePortId, input ExpressRoutePort, callback func() error) error {
