...
func (c ExpressRouteCircuitConnectionsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id PeeringConnectionId, input ExpressRouteCircuitConnection, callback func() error) error {
