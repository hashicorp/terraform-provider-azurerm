...
// ListRadiusSecrets ...
func (c VpnServerConfigurationsClient) ListRadiusSecrets(ctx context.Context, id VpnServerConfigurationId) (result ListRadiusSecretsOperationResponse, err error) {
...
func (c VpnServerConfigurationsClient) ListRadiusSecretsComplete(ctx context.Context, id VpnServerConfigurationId) (ListRadiusSecretsCompleteResult, error) {
...
func (c VpnServerConfigurationsClient) ListRadiusSecretsCompleteMatchingPredicate(ctx context.Context, id VpnServerConfigurationId, predicate RadiusAuthServerOperationPredicate) (result ListRadiusSecretsCompleteResult, err error) {
