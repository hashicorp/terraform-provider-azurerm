...
func PossibleValuesForAdvertisedPublicPrefixPropertiesValidationState() []string {
	return []string{
		string(AdvertisedPublicPrefixPropertiesValidationStateAsnValidationFailed),
		string(AdvertisedPublicPrefixPropertiesValidationStateCertificateMissingInRoutingRegistry),
		string(AdvertisedPublicPrefixPropertiesValidationStateConfigured),
		string(AdvertisedPublicPrefixPropertiesValidationStateConfiguring),
		string(AdvertisedPublicPrefixPropertiesValidationStateInvalidSignatureEncoding),
		string(AdvertisedPublicPrefixPropertiesValidationStateManualValidationNeeded),
		string(AdvertisedPublicPrefixPropertiesValidationStateNotConfigured),
		string(AdvertisedPublicPrefixPropertiesValidationStateSignatureVerificationFailed),
		string(AdvertisedPublicPrefixPropertiesValidationStateValidationFailed),
		string(AdvertisedPublicPrefixPropertiesValidationStateValidationNeeded),
	}
}

func (s *AdvertisedPublicPrefixPropertiesValidationState) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseAdvertisedPublicPrefixPropertiesValidationState(decoded)
	if err != nil {
...
func parseAdvertisedPublicPrefixPropertiesValidationState(input string) (*AdvertisedPublicPrefixPropertiesValidationState, error) {
	vals := map[string]AdvertisedPublicPrefixPropertiesValidationState{
		"asnvalidationfailed":                 AdvertisedPublicPrefixPropertiesValidationStateAsnValidationFailed,
		"certificatemissinginroutingregistry": AdvertisedPublicPrefixPropertiesValidationStateCertificateMissingInRoutingRegistry,
		"configured":                          AdvertisedPublicPrefixPropertiesValidationStateConfigured,
		"configuring":                         AdvertisedPublicPrefixPropertiesValidationStateConfiguring,
		"invalidsignatureencoding":            AdvertisedPublicPrefixPropertiesValidationStateInvalidSignatureEncoding,
		...
		"signatureverificationfailed":         AdvertisedPublicPrefixPropertiesValidationStateSignatureVerificationFailed,
	...
	out := AdvertisedPublicPrefixPropertiesValidationState(input)
	return &out, nil
}
