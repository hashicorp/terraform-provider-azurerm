...
func (c ExpressRoutePortAuthorizationsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id ExpressRoutePortAuthorizationId, input ExpressRoutePortAuthorization, callback func() error) error {
