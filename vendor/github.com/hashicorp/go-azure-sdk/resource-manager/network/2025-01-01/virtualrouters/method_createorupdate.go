...
// CreateOrUpdate ...
func (c VirtualRoutersClient) CreateOrUpdate(ctx context.Context, id VirtualRouterId, input VirtualRouter) (result CreateOrUpdateOperationResponse, err error) {
...
func (c VirtualRoutersClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id VirtualRouterId, input VirtualRouter, callback func() error) error {
