...
func PossibleValuesForAzureFirewallPacketCaptureOperationType() []string {
	return []string{
		string(AzureFirewallPacketCaptureOperationTypeStart),
		string(AzureFirewallPacketCaptureOperationTypeStatus),
		string(AzureFirewallPacketCaptureOperationTypeStop),
	}
}

func (s *AzureFirewallPacketCaptureOperationType) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseAzureFirewallPacketCaptureOperationType(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseAzureFirewallPacketCaptureOperationType(input string) (*AzureFirewallPacketCaptureOperationType, error) {
	vals := map[string]AzureFirewallPacketCaptureOperationType{
		"start":  AzureFirewallPacketCaptureOperationTypeStart,
		"status": AzureFirewallPacketCaptureOperationTypeStatus,
		"stop":   AzureFirewallPacketCaptureOperationTypeStop,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := AzureFirewallPacketCaptureOperationType(input)
	return &out, nil
}
...
func PossibleValuesForAzureFirewallPacketCaptureResponseCode() []string {
	return []string{
		string(AzureFirewallPacketCaptureResponseCodeAzureFirewallPacketCaptureCompleted),
		string(AzureFirewallPacketCaptureResponseCodeAzureFirewallPacketCaptureFailed),
		string(AzureFirewallPacketCaptureResponseCodeAzureFirewallPacketCaptureInProgress),
		string(AzureFirewallPacketCaptureResponseCodeAzureFirewallPacketCaptureNotInProgress),
		string(AzureFirewallPacketCaptureResponseCodeAzureFirewallPacketCaptureStartFailed),
		string(AzureFirewallPacketCaptureResponseCodeAzureFirewallPacketCaptureStartFailedToUpload),
		string(AzureFirewallPacketCaptureResponseCodeAzureFirewallPacketCaptureStartFailure),
		string(AzureFirewallPacketCaptureResponseCodeAzureFirewallPacketCaptureStartSucceeded),
		string(AzureFirewallPacketCaptureResponseCodeAzureFirewallPacketCaptureStopSucceeded),
		string(AzureFirewallPacketCaptureResponseCodeNotImplemented),
	}
}

func (s *AzureFirewallPacketCaptureResponseCode) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseAzureFirewallPacketCaptureResponseCode(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseAzureFirewallPacketCaptureResponseCode(input string) (*AzureFirewallPacketCaptureResponseCode, error) {
	vals := map[string]AzureFirewallPacketCaptureResponseCode{
		"azurefirewallpacketcapturecompleted":           AzureFirewallPacketCaptureResponseCodeAzureFirewallPacketCaptureCompleted,
		"azurefirewallpacketcapturefailed":              AzureFirewallPacketCaptureResponseCodeAzureFirewallPacketCaptureFailed,
		"azurefirewallpacketcaptureinprogress":          AzureFirewallPacketCaptureResponseCodeAzureFirewallPacketCaptureInProgress,
		"azurefirewallpacketcapturenotinprogress":       AzureFirewallPacketCaptureResponseCodeAzureFirewallPacketCaptureNotInProgress,
		"azurefirewallpacketcapturestartfailed":         AzureFirewallPacketCaptureResponseCodeAzureFirewallPacketCaptureStartFailed,
		...
		"azurefirewallpacketcapturestartsucceeded":      AzureFirewallPacketCaptureResponseCodeAzureFirewallPacketCaptureStartSucceeded,
		"azurefirewallpacketcapturestopsucceeded":       AzureFirewallPacketCaptureResponseCodeAzureFirewallPacketCaptureStopSucceeded,
		"notimplemented":                                AzureFirewallPacketCaptureResponseCodeNotImplemented,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := AzureFirewallPacketCaptureResponseCode(input)
	return &out, nil
}
