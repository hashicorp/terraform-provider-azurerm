...
func (c VirtualRouterPeeringsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id commonids.VirtualRouterPeeringId, input VirtualRouterPeering, callback func() error) error {
