...
func (c ExpressRouteConnectionsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id ExpressRouteConnectionId, input ExpressRouteConnection, callback func() error) error {
