...
func (c ExpressRouteCrossConnectionPeeringsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id PeeringId, input ExpressRouteCrossConnectionPeering, callback func() error) error {
