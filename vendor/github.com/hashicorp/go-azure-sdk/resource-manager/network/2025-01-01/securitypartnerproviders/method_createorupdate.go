...
func (c SecurityPartnerProvidersClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id SecurityPartnerProviderId, input SecurityPartnerProvider, callback func() error) error {
