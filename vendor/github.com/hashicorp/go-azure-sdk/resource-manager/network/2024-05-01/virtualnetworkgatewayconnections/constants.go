...
func PossibleValuesForResiliencyModel() []string {
	return []string{
		string(ResiliencyModelMultiHomed),
		string(ResiliencyModelSingleHomed),
	}
}

func (s *ResiliencyModel) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseResiliencyModel(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseResiliencyModel(input string) (*ResiliencyModel, error) {
	vals := map[string]ResiliencyModel{
		"multihomed":  ResiliencyModelMultiHomed,
		"singlehomed": ResiliencyModelSingleHomed,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
...
func PossibleValuesForVirtualNetworkGatewaySkuName() []string {
	return []string{
		...
		string(VirtualNetworkGatewaySkuNameErGwScale),
...
func parseVirtualNetworkGatewaySkuName(input string) (*VirtualNetworkGatewaySkuName, error) {
	vals := map[string]VirtualNetworkGatewaySkuName{
		...
		"ergwscale":        VirtualNetworkGatewaySkuNameErGwScale,
...
func PossibleValuesForVirtualNetworkGatewaySkuTier() []string {
	return []string{
		...
		string(VirtualNetworkGatewaySkuTierErGwScale),
...
func parseVirtualNetworkGatewaySkuTier(input string) (*VirtualNetworkGatewaySkuTier, error) {
	vals := map[string]VirtualNetworkGatewaySkuTier{
		...
		"ergwscale":        VirtualNetworkGatewaySkuTierErGwScale,
