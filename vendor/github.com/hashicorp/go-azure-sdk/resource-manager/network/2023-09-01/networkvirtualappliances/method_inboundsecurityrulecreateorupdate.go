...
func (c NetworkVirtualAppliancesClient) InboundSecurityRuleCreateOrUpdateCallbackThenPoll(ctx context.Context, id InboundSecurityRuleId, input InboundSecurityRule, callback func() error) error {
