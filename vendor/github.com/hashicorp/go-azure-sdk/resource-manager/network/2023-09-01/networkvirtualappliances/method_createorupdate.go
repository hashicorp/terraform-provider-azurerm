...
func (c NetworkVirtualAppliancesClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id NetworkVirtualApplianceId, input NetworkVirtualAppliance, callback func() error) error {
