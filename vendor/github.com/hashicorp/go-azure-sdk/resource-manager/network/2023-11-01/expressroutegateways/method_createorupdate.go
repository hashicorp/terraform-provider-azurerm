...
func (c ExpressRouteGatewaysClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id ExpressRouteGatewayId, input ExpressRouteGateway, callback func() error) error {
