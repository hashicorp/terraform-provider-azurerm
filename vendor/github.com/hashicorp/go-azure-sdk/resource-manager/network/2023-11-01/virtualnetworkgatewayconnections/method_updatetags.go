...
func (c VirtualNetworkGatewayConnectionsClient) UpdateTagsCallbackThenPoll(ctx context.Context, id ConnectionId, input TagsObject, callback func() error) error {
