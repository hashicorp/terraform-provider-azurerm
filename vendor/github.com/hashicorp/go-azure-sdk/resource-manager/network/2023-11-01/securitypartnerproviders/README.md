...
The `securitypartnerproviders` SDK allows for interaction with Azure Resource Manager `network` (API Version `2023-11-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/network/2023-11-01/securitypartnerproviders"
```
