...
func (c ApplicationGatewaysClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id ApplicationGatewayId, input ApplicationGateway, callback func() error) error {
