...
func PossibleValuesForApplicationGatewayClientAuthVerificationModes() []string {
	return []string{
		string(ApplicationGatewayClientAuthVerificationModesPassthrough),
		string(ApplicationGatewayClientAuthVerificationModesStrict),
	}
}

func (s *ApplicationGatewayClientAuthVerificationModes) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseApplicationGatewayClientAuthVerificationModes(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseApplicationGatewayClientAuthVerificationModes(input string) (*ApplicationGatewayClientAuthVerificationModes, error) {
	vals := map[string]ApplicationGatewayClientAuthVerificationModes{
		"passthrough": ApplicationGatewayClientAuthVerificationModesPassthrough,
		"strict":      ApplicationGatewayClientAuthVerificationModesStrict,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := ApplicationGatewayClientAuthVerificationModes(input)
	return &out, nil
}
...
func PossibleValuesForApplicationGatewayFirewallUserSessionVariable() []string {
	return []string{
		...
		string(ApplicationGatewayFirewallUserSessionVariableGeoLocationXFFHeader),
...
func parseApplicationGatewayFirewallUserSessionVariable(input string) (*ApplicationGatewayFirewallUserSessionVariable, error) {
	vals := map[string]ApplicationGatewayFirewallUserSessionVariable{
		...
		"clientaddrxffheader":  ApplicationGatewayFirewallUserSessionVariableClientAddrXFFHeader,
...
func PossibleValuesForApplicationGatewayUnAuthorizedRequestAction() []string {
	return []string{
		string(ApplicationGatewayUnAuthorizedRequestActionAllow),
		string(ApplicationGatewayUnAuthorizedRequestActionDeny),
	}
}

func (s *ApplicationGatewayUnAuthorizedRequestAction) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseApplicationGatewayUnAuthorizedRequestAction(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseApplicationGatewayUnAuthorizedRequestAction(input string) (*ApplicationGatewayUnAuthorizedRequestAction, error) {
	vals := map[string]ApplicationGatewayUnAuthorizedRequestAction{
		"allow": ApplicationGatewayUnAuthorizedRequestActionAllow,
	...
	// otherwise presume it's an undefined value and best-effort it
	out := ApplicationGatewayUnAuthorizedRequestAction(input)
	return &out, nil
}
...
func PossibleValuesForExceptionEntryMatchVariable() []string {
	return []string{
		string(ExceptionEntryMatchVariableRemoteAddr),
		string(ExceptionEntryMatchVariableRequestHeader),
		string(ExceptionEntryMatchVariableRequestURI),
	}
}

func (s *ExceptionEntryMatchVariable) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseExceptionEntryMatchVariable(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseExceptionEntryMatchVariable(input string) (*ExceptionEntryMatchVariable, error) {
	vals := map[string]ExceptionEntryMatchVariable{
		"remoteaddr":    ExceptionEntryMatchVariableRemoteAddr,
		"requestheader": ExceptionEntryMatchVariableRequestHeader,
		"requesturi":    ExceptionEntryMatchVariableRequestURI,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := ExceptionEntryMatchVariable(input)
	return &out, nil
}
...
func PossibleValuesForExceptionEntrySelectorMatchOperator() []string {
	return []string{
		string(ExceptionEntrySelectorMatchOperatorContains),
		string(ExceptionEntrySelectorMatchOperatorEndsWith),
		string(ExceptionEntrySelectorMatchOperatorEquals),
		string(ExceptionEntrySelectorMatchOperatorStartsWith),
	}
}

func (s *ExceptionEntrySelectorMatchOperator) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseExceptionEntrySelectorMatchOperator(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseExceptionEntrySelectorMatchOperator(input string) (*ExceptionEntrySelectorMatchOperator, error) {
	vals := map[string]ExceptionEntrySelectorMatchOperator{
		"contains":   ExceptionEntrySelectorMatchOperatorContains,
		"endswith":   ExceptionEntrySelectorMatchOperatorEndsWith,
		"equals":     ExceptionEntrySelectorMatchOperatorEquals,
	...
	// otherwise presume it's an undefined value and best-effort it
	out := ExceptionEntrySelectorMatchOperator(input)
	return &out, nil
}
...
func PossibleValuesForExceptionEntryValueMatchOperator() []string {
	return []string{
		string(ExceptionEntryValueMatchOperatorContains),
		string(ExceptionEntryValueMatchOperatorEndsWith),
		string(ExceptionEntryValueMatchOperatorEquals),
		string(ExceptionEntryValueMatchOperatorIPMatch),
		string(ExceptionEntryValueMatchOperatorStartsWith),
	}
}

func (s *ExceptionEntryValueMatchOperator) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseExceptionEntryValueMatchOperator(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseExceptionEntryValueMatchOperator(input string) (*ExceptionEntryValueMatchOperator, error) {
	vals := map[string]ExceptionEntryValueMatchOperator{
		"contains":   ExceptionEntryValueMatchOperatorContains,
		"endswith":   ExceptionEntryValueMatchOperatorEndsWith,
		"equals":     ExceptionEntryValueMatchOperatorEquals,
		"ipmatch":    ExceptionEntryValueMatchOperatorIPMatch,
		"startswith": ExceptionEntryValueMatchOperatorStartsWith,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := ExceptionEntryValueMatchOperator(input)
	return &out, nil
}
...
func PossibleValuesForSensitivityType() []string {
	return []string{
		string(SensitivityTypeHigh),
		string(SensitivityTypeLow),
		string(SensitivityTypeMedium),
	}
}

func (s *SensitivityType) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseSensitivityType(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseSensitivityType(input string) (*SensitivityType, error) {
	vals := map[string]SensitivityType{
		"high":   SensitivityTypeHigh,
		"low":    SensitivityTypeLow,
		"medium": SensitivityTypeMedium,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
...
func PossibleValuesForWebApplicationFirewallAction() []string {
	return []string{
		...
		string(WebApplicationFirewallActionCAPTCHA),
...
func parseWebApplicationFirewallAction(input string) (*WebApplicationFirewallAction, error) {
	vals := map[string]WebApplicationFirewallAction{
		...
		"captcha":     WebApplicationFirewallActionCAPTCHA,
