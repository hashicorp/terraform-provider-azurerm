...
func (c PrivateDnsZoneGroupsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id PrivateDnsZoneGroupId, input PrivateDnsZoneGroup, callback func() error) error {
