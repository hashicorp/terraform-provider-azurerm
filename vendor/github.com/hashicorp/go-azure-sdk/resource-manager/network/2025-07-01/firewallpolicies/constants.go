...
type FirewallPolicyIDPSSignatureDirection float64
...
func PossibleValuesForFirewallPolicyIDPSSignatureDirection() []float64 {
	return []float64{
		float64(FirewallPolicyIDPSSignatureDirectionFive),
		float64(FirewallPolicyIDPSSignatureDirectionFour),
		float64(FirewallPolicyIDPSSignatureDirectionOne),
		float64(FirewallPolicyIDPSSignatureDirectionThree),
		float64(FirewallPolicyIDPSSignatureDirectionTwo),
		float64(FirewallPolicyIDPSSignatureDirectionZero),
	}
}

type FirewallPolicyIDPSSignatureMode float64
...
func PossibleValuesForFirewallPolicyIDPSSignatureMode() []float64 {
	return []float64{
		float64(FirewallPolicyIDPSSignatureModeOne),
		float64(FirewallPolicyIDPSSignatureModeTwo),
		float64(FirewallPolicyIDPSSignatureModeZero),
	}
}

type FirewallPolicyIDPSSignatureSeverity float64
...
func PossibleValuesForFirewallPolicyIDPSSignatureSeverity() []float64 {
	return []float64{
		float64(FirewallPolicyIDPSSignatureSeverityOne),
		float64(FirewallPolicyIDPSSignatureSeverityThree),
		float64(FirewallPolicyIDPSSignatureSeverityTwo),
	}
}
