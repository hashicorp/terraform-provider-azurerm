...
func (c DdosCustomPoliciesClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id DdosCustomPolicyId, input DdosCustomPolicy, callback func() error) error {
