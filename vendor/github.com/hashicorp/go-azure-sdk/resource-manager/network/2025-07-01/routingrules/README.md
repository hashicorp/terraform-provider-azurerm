...
## `github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/routingrules` Documentation

The `routingrules` SDK allows for interaction with Azure Resource Manager `network` (API Version `2025-07-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/routingrules"
```
...
// alternatively `client.List(ctx, id, routingrules.DefaultListOperationOptions())` can be used to do batched pagination
items, err := client.ListComplete(ctx, id, routingrules.DefaultListOperationOptions())
if err != nil {
	// handle the error
}
