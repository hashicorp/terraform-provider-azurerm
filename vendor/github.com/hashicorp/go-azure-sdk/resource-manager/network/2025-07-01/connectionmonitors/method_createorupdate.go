...
func (c ConnectionMonitorsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id ConnectionMonitorId, input ConnectionMonitor, options CreateOrUpdateOperationOptions, callback func() error) error {
