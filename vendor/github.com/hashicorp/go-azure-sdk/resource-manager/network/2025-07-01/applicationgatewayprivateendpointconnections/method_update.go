...
func (c ApplicationGatewayPrivateEndpointConnectionsClient) UpdateCallbackThenPoll(ctx context.Context, id ApplicationGatewayPrivateEndpointConnectionId, input ApplicationGatewayPrivateEndpointConnection, callback func() error) error {
