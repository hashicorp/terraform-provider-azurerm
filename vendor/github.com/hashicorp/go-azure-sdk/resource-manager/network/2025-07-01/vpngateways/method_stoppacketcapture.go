...
func (c VpnGatewaysClient) StopPacketCaptureCallbackThenPoll(ctx context.Context, id VpnGatewayId, input VpnGatewayPacketCaptureStopParameters, callback func() error) error {
