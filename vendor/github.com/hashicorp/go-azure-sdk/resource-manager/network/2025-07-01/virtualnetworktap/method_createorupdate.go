...
func (c VirtualNetworkTapClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id VirtualNetworkTapId, input VirtualNetworkTap, callback func() error) error {
