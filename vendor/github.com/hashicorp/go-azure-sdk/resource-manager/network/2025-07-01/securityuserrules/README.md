...
## `github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/securityuserrules` Documentation

The `securityuserrules` SDK allows for interaction with Azure Resource Manager `network` (API Version `2025-07-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/securityuserrules"
```
...
// alternatively `client.List(ctx, id, securityuserrules.DefaultListOperationOptions())` can be used to do batched pagination
items, err := client.ListComplete(ctx, id, securityuserrules.DefaultListOperationOptions())
if err != nil {
	// handle the error
}
