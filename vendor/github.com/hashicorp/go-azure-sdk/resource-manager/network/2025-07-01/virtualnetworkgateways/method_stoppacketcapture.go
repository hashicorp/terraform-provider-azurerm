...
func (c VirtualNetworkGatewaysClient) StopPacketCaptureCallbackThenPoll(ctx context.Context, id VirtualNetworkGatewayId, input VpnPacketCaptureStopParameters, callback func() error) error {
