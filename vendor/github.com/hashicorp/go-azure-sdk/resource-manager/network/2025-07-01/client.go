...
import (
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/applicationgatewayprivateendpointconnections"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/applicationgatewayprivatelinkresources"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/bastionshareablelink"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/bgpservicecommunities"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/commits"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/dscpconfiguration"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/dscpconfigurations"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/expressroutecircuitarptable"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/expressroutecircuitroutestable"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/expressroutecircuitroutestablesummary"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/expressroutecircuits"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/expressroutecircuitstats"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/expressrouteconnections"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/expressroutecrossconnectionarptable"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/expressroutecrossconnectionpeerings"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/expressroutecrossconnectionroutetable"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/expressroutecrossconnectionroutetablesummary"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/expressroutecrossconnections"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/expressroutegateways"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/expressroutelinks"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/expressrouteportslocations"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/expressrouteproviderports"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/expressrouteserviceproviders"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/firewalls"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/flowlogs"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/interconnectgroups"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/ipallocations"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/networkmanageractiveconfigurations"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/networkmanageractiveconnectivityconfigurations"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/networkmanagerconnections"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/networkmanagereffectiveconnectivityconfiguration"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/networkmanagereffectivesecurityadminrules"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/networksecurityperimeterassociableresourcetypes"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/networksecurityperimeterassociations"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/networksecurityperimeterlinkreferences"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/networksecurityperimeterlinks"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/networksecurityperimeterloggingconfigurations"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/networksecurityperimeterservicetags"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/p2svpngateways"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/packetcaptures"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/peerexpressroutecircuitconnections"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/reachabilityanalysisintent"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/reachabilityanalysisintents"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/reachabilityanalysisruns"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/routefilterrules"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/routingrulecollections"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/securityuserconfigurations"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/securityuserrulecollections"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/securityuserrules"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/serviceendpointpolicies"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/serviceendpointpolicydefinitions"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/servicegateways"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/staticcidrs"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/staticmembers"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/subgroups"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/subnets"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/trafficanalytics"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/usages"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/verifierworkspaces"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/vipswap"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/virtualappliancesites"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/virtualapplianceskus"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/virtualnetworktap"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/virtualnetworktaps"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/virtualrouterpeerings"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/virtualrouters"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/virtualwans"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/vpngateways"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/vpnlinkconnections"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/vpnserverconfigurations"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/vpnsites"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/webapplicationfirewallpolicies"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/webcategories"
...
type Client struct {
	...
	InterconnectGroups                               *interconnectgroups.InterconnectGroupsClient
	...
	NetworkGateways                                  *networkgateways.NetworkGatewaysClient
	...
	ServiceGateways                                  *servicegateways.ServiceGatewaysClient
	StaticCidrs                                      *staticcidrs.StaticCidrsClient
	StaticMembers                                    *staticmembers.StaticMembersClient
	Subgroups                                        *subgroups.SubgroupsClient
	...
	VirtualNetworkAppliances                         *virtualnetworkappliances.VirtualNetworkAppliancesClient
...
func NewClientWithBaseURI(sdkApi sdkEnv.Api, configureFunc func(c *resourcemanager.Client)) (*Client, error) {
	...
	commitsClient, err := commits.NewCommitsClientWithBaseURI(sdkApi)
	if err != nil {
		return nil, fmt.Errorf("building Commits client: %+v", err)
	}
	configureFunc(commitsClient.Client)
	...
	interconnectGroupsClient, err := interconnectgroups.NewInterconnectGroupsClientWithBaseURI(sdkApi)
	if err != nil {
		return nil, fmt.Errorf("building InterconnectGroups client: %+v", err)
	}
	configureFunc(interconnectGroupsClient.Client)
	...
	networkGatewaysClient, err := networkgateways.NewNetworkGatewaysClientWithBaseURI(sdkApi)
	if err != nil {
		return nil, fmt.Errorf("building NetworkGateways client: %+v", err)
	}
	configureFunc(networkGatewaysClient.Client)
	...
	serviceGatewaysClient, err := servicegateways.NewServiceGatewaysClientWithBaseURI(sdkApi)
	if err != nil {
		return nil, fmt.Errorf("building ServiceGateways client: %+v", err)
	}
	configureFunc(serviceGatewaysClient.Client)
	...
	subgroupsClient, err := subgroups.NewSubgroupsClientWithBaseURI(sdkApi)
	if err != nil {
		return nil, fmt.Errorf("building Subgroups client: %+v", err)
	}
	configureFunc(subgroupsClient.Client)
	...
	virtualNetworkAppliancesClient, err := virtualnetworkappliances.NewVirtualNetworkAppliancesClientWithBaseURI(sdkApi)
	if err != nil {
		return nil, fmt.Errorf("building VirtualNetworkAppliances client: %+v", err)
	}
	configureFunc(virtualNetworkAppliancesClient.Client)
	...
	return &Client{
		...
		ServiceGateways:                                  serviceGatewaysClient,
		StaticCidrs:                                      staticCidrsClient,
		StaticMembers:                                    staticMembersClient,
		Subgroups:                                        subgroupsClient,
		...
		VirtualNetworkAppliances:                         virtualNetworkAppliancesClient,
