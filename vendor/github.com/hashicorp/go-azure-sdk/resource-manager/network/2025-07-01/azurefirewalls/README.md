...
## `github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/azurefirewalls` Documentation

The `azurefirewalls` SDK allows for interaction with Azure Resource Manager `network` (API Version `2025-07-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/azurefirewalls"
```
...
if err := client.CreateOrUpdateThenPoll(ctx, id, payload, azurefirewalls.DefaultCreateOrUpdateOperationOptions()); err != nil {
	// handle the error
}
```
...
### Example Usage: `AzureFirewallsClient.PacketCaptureOperation`
...
if err := client.PacketCaptureOperationThenPoll(ctx, id, payload); err != nil {
	// handle the error
}
```
