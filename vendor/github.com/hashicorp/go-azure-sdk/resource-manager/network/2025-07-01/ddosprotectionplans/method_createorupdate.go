...
func (c DdosProtectionPlansClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id DdosProtectionPlanId, input DdosProtectionPlan, callback func() error) error {
