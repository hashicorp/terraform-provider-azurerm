...
type VirtualNetworkGatewayConnectionPropertiesFormat struct {
	AuthenticationType             *ConnectionAuthenticationType                      `json:"authenticationType,omitempty"`
	AuthorizationKey               *string                                            `json:"authorizationKey,omitempty"`
	CertificateAuthentication      *CertificateAuthentication                         `json:"certificateAuthentication,omitempty"`
	...
	TunnelProperties               *[]VirtualNetworkGatewayConnectionTunnelProperties `json:"tunnelProperties,omitempty"`
