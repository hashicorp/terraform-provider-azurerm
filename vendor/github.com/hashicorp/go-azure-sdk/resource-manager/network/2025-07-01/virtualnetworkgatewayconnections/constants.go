...
func PossibleValuesForConnectionAuthenticationType() []string {
	return []string{
		string(ConnectionAuthenticationTypeCertificate),
		string(ConnectionAuthenticationTypePSK),
	}
}

func (s *ConnectionAuthenticationType) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseConnectionAuthenticationType(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseConnectionAuthenticationType(input string) (*ConnectionAuthenticationType, error) {
	vals := map[string]ConnectionAuthenticationType{
		"certificate": ConnectionAuthenticationTypeCertificate,
		"psk":         ConnectionAuthenticationTypePSK,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := ConnectionAuthenticationType(input)
	return &out, nil
}
...
func PossibleValuesForVirtualNetworkGatewayMigrationPhase() []string {
	return []string{
		string(VirtualNetworkGatewayMigrationPhaseAbort),
		string(VirtualNetworkGatewayMigrationPhaseAbortSucceeded),
		string(VirtualNetworkGatewayMigrationPhaseCommit),
		string(VirtualNetworkGatewayMigrationPhaseCommitSucceeded),
		string(VirtualNetworkGatewayMigrationPhaseExecute),
		string(VirtualNetworkGatewayMigrationPhaseExecuteSucceeded),
		string(VirtualNetworkGatewayMigrationPhaseNone),
		string(VirtualNetworkGatewayMigrationPhasePrepare),
		string(VirtualNetworkGatewayMigrationPhasePrepareSucceeded),
	}
}

func (s *VirtualNetworkGatewayMigrationPhase) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseVirtualNetworkGatewayMigrationPhase(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseVirtualNetworkGatewayMigrationPhase(input string) (*VirtualNetworkGatewayMigrationPhase, error) {
	vals := map[string]VirtualNetworkGatewayMigrationPhase{
		"abort":            VirtualNetworkGatewayMigrationPhaseAbort,
		"abortsucceeded":   VirtualNetworkGatewayMigrationPhaseAbortSucceeded,
		"commit":           VirtualNetworkGatewayMigrationPhaseCommit,
		"commitsucceeded":  VirtualNetworkGatewayMigrationPhaseCommitSucceeded,
		"execute":          VirtualNetworkGatewayMigrationPhaseExecute,
		"executesucceeded": VirtualNetworkGatewayMigrationPhaseExecuteSucceeded,
		"none":             VirtualNetworkGatewayMigrationPhaseNone,
		"prepare":          VirtualNetworkGatewayMigrationPhasePrepare,
		"preparesucceeded": VirtualNetworkGatewayMigrationPhasePrepareSucceeded,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := VirtualNetworkGatewayMigrationPhase(input)
	return &out, nil
}
...
func PossibleValuesForVirtualNetworkGatewayMigrationState() []string {
	return []string{
		string(VirtualNetworkGatewayMigrationStateFailed),
		string(VirtualNetworkGatewayMigrationStateInProgress),
		string(VirtualNetworkGatewayMigrationStateNone),
		string(VirtualNetworkGatewayMigrationStateSucceeded),
	}
}

func (s *VirtualNetworkGatewayMigrationState) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseVirtualNetworkGatewayMigrationState(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseVirtualNetworkGatewayMigrationState(input string) (*VirtualNetworkGatewayMigrationState, error) {
	vals := map[string]VirtualNetworkGatewayMigrationState{
		"failed":     VirtualNetworkGatewayMigrationStateFailed,
		"inprogress": VirtualNetworkGatewayMigrationStateInProgress,
		"none":       VirtualNetworkGatewayMigrationStateNone,
		"succeeded":  VirtualNetworkGatewayMigrationStateSucceeded,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := VirtualNetworkGatewayMigrationState(input)
	return &out, nil
}
