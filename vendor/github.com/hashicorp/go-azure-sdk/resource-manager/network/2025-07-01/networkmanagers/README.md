...
## `github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/networkmanagers` Documentation

The `networkmanagers` SDK allows for interaction with Azure Resource Manager `network` (API Version `2025-07-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/networkmanagers"
```
...
read, err := client.NetworkManagerDeploymentStatusList(ctx, id, payload, networkmanagers.DefaultNetworkManagerDeploymentStatusListOperationOptions())
if err != nil {
	// handle the error
}
if model := read.Model; model != nil {
