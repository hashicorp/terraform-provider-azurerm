...
func (c ExpressRouteGatewaysClient) GetResiliencyInformation(ctx context.Context, id ExpressRouteGatewayId, options GetResiliencyInformationOperationOptions) (result GetResiliencyInformationOperationResponse, err error) {
...
func (c ExpressRouteGatewaysClient) GetResiliencyInformationThenPoll(ctx context.Context, id ExpressRouteGatewayId, options GetResiliencyInformationOperationOptions) error {
...
func (c ExpressRouteGatewaysClient) GetResiliencyInformationCallbackThenPoll(ctx context.Context, id ExpressRouteGatewayId, options GetResiliencyInformationOperationOptions, callback func() error) error {
