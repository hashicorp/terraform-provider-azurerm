...
func (c ExpressRouteGatewaysClient) GetFailoverSingleTestDetails(ctx context.Context, id ExpressRouteGatewayId, options GetFailoverSingleTestDetailsOperationOptions) (result GetFailoverSingleTestDetailsOperationResponse, err error) {
...
func (c ExpressRouteGatewaysClient) GetFailoverSingleTestDetailsThenPoll(ctx context.Context, id ExpressRouteGatewayId, options GetFailoverSingleTestDetailsOperationOptions) error {
...
func (c ExpressRouteGatewaysClient) GetFailoverSingleTestDetailsCallbackThenPoll(ctx context.Context, id ExpressRouteGatewayId, options GetFailoverSingleTestDetailsOperationOptions, callback func() error) error {
