...
const (
	ExpressRouteFailoverBgpStatusAddressFamilyIPvFour ExpressRouteFailoverBgpStatusAddressFamily = "IPv4"
	ExpressRouteFailoverBgpStatusAddressFamilyIPvSix  ExpressRouteFailoverBgpStatusAddressFamily = "IPv6"
)

func PossibleValuesForExpressRouteFailoverBgpStatusAddressFamily() []string {
	return []string{
		string(ExpressRouteFailoverBgpStatusAddressFamilyIPvFour),
		string(ExpressRouteFailoverBgpStatusAddressFamilyIPvSix),
	}
}

func (s *ExpressRouteFailoverBgpStatusAddressFamily) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseExpressRouteFailoverBgpStatusAddressFamily(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseExpressRouteFailoverBgpStatusAddressFamily(input string) (*ExpressRouteFailoverBgpStatusAddressFamily, error) {
	vals := map[string]ExpressRouteFailoverBgpStatusAddressFamily{
		"ipv4": ExpressRouteFailoverBgpStatusAddressFamilyIPvFour,
		"ipv6": ExpressRouteFailoverBgpStatusAddressFamilyIPvSix,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := ExpressRouteFailoverBgpStatusAddressFamily(input)
	return &out, nil
}
...
func PossibleValuesForExpressRouteFailoverLinkType() []string {
	return []string{
		string(ExpressRouteFailoverLinkTypePrimary),
		string(ExpressRouteFailoverLinkTypeSecondary),
	}
}

func (s *ExpressRouteFailoverLinkType) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseExpressRouteFailoverLinkType(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseExpressRouteFailoverLinkType(input string) (*ExpressRouteFailoverLinkType, error) {
	vals := map[string]ExpressRouteFailoverLinkType{
		"primary":   ExpressRouteFailoverLinkTypePrimary,
		"secondary": ExpressRouteFailoverLinkTypeSecondary,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := ExpressRouteFailoverLinkType(input)
	return &out, nil
}
...
func PossibleValuesForExpressRouteLinkFailoverBgpStatus() []string {
	return []string{
		string(ExpressRouteLinkFailoverBgpStatusConnected),
		string(ExpressRouteLinkFailoverBgpStatusDisconnected),
		string(ExpressRouteLinkFailoverBgpStatusUndefined),
	}
}

func (s *ExpressRouteLinkFailoverBgpStatus) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseExpressRouteLinkFailoverBgpStatus(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseExpressRouteLinkFailoverBgpStatus(input string) (*ExpressRouteLinkFailoverBgpStatus, error) {
	vals := map[string]ExpressRouteLinkFailoverBgpStatus{
		"connected":    ExpressRouteLinkFailoverBgpStatusConnected,
		"disconnected": ExpressRouteLinkFailoverBgpStatusDisconnected,
		"undefined":    ExpressRouteLinkFailoverBgpStatusUndefined,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := ExpressRouteLinkFailoverBgpStatus(input)
	return &out, nil
}
...
func PossibleValuesForMaintenanceTestCategory() []string {
	return []string{
		string(MaintenanceTestCategoryASPathPrepend),
		string(MaintenanceTestCategoryBgpDisconnect),
	}
}

func (s *MaintenanceTestCategory) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseMaintenanceTestCategory(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseMaintenanceTestCategory(input string) (*MaintenanceTestCategory, error) {
	vals := map[string]MaintenanceTestCategory{
		"aspathprepend": MaintenanceTestCategoryASPathPrepend,
		"bgpdisconnect": MaintenanceTestCategoryBgpDisconnect,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := MaintenanceTestCategory(input)
	return &out, nil
}
