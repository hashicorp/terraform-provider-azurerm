...
## `github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/networkmanagerconnections` Documentation

The `networkmanagerconnections` SDK allows for interaction with Azure Resource Manager `network` (API Version `2025-07-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/networkmanagerconnections"
```
