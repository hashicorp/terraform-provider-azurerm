...
func PossibleValuesForLoadBalancerDetailLevel() []string {
	return []string{
		string(LoadBalancerDetailLevelReduced),
	}
}

func (s *LoadBalancerDetailLevel) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseLoadBalancerDetailLevel(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseLoadBalancerDetailLevel(input string) (*LoadBalancerDetailLevel, error) {
	vals := map[string]LoadBalancerDetailLevel{
		"reduced": LoadBalancerDetailLevelReduced,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := LoadBalancerDetailLevel(input)
	return &out, nil
}
...
func PossibleValuesForLoadBalancerScope() []string {
	return []string{
		string(LoadBalancerScopePrivate),
		string(LoadBalancerScopePublic),
	}
}

func (s *LoadBalancerScope) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseLoadBalancerScope(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseLoadBalancerScope(input string) (*LoadBalancerScope, error) {
	vals := map[string]LoadBalancerScope{
		"private": LoadBalancerScopePrivate,
		"public":  LoadBalancerScopePublic,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
...
func PossibleValuesForProbeNoHealthyBackendsBehavior() []string {
	return []string{
		string(ProbeNoHealthyBackendsBehaviorAllProbedDown),
		string(ProbeNoHealthyBackendsBehaviorAllProbedUp),
	}
}

func (s *ProbeNoHealthyBackendsBehavior) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseProbeNoHealthyBackendsBehavior(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseProbeNoHealthyBackendsBehavior(input string) (*ProbeNoHealthyBackendsBehavior, error) {
	vals := map[string]ProbeNoHealthyBackendsBehavior{
		"allprobeddown": ProbeNoHealthyBackendsBehaviorAllProbedDown,
		"allprobedup":   ProbeNoHealthyBackendsBehaviorAllProbedUp,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := ProbeNoHealthyBackendsBehavior(input)
	return &out, nil
}
