...
func NewServiceGatewayID(subscriptionId string, resourceGroupName string, serviceGatewayName string) ServiceGatewayId {
...
func (id *ServiceGatewayId) FromParseResult(input resourceids.ParseResult) error {
	...
	if id.ServiceGatewayName, ok = input.Parsed["serviceGatewayName"]; !ok {
		return resourceids.NewSegmentNotSpecifiedError(id, "serviceGatewayName", input)
	}
...
func (id ServiceGatewayId) ID() string {
	fmtString := "/subscriptions/%s/resourceGroups/%s/providers/Microsoft.Network/serviceGateways/%s"
	return fmt.Sprintf(fmtString, id.SubscriptionId, id.ResourceGroupName, id.ServiceGatewayName)
}
...
func (id ServiceGatewayId) Segments() []resourceids.Segment {
	return []resourceids.Segment{
		...
		resourceids.StaticSegment("staticServiceGateways", "serviceGateways", "serviceGateways"),
		resourceids.UserSpecifiedSegment("serviceGatewayName", "serviceGatewayName"),
	}
}
...
func (id ServiceGatewayId) String() string {
	components := []string{
		...
		fmt.Sprintf("Service Gateway Name: %q", id.ServiceGatewayName),
	}
