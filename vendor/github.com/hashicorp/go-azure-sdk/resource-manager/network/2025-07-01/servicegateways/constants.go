...
func PossibleValuesForAddressUpdateAction() []string {
	return []string{
		string(AddressUpdateActionFullUpdate),
		string(AddressUpdateActionPartialUpdate),
	}
}

func (s *AddressUpdateAction) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseAddressUpdateAction(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseAddressUpdateAction(input string) (*AddressUpdateAction, error) {
	vals := map[string]AddressUpdateAction{
		"fullupdate":    AddressUpdateActionFullUpdate,
		"partialupdate": AddressUpdateActionPartialUpdate,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
...
func PossibleValuesForServiceGatewaySkuName() []string {
	return []string{
		string(ServiceGatewaySkuNameStandard),
	}
}

func (s *ServiceGatewaySkuName) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseServiceGatewaySkuName(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseServiceGatewaySkuName(input string) (*ServiceGatewaySkuName, error) {
	vals := map[string]ServiceGatewaySkuName{
		"standard": ServiceGatewaySkuNameStandard,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := ServiceGatewaySkuName(input)
	return &out, nil
}
...
func PossibleValuesForServiceGatewaySkuTier() []string {
	return []string{
		string(ServiceGatewaySkuTierRegional),
	}
}

func (s *ServiceGatewaySkuTier) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseServiceGatewaySkuTier(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseServiceGatewaySkuTier(input string) (*ServiceGatewaySkuTier, error) {
	vals := map[string]ServiceGatewaySkuTier{
		"regional": ServiceGatewaySkuTierRegional,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := ServiceGatewaySkuTier(input)
	return &out, nil
}
...
func PossibleValuesForServiceType() []string {
	return []string{
		string(ServiceTypeInbound),
		string(ServiceTypeInboundOutbound),
		string(ServiceTypeOutbound),
	}
}
...
func parseServiceType(input string) (*ServiceType, error) {
	vals := map[string]ServiceType{
		"inbound":         ServiceTypeInbound,
		"inboundoutbound": ServiceTypeInboundOutbound,
		"outbound":        ServiceTypeOutbound,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
...
func PossibleValuesForServiceUpdateAction() []string {
	return []string{
		string(ServiceUpdateActionFullUpdate),
		string(ServiceUpdateActionPartialUpdate),
	}
}

func (s *ServiceUpdateAction) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseServiceUpdateAction(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseServiceUpdateAction(input string) (*ServiceUpdateAction, error) {
	vals := map[string]ServiceUpdateAction{
		"fullupdate":    ServiceUpdateActionFullUpdate,
		"partialupdate": ServiceUpdateActionPartialUpdate,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
...
func PossibleValuesForUpdateAction() []string {
	return []string{
		string(UpdateActionFullUpdate),
		string(UpdateActionPartialUpdate),
	}
}

func (s *UpdateAction) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseUpdateAction(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseUpdateAction(input string) (*UpdateAction, error) {
	vals := map[string]UpdateAction{
		"fullupdate":    UpdateActionFullUpdate,
		"partialupdate": UpdateActionPartialUpdate,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
