...
func (c BastionHostsClient) PutBastionShareableLinkCallbackThenPoll(ctx context.Context, id BastionHostId, input BastionShareableLinkListRequest, callback func() error) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after PutBastionShareableLink: %+v", err)
	}
