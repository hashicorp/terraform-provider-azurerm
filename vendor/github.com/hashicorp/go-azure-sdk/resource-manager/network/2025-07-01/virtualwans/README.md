...
## `github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/virtualwans` Documentation

The `virtualwans` SDK allows for interaction with Azure Resource Manager `network` (API Version `2025-07-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/network/2025-07-01/virtualwans"
```
...
### Example Usage: `VirtualWANsClient.ConnectionPoliciesCreateOrUpdate`

```go
ctx := context.TODO()
id := virtualwans.NewConnectionPolicyID("12345678-1234-9876-4563-123456789012", "example-resource-group", "virtualHubName", "connectionPolicyName")

payload := virtualwans.ConnectionPolicy{
	// ...
}


if err := client.ConnectionPoliciesCreateOrUpdateThenPoll(ctx, id, payload); err != nil {
	// handle the error
}
```


### Example Usage: `VirtualWANsClient.ConnectionPoliciesDelete`

```go
ctx := context.TODO()
id := virtualwans.NewConnectionPolicyID("12345678-1234-9876-4563-123456789012", "example-resource-group", "virtualHubName", "connectionPolicyName")

if err := client.ConnectionPoliciesDeleteThenPoll(ctx, id); err != nil {
	// handle the error
}
```


### Example Usage: `VirtualWANsClient.ConnectionPoliciesGet`

```go
ctx := context.TODO()
id := virtualwans.NewConnectionPolicyID("12345678-1234-9876-4563-123456789012", "example-resource-group", "virtualHubName", "connectionPolicyName")

read, err := client.ConnectionPoliciesGet(ctx, id)
if err != nil {
	// handle the error
}
if model := read.Model; model != nil {
...
### Example Usage: `VirtualWANsClient.ConnectionPoliciesList`

```go
ctx := context.TODO()
id := virtualwans.NewVirtualHubID("12345678-1234-9876-4563-123456789012", "example-resource-group", "virtualHubName")

// alternatively `client.ConnectionPoliciesList(ctx, id)` can be used to do batched pagination
items, err := client.ConnectionPoliciesListComplete(ctx, id)
if err != nil {
	// handle the error
}
for _, item := range items {
