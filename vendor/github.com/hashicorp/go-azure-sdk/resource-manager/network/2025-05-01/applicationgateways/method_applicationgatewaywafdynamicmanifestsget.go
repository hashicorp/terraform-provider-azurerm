...
type ApplicationGatewayWafDynamicManifestsGetCustomPager struct {
	NextLink *odata.Link `json:"nextLink"`
}

func (p *ApplicationGatewayWafDynamicManifestsGetCustomPager) NextPageLink() *odata.Link {
	defer func() {
		p.NextLink = nil
	}()
...
func (c ApplicationGatewaysClient) ApplicationGatewayWafDynamicManifestsGet(ctx context.Context, id LocationId) (result ApplicationGatewayWafDynamicManifestsGetOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Pager:      &ApplicationGatewayWafDynamicManifestsGetCustomPager{},
...
func (c ApplicationGatewaysClient) ApplicationGatewayWafDynamicManifestsGetComplete(ctx context.Context, id LocationId) (ApplicationGatewayWafDynamicManifestsGetCompleteResult, error) {
...
func (c ApplicationGatewaysClient) ApplicationGatewayWafDynamicManifestsGetCompleteMatchingPredicate(ctx context.Context, id LocationId, predicate ApplicationGatewayWafDynamicManifestResultOperationPredicate) (result ApplicationGatewayWafDynamicManifestsGetCompleteResult, err error) {
