...
## `github.com/hashicorp/go-azure-sdk/resource-manager/network/2022-09-01/virtualappliancesites` Documentation

The `virtualappliancesites` SDK allows for interaction with the Azure Resource Manager Service `network` (API Version `2022-09-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/network/2022-09-01/virtualappliancesites"
```
