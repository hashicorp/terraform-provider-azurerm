...
## `github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/customipprefixes` Documentation

The `customipprefixes` SDK allows for interaction with Azure Resource Manager `network` (API Version `2024-10-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/customipprefixes"
```
