...
import (
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/applicationgatewayprivateendpointconnections"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/applicationgatewayprivatelinkresources"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/applicationgateways"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/applicationgatewaywafdynamicmanifests"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/applicationsecuritygroups"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/availabledelegations"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/availableservicealiases"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/azurefirewalls"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/bastionhosts"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/bastionshareablelink"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/bgpservicecommunities"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/checkdnsavailabilities"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/cloudservicepublicipaddresses"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/ddoscustompolicies"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/ddosprotectionplans"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/dscpconfiguration"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/dscpconfigurations"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/endpointservices"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/expressroutecircuitarptable"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/expressroutecircuitauthorizations"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/expressroutecircuitconnections"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/expressroutecircuitpeerings"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/expressroutecircuitroutestable"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/expressroutecircuitroutestablesummary"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/expressroutecircuits"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/expressroutecircuitstats"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/expressrouteconnections"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/expressroutecrossconnectionarptable"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/expressroutecrossconnectionpeerings"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/expressroutecrossconnectionroutetable"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/expressroutecrossconnectionroutetablesummary"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/expressroutecrossconnections"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/expressroutegateways"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/expressroutelinks"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/expressrouteportslocations"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/expressrouteproviderports"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/expressrouteserviceproviders"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/ipallocations"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/loadbalancers"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/networkmanageractiveconfigurations"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/networkmanageractiveconnectivityconfigurations"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/networkmanagerconnections"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/networkmanagereffectiveconnectivityconfiguration"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/networkmanagereffectivesecurityadminrules"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/networksecurityperimeterassociableresourcetypes"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/networksecurityperimeterassociations"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/networksecurityperimeterlinkreferences"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/networksecurityperimeterlinks"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/networksecurityperimeterloggingconfigurations"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/networksecurityperimeterservicetags"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/networkvirtualappliances"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/networkwatchers"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/p2svpngateways"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/packetcaptures"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/peerexpressroutecircuitconnections"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/reachabilityanalysisintent"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/reachabilityanalysisintents"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/reachabilityanalysisruns"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/routefilterrules"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/routefilters"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/routes"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/routetables"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/routingrulecollections"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/routingrules"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/securityuserconfigurations"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/securityuserrulecollections"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/securityuserrules"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/serviceendpointpolicies"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/serviceendpointpolicydefinitions"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/servicetags"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/trafficanalytics"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/usages"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/verifierworkspaces"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/vipswap"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/virtualappliancesites"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/virtualapplianceskus"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/virtualnetworkgatewayconnections"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/virtualnetworktap"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/virtualnetworktaps"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/virtualrouterpeerings"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/virtualrouters"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/virtualwans"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/vmsspublicipaddresses"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/vpngateways"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/vpnlinkconnections"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/vpnserverconfigurations"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/vpnsites"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/webapplicationfirewallpolicies"
	"github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/webcategories"
