...
## `github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/expressrouteconnections` Documentation

The `expressrouteconnections` SDK allows for interaction with Azure Resource Manager `network` (API Version `2024-10-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/network/2024-10-01/expressrouteconnections"
```
