...
## `github.com/hashicorp/go-azure-sdk/resource-manager/network/2023-04-01/expressrouteports` Documentation

The `expressrouteports` SDK allows for interaction with the Azure Resource Manager Service `network` (API Version `2023-04-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/network/2023-04-01/expressrouteports"
```
...
```go
ctx := context.TODO()
id := expressrouteports.NewSubscriptionID("12345678-1234-9876-4563-123456789012")
...
```go
ctx := context.TODO()
id := expressrouteports.NewResourceGroupID("12345678-1234-9876-4563-123456789012", "example-resource-group")
