...
func (c FileSystemsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id FileSystemId, input LiftrBaseStorageFileSystemResource, callback func() error) error {
