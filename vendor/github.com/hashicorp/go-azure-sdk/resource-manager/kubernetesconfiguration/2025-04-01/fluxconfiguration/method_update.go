...
func (c FluxConfigurationClient) UpdateCallbackThenPoll(ctx context.Context, id ScopedFluxConfigurationId, input FluxConfigurationPatch, callback func() error) error {
