...
func (c FluxConfigurationClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id ScopedFluxConfigurationId, input FluxConfiguration, callback func() error) error {
