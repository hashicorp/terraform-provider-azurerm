...
func (c ClustersClient) preparerForUpdate(ctx context.Context, id ClusterId, input Cluster, options UpdateOperationOptions) (*http.Request, error) {
...
func (c ClustersClient) senderForUpdate(ctx context.Context, req *http.Request) (future UpdateOperationResponse, err error) {
