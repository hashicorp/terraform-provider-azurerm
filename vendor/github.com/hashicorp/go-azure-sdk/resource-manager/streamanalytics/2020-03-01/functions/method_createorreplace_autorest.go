...
func (c FunctionsClient) CreateOrReplace(ctx context.Context, id FunctionId, input Function, options CreateOrReplaceOperationOptions) (result CreateOrReplaceOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "functions.FunctionsClient", "CreateOrReplace", nil, "Failure preparing request")
		return
	}

	result.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "functions.FunctionsClient", "CreateOrReplace", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForCreateOrReplace(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "functions.FunctionsClient", "CreateOrReplace", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c FunctionsClient) preparerForCreateOrReplace(ctx context.Context, id FunctionId, input Function, options CreateOrReplaceOperationOptions) (*http.Request, error) {
...
func (c FunctionsClient) responderForCreateOrReplace(resp *http.Response) (result CreateOrReplaceOperationResponse, err error) {
