...
func (c FunctionsClient) Test(ctx context.Context, id FunctionId, input Function) (result TestOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "functions.FunctionsClient", "Test", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForTest(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "functions.FunctionsClient", "Test", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c FunctionsClient) preparerForTest(ctx context.Context, id FunctionId, input Function) (*http.Request, error) {
...
func (c FunctionsClient) senderForTest(ctx context.Context, req *http.Request) (future TestOperationResponse, err error) {
