...
func (c VirtualMachineInstancesClient) UpdateCallbackThenPoll(ctx context.Context, id commonids.ScopeId, input VirtualMachineInstanceUpdate, callback func() error) error {
