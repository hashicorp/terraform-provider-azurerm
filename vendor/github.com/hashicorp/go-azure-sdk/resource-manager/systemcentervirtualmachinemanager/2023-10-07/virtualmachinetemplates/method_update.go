...
func (c VirtualMachineTemplatesClient) UpdateCallbackThenPoll(ctx context.Context, id VirtualMachineTemplateId, input VirtualMachineTemplateTagsUpdate, callback func() error) error {
