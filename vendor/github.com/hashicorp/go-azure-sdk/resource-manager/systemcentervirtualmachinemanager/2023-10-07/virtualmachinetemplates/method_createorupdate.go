...
func (c VirtualMachineTemplatesClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id VirtualMachineTemplateId, input VirtualMachineTemplate, callback func() error) error {
