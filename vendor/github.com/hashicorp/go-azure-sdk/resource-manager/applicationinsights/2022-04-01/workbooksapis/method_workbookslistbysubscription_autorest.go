...
func (c WorkbooksAPIsClient) WorkbooksListBySubscription(ctx context.Context, id commonids.SubscriptionId, options WorkbooksListBySubscriptionOperationOptions) (resp WorkbooksListBySubscriptionOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "workbooksapis.WorkbooksAPIsClient", "WorkbooksListBySubscription", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "workbooksapis.WorkbooksAPIsClient", "WorkbooksListBySubscription", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForWorkbooksListBySubscription(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "workbooksapis.WorkbooksAPIsClient", "WorkbooksListBySubscription", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c WorkbooksAPIsClient) preparerForWorkbooksListBySubscription(ctx context.Context, id commonids.SubscriptionId, options WorkbooksListBySubscriptionOperationOptions) (*http.Request, error) {
...
func (c WorkbooksAPIsClient) preparerForWorkbooksListBySubscriptionWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c WorkbooksAPIsClient) responderForWorkbooksListBySubscription(resp *http.Response) (result WorkbooksListBySubscriptionOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result WorkbooksListBySubscriptionOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "workbooksapis.WorkbooksAPIsClient", "WorkbooksListBySubscription", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForWorkbooksListBySubscription(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "workbooksapis.WorkbooksAPIsClient", "WorkbooksListBySubscription", result.HttpResponse, "Failure responding to request")
				return
			}
