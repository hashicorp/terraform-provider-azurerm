...
func (c WorkbooksAPIsClient) WorkbooksRevisionsList(ctx context.Context, id WorkbookId) (resp WorkbooksRevisionsListOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "workbooksapis.WorkbooksAPIsClient", "WorkbooksRevisionsList", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "workbooksapis.WorkbooksAPIsClient", "WorkbooksRevisionsList", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForWorkbooksRevisionsList(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "workbooksapis.WorkbooksAPIsClient", "WorkbooksRevisionsList", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c WorkbooksAPIsClient) preparerForWorkbooksRevisionsList(ctx context.Context, id WorkbookId) (*http.Request, error) {
...
func (c WorkbooksAPIsClient) preparerForWorkbooksRevisionsListWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c WorkbooksAPIsClient) responderForWorkbooksRevisionsList(resp *http.Response) (result WorkbooksRevisionsListOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result WorkbooksRevisionsListOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "workbooksapis.WorkbooksAPIsClient", "WorkbooksRevisionsList", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForWorkbooksRevisionsList(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "workbooksapis.WorkbooksAPIsClient", "WorkbooksRevisionsList", result.HttpResponse, "Failure responding to request")
				return
			}
