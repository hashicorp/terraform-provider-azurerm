...
func (c WorkbooksAPIsClient) WorkbooksGet(ctx context.Context, id WorkbookId, options WorkbooksGetOperationOptions) (result WorkbooksGetOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "workbooksapis.WorkbooksAPIsClient", "WorkbooksGet", nil, "Failure preparing request")
		return
	}

	result.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "workbooksapis.WorkbooksAPIsClient", "WorkbooksGet", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForWorkbooksGet(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "workbooksapis.WorkbooksAPIsClient", "WorkbooksGet", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c WorkbooksAPIsClient) preparerForWorkbooksGet(ctx context.Context, id WorkbookId, options WorkbooksGetOperationOptions) (*http.Request, error) {
...
func (c WorkbooksAPIsClient) responderForWorkbooksGet(resp *http.Response) (result WorkbooksGetOperationResponse, err error) {
