...
func (c WorkbooksAPIsClient) WorkbooksCreateOrUpdate(ctx context.Context, id WorkbookId, input Workbook, options WorkbooksCreateOrUpdateOperationOptions) (result WorkbooksCreateOrUpdateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "workbooksapis.WorkbooksAPIsClient", "WorkbooksCreateOrUpdate", nil, "Failure preparing request")
		return
	}

	result.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "workbooksapis.WorkbooksAPIsClient", "WorkbooksCreateOrUpdate", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForWorkbooksCreateOrUpdate(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "workbooksapis.WorkbooksAPIsClient", "WorkbooksCreateOrUpdate", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c WorkbooksAPIsClient) preparerForWorkbooksCreateOrUpdate(ctx context.Context, id WorkbookId, input Workbook, options WorkbooksCreateOrUpdateOperationOptions) (*http.Request, error) {
...
func (c WorkbooksAPIsClient) responderForWorkbooksCreateOrUpdate(resp *http.Response) (result WorkbooksCreateOrUpdateOperationResponse, err error) {
