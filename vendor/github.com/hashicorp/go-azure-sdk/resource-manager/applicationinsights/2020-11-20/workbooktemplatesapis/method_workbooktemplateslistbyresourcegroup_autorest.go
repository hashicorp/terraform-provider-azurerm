...
func (c WorkbookTemplatesAPIsClient) WorkbookTemplatesListByResourceGroup(ctx context.Context, id commonids.ResourceGroupId) (result WorkbookTemplatesListByResourceGroupOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "workbooktemplatesapis.WorkbookTemplatesAPIsClient", "WorkbookTemplatesListByResourceGroup", nil, "Failure preparing request")
		return
	}

	result.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "workbooktemplatesapis.WorkbookTemplatesAPIsClient", "WorkbookTemplatesListByResourceGroup", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForWorkbookTemplatesListByResourceGroup(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "workbooktemplatesapis.WorkbookTemplatesAPIsClient", "WorkbookTemplatesListByResourceGroup", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c WorkbookTemplatesAPIsClient) preparerForWorkbookTemplatesListByResourceGroup(ctx context.Context, id commonids.ResourceGroupId) (*http.Request, error) {
...
func (c WorkbookTemplatesAPIsClient) responderForWorkbookTemplatesListByResourceGroup(resp *http.Response) (result WorkbookTemplatesListByResourceGroupOperationResponse, err error) {
