...
// CreateOrReplace ...
func (c RetentionPoliciesClient) CreateOrReplace(ctx context.Context, id SchedulerId, input RetentionPolicy) (result CreateOrReplaceOperationResponse, err error) {
