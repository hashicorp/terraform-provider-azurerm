...
// List ...
func (c ViewsClient) List(ctx context.Context) (resp ListOperationResponse, err error) {
...
func (c ViewsClient) responderForList(resp *http.Response) (result ListOperationResponse, err error) {
	type page struct {
