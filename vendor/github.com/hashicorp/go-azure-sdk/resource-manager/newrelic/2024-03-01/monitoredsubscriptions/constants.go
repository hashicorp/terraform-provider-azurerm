...
func PossibleValuesForPatchOperation() []string {
	return []string{
		string(PatchOperationActive),
		string(PatchOperationAddBegin),
		string(PatchOperationAddComplete),
		string(PatchOperationDeleteBegin),
		string(PatchOperationDeleteComplete),
	}
}
...
func (s *PatchOperation) UnmarshalJSON(bytes []byte) error {
	...
	out, err := parsePatchOperation(decoded)
	if err != nil {
...
func parsePatchOperation(input string) (*PatchOperation, error) {
	vals := map[string]PatchOperation{
		"active":         PatchOperationActive,
		"addbegin":       PatchOperationAddBegin,
		"addcomplete":    PatchOperationAddComplete,
		"deletebegin":    PatchOperationDeleteBegin,
		"deletecomplete": PatchOperationDeleteComplete,
	}
