...
The `serverkeys` SDK allows for interaction with Azure Resource Manager `postgresql` (API Version `2020-01-01`).
...
```go
ctx := context.TODO()
id := serverkeys.NewServerID("12345678-1234-9876-4563-123456789012", "example-resource-group", "serverName")
