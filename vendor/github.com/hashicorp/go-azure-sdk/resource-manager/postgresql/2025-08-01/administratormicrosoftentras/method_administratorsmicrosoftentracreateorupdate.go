...
type AdministratorsMicrosoftEntraCreateOrUpdateOperationResponse struct {
...
func (c AdministratorMicrosoftEntrasClient) AdministratorsMicrosoftEntraCreateOrUpdate(ctx context.Context, id AdministratorId, input AdministratorMicrosoftEntraAdd) (result AdministratorsMicrosoftEntraCreateOrUpdateOperationResponse, err error) {
...
func (c AdministratorMicrosoftEntrasClient) AdministratorsMicrosoftEntraCreateOrUpdateThenPoll(ctx context.Context, id AdministratorId, input AdministratorMicrosoftEntraAdd) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after AdministratorsMicrosoftEntraCreateOrUpdate: %+v", err)
	}
