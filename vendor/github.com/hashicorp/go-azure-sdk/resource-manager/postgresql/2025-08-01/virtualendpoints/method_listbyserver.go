...
func (c VirtualEndpointsClient) ListByServer(ctx context.Context, id FlexibleServerId) (result ListByServerOperationResponse, err error) {
	...
	var values struct {
		Values *[]VirtualEndpoint `json:"value"`
	}
...
func (c VirtualEndpointsClient) ListByServerComplete(ctx context.Context, id FlexibleServerId) (ListByServerCompleteResult, error) {
	return c.ListByServerCompleteMatchingPredicate(ctx, id, VirtualEndpointOperationPredicate{})
}

// ListByServerCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c VirtualEndpointsClient) ListByServerCompleteMatchingPredicate(ctx context.Context, id FlexibleServerId, predicate VirtualEndpointOperationPredicate) (result ListByServerCompleteResult, err error) {
	items := make([]VirtualEndpoint, 0)
