...
func (c VirtualEndpointsClient) UpdateCallbackThenPoll(ctx context.Context, id VirtualEndpointId, input VirtualEndpointResourceForPatch, callback func() error) error {
