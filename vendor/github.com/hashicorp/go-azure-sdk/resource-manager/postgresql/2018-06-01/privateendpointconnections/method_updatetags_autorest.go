...
func (c PrivateEndpointConnectionsClient) UpdateTags(ctx context.Context, id PrivateEndpointConnectionId, input TagsObject) (result UpdateTagsOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "privateendpointconnections.PrivateEndpointConnectionsClient", "UpdateTags", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForUpdateTags(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "privateendpointconnections.PrivateEndpointConnectionsClient", "UpdateTags", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c PrivateEndpointConnectionsClient) preparerForUpdateTags(ctx context.Context, id PrivateEndpointConnectionId, input TagsObject) (*http.Request, error) {
...
func (c PrivateEndpointConnectionsClient) senderForUpdateTags(ctx context.Context, req *http.Request) (future UpdateTagsOperationResponse, err error) {
