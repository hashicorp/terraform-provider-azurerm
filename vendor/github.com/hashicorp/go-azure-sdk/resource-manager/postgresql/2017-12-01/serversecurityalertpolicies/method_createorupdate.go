...
func (c ServerSecurityAlertPoliciesClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id ServerId, input ServerSecurityAlertPolicy, callback func() error) error {
