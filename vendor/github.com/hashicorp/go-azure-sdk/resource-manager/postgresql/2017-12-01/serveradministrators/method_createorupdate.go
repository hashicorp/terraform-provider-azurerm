...
func (c ServerAdministratorsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id ServerId, input ServerAdministratorResource, callback func() error) error {
