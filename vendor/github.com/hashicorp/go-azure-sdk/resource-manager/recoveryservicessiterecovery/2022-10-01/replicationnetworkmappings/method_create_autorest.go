...
func (c ReplicationNetworkMappingsClient) Create(ctx context.Context, id ReplicationNetworkMappingId, input CreateNetworkMappingInput) (result CreateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationnetworkmappings.ReplicationNetworkMappingsClient", "Create", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForCreate(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationnetworkmappings.ReplicationNetworkMappingsClient", "Create", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c ReplicationNetworkMappingsClient) preparerForCreate(ctx context.Context, id ReplicationNetworkMappingId, input CreateNetworkMappingInput) (*http.Request, error) {
...
func (c ReplicationNetworkMappingsClient) senderForCreate(ctx context.Context, req *http.Request) (future CreateOperationResponse, err error) {
