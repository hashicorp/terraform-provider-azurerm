...
func (c ReplicationProtectedItemsClient) ListByReplicationProtectionContainers(ctx context.Context, id ReplicationProtectionContainerId) (resp ListByReplicationProtectionContainersOperationResponse, err error) {
	req, err := c.preparerForListByReplicationProtectionContainers(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationprotecteditems.ReplicationProtectedItemsClient", "ListByReplicationProtectionContainers", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationprotecteditems.ReplicationProtectedItemsClient", "ListByReplicationProtectionContainers", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListByReplicationProtectionContainers(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationprotecteditems.ReplicationProtectedItemsClient", "ListByReplicationProtectionContainers", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c ReplicationProtectedItemsClient) preparerForListByReplicationProtectionContainers(ctx context.Context, id ReplicationProtectionContainerId) (*http.Request, error) {
...
func (c ReplicationProtectedItemsClient) preparerForListByReplicationProtectionContainersWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c ReplicationProtectedItemsClient) responderForListByReplicationProtectionContainers(resp *http.Response) (result ListByReplicationProtectionContainersOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByReplicationProtectionContainersOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "replicationprotecteditems.ReplicationProtectedItemsClient", "ListByReplicationProtectionContainers", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListByReplicationProtectionContainers(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "replicationprotecteditems.ReplicationProtectedItemsClient", "ListByReplicationProtectionContainers", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c ReplicationProtectedItemsClient) ListByReplicationProtectionContainersCompleteMatchingPredicate(ctx context.Context, id ReplicationProtectionContainerId, predicate ReplicationProtectedItemOperationPredicate) (resp ListByReplicationProtectionContainersCompleteResult, err error) {
