...
func (c ReplicationProtectedItemsClient) FailoverCancel(ctx context.Context, id ReplicationProtectedItemId) (result FailoverCancelOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationprotecteditems.ReplicationProtectedItemsClient", "FailoverCancel", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForFailoverCancel(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationprotecteditems.ReplicationProtectedItemsClient", "FailoverCancel", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c ReplicationProtectedItemsClient) preparerForFailoverCancel(ctx context.Context, id ReplicationProtectedItemId) (*http.Request, error) {
...
func (c ReplicationProtectedItemsClient) senderForFailoverCancel(ctx context.Context, req *http.Request) (future FailoverCancelOperationResponse, err error) {
