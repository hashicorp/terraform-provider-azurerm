...
func (c ReplicationProtectedItemsClient) Purge(ctx context.Context, id ReplicationProtectedItemId) (result PurgeOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationprotecteditems.ReplicationProtectedItemsClient", "Purge", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForPurge(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationprotecteditems.ReplicationProtectedItemsClient", "Purge", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c ReplicationProtectedItemsClient) preparerForPurge(ctx context.Context, id ReplicationProtectedItemId) (*http.Request, error) {
...
func (c ReplicationProtectedItemsClient) senderForPurge(ctx context.Context, req *http.Request) (future PurgeOperationResponse, err error) {
