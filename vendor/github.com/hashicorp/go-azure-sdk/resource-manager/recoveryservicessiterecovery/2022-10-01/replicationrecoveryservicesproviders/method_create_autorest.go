...
func (c ReplicationRecoveryServicesProvidersClient) Create(ctx context.Context, id ReplicationRecoveryServicesProviderId, input AddRecoveryServicesProviderInput) (result CreateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationrecoveryservicesproviders.ReplicationRecoveryServicesProvidersClient", "Create", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForCreate(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationrecoveryservicesproviders.ReplicationRecoveryServicesProvidersClient", "Create", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c ReplicationRecoveryServicesProvidersClient) preparerForCreate(ctx context.Context, id ReplicationRecoveryServicesProviderId, input AddRecoveryServicesProviderInput) (*http.Request, error) {
...
func (c ReplicationRecoveryServicesProvidersClient) senderForCreate(ctx context.Context, req *http.Request) (future CreateOperationResponse, err error) {
