...
func (c ReplicationProtectionContainerMappingsClient) Purge(ctx context.Context, id ReplicationProtectionContainerMappingId) (result PurgeOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationprotectioncontainermappings.ReplicationProtectionContainerMappingsClient", "Purge", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForPurge(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationprotectioncontainermappings.ReplicationProtectionContainerMappingsClient", "Purge", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c ReplicationProtectionContainerMappingsClient) preparerForPurge(ctx context.Context, id ReplicationProtectionContainerMappingId) (*http.Request, error) {
...
func (c ReplicationProtectionContainerMappingsClient) senderForPurge(ctx context.Context, req *http.Request) (future PurgeOperationResponse, err error) {
