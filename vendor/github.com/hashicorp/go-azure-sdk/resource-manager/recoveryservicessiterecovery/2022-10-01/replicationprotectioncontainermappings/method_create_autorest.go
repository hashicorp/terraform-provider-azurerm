...
func (c ReplicationProtectionContainerMappingsClient) Create(ctx context.Context, id ReplicationProtectionContainerMappingId, input CreateProtectionContainerMappingInput) (result CreateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationprotectioncontainermappings.ReplicationProtectionContainerMappingsClient", "Create", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForCreate(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationprotectioncontainermappings.ReplicationProtectionContainerMappingsClient", "Create", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c ReplicationProtectionContainerMappingsClient) preparerForCreate(ctx context.Context, id ReplicationProtectionContainerMappingId, input CreateProtectionContainerMappingInput) (*http.Request, error) {
...
func (c ReplicationProtectionContainerMappingsClient) senderForCreate(ctx context.Context, req *http.Request) (future CreateOperationResponse, err error) {
