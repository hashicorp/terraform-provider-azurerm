...
func (c ReplicationNetworksClient) ListByReplicationFabrics(ctx context.Context, id ReplicationFabricId) (resp ListByReplicationFabricsOperationResponse, err error) {
	req, err := c.preparerForListByReplicationFabrics(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationnetworks.ReplicationNetworksClient", "ListByReplicationFabrics", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationnetworks.ReplicationNetworksClient", "ListByReplicationFabrics", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListByReplicationFabrics(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationnetworks.ReplicationNetworksClient", "ListByReplicationFabrics", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c ReplicationNetworksClient) preparerForListByReplicationFabrics(ctx context.Context, id ReplicationFabricId) (*http.Request, error) {
...
func (c ReplicationNetworksClient) preparerForListByReplicationFabricsWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c ReplicationNetworksClient) responderForListByReplicationFabrics(resp *http.Response) (result ListByReplicationFabricsOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByReplicationFabricsOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "replicationnetworks.ReplicationNetworksClient", "ListByReplicationFabrics", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListByReplicationFabrics(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "replicationnetworks.ReplicationNetworksClient", "ListByReplicationFabrics", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c ReplicationNetworksClient) ListByReplicationFabricsCompleteMatchingPredicate(ctx context.Context, id ReplicationFabricId, predicate NetworkOperationPredicate) (resp ListByReplicationFabricsCompleteResult, err error) {
