...
func (c ReplicationFabricsClient) Purge(ctx context.Context, id ReplicationFabricId) (result PurgeOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationfabrics.ReplicationFabricsClient", "Purge", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForPurge(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationfabrics.ReplicationFabricsClient", "Purge", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c ReplicationFabricsClient) preparerForPurge(ctx context.Context, id ReplicationFabricId) (*http.Request, error) {
...
func (c ReplicationFabricsClient) senderForPurge(ctx context.Context, req *http.Request) (future PurgeOperationResponse, err error) {
