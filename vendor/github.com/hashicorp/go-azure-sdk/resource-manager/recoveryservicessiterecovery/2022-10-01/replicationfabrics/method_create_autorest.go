...
func (c ReplicationFabricsClient) Create(ctx context.Context, id ReplicationFabricId, input FabricCreationInput) (result CreateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationfabrics.ReplicationFabricsClient", "Create", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForCreate(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationfabrics.ReplicationFabricsClient", "Create", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c ReplicationFabricsClient) preparerForCreate(ctx context.Context, id ReplicationFabricId, input FabricCreationInput) (*http.Request, error) {
...
func (c ReplicationFabricsClient) senderForCreate(ctx context.Context, req *http.Request) (future CreateOperationResponse, err error) {
