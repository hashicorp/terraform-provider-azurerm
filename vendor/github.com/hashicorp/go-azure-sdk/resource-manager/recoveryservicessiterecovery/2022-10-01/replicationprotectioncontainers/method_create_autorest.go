...
func (c ReplicationProtectionContainersClient) Create(ctx context.Context, id ReplicationProtectionContainerId, input CreateProtectionContainerInput) (result CreateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationprotectioncontainers.ReplicationProtectionContainersClient", "Create", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForCreate(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationprotectioncontainers.ReplicationProtectionContainersClient", "Create", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c ReplicationProtectionContainersClient) preparerForCreate(ctx context.Context, id ReplicationProtectionContainerId, input CreateProtectionContainerInput) (*http.Request, error) {
...
func (c ReplicationProtectionContainersClient) senderForCreate(ctx context.Context, req *http.Request) (future CreateOperationResponse, err error) {
