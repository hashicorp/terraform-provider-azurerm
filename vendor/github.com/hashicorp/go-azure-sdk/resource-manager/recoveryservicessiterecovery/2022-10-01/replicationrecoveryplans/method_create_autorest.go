...
func (c ReplicationRecoveryPlansClient) Create(ctx context.Context, id ReplicationRecoveryPlanId, input CreateRecoveryPlanInput) (result CreateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationrecoveryplans.ReplicationRecoveryPlansClient", "Create", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForCreate(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationrecoveryplans.ReplicationRecoveryPlansClient", "Create", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c ReplicationRecoveryPlansClient) preparerForCreate(ctx context.Context, id ReplicationRecoveryPlanId, input CreateRecoveryPlanInput) (*http.Request, error) {
...
func (c ReplicationRecoveryPlansClient) senderForCreate(ctx context.Context, req *http.Request) (future CreateOperationResponse, err error) {
