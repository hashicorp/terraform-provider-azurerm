...
func (c ReplicationRecoveryPlansClient) PlannedFailover(ctx context.Context, id ReplicationRecoveryPlanId, input RecoveryPlanPlannedFailoverInput) (result PlannedFailoverOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationrecoveryplans.ReplicationRecoveryPlansClient", "PlannedFailover", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForPlannedFailover(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationrecoveryplans.ReplicationRecoveryPlansClient", "PlannedFailover", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c ReplicationRecoveryPlansClient) preparerForPlannedFailover(ctx context.Context, id ReplicationRecoveryPlanId, input RecoveryPlanPlannedFailoverInput) (*http.Request, error) {
...
func (c ReplicationRecoveryPlansClient) senderForPlannedFailover(ctx context.Context, req *http.Request) (future PlannedFailoverOperationResponse, err error) {
