...
func (c ReplicationRecoveryPlansClient) TestFailover(ctx context.Context, id ReplicationRecoveryPlanId, input RecoveryPlanTestFailoverInput) (result TestFailoverOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationrecoveryplans.ReplicationRecoveryPlansClient", "TestFailover", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForTestFailover(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationrecoveryplans.ReplicationRecoveryPlansClient", "TestFailover", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c ReplicationRecoveryPlansClient) preparerForTestFailover(ctx context.Context, id ReplicationRecoveryPlanId, input RecoveryPlanTestFailoverInput) (*http.Request, error) {
...
func (c ReplicationRecoveryPlansClient) senderForTestFailover(ctx context.Context, req *http.Request) (future TestFailoverOperationResponse, err error) {
