...
func (c ReplicationRecoveryPlansClient) FailoverCommit(ctx context.Context, id ReplicationRecoveryPlanId) (result FailoverCommitOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationrecoveryplans.ReplicationRecoveryPlansClient", "FailoverCommit", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForFailoverCommit(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationrecoveryplans.ReplicationRecoveryPlansClient", "FailoverCommit", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c ReplicationRecoveryPlansClient) preparerForFailoverCommit(ctx context.Context, id ReplicationRecoveryPlanId) (*http.Request, error) {
...
func (c ReplicationRecoveryPlansClient) senderForFailoverCommit(ctx context.Context, req *http.Request) (future FailoverCommitOperationResponse, err error) {
