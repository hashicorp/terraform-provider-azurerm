...
func (c ReplicationNetworkMappingsClient) UpdateCallbackThenPoll(ctx context.Context, id ReplicationNetworkMappingId, input UpdateNetworkMappingInput, callback func() error) error {
