...
func (c ReplicationRecoveryPlansClient) TestFailoverCleanupCallbackThenPoll(ctx context.Context, id ReplicationRecoveryPlanId, input RecoveryPlanTestFailoverCleanupInput, callback func() error) error {
