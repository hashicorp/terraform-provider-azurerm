...
func (c ReplicationRecoveryPlansClient) CreateCallbackThenPoll(ctx context.Context, id ReplicationRecoveryPlanId, input CreateRecoveryPlanInput, callback func() error) error {
