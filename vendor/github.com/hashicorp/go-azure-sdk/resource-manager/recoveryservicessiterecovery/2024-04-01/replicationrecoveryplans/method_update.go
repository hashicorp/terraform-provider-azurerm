...
func (c ReplicationRecoveryPlansClient) UpdateCallbackThenPoll(ctx context.Context, id ReplicationRecoveryPlanId, input UpdateRecoveryPlanInput, callback func() error) error {
