...
func (c ReplicationRecoveryServicesProvidersClient) CreateCallbackThenPoll(ctx context.Context, id ReplicationRecoveryServicesProviderId, input AddRecoveryServicesProviderInput, callback func() error) error {
