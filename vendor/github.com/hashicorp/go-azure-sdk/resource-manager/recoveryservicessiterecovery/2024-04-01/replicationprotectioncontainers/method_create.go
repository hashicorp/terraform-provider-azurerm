...
func (c ReplicationProtectionContainersClient) CreateCallbackThenPoll(ctx context.Context, id ReplicationProtectionContainerId, input CreateProtectionContainerInput, callback func() error) error {
