...
func (c ReplicationProtectedItemsClient) PlannedFailoverCallbackThenPoll(ctx context.Context, id ReplicationProtectedItemId, input PlannedFailoverInput, callback func() error) error {
