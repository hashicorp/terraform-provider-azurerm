...
func (c ReplicationProtectedItemsClient) TestFailoverCallbackThenPoll(ctx context.Context, id ReplicationProtectedItemId, input TestFailoverInput, callback func() error) error {
