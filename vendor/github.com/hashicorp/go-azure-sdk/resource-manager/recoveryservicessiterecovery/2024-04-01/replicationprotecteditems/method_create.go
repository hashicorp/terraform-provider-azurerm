...
func (c ReplicationProtectedItemsClient) CreateCallbackThenPoll(ctx context.Context, id ReplicationProtectedItemId, input EnableProtectionInput, callback func() error) error {
