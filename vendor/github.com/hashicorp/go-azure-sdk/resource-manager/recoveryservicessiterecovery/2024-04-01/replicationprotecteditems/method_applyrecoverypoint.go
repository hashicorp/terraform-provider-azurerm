...
func (c ReplicationProtectedItemsClient) ApplyRecoveryPointCallbackThenPoll(ctx context.Context, id ReplicationProtectedItemId, input ApplyRecoveryPointInput, callback func() error) error {
