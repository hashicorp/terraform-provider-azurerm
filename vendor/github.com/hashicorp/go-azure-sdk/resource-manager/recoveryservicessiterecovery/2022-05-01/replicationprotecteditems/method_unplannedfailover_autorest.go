...
func (c ReplicationProtectedItemsClient) UnplannedFailover(ctx context.Context, id ReplicationProtectedItemId, input UnplannedFailoverInput) (result UnplannedFailoverOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationprotecteditems.ReplicationProtectedItemsClient", "UnplannedFailover", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForUnplannedFailover(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "replicationprotecteditems.ReplicationProtectedItemsClient", "UnplannedFailover", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c ReplicationProtectedItemsClient) preparerForUnplannedFailover(ctx context.Context, id ReplicationProtectedItemId, input UnplannedFailoverInput) (*http.Request, error) {
...
func (c ReplicationProtectedItemsClient) senderForUnplannedFailover(ctx context.Context, req *http.Request) (future UnplannedFailoverOperationResponse, err error) {
