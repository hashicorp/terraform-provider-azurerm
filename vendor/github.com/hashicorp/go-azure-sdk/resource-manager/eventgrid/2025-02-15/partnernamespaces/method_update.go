...
func (c PartnerNamespacesClient) UpdateCallbackThenPoll(ctx context.Context, id PartnerNamespaceId, input PartnerNamespaceUpdateParameters, callback func() error) error {
