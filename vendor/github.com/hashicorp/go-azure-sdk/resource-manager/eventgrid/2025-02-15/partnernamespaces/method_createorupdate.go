...
func (c PartnerNamespacesClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id PartnerNamespaceId, input PartnerNamespace, callback func() error) error {
