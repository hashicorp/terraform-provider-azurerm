...
func (c PermissionBindingsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id PermissionBindingId, input PermissionBinding, callback func() error) error {
