...
func (c EventSubscriptionsClient) UpdateCallbackThenPoll(ctx context.Context, id ScopedEventSubscriptionId, input EventSubscriptionUpdateParameters, callback func() error) error {
