...
func (c PrivateEndpointConnectionsClient) UpdateCallbackThenPoll(ctx context.Context, id ScopedPrivateEndpointConnectionId, input PrivateEndpointConnection, callback func() error) error {
