...
func (c NamespaceTopicsClient) UpdateCallbackThenPoll(ctx context.Context, id NamespaceTopicId, input NamespaceTopicUpdateParameters, callback func() error) error {
