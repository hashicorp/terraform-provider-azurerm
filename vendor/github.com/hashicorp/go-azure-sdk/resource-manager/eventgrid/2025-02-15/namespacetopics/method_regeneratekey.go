...
func (c NamespaceTopicsClient) RegenerateKeyCallbackThenPoll(ctx context.Context, id NamespaceTopicId, input TopicRegenerateKeyRequest, callback func() error) error {
