...
type ValidateCustomDomainOwnershipOperationResponse struct {
...
func (c NamespacesClient) ValidateCustomDomainOwnership(ctx context.Context, id NamespaceId) (result ValidateCustomDomainOwnershipOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:       fmt.Sprintf("%s/validateCustomDomainOwnership", id.ID()),
	}
...
func (c NamespacesClient) ValidateCustomDomainOwnershipThenPoll(ctx context.Context, id NamespaceId) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after ValidateCustomDomainOwnership: %+v", err)
	}
