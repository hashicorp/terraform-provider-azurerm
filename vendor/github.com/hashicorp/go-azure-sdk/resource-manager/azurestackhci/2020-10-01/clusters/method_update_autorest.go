...
func (c ClustersClient) Update(ctx context.Context, id ClusterId, input ClusterUpdate) (result UpdateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "clusters.ClustersClient", "Update", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c ClustersClient) responderForUpdate(resp *http.Response) (result UpdateOperationResponse, err error) {
