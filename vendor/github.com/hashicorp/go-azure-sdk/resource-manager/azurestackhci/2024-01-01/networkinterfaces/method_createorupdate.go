...
func (c NetworkInterfacesClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id NetworkInterfaceId, input NetworkInterfaces, callback func() error) error {
