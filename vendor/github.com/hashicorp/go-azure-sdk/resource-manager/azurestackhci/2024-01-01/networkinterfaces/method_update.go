...
func (c NetworkInterfacesClient) UpdateCallbackThenPoll(ctx context.Context, id NetworkInterfaceId, input NetworkInterfacesUpdateRequest, callback func() error) error {
