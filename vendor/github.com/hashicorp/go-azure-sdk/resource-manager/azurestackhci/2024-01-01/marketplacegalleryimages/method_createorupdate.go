...
func (c MarketplaceGalleryImagesClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id MarketplaceGalleryImageId, input MarketplaceGalleryImages, callback func() error) error {
