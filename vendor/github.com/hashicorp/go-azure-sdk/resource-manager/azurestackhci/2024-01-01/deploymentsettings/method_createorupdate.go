...
func (c DeploymentSettingsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id DeploymentSettingId, input DeploymentSetting, callback func() error) error {
