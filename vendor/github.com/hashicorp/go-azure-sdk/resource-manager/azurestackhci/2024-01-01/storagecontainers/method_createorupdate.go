...
func (c StorageContainersClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id StorageContainerId, input StorageContainers, callback func() error) error {
