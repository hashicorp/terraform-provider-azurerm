...
func (c StorageContainersClient) UpdateCallbackThenPoll(ctx context.Context, id StorageContainerId, input StorageContainersUpdateRequest, callback func() error) error {
