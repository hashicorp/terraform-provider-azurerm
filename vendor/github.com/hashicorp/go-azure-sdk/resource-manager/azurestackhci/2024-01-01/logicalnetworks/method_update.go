...
func (c LogicalNetworksClient) UpdateCallbackThenPoll(ctx context.Context, id LogicalNetworkId, input LogicalNetworksUpdateRequest, callback func() error) error {
