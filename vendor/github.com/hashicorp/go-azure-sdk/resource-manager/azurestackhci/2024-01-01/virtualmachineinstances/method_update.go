...
func (c VirtualMachineInstancesClient) UpdateCallbackThenPoll(ctx context.Context, id commonids.ScopeId, input VirtualMachineInstanceUpdateRequest, callback func() error) error {
