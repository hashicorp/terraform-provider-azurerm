...
// CreateOrUpdate ...
func (c GalleryImagesClient) CreateOrUpdate(ctx context.Context, id GalleryImageId, input GalleryImages) (result CreateOrUpdateOperationResponse, err error) {
...
func (c GalleryImagesClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id GalleryImageId, input GalleryImages, callback func() error) error {
