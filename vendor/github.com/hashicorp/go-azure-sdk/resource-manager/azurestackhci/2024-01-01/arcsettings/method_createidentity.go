...
func (c ArcSettingsClient) CreateIdentityThenPoll(ctx context.Context, id ArcSettingId) error {
	return c.CreateIdentityCallbackThenPoll(ctx, id, nil)
}

// CreateIdentityCallbackThenPoll performs CreateIdentity, runs the optional callback function, then polls until it's completed
func (c ArcSettingsClient) CreateIdentityCallbackThenPoll(ctx context.Context, id ArcSettingId, callback func() error) error {
