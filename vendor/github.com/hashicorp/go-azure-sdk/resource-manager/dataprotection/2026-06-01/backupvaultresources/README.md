...
## `github.com/hashicorp/go-azure-sdk/resource-manager/dataprotection/2026-06-01/backupvaultresources` Documentation

The `backupvaultresources` SDK allows for interaction with Azure Resource Manager `dataprotection` (API Version `2026-06-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/dataprotection/2026-06-01/backupvaultresources"
```
