...
type BackupInstancesValidateForRestoreOperationResponse struct {
...
// BackupInstancesValidateForRestore ...
func (c BackupInstanceResourcesClient) BackupInstancesValidateForRestore(ctx context.Context, id BackupInstanceId, input ValidateRestoreRequestObject) (result BackupInstancesValidateForRestoreOperationResponse, err error) {
...
func (c BackupInstanceResourcesClient) BackupInstancesValidateForRestoreThenPoll(ctx context.Context, id BackupInstanceId, input ValidateRestoreRequestObject) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after BackupInstancesValidateForRestore: %+v", err)
	}
