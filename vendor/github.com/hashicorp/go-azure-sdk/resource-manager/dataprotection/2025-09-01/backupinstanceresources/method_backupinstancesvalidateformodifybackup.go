...
type BackupInstancesValidateForModifyBackupOperationResponse struct {
	Poller       pollers.Poller
	HttpResponse *http.Response
	OData        *odata.OData
}

// BackupInstancesValidateForModifyBackup ...
func (c BackupInstanceResourcesClient) BackupInstancesValidateForModifyBackup(ctx context.Context, id BackupInstanceId, input ValidateForModifyBackupRequest) (result BackupInstancesValidateForModifyBackupOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:       fmt.Sprintf("%s/validateForModifyBackup", id.ID()),
	}
...
func (c BackupInstanceResourcesClient) BackupInstancesValidateForModifyBackupThenPoll(ctx context.Context, id BackupInstanceId, input ValidateForModifyBackupRequest) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after BackupInstancesValidateForModifyBackup: %+v", err)
	}
