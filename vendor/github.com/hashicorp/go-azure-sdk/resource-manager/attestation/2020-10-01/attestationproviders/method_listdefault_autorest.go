...
func (c AttestationProvidersClient) preparerForListDefault(ctx context.Context, id commonids.SubscriptionId) (*http.Request, error) {
...
func (c AttestationProvidersClient) responderForListDefault(resp *http.Response) (result ListDefaultOperationResponse, err error) {
