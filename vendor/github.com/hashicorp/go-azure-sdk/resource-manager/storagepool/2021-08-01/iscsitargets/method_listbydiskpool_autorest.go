...
type ListByDiskPoolOperationResponse struct {
	...
	nextLink     *string
	nextPageFunc func(ctx context.Context, nextLink string) (ListByDiskPoolOperationResponse, error)
}
...
func (r ListByDiskPoolOperationResponse) HasMore() bool {
	return r.nextLink != nil
}

func (r ListByDiskPoolOperationResponse) LoadMore(ctx context.Context) (resp ListByDiskPoolOperationResponse, err error) {
	if !r.HasMore() {
...
// ListByDiskPool ...
func (c IscsiTargetsClient) ListByDiskPool(ctx context.Context, id DiskPoolId) (resp ListByDiskPoolOperationResponse, err error) {
...
func (c IscsiTargetsClient) responderForListByDiskPool(resp *http.Response) (result ListByDiskPoolOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByDiskPoolOperationResponse, err error) {
...
func (c IscsiTargetsClient) ListByDiskPoolCompleteMatchingPredicate(ctx context.Context, id DiskPoolId, predicate IscsiTargetOperationPredicate) (resp ListByDiskPoolCompleteResult, err error) {
