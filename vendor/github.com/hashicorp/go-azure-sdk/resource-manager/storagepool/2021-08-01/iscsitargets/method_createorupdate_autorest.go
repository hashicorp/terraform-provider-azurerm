...
// CreateOrUpdate ...
func (c IscsiTargetsClient) CreateOrUpdate(ctx context.Context, id IscsiTargetId, input IscsiTargetCreate) (result CreateOrUpdateOperationResponse, err error) {
...
func (c IscsiTargetsClient) senderForCreateOrUpdate(ctx context.Context, req *http.Request) (future CreateOrUpdateOperationResponse, err error) {
