...
func (c SignalRClient) SharedPrivateLinkResourcesCreateOrUpdateCallbackThenPoll(ctx context.Context, id SharedPrivateLinkResourceId, input SharedPrivateLinkResource, callback func() error) error {
