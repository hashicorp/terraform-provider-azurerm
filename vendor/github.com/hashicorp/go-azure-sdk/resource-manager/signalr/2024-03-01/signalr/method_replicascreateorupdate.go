...
func (c SignalRClient) ReplicasCreateOrUpdateCallbackThenPoll(ctx context.Context, id ReplicaId, input Replica, callback func() error) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after ReplicasCreateOrUpdate: %+v", err)
	}
