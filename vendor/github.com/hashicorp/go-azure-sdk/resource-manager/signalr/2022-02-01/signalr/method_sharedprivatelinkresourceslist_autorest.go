...
type SharedPrivateLinkResourcesListOperationResponse struct {
	...
	nextLink     *string
	nextPageFunc func(ctx context.Context, nextLink string) (SharedPrivateLinkResourcesListOperationResponse, error)
}
...
func (c SignalRClient) SharedPrivateLinkResourcesList(ctx context.Context, id SignalRId) (resp SharedPrivateLinkResourcesListOperationResponse, err error) {
	req, err := c.preparerForSharedPrivateLinkResourcesList(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "signalr.SignalRClient", "SharedPrivateLinkResourcesList", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "signalr.SignalRClient", "SharedPrivateLinkResourcesList", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForSharedPrivateLinkResourcesList(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "signalr.SignalRClient", "SharedPrivateLinkResourcesList", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
// preparerForSharedPrivateLinkResourcesListWithNextLink prepares the SharedPrivateLinkResourcesList request with the given nextLink token.
func (c SignalRClient) preparerForSharedPrivateLinkResourcesListWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
// responderForSharedPrivateLinkResourcesList handles the response to the SharedPrivateLinkResourcesList request. The method always
// closes the http.Response Body.
func (c SignalRClient) responderForSharedPrivateLinkResourcesList(resp *http.Response) (result SharedPrivateLinkResourcesListOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result SharedPrivateLinkResourcesListOperationResponse, err error) {
			req, err := c.preparerForSharedPrivateLinkResourcesListWithNextLink(ctx, nextLink)
			if err != nil {
				err = autorest.NewErrorWithError(err, "signalr.SignalRClient", "SharedPrivateLinkResourcesList", nil, "Failure preparing request")
				return
			}
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "signalr.SignalRClient", "SharedPrivateLinkResourcesList", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForSharedPrivateLinkResourcesList(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "signalr.SignalRClient", "SharedPrivateLinkResourcesList", result.HttpResponse, "Failure responding to request")
				return
			}
