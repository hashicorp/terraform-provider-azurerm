...
// ListByCluster ...
func (c PrivateEndpointConnectionsClient) ListByCluster(ctx context.Context, id ClusterId) (result ListByClusterOperationResponse, err error) {
...
func (c PrivateEndpointConnectionsClient) ListByClusterComplete(ctx context.Context, id ClusterId) (ListByClusterCompleteResult, error) {
...
func (c PrivateEndpointConnectionsClient) ListByClusterCompleteMatchingPredicate(ctx context.Context, id ClusterId, predicate PrivateEndpointConnectionOperationPredicate) (result ListByClusterCompleteResult, err error) {
