...
func (c ClustersClient) CreateCallbackThenPoll(ctx context.Context, id commonids.HDInsightClusterId, input ClusterCreateParametersExtended, callback func() error) error {
