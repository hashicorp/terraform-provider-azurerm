...
func (c HdinsightsClient) ClusterPoolsListByResourceGroupComplete(ctx context.Context, id commonids.ResourceGroupId) (ClusterPoolsListByResourceGroupCompleteResult, error) {
	return c.ClusterPoolsListByResourceGroupCompleteMatchingPredicate(ctx, id, ClusterPoolOperationPredicate{})
}
...
func (c HdinsightsClient) ClusterPoolsListByResourceGroupCompleteMatchingPredicate(ctx context.Context, id commonids.ResourceGroupId, predicate ClusterPoolOperationPredicate) (result ClusterPoolsListByResourceGroupCompleteResult, err error) {
	...
	resp, err := c.ClusterPoolsListByResourceGroup(ctx, id)
	if err != nil {
	...
	result = ClusterPoolsListByResourceGroupCompleteResult{
