...
var _ ClusterUpgradeHistoryProperties = ClusterHotfixUpgradeHistoryProperties{}
...
var _ json.Marshaler = ClusterHotfixUpgradeHistoryProperties{}

func (s ClusterHotfixUpgradeHistoryProperties) MarshalJSON() ([]byte, error) {
	type wrapper ClusterHotfixUpgradeHistoryProperties
	wrapped := wrapper(s)
	encoded, err := json.Marshal(wrapped)
	if err != nil {
		return nil, fmt.Errorf("marshaling ClusterHotfixUpgradeHistoryProperties: %+v", err)
	}

	var decoded map[string]interface{}
	if err := json.Unmarshal(encoded, &decoded); err != nil {
		return nil, fmt.Errorf("unmarshaling ClusterHotfixUpgradeHistoryProperties: %+v", err)
	}
	decoded["upgradeType"] = "HotfixUpgrade"

	encoded, err = json.Marshal(decoded)
	if err != nil {
		return nil, fmt.Errorf("re-marshaling ClusterHotfixUpgradeHistoryProperties: %+v", err)
	}
