...
func (c ConfigurationsClient) ListByCluster(ctx context.Context, id ServerGroupsv2Id) (resp ListByClusterOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "configurations.ConfigurationsClient", "ListByCluster", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "configurations.ConfigurationsClient", "ListByCluster", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListByCluster(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "configurations.ConfigurationsClient", "ListByCluster", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c ConfigurationsClient) preparerForListByCluster(ctx context.Context, id ServerGroupsv2Id) (*http.Request, error) {
...
func (c ConfigurationsClient) preparerForListByClusterWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c ConfigurationsClient) responderForListByCluster(resp *http.Response) (result ListByClusterOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByClusterOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "configurations.ConfigurationsClient", "ListByCluster", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListByCluster(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "configurations.ConfigurationsClient", "ListByCluster", result.HttpResponse, "Failure responding to request")
				return
			}
