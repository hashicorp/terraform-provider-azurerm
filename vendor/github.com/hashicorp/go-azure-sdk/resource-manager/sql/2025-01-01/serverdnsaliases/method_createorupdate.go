...
// CreateOrUpdate ...
func (c ServerDnsAliasesClient) CreateOrUpdate(ctx context.Context, id DnsAliasId) (result CreateOrUpdateOperationResponse, err error) {
...
func (c ServerDnsAliasesClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id DnsAliasId, callback func() error) error {
