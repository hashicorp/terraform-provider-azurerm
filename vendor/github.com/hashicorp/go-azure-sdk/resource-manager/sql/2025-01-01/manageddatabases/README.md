...
## `github.com/hashicorp/go-azure-sdk/resource-manager/sql/2025-01-01/manageddatabases` Documentation

The `manageddatabases` SDK allows for interaction with Azure Resource Manager `sql` (API Version `2025-01-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/sql/2025-01-01/manageddatabases"
```
