...
// Suspend ...
func (c TransparentDataEncryptionsClient) Suspend(ctx context.Context, id commonids.SqlDatabaseId) (result SuspendOperationResponse, err error) {
	opts := client.RequestOptions{
		...
		Path:       fmt.Sprintf("%s/transparentDataEncryption/current/suspend", id.ID()),
	}
