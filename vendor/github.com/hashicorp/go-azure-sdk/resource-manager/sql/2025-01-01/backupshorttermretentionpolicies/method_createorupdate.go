...
func (c BackupShortTermRetentionPoliciesClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id commonids.SqlDatabaseId, input BackupShortTermRetentionPolicy, callback func() error) error {
