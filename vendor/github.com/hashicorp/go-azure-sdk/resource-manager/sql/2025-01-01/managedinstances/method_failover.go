...
func (c ManagedInstancesClient) FailoverCallbackThenPoll(ctx context.Context, id commonids.SqlManagedInstanceId, options FailoverOperationOptions, callback func() error) error {
