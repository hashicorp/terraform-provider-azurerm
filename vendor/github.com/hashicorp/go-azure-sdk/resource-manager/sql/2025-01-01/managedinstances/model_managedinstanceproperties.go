...
type ManagedInstanceProperties struct {
	...
	MemorySizeInGB                   *int64                                `json:"memorySizeInGB,omitempty"`
	...
	RequestedLogicalAvailabilityZone *AvailabilityZoneType                 `json:"requestedLogicalAvailabilityZone,omitempty"`
