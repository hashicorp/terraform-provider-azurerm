...
func (c ManagedInstancesClient) ReevaluateInaccessibleDatabaseState(ctx context.Context, id commonids.SqlManagedInstanceId) (result ReevaluateInaccessibleDatabaseStateOperationResponse, err error) {
