...
func (c ServerSecurityAlertPoliciesClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id commonids.SqlServerId, input ServerSecurityAlertPolicy, callback func() error) error {
