...
func (c InstanceFailoverGroupsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id InstanceFailoverGroupId, input InstanceFailoverGroup, callback func() error) error {
