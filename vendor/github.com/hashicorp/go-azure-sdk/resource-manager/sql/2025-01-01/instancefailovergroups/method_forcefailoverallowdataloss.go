...
func (c InstanceFailoverGroupsClient) ForceFailoverAllowDataLossCallbackThenPoll(ctx context.Context, id InstanceFailoverGroupId, callback func() error) error {
