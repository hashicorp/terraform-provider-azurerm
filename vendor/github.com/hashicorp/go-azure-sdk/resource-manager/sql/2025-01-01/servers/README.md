...
## `github.com/hashicorp/go-azure-sdk/resource-manager/sql/2025-01-01/servers` Documentation

The `servers` SDK allows for interaction with Azure Resource Manager `sql` (API Version `2025-01-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/sql/2025-01-01/servers"
```
