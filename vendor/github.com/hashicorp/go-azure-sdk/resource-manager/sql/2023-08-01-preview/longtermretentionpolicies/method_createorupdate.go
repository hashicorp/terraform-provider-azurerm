...
func (c LongTermRetentionPoliciesClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id commonids.SqlDatabaseId, input LongTermRetentionPolicy, callback func() error) error {
