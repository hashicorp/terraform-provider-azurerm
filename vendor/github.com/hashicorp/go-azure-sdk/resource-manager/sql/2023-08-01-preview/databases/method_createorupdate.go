...
// CreateOrUpdate ...
func (c DatabasesClient) CreateOrUpdate(ctx context.Context, id commonids.SqlDatabaseId, input Database) (result CreateOrUpdateOperationResponse, err error) {
...
func (c DatabasesClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id commonids.SqlDatabaseId, input Database, callback func() error) error {
