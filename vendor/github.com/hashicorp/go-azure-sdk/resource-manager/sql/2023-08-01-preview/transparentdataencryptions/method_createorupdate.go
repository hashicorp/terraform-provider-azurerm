...
func (c TransparentDataEncryptionsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id commonids.SqlDatabaseId, input LogicalDatabaseTransparentDataEncryption, callback func() error) error {
