...
func (c ManagedInstanceAzureADOnlyAuthenticationsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id commonids.SqlManagedInstanceId, input ManagedInstanceAzureADOnlyAuthentication, callback func() error) error {
