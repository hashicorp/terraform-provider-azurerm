...
func (c ServerAzureADAdministratorsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id commonids.SqlServerId, input ServerAzureADAdministrator, callback func() error) error {
