...
func (c ServerAzureADOnlyAuthenticationsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id commonids.SqlServerId, input ServerAzureADOnlyAuthentication, callback func() error) error {
