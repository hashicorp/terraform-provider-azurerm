...
func (c ManagedInstanceAdministratorsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id commonids.SqlManagedInstanceId, input ManagedInstanceAdministrator, callback func() error) error {
