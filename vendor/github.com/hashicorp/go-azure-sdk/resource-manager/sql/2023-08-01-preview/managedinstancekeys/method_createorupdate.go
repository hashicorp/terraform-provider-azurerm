...
func (c ManagedInstanceKeysClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id ManagedInstanceKeyId, input ManagedInstanceKey, callback func() error) error {
