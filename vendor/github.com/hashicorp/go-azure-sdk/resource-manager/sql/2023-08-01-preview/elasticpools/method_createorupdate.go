...
func (c ElasticPoolsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id commonids.SqlElasticPoolId, input ElasticPool, callback func() error) error {
