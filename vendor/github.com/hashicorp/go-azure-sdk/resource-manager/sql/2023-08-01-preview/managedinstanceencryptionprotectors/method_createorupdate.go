...
func (c ManagedInstanceEncryptionProtectorsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id commonids.SqlManagedInstanceId, input ManagedInstanceEncryptionProtector, callback func() error) error {
