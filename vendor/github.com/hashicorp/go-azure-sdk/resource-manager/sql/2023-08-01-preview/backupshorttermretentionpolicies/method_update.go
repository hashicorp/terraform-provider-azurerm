...
func (c BackupShortTermRetentionPoliciesClient) UpdateCallbackThenPoll(ctx context.Context, id commonids.SqlDatabaseId, input BackupShortTermRetentionPolicy, callback func() error) error {
