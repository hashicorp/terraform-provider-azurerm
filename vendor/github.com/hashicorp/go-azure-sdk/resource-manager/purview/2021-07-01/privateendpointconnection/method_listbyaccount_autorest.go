...
// ListByAccount ...
func (c PrivateEndpointConnectionClient) ListByAccount(ctx context.Context, id AccountId) (resp ListByAccountOperationResponse, err error) {
...
func (c PrivateEndpointConnectionClient) responderForListByAccount(resp *http.Response) (result ListByAccountOperationResponse, err error) {
	type page struct {
