...
func (c SchedulesClient) Execute(ctx context.Context, id LabScheduleId) (result ExecuteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "schedules.SchedulesClient", "Execute", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForExecute(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "schedules.SchedulesClient", "Execute", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c SchedulesClient) preparerForExecute(ctx context.Context, id LabScheduleId) (*http.Request, error) {
...
func (c SchedulesClient) senderForExecute(ctx context.Context, req *http.Request) (future ExecuteOperationResponse, err error) {
