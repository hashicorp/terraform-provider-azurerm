...
func (c IotDpsResourceClient) UpdateCallbackThenPoll(ctx context.Context, id commonids.ProvisioningServiceId, input TagsResource, callback func() error) error {
