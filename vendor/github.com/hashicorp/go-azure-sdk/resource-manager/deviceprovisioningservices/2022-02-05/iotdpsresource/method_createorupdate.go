...
func (c IotDpsResourceClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id commonids.ProvisioningServiceId, input ProvisioningServiceDescription, callback func() error) error {
