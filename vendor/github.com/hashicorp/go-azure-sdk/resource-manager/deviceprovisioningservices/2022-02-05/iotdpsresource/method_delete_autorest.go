...
func (c IotDpsResourceClient) Delete(ctx context.Context, id commonids.ProvisioningServiceId) (result DeleteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "iotdpsresource.IotDpsResourceClient", "Delete", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c IotDpsResourceClient) senderForDelete(ctx context.Context, req *http.Request) (future DeleteOperationResponse, err error) {
