...
func (c AuthorizationsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id AuthorizationId, input ExpressRouteAuthorization, callback func() error) error {
