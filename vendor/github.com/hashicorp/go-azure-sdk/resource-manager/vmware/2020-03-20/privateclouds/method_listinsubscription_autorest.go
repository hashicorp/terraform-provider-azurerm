...
type ListInSubscriptionOperationResponse struct {
	...
	nextLink     *string
	nextPageFunc func(ctx context.Context, nextLink string) (ListInSubscriptionOperationResponse, error)
}
...
func (c PrivateCloudsClient) responderForListInSubscription(resp *http.Response) (result ListInSubscriptionOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListInSubscriptionOperationResponse, err error) {
