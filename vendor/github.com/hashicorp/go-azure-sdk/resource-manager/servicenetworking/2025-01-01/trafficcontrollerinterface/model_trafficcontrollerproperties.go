...
type TrafficControllerProperties struct {
	...
	SecurityPolicies             *[]ResourceId                 `json:"securityPolicies,omitempty"`
	SecurityPolicyConfigurations *SecurityPolicyConfigurations `json:"securityPolicyConfigurations,omitempty"`
}
