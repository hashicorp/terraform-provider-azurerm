...
func (c SecurityPoliciesInterfaceClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id SecurityPolicyId, input SecurityPolicy, callback func() error) error {
