...
## `github.com/hashicorp/go-azure-sdk/resource-manager/datadog/2023-01-01/hosts` Documentation

The `hosts` SDK allows for interaction with Azure Resource Manager `datadog` (API Version `2023-01-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/datadog/2023-01-01/hosts"
```
