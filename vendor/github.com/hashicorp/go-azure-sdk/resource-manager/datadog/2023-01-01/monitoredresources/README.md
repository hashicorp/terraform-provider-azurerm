...
## `github.com/hashicorp/go-azure-sdk/resource-manager/datadog/2023-01-01/monitoredresources` Documentation

The `monitoredresources` SDK allows for interaction with Azure Resource Manager `datadog` (API Version `2023-01-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/datadog/2023-01-01/monitoredresources"
```
