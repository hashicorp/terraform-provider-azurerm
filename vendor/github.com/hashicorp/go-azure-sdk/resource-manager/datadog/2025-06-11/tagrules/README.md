...
## `github.com/hashicorp/go-azure-sdk/resource-manager/datadog/2025-06-11/tagrules` Documentation

The `tagrules` SDK allows for interaction with Azure Resource Manager `datadog` (API Version `2025-06-11`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/datadog/2025-06-11/tagrules"
```
