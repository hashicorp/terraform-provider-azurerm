...
func (c DatadogsClient) MarketplaceAgreementsList(ctx context.Context, id commonids.SubscriptionId) (result MarketplaceAgreementsListOperationResponse, err error) {
...
func (c DatadogsClient) MarketplaceAgreementsListComplete(ctx context.Context, id commonids.SubscriptionId) (MarketplaceAgreementsListCompleteResult, error) {
...
func (c DatadogsClient) MarketplaceAgreementsListCompleteMatchingPredicate(ctx context.Context, id commonids.SubscriptionId, predicate DatadogAgreementResourceOperationPredicate) (result MarketplaceAgreementsListCompleteResult, err error) {
