...
func (c MonitoredSubscriptionsClient) UpdateCallbackThenPoll(ctx context.Context, id MonitoredSubscriptionId, input MonitoredSubscriptionProperties, callback func() error) error {
