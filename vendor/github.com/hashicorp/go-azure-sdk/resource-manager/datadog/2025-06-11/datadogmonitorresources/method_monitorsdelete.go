...
// MonitorsDelete ...
func (c DatadogMonitorResourcesClient) MonitorsDelete(ctx context.Context, id MonitorId) (result MonitorsDeleteOperationResponse, err error) {
...
func (c DatadogMonitorResourcesClient) MonitorsDeleteThenPoll(ctx context.Context, id MonitorId) error {
