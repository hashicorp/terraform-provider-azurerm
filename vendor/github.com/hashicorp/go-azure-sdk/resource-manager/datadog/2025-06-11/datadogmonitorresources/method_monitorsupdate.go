...
// MonitorsUpdate ...
func (c DatadogMonitorResourcesClient) MonitorsUpdate(ctx context.Context, id MonitorId, input DatadogMonitorResourceUpdateParameters) (result MonitorsUpdateOperationResponse, err error) {
...
func (c DatadogMonitorResourcesClient) MonitorsUpdateThenPoll(ctx context.Context, id MonitorId, input DatadogMonitorResourceUpdateParameters) error {
...
func (c DatadogMonitorResourcesClient) MonitorsUpdateCallbackThenPoll(ctx context.Context, id MonitorId, input DatadogMonitorResourceUpdateParameters, callback func() error) error {
