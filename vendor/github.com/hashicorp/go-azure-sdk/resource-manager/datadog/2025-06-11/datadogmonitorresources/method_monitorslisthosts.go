...
// MonitorsListHosts ...
func (c DatadogMonitorResourcesClient) MonitorsListHosts(ctx context.Context, id MonitorId) (result MonitorsListHostsOperationResponse, err error) {
...
func (c DatadogMonitorResourcesClient) MonitorsListHostsComplete(ctx context.Context, id MonitorId) (MonitorsListHostsCompleteResult, error) {
...
func (c DatadogMonitorResourcesClient) MonitorsListHostsCompleteMatchingPredicate(ctx context.Context, id MonitorId, predicate DatadogHostOperationPredicate) (result MonitorsListHostsCompleteResult, err error) {
