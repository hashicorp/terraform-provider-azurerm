...
func (c AlertProcessingRulesClient) AlertProcessingRulesListBySubscription(ctx context.Context, id commonids.SubscriptionId) (result AlertProcessingRulesListBySubscriptionOperationResponse, err error) {
...
func (c AlertProcessingRulesClient) AlertProcessingRulesListBySubscriptionCompleteMatchingPredicate(ctx context.Context, id commonids.SubscriptionId, predicate AlertProcessingRuleOperationPredicate) (result AlertProcessingRulesListBySubscriptionCompleteResult, err error) {
	...
	resp, err := c.AlertProcessingRulesListBySubscription(ctx, id)
	if err != nil {
	...
	result = AlertProcessingRulesListBySubscriptionCompleteResult{
		Items: items,
	}
	return
}
