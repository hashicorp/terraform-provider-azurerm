...
func (c PrivateZonesClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id PrivateDnsZoneId, input PrivateZone, options CreateOrUpdateOperationOptions, callback func() error) error {
