...
## `github.com/hashicorp/go-azure-sdk/resource-manager/kusto/2022-07-07/clusterprincipalassignments` Documentation

The `clusterprincipalassignments` SDK allows for interaction with the Azure Resource Manager Service `kusto` (API Version `2022-07-07`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/kusto/2022-07-07/clusterprincipalassignments"
```
