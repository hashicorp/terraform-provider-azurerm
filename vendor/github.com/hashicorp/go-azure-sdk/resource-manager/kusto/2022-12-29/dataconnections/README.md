...
## `github.com/hashicorp/go-azure-sdk/resource-manager/kusto/2022-12-29/dataconnections` Documentation

The `dataconnections` SDK allows for interaction with the Azure Resource Manager Service `kusto` (API Version `2022-12-29`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/kusto/2022-12-29/dataconnections"
```
