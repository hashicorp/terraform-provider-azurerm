...
## `github.com/hashicorp/go-azure-sdk/resource-manager/kusto/2022-02-01/clusters` Documentation

The `clusters` SDK allows for interaction with the Azure Resource Manager Service `kusto` (API Version `2022-02-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/kusto/2022-02-01/clusters"
```
