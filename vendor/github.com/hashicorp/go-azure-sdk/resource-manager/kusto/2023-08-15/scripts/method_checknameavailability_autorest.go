...
func (c ScriptsClient) CheckNameAvailability(ctx context.Context, id commonids.KustoDatabaseId, input ScriptCheckNameRequest) (result CheckNameAvailabilityOperationResponse, err error) {
...
func (c ScriptsClient) preparerForCheckNameAvailability(ctx context.Context, id commonids.KustoDatabaseId, input ScriptCheckNameRequest) (*http.Request, error) {
