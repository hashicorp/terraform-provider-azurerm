...
func (c ClustersClient) Start(ctx context.Context, id commonids.KustoClusterId) (result StartOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "clusters.ClustersClient", "Start", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c ClustersClient) senderForStart(ctx context.Context, req *http.Request) (future StartOperationResponse, err error) {
