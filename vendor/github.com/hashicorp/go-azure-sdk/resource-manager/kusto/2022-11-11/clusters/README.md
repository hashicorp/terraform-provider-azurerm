...
## `github.com/hashicorp/go-azure-sdk/resource-manager/kusto/2022-11-11/clusters` Documentation

The `clusters` SDK allows for interaction with the Azure Resource Manager Service `kusto` (API Version `2022-11-11`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/kusto/2022-11-11/clusters"
```
