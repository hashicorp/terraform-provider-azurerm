...
func (c ManagedPrivateEndpointsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id ManagedPrivateEndpointId, input ManagedPrivateEndpoint, callback func() error) error {
