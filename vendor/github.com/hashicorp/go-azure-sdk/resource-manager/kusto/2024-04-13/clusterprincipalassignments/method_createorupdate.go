...
func (c ClusterPrincipalAssignmentsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id PrincipalAssignmentId, input ClusterPrincipalAssignment, callback func() error) error {
