...
## `github.com/hashicorp/go-azure-sdk/resource-manager/kusto/2024-04-13/clusterprincipalassignments` Documentation

The `clusterprincipalassignments` SDK allows for interaction with Azure Resource Manager `kusto` (API Version `2024-04-13`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/kusto/2024-04-13/clusterprincipalassignments"
```
