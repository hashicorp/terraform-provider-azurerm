...
## `github.com/hashicorp/go-azure-sdk/resource-manager/kusto/2024-04-13/scripts` Documentation

The `scripts` SDK allows for interaction with Azure Resource Manager `kusto` (API Version `2024-04-13`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/kusto/2024-04-13/scripts"
```
