...
func (c ClustersClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id commonids.KustoClusterId, input Cluster, options CreateOrUpdateOperationOptions, callback func() error) error {
