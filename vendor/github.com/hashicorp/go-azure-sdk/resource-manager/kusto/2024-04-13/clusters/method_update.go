...
func (c ClustersClient) UpdateCallbackThenPoll(ctx context.Context, id commonids.KustoClusterId, input ClusterUpdate, options UpdateOperationOptions, callback func() error) error {
