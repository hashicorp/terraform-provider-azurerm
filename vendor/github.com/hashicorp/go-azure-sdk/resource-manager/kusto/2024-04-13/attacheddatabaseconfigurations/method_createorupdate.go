...
func (c AttachedDatabaseConfigurationsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id AttachedDatabaseConfigurationId, input AttachedDatabaseConfiguration, callback func() error) error {
