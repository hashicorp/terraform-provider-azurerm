...
func (c DatabasesClient) UpdateCallbackThenPoll(ctx context.Context, id commonids.KustoDatabaseId, input Database, options UpdateOperationOptions, callback func() error) error {
