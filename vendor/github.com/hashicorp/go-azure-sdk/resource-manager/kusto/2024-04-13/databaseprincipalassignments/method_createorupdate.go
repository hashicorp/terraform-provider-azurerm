...
func (c DatabasePrincipalAssignmentsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id DatabasePrincipalAssignmentId, input DatabasePrincipalAssignment, callback func() error) error {
