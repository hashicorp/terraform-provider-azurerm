...
func (c ClustersClient) Stop(ctx context.Context, id ClusterId) (result StopOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "clusters.ClustersClient", "Stop", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c ClustersClient) senderForStop(ctx context.Context, req *http.Request) (future StopOperationResponse, err error) {
