...
func (c MonitorsClient) Create(ctx context.Context, id MonitorId, input LogzMonitorResource) (result CreateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "monitors.MonitorsClient", "Create", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForCreate(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "monitors.MonitorsClient", "Create", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c MonitorsClient) preparerForCreate(ctx context.Context, id MonitorId, input LogzMonitorResource) (*http.Request, error) {
...
func (c MonitorsClient) senderForCreate(ctx context.Context, req *http.Request) (future CreateOperationResponse, err error) {
