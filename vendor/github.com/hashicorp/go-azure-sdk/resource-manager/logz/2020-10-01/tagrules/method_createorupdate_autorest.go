...
func (c TagRulesClient) CreateOrUpdate(ctx context.Context, id TagRuleId, input MonitoringTagRules) (result CreateOrUpdateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "tagrules.TagRulesClient", "CreateOrUpdate", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c TagRulesClient) preparerForCreateOrUpdate(ctx context.Context, id TagRuleId, input MonitoringTagRules) (*http.Request, error) {
...
func (c TagRulesClient) responderForCreateOrUpdate(resp *http.Response) (result CreateOrUpdateOperationResponse, err error) {
