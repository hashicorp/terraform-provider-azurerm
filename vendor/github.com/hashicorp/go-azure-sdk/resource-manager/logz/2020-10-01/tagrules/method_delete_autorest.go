...
func (c TagRulesClient) Delete(ctx context.Context, id TagRuleId) (result DeleteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "tagrules.TagRulesClient", "Delete", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c TagRulesClient) responderForDelete(resp *http.Response) (result DeleteOperationResponse, err error) {
