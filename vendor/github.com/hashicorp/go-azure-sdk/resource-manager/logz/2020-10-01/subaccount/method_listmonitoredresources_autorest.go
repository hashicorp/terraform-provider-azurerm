...
func (c SubAccountClient) ListMonitoredResources(ctx context.Context, id AccountId) (resp ListMonitoredResourcesOperationResponse, err error) {
	req, err := c.preparerForListMonitoredResources(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "subaccount.SubAccountClient", "ListMonitoredResources", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "subaccount.SubAccountClient", "ListMonitoredResources", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListMonitoredResources(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "subaccount.SubAccountClient", "ListMonitoredResources", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c SubAccountClient) preparerForListMonitoredResources(ctx context.Context, id AccountId) (*http.Request, error) {
...
func (c SubAccountClient) preparerForListMonitoredResourcesWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c SubAccountClient) responderForListMonitoredResources(resp *http.Response) (result ListMonitoredResourcesOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListMonitoredResourcesOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "subaccount.SubAccountClient", "ListMonitoredResources", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListMonitoredResources(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "subaccount.SubAccountClient", "ListMonitoredResources", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c SubAccountClient) ListMonitoredResourcesCompleteMatchingPredicate(ctx context.Context, id AccountId, predicate MonitoredResourceOperationPredicate) (resp ListMonitoredResourcesCompleteResult, err error) {
