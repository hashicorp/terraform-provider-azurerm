...
func (c SubAccountClient) Create(ctx context.Context, id AccountId, input LogzMonitorResource) (result CreateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "subaccount.SubAccountClient", "Create", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForCreate(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "subaccount.SubAccountClient", "Create", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c SubAccountClient) preparerForCreate(ctx context.Context, id AccountId, input LogzMonitorResource) (*http.Request, error) {
...
func (c SubAccountClient) senderForCreate(ctx context.Context, req *http.Request) (future CreateOperationResponse, err error) {
