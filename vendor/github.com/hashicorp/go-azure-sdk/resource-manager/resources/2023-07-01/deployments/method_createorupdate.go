...
func (c DeploymentsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id ResourceGroupProviderDeploymentId, input Deployment, callback func() error) error {
