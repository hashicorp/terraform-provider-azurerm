...
func (c DeploymentsClient) WhatIfAtTenantScopeThenPoll(ctx context.Context, id DeploymentId, input ScopedDeploymentWhatIf) error {
	return c.WhatIfAtTenantScopeCallbackThenPoll(ctx, id, input, nil)
}

// WhatIfAtTenantScopeCallbackThenPoll performs WhatIfAtTenantScope, runs the optional callback function, then polls until it's completed
func (c DeploymentsClient) WhatIfAtTenantScopeCallbackThenPoll(ctx context.Context, id DeploymentId, input ScopedDeploymentWhatIf, callback func() error) error {
