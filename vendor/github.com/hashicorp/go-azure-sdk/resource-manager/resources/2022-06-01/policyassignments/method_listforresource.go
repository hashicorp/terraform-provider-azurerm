...
// ListForResource ...
func (c PolicyAssignmentsClient) ListForResource(ctx context.Context, id ResourceId, options ListForResourceOperationOptions) (result ListForResourceOperationResponse, err error) {
...
func (c PolicyAssignmentsClient) ListForResourceCompleteMatchingPredicate(ctx context.Context, id ResourceId, options ListForResourceOperationOptions, predicate PolicyAssignmentOperationPredicate) (result ListForResourceCompleteResult, err error) {
