...
func (c ManagementLocksClient) CreateOrUpdateByScope(ctx context.Context, id ScopedLockId, input ManagementLockObject) (result CreateOrUpdateByScopeOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "managementlocks.ManagementLocksClient", "CreateOrUpdateByScope", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForCreateOrUpdateByScope(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "managementlocks.ManagementLocksClient", "CreateOrUpdateByScope", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c ManagementLocksClient) responderForCreateOrUpdateByScope(resp *http.Response) (result CreateOrUpdateByScopeOperationResponse, err error) {
