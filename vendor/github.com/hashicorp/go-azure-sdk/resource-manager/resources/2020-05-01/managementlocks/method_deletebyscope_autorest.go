...
func (c ManagementLocksClient) DeleteByScope(ctx context.Context, id ScopedLockId) (result DeleteByScopeOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "managementlocks.ManagementLocksClient", "DeleteByScope", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForDeleteByScope(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "managementlocks.ManagementLocksClient", "DeleteByScope", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c ManagementLocksClient) responderForDeleteByScope(resp *http.Response) (result DeleteByScopeOperationResponse, err error) {
