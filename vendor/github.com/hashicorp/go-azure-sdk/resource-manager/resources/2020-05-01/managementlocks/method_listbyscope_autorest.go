...
func (c ManagementLocksClient) ListByScope(ctx context.Context, id commonids.ScopeId, options ListByScopeOperationOptions) (resp ListByScopeOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "managementlocks.ManagementLocksClient", "ListByScope", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "managementlocks.ManagementLocksClient", "ListByScope", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListByScope(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "managementlocks.ManagementLocksClient", "ListByScope", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c ManagementLocksClient) preparerForListByScope(ctx context.Context, id commonids.ScopeId, options ListByScopeOperationOptions) (*http.Request, error) {
...
func (c ManagementLocksClient) preparerForListByScopeWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c ManagementLocksClient) responderForListByScope(resp *http.Response) (result ListByScopeOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByScopeOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "managementlocks.ManagementLocksClient", "ListByScope", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListByScope(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "managementlocks.ManagementLocksClient", "ListByScope", result.HttpResponse, "Failure responding to request")
				return
			}
