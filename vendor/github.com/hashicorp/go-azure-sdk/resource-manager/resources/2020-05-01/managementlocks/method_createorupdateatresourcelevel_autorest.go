...
func (c ManagementLocksClient) CreateOrUpdateAtResourceLevel(ctx context.Context, id ScopedLockId, input ManagementLockObject) (result CreateOrUpdateAtResourceLevelOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "managementlocks.ManagementLocksClient", "CreateOrUpdateAtResourceLevel", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForCreateOrUpdateAtResourceLevel(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "managementlocks.ManagementLocksClient", "CreateOrUpdateAtResourceLevel", result.HttpResponse, "Failure responding to request")
		return
	}
...
// responderForCreateOrUpdateAtResourceLevel handles the response to the CreateOrUpdateAtResourceLevel request. The method always
// closes the http.Response Body.
func (c ManagementLocksClient) responderForCreateOrUpdateAtResourceLevel(resp *http.Response) (result CreateOrUpdateAtResourceLevelOperationResponse, err error) {
