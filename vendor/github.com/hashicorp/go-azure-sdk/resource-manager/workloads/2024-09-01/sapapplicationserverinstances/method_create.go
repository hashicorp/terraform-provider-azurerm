...
func (c SAPApplicationServerInstancesClient) CreateCallbackThenPoll(ctx context.Context, id ApplicationInstanceId, input SAPApplicationServerInstance, callback func() error) error {
