...
func (c SAPVirtualInstancesClient) CreateCallbackThenPoll(ctx context.Context, id SapVirtualInstanceId, input SAPVirtualInstance, callback func() error) error {
