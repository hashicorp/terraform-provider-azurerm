...
func PossibleValuesForFileShareConfigurationType() []string {
	return []string{
		string(FileShareConfigurationTypeCreateAndMount),
		string(FileShareConfigurationTypeMount),
		string(FileShareConfigurationTypeSkip),
	}
}
...
func (s *FileShareConfigurationType) UnmarshalJSON(bytes []byte) error {
	...
	out, err := parseFileShareConfigurationType(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseFileShareConfigurationType(input string) (*FileShareConfigurationType, error) {
	vals := map[string]FileShareConfigurationType{
		"createandmount": FileShareConfigurationTypeCreateAndMount,
		"mount":          FileShareConfigurationTypeMount,
		"skip":           FileShareConfigurationTypeSkip,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := FileShareConfigurationType(input)
	return &out, nil
}
...
func PossibleValuesForManagedResourcesNetworkAccessType() []string {
	return []string{
		string(ManagedResourcesNetworkAccessTypePrivate),
		string(ManagedResourcesNetworkAccessTypePublic),
	}
}
...
func (s *ManagedResourcesNetworkAccessType) UnmarshalJSON(bytes []byte) error {
	...
	out, err := parseManagedResourcesNetworkAccessType(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseManagedResourcesNetworkAccessType(input string) (*ManagedResourcesNetworkAccessType, error) {
	vals := map[string]ManagedResourcesNetworkAccessType{
		"private": ManagedResourcesNetworkAccessTypePrivate,
	...
	// otherwise presume it's an undefined value and best-effort it
	out := ManagedResourcesNetworkAccessType(input)
	return &out, nil
}
...
func PossibleValuesForSAPVirtualInstanceState() []string {
	return []string{
		string(SAPVirtualInstanceStateACSSInstallationBlocked),
...
func parseSAPVirtualInstanceState(input string) (*SAPVirtualInstanceState, error) {
	vals := map[string]SAPVirtualInstanceState{
		"acssinstallationblocked":            SAPVirtualInstanceStateACSSInstallationBlocked,
