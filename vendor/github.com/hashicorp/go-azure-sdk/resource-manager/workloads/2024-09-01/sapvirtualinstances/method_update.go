...
func (c SAPVirtualInstancesClient) UpdateCallbackThenPoll(ctx context.Context, id SapVirtualInstanceId, input UpdateSAPVirtualInstanceRequest, callback func() error) error {
