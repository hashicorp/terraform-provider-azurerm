...
func (c ExascaleDbStorageVaultsClient) CreateCallbackThenPoll(ctx context.Context, id ExascaleDbStorageVaultId, input ExascaleDbStorageVault, callback func() error) error {
