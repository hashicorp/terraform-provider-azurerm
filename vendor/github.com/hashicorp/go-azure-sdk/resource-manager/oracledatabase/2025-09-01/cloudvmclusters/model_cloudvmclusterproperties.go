...
type CloudVMClusterProperties struct {
	...
	ExascaleDbStorageVaultId       *string                                `json:"exascaleDbStorageVaultId,omitempty"`
	...
	StorageManagementType          *ExadataVMClusterStorageManagementType `json:"storageManagementType,omitempty"`
