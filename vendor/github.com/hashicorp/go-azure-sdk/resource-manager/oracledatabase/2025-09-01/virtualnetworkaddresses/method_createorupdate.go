...
func (c VirtualNetworkAddressesClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id VirtualNetworkAddressId, input VirtualNetworkAddress, callback func() error) error {
