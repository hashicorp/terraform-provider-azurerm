...
func (c OracleSubscriptionsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id commonids.SubscriptionId, input OracleSubscription, callback func() error) error {
