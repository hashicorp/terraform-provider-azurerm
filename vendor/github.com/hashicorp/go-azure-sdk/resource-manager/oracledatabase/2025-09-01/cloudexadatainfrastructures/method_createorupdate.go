...
func (c CloudExadataInfrastructuresClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id CloudExadataInfrastructureId, input CloudExadataInfrastructure, callback func() error) error {
