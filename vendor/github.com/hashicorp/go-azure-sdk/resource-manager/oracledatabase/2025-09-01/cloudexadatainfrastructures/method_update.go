...
func (c CloudExadataInfrastructuresClient) UpdateCallbackThenPoll(ctx context.Context, id CloudExadataInfrastructureId, input CloudExadataInfrastructureUpdate, callback func() error) error {
