...
func (c AutonomousDatabasesClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id AutonomousDatabaseId, input AutonomousDatabase, callback func() error) error {
