...
func (c AutonomousDatabasesClient) UpdateCallbackThenPoll(ctx context.Context, id AutonomousDatabaseId, input AutonomousDatabaseUpdate, callback func() error) error {
