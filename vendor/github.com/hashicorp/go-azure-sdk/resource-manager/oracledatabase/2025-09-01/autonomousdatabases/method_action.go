...
// Action ...
func (c AutonomousDatabasesClient) Action(ctx context.Context, id AutonomousDatabaseId, input AutonomousDatabaseLifecycleAction) (result ActionOperationResponse, err error) {
