...
func (c AutonomousDatabaseBackupsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id AutonomousDatabaseBackupId, input AutonomousDatabaseBackup, callback func() error) error {
