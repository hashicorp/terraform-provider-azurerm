...
func (c AutonomousDatabaseBackupsClient) UpdateCallbackThenPoll(ctx context.Context, id AutonomousDatabaseBackupId, input AutonomousDatabaseBackupUpdate, callback func() error) error {
