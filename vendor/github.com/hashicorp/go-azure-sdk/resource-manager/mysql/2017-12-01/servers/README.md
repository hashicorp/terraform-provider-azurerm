...
## `github.com/hashicorp/go-azure-sdk/resource-manager/mysql/2017-12-01/servers` Documentation

The `servers` SDK allows for interaction with Azure Resource Manager `mysql` (API Version `2017-12-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/mysql/2017-12-01/servers"
```
