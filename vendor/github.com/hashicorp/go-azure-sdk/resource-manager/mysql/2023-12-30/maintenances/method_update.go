...
// Update ...
func (c MaintenancesClient) Update(ctx context.Context, id MaintenanceId, input MaintenanceUpdate) (result UpdateOperationResponse, err error) {
...
func (c MaintenancesClient) UpdateCallbackThenPoll(ctx context.Context, id MaintenanceId, input MaintenanceUpdate, callback func() error) error {
