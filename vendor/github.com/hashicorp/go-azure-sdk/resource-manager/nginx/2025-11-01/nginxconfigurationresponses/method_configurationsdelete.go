...
func (c NginxConfigurationResponsesClient) ConfigurationsDelete(ctx context.Context, id ConfigurationId) (result ConfigurationsDeleteOperationResponse, err error) {
...
func (c NginxConfigurationResponsesClient) ConfigurationsDeleteThenPoll(ctx context.Context, id ConfigurationId) error {
