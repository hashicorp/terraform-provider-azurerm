...
// DeploymentsDelete ...
func (c NginxDeploymentsClient) DeploymentsDelete(ctx context.Context, id NginxDeploymentId) (result DeploymentsDeleteOperationResponse, err error) {
...
func (c NginxDeploymentsClient) DeploymentsDeleteThenPoll(ctx context.Context, id NginxDeploymentId) error {
