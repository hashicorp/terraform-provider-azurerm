...
// CertificatesDelete ...
func (c NginxCertificatesClient) CertificatesDelete(ctx context.Context, id CertificateId) (result CertificatesDeleteOperationResponse, err error) {
...
func (c NginxCertificatesClient) CertificatesDeleteThenPoll(ctx context.Context, id CertificateId) error {
