...
## `github.com/hashicorp/go-azure-sdk/resource-manager/nginx/2024-11-01-preview/nginxdeployment` Documentation

The `nginxdeployment` SDK allows for interaction with Azure Resource Manager `nginx` (API Version `2024-11-01-preview`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/nginx/2024-11-01-preview/nginxdeployment"
```
