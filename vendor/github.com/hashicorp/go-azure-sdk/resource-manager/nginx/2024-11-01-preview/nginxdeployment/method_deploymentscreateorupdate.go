...
func (c NginxDeploymentClient) DeploymentsCreateOrUpdateCallbackThenPoll(ctx context.Context, id NginxDeploymentId, input NginxDeployment, callback func() error) error {
