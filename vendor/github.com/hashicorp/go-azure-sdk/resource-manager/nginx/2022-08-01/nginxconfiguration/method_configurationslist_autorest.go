...
// ConfigurationsList ...
func (c NginxConfigurationClient) ConfigurationsList(ctx context.Context, id NginxDeploymentId) (resp ConfigurationsListOperationResponse, err error) {
	req, err := c.preparerForConfigurationsList(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "nginxconfiguration.NginxConfigurationClient", "ConfigurationsList", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "nginxconfiguration.NginxConfigurationClient", "ConfigurationsList", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForConfigurationsList(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "nginxconfiguration.NginxConfigurationClient", "ConfigurationsList", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c NginxConfigurationClient) preparerForConfigurationsList(ctx context.Context, id NginxDeploymentId) (*http.Request, error) {
...
func (c NginxConfigurationClient) preparerForConfigurationsListWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c NginxConfigurationClient) responderForConfigurationsList(resp *http.Response) (result ConfigurationsListOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ConfigurationsListOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "nginxconfiguration.NginxConfigurationClient", "ConfigurationsList", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForConfigurationsList(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "nginxconfiguration.NginxConfigurationClient", "ConfigurationsList", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c NginxConfigurationClient) ConfigurationsListCompleteMatchingPredicate(ctx context.Context, id NginxDeploymentId, predicate NginxConfigurationOperationPredicate) (resp ConfigurationsListCompleteResult, err error) {
