...
func (c NginxConfigurationClient) ConfigurationsCreateOrUpdate(ctx context.Context, id ConfigurationId, input NginxConfiguration) (result ConfigurationsCreateOrUpdateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "nginxconfiguration.NginxConfigurationClient", "ConfigurationsCreateOrUpdate", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForConfigurationsCreateOrUpdate(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "nginxconfiguration.NginxConfigurationClient", "ConfigurationsCreateOrUpdate", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c NginxConfigurationClient) preparerForConfigurationsCreateOrUpdate(ctx context.Context, id ConfigurationId, input NginxConfiguration) (*http.Request, error) {
...
func (c NginxConfigurationClient) senderForConfigurationsCreateOrUpdate(ctx context.Context, req *http.Request) (future ConfigurationsCreateOrUpdateOperationResponse, err error) {
