...
// CertificatesList ...
func (c NginxCertificateClient) CertificatesList(ctx context.Context, id NginxDeploymentId) (resp CertificatesListOperationResponse, err error) {
	req, err := c.preparerForCertificatesList(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "nginxcertificate.NginxCertificateClient", "CertificatesList", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "nginxcertificate.NginxCertificateClient", "CertificatesList", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForCertificatesList(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "nginxcertificate.NginxCertificateClient", "CertificatesList", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c NginxCertificateClient) preparerForCertificatesList(ctx context.Context, id NginxDeploymentId) (*http.Request, error) {
...
func (c NginxCertificateClient) preparerForCertificatesListWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c NginxCertificateClient) responderForCertificatesList(resp *http.Response) (result CertificatesListOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result CertificatesListOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "nginxcertificate.NginxCertificateClient", "CertificatesList", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForCertificatesList(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "nginxcertificate.NginxCertificateClient", "CertificatesList", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c NginxCertificateClient) CertificatesListCompleteMatchingPredicate(ctx context.Context, id NginxDeploymentId, predicate NginxCertificateOperationPredicate) (resp CertificatesListCompleteResult, err error) {
