...
func (c VaultsClient) ReplicationUsagesList(ctx context.Context, id VaultId) (result ReplicationUsagesListOperationResponse, err error) {
...
func (c VaultsClient) ReplicationUsagesListComplete(ctx context.Context, id VaultId) (ReplicationUsagesListCompleteResult, error) {
...
func (c VaultsClient) ReplicationUsagesListCompleteMatchingPredicate(ctx context.Context, id VaultId, predicate ReplicationUsageOperationPredicate) (result ReplicationUsagesListCompleteResult, err error) {
