...
## `github.com/hashicorp/go-azure-sdk/resource-manager/recoveryservices/2025-08-01/vaults` Documentation

The `vaults` SDK allows for interaction with Azure Resource Manager `recoveryservices` (API Version `2025-08-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/recoveryservices/2025-08-01/vaults"
```
