...
func (c VaultsClient) preparerForUpdate(ctx context.Context, id VaultId, input PatchVault) (*http.Request, error) {
...
func (c VaultsClient) senderForUpdate(ctx context.Context, req *http.Request) (future UpdateOperationResponse, err error) {
