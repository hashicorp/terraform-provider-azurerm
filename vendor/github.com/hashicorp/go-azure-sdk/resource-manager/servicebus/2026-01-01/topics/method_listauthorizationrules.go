...
func (c TopicsClient) ListAuthorizationRules(ctx context.Context, id TopicId) (result ListAuthorizationRulesOperationResponse, err error) {
...
func (c TopicsClient) ListAuthorizationRulesComplete(ctx context.Context, id TopicId) (ListAuthorizationRulesCompleteResult, error) {
...
func (c TopicsClient) ListAuthorizationRulesCompleteMatchingPredicate(ctx context.Context, id TopicId, predicate SBAuthorizationRuleOperationPredicate) (result ListAuthorizationRulesCompleteResult, err error) {
