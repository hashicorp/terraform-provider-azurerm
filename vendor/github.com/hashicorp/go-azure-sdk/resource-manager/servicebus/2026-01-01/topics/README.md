...
## `github.com/hashicorp/go-azure-sdk/resource-manager/servicebus/2026-01-01/topics` Documentation

The `topics` SDK allows for interaction with Azure Resource Manager `servicebus` (API Version `2026-01-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/servicebus/2026-01-01/topics"
```
...
### Example Usage: `TopicsClient.CreateOrUpdateAuthorizationRule`

```go
ctx := context.TODO()
id := topics.NewTopicAuthorizationRuleID("12345678-1234-9876-4563-123456789012", "example-resource-group", "namespaceName", "topicName", "authorizationRuleName")

payload := topics.SBAuthorizationRule{
	// ...
}
...
### Example Usage: `TopicsClient.DeleteAuthorizationRule`
...
### Example Usage: `TopicsClient.GetAuthorizationRule`
...
### Example Usage: `TopicsClient.ListAuthorizationRules`
...
### Example Usage: `TopicsClient.ListKeys`
...
### Example Usage: `TopicsClient.RegenerateKeys`

```go
ctx := context.TODO()
id := topics.NewTopicAuthorizationRuleID("12345678-1234-9876-4563-123456789012", "example-resource-group", "namespaceName", "topicName", "authorizationRuleName")

payload := topics.RegenerateAccessKeyParameters{
	// ...
}
