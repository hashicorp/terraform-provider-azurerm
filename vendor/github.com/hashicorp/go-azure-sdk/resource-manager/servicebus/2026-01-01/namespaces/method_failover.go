...
// Failover ...
func (c NamespacesClient) Failover(ctx context.Context, id NamespaceId, input FailOver) (result FailoverOperationResponse, err error) {
...
func (c NamespacesClient) FailoverThenPoll(ctx context.Context, id NamespaceId, input FailOver) error {
...
func (c NamespacesClient) FailoverCallbackThenPoll(ctx context.Context, id NamespaceId, input FailOver, callback func() error) error {
