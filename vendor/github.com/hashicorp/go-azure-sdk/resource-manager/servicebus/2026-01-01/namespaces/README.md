...
## `github.com/hashicorp/go-azure-sdk/resource-manager/servicebus/2026-01-01/namespaces` Documentation

The `namespaces` SDK allows for interaction with Azure Resource Manager `servicebus` (API Version `2026-01-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/servicebus/2026-01-01/namespaces"
```
...
### Example Usage: `NamespacesClient.DisasterRecoveryConfigsCheckNameAvailability`
...
### Example Usage: `NamespacesClient.Failover`

```go
ctx := context.TODO()
id := namespaces.NewNamespaceID("12345678-1234-9876-4563-123456789012", "example-resource-group", "namespaceName")

payload := namespaces.FailOver{
	// ...
}
...
### Example Usage: `NamespacesClient.PrivateLinkResourcesGet`
