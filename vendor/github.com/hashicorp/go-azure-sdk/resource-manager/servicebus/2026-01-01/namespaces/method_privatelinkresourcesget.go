...
func (c NamespacesClient) PrivateLinkResourcesGet(ctx context.Context, id NamespaceId) (result PrivateLinkResourcesGetOperationResponse, err error) {
...
func (c NamespacesClient) PrivateLinkResourcesGetComplete(ctx context.Context, id NamespaceId) (PrivateLinkResourcesGetCompleteResult, error) {
...
func (c NamespacesClient) PrivateLinkResourcesGetCompleteMatchingPredicate(ctx context.Context, id NamespaceId, predicate PrivateLinkResourceOperationPredicate) (result PrivateLinkResourcesGetCompleteResult, err error) {
