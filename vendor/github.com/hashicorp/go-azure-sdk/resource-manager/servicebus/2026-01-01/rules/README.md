...
## `github.com/hashicorp/go-azure-sdk/resource-manager/servicebus/2026-01-01/rules` Documentation

The `rules` SDK allows for interaction with Azure Resource Manager `servicebus` (API Version `2026-01-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/servicebus/2026-01-01/rules"
```
