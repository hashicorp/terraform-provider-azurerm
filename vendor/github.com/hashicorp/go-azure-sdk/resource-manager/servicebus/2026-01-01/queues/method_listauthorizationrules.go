...
func (c QueuesClient) ListAuthorizationRules(ctx context.Context, id QueueId) (result ListAuthorizationRulesOperationResponse, err error) {
...
func (c QueuesClient) ListAuthorizationRulesComplete(ctx context.Context, id QueueId) (ListAuthorizationRulesCompleteResult, error) {
...
func (c QueuesClient) ListAuthorizationRulesCompleteMatchingPredicate(ctx context.Context, id QueueId, predicate SBAuthorizationRuleOperationPredicate) (result ListAuthorizationRulesCompleteResult, err error) {
