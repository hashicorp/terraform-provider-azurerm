...
## `github.com/hashicorp/go-azure-sdk/resource-manager/servicebus/2026-01-01/queues` Documentation

The `queues` SDK allows for interaction with Azure Resource Manager `servicebus` (API Version `2026-01-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/servicebus/2026-01-01/queues"
```
...
### Example Usage: `QueuesClient.CreateOrUpdateAuthorizationRule`

```go
ctx := context.TODO()
id := queues.NewQueueAuthorizationRuleID("12345678-1234-9876-4563-123456789012", "example-resource-group", "namespaceName", "queueName", "authorizationRuleName")

payload := queues.SBAuthorizationRule{
	// ...
}
...
### Example Usage: `QueuesClient.DeleteAuthorizationRule`
...
### Example Usage: `QueuesClient.GetAuthorizationRule`
...
### Example Usage: `QueuesClient.ListAuthorizationRules`
...
### Example Usage: `QueuesClient.ListKeys`
...
### Example Usage: `QueuesClient.RegenerateKeys`

```go
ctx := context.TODO()
id := queues.NewQueueAuthorizationRuleID("12345678-1234-9876-4563-123456789012", "example-resource-group", "namespaceName", "queueName", "authorizationRuleName")

payload := queues.RegenerateAccessKeyParameters{
	// ...
}
