...
func (c DisasterRecoveryConfigsClient) FailOver(ctx context.Context, id DisasterRecoveryConfigId, input FailoverProperties) (result FailOverOperationResponse, err error) {
	req, err := c.preparerForFailOver(ctx, id, input)
	if err != nil {
...
func (c DisasterRecoveryConfigsClient) preparerForFailOver(ctx context.Context, id DisasterRecoveryConfigId, input FailoverProperties) (*http.Request, error) {
