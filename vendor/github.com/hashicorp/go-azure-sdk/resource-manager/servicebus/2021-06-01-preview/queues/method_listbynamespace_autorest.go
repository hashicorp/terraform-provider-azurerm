...
// ListByNamespace ...
func (c QueuesClient) ListByNamespace(ctx context.Context, id NamespaceId, options ListByNamespaceOperationOptions) (resp ListByNamespaceOperationResponse, err error) {
	req, err := c.preparerForListByNamespace(ctx, id, options)
	if err != nil {
		err = autorest.NewErrorWithError(err, "queues.QueuesClient", "ListByNamespace", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "queues.QueuesClient", "ListByNamespace", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForListByNamespace(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "queues.QueuesClient", "ListByNamespace", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c QueuesClient) ListByNamespaceCompleteMatchingPredicate(ctx context.Context, id NamespaceId, options ListByNamespaceOperationOptions, predicate SBQueueOperationPredicate) (resp ListByNamespaceCompleteResult, err error) {
...
func (c QueuesClient) preparerForListByNamespace(ctx context.Context, id NamespaceId, options ListByNamespaceOperationOptions) (*http.Request, error) {
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithPath(fmt.Sprintf("%s/queues", id.ID())),
...
func (c QueuesClient) preparerForListByNamespaceWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c QueuesClient) responderForListByNamespace(resp *http.Response) (result ListByNamespaceOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListByNamespaceOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "queues.QueuesClient", "ListByNamespace", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForListByNamespace(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "queues.QueuesClient", "ListByNamespace", result.HttpResponse, "Failure responding to request")
				return
			}
