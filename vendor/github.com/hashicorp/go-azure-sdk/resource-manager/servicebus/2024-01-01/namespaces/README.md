...
## `github.com/hashicorp/go-azure-sdk/resource-manager/servicebus/2024-01-01/namespaces` Documentation

The `namespaces` SDK allows for interaction with Azure Resource Manager `servicebus` (API Version `2024-01-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/servicebus/2024-01-01/namespaces"
```
