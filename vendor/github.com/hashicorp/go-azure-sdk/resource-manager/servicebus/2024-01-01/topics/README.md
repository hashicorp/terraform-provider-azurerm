...
## `github.com/hashicorp/go-azure-sdk/resource-manager/servicebus/2024-01-01/topics` Documentation

The `topics` SDK allows for interaction with Azure Resource Manager `servicebus` (API Version `2024-01-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/servicebus/2024-01-01/topics"
```
