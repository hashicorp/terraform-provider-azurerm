...
func (c AppPlatformClient) CertificatesCreateOrUpdateCallbackThenPoll(ctx context.Context, id CertificateId, input CertificateResource, callback func() error) error {
