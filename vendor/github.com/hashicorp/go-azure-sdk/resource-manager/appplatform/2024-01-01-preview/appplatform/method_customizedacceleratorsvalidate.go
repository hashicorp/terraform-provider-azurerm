...
func (c AppPlatformClient) CustomizedAcceleratorsValidateThenPoll(ctx context.Context, id CustomizedAcceleratorId, input CustomizedAcceleratorProperties) error {
	return c.CustomizedAcceleratorsValidateCallbackThenPoll(ctx, id, input, nil)
}

// CustomizedAcceleratorsValidateCallbackThenPoll performs CustomizedAcceleratorsValidate, runs the optional callback function, then polls until it's completed
func (c AppPlatformClient) CustomizedAcceleratorsValidateCallbackThenPoll(ctx context.Context, id CustomizedAcceleratorId, input CustomizedAcceleratorProperties, callback func() error) error {
