...
func ParseContainerRegistryID(input string) (*ContainerRegistryId, error) {
	...
	if id.ContainerRegistryName, ok = parsed.Parsed["containerRegistryName"]; !ok {
		return nil, resourceids.NewSegmentNotSpecifiedError(id, "containerRegistryName", *parsed)
	}
