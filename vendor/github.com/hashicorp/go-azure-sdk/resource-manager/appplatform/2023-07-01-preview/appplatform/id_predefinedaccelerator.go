...
func ParsePredefinedAcceleratorID(input string) (*PredefinedAcceleratorId, error) {
	...
	if id.PredefinedAcceleratorName, ok = parsed.Parsed["predefinedAcceleratorName"]; !ok {
		return nil, resourceids.NewSegmentNotSpecifiedError(id, "predefinedAcceleratorName", *parsed)
	}
