...
func (c CachesClient) Stop(ctx context.Context, id CacheId) (result StopOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "caches.CachesClient", "Stop", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForStop(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "caches.CachesClient", "Stop", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c CachesClient) preparerForStop(ctx context.Context, id CacheId) (*http.Request, error) {
...
func (c CachesClient) senderForStop(ctx context.Context, req *http.Request) (future StopOperationResponse, err error) {
