...
## `github.com/hashicorp/go-azure-sdk/resource-manager/storagecache/2024-07-01/caches` Documentation

The `caches` SDK allows for interaction with Azure Resource Manager `storagecache` (API Version `2024-07-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/storagecache/2024-07-01/caches"
```
