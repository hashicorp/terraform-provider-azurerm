...
## `github.com/hashicorp/go-azure-sdk/resource-manager/storagecache/2024-07-01/storagetargets` Documentation

The `storagetargets` SDK allows for interaction with Azure Resource Manager `storagecache` (API Version `2024-07-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/storagecache/2024-07-01/storagetargets"
```
