...
// CreateOrUpdate ...
func (c AutoExportJobClient) CreateOrUpdate(ctx context.Context, id AutoExportJobId, input AutoExportJob) (result CreateOrUpdateOperationResponse, err error) {
...
func (c AutoExportJobClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id AutoExportJobId, input AutoExportJob, callback func() error) error {
