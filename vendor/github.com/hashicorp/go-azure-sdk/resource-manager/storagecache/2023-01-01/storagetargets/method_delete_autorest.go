...
func (c StorageTargetsClient) Delete(ctx context.Context, id StorageTargetId, options DeleteOperationOptions) (result DeleteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "storagetargets.StorageTargetsClient", "Delete", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForDelete(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "storagetargets.StorageTargetsClient", "Delete", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c StorageTargetsClient) preparerForDelete(ctx context.Context, id StorageTargetId, options DeleteOperationOptions) (*http.Request, error) {
...
func (c StorageTargetsClient) senderForDelete(ctx context.Context, req *http.Request) (future DeleteOperationResponse, err error) {
