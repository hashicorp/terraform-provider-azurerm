...
func (c CachesClient) Start(ctx context.Context, id CacheId) (result StartOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "caches.CachesClient", "Start", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForStart(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "caches.CachesClient", "Start", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c CachesClient) preparerForStart(ctx context.Context, id CacheId) (*http.Request, error) {
...
func (c CachesClient) senderForStart(ctx context.Context, req *http.Request) (future StartOperationResponse, err error) {
