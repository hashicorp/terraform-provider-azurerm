...
func TestNewNotificationNotificationID(t *testing.T) {
	id := NewNotificationNotificationID("12345678-1234-9876-4563-123456789012", "example-resource-group", "serviceName", "workspaceId", "AccountClosedPublisher")
...
func TestFormatNotificationNotificationID(t *testing.T) {
	actual := NewNotificationNotificationID("12345678-1234-9876-4563-123456789012", "example-resource-group", "serviceName", "workspaceId", "AccountClosedPublisher").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.ApiManagement/service/serviceName/workspaces/workspaceId/notifications/AccountClosedPublisher"
	if actual != expected {
		t.Fatalf("Expected the Formatted ID to be %q but got %q", expected, actual)
	}
}

func TestParseNotificationNotificationID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/example-resource-group/providers/Microsoft.ApiManagement/service/serviceName/workspaces/workspaceId/notifications/AccountClosedPublisher/extra",
			Error: true,
		},
	}
	for _, v := range testData {
		...
		actual, err := ParseNotificationNotificationID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestParseNotificationNotificationIDInsensitively(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *NotificationNotificationId
	...
	for _, v := range testData {
		...
		actual, err := ParseNotificationNotificationIDInsensitively(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
...
func TestSegmentsForNotificationNotificationId(t *testing.T) {
	segments := NotificationNotificationId{}.Segments()
	if len(segments) == 0 {
		t.Fatalf("NotificationNotificationId has no segments")
	}
