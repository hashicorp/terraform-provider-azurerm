...
func (c NamedValueClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id NamedValueId, input NamedValueCreateContract, options CreateOrUpdateOperationOptions, callback func() error) error {
