...
// ListByService ...
func (c GatewayCertificateAuthorityClient) ListByService(ctx context.Context, id ServiceGatewayId, options ListByServiceOperationOptions) (result ListByServiceOperationResponse, err error) {
...
func (c GatewayCertificateAuthorityClient) ListByServiceComplete(ctx context.Context, id ServiceGatewayId, options ListByServiceOperationOptions) (ListByServiceCompleteResult, error) {
...
func (c GatewayCertificateAuthorityClient) ListByServiceCompleteMatchingPredicate(ctx context.Context, id ServiceGatewayId, options ListByServiceOperationOptions, predicate GatewayCertificateAuthorityContractOperationPredicate) (result ListByServiceCompleteResult, err error) {
