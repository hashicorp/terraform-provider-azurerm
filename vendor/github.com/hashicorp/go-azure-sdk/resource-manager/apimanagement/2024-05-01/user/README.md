...
## `github.com/hashicorp/go-azure-sdk/resource-manager/apimanagement/2024-05-01/user` Documentation

The `user` SDK allows for interaction with Azure Resource Manager `apimanagement` (API Version `2024-05-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/apimanagement/2024-05-01/user"
```
