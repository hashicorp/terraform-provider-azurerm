...
func (c ApiManagementServiceClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id ServiceId, input ApiManagementServiceResource, callback func() error) error {
