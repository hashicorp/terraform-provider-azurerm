...
func (c ApiManagementServiceClient) UpdateCallbackThenPoll(ctx context.Context, id ServiceId, input ApiManagementServiceUpdateParameters, callback func() error) error {
