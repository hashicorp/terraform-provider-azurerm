...
func (c ApiClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id ApiId, input ApiCreateOrUpdateParameter, options CreateOrUpdateOperationOptions, callback func() error) error {
