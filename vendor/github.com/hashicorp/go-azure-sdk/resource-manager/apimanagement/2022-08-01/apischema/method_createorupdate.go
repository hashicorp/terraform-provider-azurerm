...
func (c ApiSchemaClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id ApiSchemaId, input SchemaContract, options CreateOrUpdateOperationOptions, callback func() error) error {
