...
type NGroupsStartOperationResponse struct {
...
// NGroupsStart ...
func (c ContainerInstanceClient) NGroupsStart(ctx context.Context, id NgroupId) (result NGroupsStartOperationResponse, err error) {
...
func (c ContainerInstanceClient) NGroupsStartThenPoll(ctx context.Context, id NgroupId) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after NGroupsStart: %+v", err)
	}
