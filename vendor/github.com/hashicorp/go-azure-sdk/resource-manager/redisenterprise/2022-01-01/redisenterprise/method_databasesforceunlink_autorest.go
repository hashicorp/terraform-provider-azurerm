...
func (c RedisEnterpriseClient) senderForDatabasesForceUnlink(ctx context.Context, req *http.Request) (future DatabasesForceUnlinkOperationResponse, err error) {
