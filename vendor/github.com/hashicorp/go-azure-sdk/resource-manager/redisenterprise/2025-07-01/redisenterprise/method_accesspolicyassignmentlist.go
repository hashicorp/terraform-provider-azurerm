...
func (c RedisEnterpriseClient) AccessPolicyAssignmentList(ctx context.Context, id DatabaseId) (result AccessPolicyAssignmentListOperationResponse, err error) {
...
func (c RedisEnterpriseClient) AccessPolicyAssignmentListComplete(ctx context.Context, id DatabaseId) (AccessPolicyAssignmentListCompleteResult, error) {
...
func (c RedisEnterpriseClient) AccessPolicyAssignmentListCompleteMatchingPredicate(ctx context.Context, id DatabaseId, predicate AccessPolicyAssignmentOperationPredicate) (result AccessPolicyAssignmentListCompleteResult, err error) {
