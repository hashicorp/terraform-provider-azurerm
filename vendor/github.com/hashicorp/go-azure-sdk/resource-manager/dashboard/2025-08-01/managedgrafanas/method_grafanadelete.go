...
// GrafanaDelete ...
func (c ManagedGrafanasClient) GrafanaDelete(ctx context.Context, id GrafanaId) (result GrafanaDeleteOperationResponse, err error) {
...
func (c ManagedGrafanasClient) GrafanaDeleteThenPoll(ctx context.Context, id GrafanaId) error {
