...
type ManagedPrivateEndpointsCreateOperationResponse struct {
...
// ManagedPrivateEndpointsCreate ...
func (c ManagedPrivateEndpointModelsClient) ManagedPrivateEndpointsCreate(ctx context.Context, id ManagedPrivateEndpointId, input ManagedPrivateEndpointModel) (result ManagedPrivateEndpointsCreateOperationResponse, err error) {
...
func (c ManagedPrivateEndpointModelsClient) ManagedPrivateEndpointsCreateThenPoll(ctx context.Context, id ManagedPrivateEndpointId, input ManagedPrivateEndpointModel) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after ManagedPrivateEndpointsCreate: %+v", err)
	}
