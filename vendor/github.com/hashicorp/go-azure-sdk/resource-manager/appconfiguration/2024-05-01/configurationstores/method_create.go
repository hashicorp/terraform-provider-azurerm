...
func (c ConfigurationStoresClient) CreateCallbackThenPoll(ctx context.Context, id ConfigurationStoreId, input ConfigurationStore, callback func() error) error {
