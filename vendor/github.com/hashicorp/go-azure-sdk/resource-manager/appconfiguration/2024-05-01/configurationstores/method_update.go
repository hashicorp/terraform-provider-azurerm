...
func (c ConfigurationStoresClient) UpdateCallbackThenPoll(ctx context.Context, id ConfigurationStoreId, input ConfigurationStoreUpdateParameters, callback func() error) error {
