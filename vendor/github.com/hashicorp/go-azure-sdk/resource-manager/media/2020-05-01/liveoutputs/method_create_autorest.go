...
func (c LiveOutputsClient) Create(ctx context.Context, id LiveOutputId, input LiveOutput) (result CreateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "liveoutputs.LiveOutputsClient", "Create", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForCreate(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "liveoutputs.LiveOutputsClient", "Create", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c LiveOutputsClient) preparerForCreate(ctx context.Context, id LiveOutputId, input LiveOutput) (*http.Request, error) {
...
func (c LiveOutputsClient) senderForCreate(ctx context.Context, req *http.Request) (future CreateOperationResponse, err error) {
