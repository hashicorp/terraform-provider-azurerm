...
func (c AccountsClient) MediaservicesSyncStorageKeys(ctx context.Context, id ProviderMediaServiceId, input SyncStorageKeysInput) (result MediaservicesSyncStorageKeysOperationResponse, err error) {
...
func (c AccountsClient) preparerForMediaservicesSyncStorageKeys(ctx context.Context, id ProviderMediaServiceId, input SyncStorageKeysInput) (*http.Request, error) {
