...
// MediaservicesGet ...
func (c AccountsClient) MediaservicesGet(ctx context.Context, id ProviderMediaServiceId) (result MediaservicesGetOperationResponse, err error) {
...
func (c AccountsClient) preparerForMediaservicesGet(ctx context.Context, id ProviderMediaServiceId) (*http.Request, error) {
