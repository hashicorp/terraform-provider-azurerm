...
func (c AccountsClient) MediaservicesListEdgePolicies(ctx context.Context, id ProviderMediaServiceId, input ListEdgePoliciesInput) (result MediaservicesListEdgePoliciesOperationResponse, err error) {
...
func (c AccountsClient) preparerForMediaservicesListEdgePolicies(ctx context.Context, id ProviderMediaServiceId, input ListEdgePoliciesInput) (*http.Request, error) {
