...
func (c StreamingEndpointsClient) Stop(ctx context.Context, id StreamingEndpointId) (result StopOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "streamingendpoints.StreamingEndpointsClient", "Stop", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForStop(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "streamingendpoints.StreamingEndpointsClient", "Stop", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c StreamingEndpointsClient) preparerForStop(ctx context.Context, id StreamingEndpointId) (*http.Request, error) {
...
func (c StreamingEndpointsClient) senderForStop(ctx context.Context, req *http.Request) (future StopOperationResponse, err error) {
