...
func (c StreamingEndpointsClient) Start(ctx context.Context, id StreamingEndpointId) (result StartOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "streamingendpoints.StreamingEndpointsClient", "Start", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForStart(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "streamingendpoints.StreamingEndpointsClient", "Start", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c StreamingEndpointsClient) preparerForStart(ctx context.Context, id StreamingEndpointId) (*http.Request, error) {
...
func (c StreamingEndpointsClient) senderForStart(ctx context.Context, req *http.Request) (future StartOperationResponse, err error) {
