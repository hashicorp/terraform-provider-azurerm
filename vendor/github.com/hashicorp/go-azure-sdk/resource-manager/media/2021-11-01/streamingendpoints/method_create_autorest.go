...
func (c StreamingEndpointsClient) Create(ctx context.Context, id StreamingEndpointId, input StreamingEndpoint, options CreateOperationOptions) (result CreateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "streamingendpoints.StreamingEndpointsClient", "Create", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForCreate(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "streamingendpoints.StreamingEndpointsClient", "Create", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c StreamingEndpointsClient) preparerForCreate(ctx context.Context, id StreamingEndpointId, input StreamingEndpoint, options CreateOperationOptions) (*http.Request, error) {
...
func (c StreamingEndpointsClient) senderForCreate(ctx context.Context, req *http.Request) (future CreateOperationResponse, err error) {
