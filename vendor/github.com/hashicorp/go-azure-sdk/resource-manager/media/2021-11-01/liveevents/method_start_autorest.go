...
func (c LiveEventsClient) Start(ctx context.Context, id LiveEventId) (result StartOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "liveevents.LiveEventsClient", "Start", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForStart(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "liveevents.LiveEventsClient", "Start", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c LiveEventsClient) preparerForStart(ctx context.Context, id LiveEventId) (*http.Request, error) {
...
func (c LiveEventsClient) senderForStart(ctx context.Context, req *http.Request) (future StartOperationResponse, err error) {
