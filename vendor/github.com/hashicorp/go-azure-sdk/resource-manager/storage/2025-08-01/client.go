...
import (
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/storage/2025-08-01/connectors"
	"github.com/hashicorp/go-azure-sdk/resource-manager/storage/2025-08-01/datashares"
	"github.com/hashicorp/go-azure-sdk/resource-manager/storage/2025-08-01/deletedaccounts"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/storage/2025-08-01/fileserviceusageoperationgroup"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/storage/2025-08-01/networksecurityperimeterconfigurations"
	"github.com/hashicorp/go-azure-sdk/resource-manager/storage/2025-08-01/objectreplicationpolicyoperationgroup"
	"github.com/hashicorp/go-azure-sdk/resource-manager/storage/2025-08-01/openapis"
	"github.com/hashicorp/go-azure-sdk/resource-manager/storage/2025-08-01/privateendpointconnections"
	"github.com/hashicorp/go-azure-sdk/resource-manager/storage/2025-08-01/queueservices"
	...
	"github.com/hashicorp/go-azure-sdk/resource-manager/storage/2025-08-01/tables"
	"github.com/hashicorp/go-azure-sdk/resource-manager/storage/2025-08-01/tableservices"
...
type Client struct {
	...
	DataShares                             *datashares.DataSharesClient
...
func NewClientWithBaseURI(sdkApi sdkEnv.Api, configureFunc func(c *resourcemanager.Client)) (*Client, error) {
	...
	dataSharesClient, err := datashares.NewDataSharesClientWithBaseURI(sdkApi)
	if err != nil {
		return nil, fmt.Errorf("building DataShares client: %+v", err)
	}
	configureFunc(dataSharesClient.Client)
