...
## `github.com/hashicorp/go-azure-sdk/resource-manager/storage/2025-08-01/fileshares` Documentation

The `fileshares` SDK allows for interaction with Azure Resource Manager `storage` (API Version `2025-08-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/storage/2025-08-01/fileshares"
```
