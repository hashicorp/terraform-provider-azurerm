...
## `github.com/hashicorp/go-azure-sdk/resource-manager/storage/2025-08-01/storagetaskassignments` Documentation

The `storagetaskassignments` SDK allows for interaction with Azure Resource Manager `storage` (API Version `2025-08-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/storage/2025-08-01/storagetaskassignments"
```
...
### Example Usage: `StorageTaskAssignmentsClient.StopAssignment`

```go
ctx := context.TODO()
id := storagetaskassignments.NewStorageTaskAssignmentID("12345678-1234-9876-4563-123456789012", "example-resource-group", "storageAccountName", "storageTaskAssignmentName")

if err := client.StopAssignmentThenPoll(ctx, id); err != nil {
	// handle the error
}
```
