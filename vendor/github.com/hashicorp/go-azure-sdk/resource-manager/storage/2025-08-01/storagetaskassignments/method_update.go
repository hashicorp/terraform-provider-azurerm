...
func (c StorageTaskAssignmentsClient) UpdateCallbackThenPoll(ctx context.Context, id StorageTaskAssignmentId, input StorageTaskAssignmentUpdateParameters, callback func() error) error {
