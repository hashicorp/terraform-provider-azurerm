...
func (c StorageTaskAssignmentsClient) CreateCallbackThenPoll(ctx context.Context, id StorageTaskAssignmentId, input StorageTaskAssignment, callback func() error) error {
