...
## `github.com/hashicorp/go-azure-sdk/resource-manager/storage/2025-08-01/encryptionscopes` Documentation

The `encryptionscopes` SDK allows for interaction with Azure Resource Manager `storage` (API Version `2025-08-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/storage/2025-08-01/encryptionscopes"
```
