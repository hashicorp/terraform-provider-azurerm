...
func (c StorageAccountsClient) preparerForUpdate(ctx context.Context, id commonids.StorageAccountId, input StorageAccountUpdateParameters) (*http.Request, error) {
