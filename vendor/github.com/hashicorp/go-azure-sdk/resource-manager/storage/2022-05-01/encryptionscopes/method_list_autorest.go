...
func (c EncryptionScopesClient) List(ctx context.Context, id StorageAccountId) (resp ListOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "encryptionscopes.EncryptionScopesClient", "List", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForList(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "encryptionscopes.EncryptionScopesClient", "List", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c EncryptionScopesClient) preparerForList(ctx context.Context, id StorageAccountId) (*http.Request, error) {
...
func (c EncryptionScopesClient) preparerForListWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c EncryptionScopesClient) responderForList(resp *http.Response) (result ListOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result ListOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "encryptionscopes.EncryptionScopesClient", "List", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForList(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "encryptionscopes.EncryptionScopesClient", "List", result.HttpResponse, "Failure responding to request")
				return
			}
