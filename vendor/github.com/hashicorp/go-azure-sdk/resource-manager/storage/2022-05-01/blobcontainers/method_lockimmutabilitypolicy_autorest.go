...
func (c BlobContainersClient) preparerForLockImmutabilityPolicy(ctx context.Context, id ContainerId, options LockImmutabilityPolicyOperationOptions) (*http.Request, error) {
