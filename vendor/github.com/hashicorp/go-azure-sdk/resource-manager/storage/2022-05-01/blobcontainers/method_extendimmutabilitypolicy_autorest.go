...
func (c BlobContainersClient) preparerForExtendImmutabilityPolicy(ctx context.Context, id ContainerId, input ImmutabilityPolicy, options ExtendImmutabilityPolicyOperationOptions) (*http.Request, error) {
