...
func (c FileServiceClient) preparerForSetServiceProperties(ctx context.Context, id commonids.StorageAccountId, input FileServiceProperties) (*http.Request, error) {
