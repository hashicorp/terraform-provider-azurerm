...
// List ...
func (c PrivateEndpointConnectionsClient) List(ctx context.Context, id StorageAccountId) (result ListOperationResponse, err error) {
...
func (c PrivateEndpointConnectionsClient) preparerForList(ctx context.Context, id StorageAccountId) (*http.Request, error) {
