...
func NewNetworkSecurityPerimeterConfigurationID(subscriptionId string, resourceGroupName string, storageAccountName string, networkSecurityPerimeterConfigurationName string) NetworkSecurityPerimeterConfigurationId {
...
func (id NetworkSecurityPerimeterConfigurationId) ID() string {
	fmtString := "/subscriptions/%s/resourceGroups/%s/providers/Microsoft.Storage/storageAccounts/%s/networkSecurityPerimeterConfigurations/%s"
	return fmt.Sprintf(fmtString, id.SubscriptionId, id.ResourceGroupName, id.StorageAccountName, id.NetworkSecurityPerimeterConfigurationName)
}
