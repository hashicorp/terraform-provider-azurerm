...
## `github.com/hashicorp/go-azure-sdk/resource-manager/storage/2023-05-01/fileshares` Documentation

The `fileshares` SDK allows for interaction with the Azure Resource Manager Service `storage` (API Version `2023-05-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/storage/2023-05-01/fileshares"
```
