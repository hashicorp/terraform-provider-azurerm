...
type CustomerInitiatedMigrationOperationResponse struct {
...
func (c StorageAccountsClient) CustomerInitiatedMigration(ctx context.Context, id commonids.StorageAccountId, input StorageAccountMigration) (result CustomerInitiatedMigrationOperationResponse, err error) {
...
func (c StorageAccountsClient) CustomerInitiatedMigrationThenPoll(ctx context.Context, id commonids.StorageAccountId, input StorageAccountMigration) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after CustomerInitiatedMigration: %+v", err)
	}
