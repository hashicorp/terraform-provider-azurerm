...
## `github.com/hashicorp/go-azure-sdk/resource-manager/storage/2025-06-01/storageaccounts` Documentation

The `storageaccounts` SDK allows for interaction with Azure Resource Manager `storage` (API Version `2025-06-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/storage/2025-06-01/storageaccounts"
```
