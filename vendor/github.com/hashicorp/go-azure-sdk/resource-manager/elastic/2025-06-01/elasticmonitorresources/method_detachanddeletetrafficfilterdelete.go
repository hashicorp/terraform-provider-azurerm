...
func (c ElasticMonitorResourcesClient) DetachAndDeleteTrafficFilterDelete(ctx context.Context, id MonitorId, options DetachAndDeleteTrafficFilterDeleteOperationOptions) (result DetachAndDeleteTrafficFilterDeleteOperationResponse, err error) {
