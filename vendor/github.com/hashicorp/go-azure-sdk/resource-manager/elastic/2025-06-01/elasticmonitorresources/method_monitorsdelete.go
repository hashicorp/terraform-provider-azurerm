...
// MonitorsDelete ...
func (c ElasticMonitorResourcesClient) MonitorsDelete(ctx context.Context, id MonitorId) (result MonitorsDeleteOperationResponse, err error) {
...
func (c ElasticMonitorResourcesClient) MonitorsDeleteThenPoll(ctx context.Context, id MonitorId) error {
