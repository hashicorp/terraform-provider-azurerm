...
// MonitorsUpdate ...
func (c ElasticMonitorResourcesClient) MonitorsUpdate(ctx context.Context, id MonitorId, input ElasticMonitorResourceUpdateParameters) (result MonitorsUpdateOperationResponse, err error) {
...
func (c ElasticMonitorResourcesClient) MonitorsUpdateThenPoll(ctx context.Context, id MonitorId, input ElasticMonitorResourceUpdateParameters) error {
...
func (c ElasticMonitorResourcesClient) MonitorsUpdateCallbackThenPoll(ctx context.Context, id MonitorId, input ElasticMonitorResourceUpdateParameters, callback func() error) error {
