...
// MonitorsList ...
func (c ElasticMonitorResourcesClient) MonitorsList(ctx context.Context, id commonids.SubscriptionId) (result MonitorsListOperationResponse, err error) {
...
func (c ElasticMonitorResourcesClient) MonitorsListComplete(ctx context.Context, id commonids.SubscriptionId) (MonitorsListCompleteResult, error) {
...
func (c ElasticMonitorResourcesClient) MonitorsListCompleteMatchingPredicate(ctx context.Context, id commonids.SubscriptionId, predicate ElasticMonitorResourceOperationPredicate) (result MonitorsListCompleteResult, err error) {
