...
func NewAuthorizationID(subscriptionId string, resourceGroupName string, instanceName string, brokerName string, authorizationName string) AuthorizationId {
...
func (id AuthorizationId) ID() string {
	fmtString := "/subscriptions/%s/resourceGroups/%s/providers/Microsoft.IoTOperations/instances/%s/brokers/%s/authorizations/%s"
	return fmt.Sprintf(fmtString, id.SubscriptionId, id.ResourceGroupName, id.InstanceName, id.BrokerName, id.AuthorizationName)
}
