...
func (c CertificateProfilesClient) CreateCallbackThenPoll(ctx context.Context, id CertificateProfileId, input CertificateProfile, callback func() error) error {
