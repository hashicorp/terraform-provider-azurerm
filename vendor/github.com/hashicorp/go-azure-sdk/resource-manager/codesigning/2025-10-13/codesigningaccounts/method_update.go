...
func (c CodeSigningAccountsClient) UpdateCallbackThenPoll(ctx context.Context, id CodeSigningAccountId, input CodeSigningAccountPatch, callback func() error) error {
