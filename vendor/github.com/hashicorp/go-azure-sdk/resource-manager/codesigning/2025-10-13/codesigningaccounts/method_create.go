...
func (c CodeSigningAccountsClient) CreateCallbackThenPoll(ctx context.Context, id CodeSigningAccountId, input CodeSigningAccount, callback func() error) error {
