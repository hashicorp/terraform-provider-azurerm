...
func (c ZonesClient) Delete(ctx context.Context, id DnsZoneId, options DeleteOperationOptions) (result DeleteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "zones.ZonesClient", "Delete", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForDelete(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "zones.ZonesClient", "Delete", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c ZonesClient) preparerForDelete(ctx context.Context, id DnsZoneId, options DeleteOperationOptions) (*http.Request, error) {
...
func (c ZonesClient) senderForDelete(ctx context.Context, req *http.Request) (future DeleteOperationResponse, err error) {
