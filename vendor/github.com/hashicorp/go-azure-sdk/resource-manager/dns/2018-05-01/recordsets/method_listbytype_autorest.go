...
// ListByType ...
func (c RecordSetsClient) ListByType(ctx context.Context, id ZoneId, options ListByTypeOperationOptions) (resp ListByTypeOperationResponse, err error) {
...
func (c RecordSetsClient) preparerForListByType(ctx context.Context, id ZoneId, options ListByTypeOperationOptions) (*http.Request, error) {
