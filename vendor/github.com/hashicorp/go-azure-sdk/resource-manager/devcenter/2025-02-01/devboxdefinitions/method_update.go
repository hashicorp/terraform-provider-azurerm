...
func (c DevBoxDefinitionsClient) UpdateCallbackThenPoll(ctx context.Context, id DevCenterDevBoxDefinitionId, input DevBoxDefinitionUpdate, callback func() error) error {
