...
func (c NetworkConnectionsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id NetworkConnectionId, input NetworkConnection, callback func() error) error {
