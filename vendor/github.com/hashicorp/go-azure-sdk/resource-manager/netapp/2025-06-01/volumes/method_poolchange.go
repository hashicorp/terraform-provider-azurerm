...
type PoolChangeOperationResponse struct {
...
// PoolChange ...
func (c VolumesClient) PoolChange(ctx context.Context, id VolumeId, input PoolChangeRequest) (result PoolChangeOperationResponse, err error) {
...
func (c VolumesClient) PoolChangeThenPoll(ctx context.Context, id VolumeId, input PoolChangeRequest) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after PoolChange: %+v", err)
	}
