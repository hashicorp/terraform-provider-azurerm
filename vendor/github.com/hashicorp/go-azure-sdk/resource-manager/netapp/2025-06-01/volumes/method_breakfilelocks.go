...
type BreakFileLocksOperationResponse struct {
...
// BreakFileLocks ...
func (c VolumesClient) BreakFileLocks(ctx context.Context, id VolumeId, input BreakFileLocksRequest) (result BreakFileLocksOperationResponse, err error) {
...
func (c VolumesClient) BreakFileLocksThenPoll(ctx context.Context, id VolumeId, input BreakFileLocksRequest) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after BreakFileLocks: %+v", err)
	}
