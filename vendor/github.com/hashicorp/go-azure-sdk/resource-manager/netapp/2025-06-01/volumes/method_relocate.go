...
type RelocateOperationResponse struct {
...
// Relocate ...
func (c VolumesClient) Relocate(ctx context.Context, id VolumeId, input RelocateVolumeRequest) (result RelocateOperationResponse, err error) {
...
func (c VolumesClient) RelocateThenPoll(ctx context.Context, id VolumeId, input RelocateVolumeRequest) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after Relocate: %+v", err)
	}
