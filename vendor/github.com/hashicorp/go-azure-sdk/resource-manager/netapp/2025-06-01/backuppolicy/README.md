...
## `github.com/hashicorp/go-azure-sdk/resource-manager/netapp/2025-06-01/backuppolicy` Documentation

The `backuppolicy` SDK allows for interaction with Azure Resource Manager `netapp` (API Version `2025-06-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/netapp/2025-06-01/backuppolicy"
```
