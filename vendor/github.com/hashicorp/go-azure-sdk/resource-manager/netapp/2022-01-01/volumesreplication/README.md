...
## `github.com/hashicorp/go-azure-sdk/resource-manager/netapp/2022-01-01/volumesreplication` Documentation

The `volumesreplication` SDK allows for interaction with the Azure Resource Manager Service `netapp` (API Version `2022-01-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/netapp/2022-01-01/volumesreplication"
```
