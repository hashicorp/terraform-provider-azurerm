...
type BackupsUnderVolumeMigrateBackupsOperationResponse struct {
	Poller       pollers.Poller
	HttpResponse *http.Response
	OData        *odata.OData
}

// BackupsUnderVolumeMigrateBackups ...
func (c VolumesClient) BackupsUnderVolumeMigrateBackups(ctx context.Context, id VolumeId, input BackupsMigrationRequest) (result BackupsUnderVolumeMigrateBackupsOperationResponse, err error) {
...
func (c VolumesClient) BackupsUnderVolumeMigrateBackupsThenPoll(ctx context.Context, id VolumeId, input BackupsMigrationRequest) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after BackupsUnderVolumeMigrateBackups: %+v", err)
	}
