...
type RevertRelocationOperationResponse struct {
...
// RevertRelocation ...
func (c VolumesClient) RevertRelocation(ctx context.Context, id VolumeId) (result RevertRelocationOperationResponse, err error) {
...
func (c VolumesClient) RevertRelocationThenPoll(ctx context.Context, id VolumeId) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after RevertRelocation: %+v", err)
	}
