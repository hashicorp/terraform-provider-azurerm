...
type BreakReplicationOperationResponse struct {
...
// BreakReplication ...
func (c VolumesClient) BreakReplication(ctx context.Context, id VolumeId, input BreakReplicationRequest) (result BreakReplicationOperationResponse, err error) {
...
func (c VolumesClient) BreakReplicationCallbackThenPoll(ctx context.Context, id VolumeId, input BreakReplicationRequest, callback func() error) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after BreakReplication: %+v", err)
	}
