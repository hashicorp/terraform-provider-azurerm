...
type SplitCloneFromParentOperationResponse struct {
...
func (c VolumesClient) SplitCloneFromParent(ctx context.Context, id VolumeId) (result SplitCloneFromParentOperationResponse, err error) {
...
func (c VolumesClient) SplitCloneFromParentThenPoll(ctx context.Context, id VolumeId) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after SplitCloneFromParent: %+v", err)
	}
