...
type VolumeProperties struct {
	AcceptGrowCapacityPoolForShortTermCloneSplit *AcceptGrowCapacityPoolForShortTermCloneSplit `json:"acceptGrowCapacityPoolForShortTermCloneSplit,omitempty"`
	...
	BreakthroughMode                             *BreakthroughMode                             `json:"breakthroughMode,omitempty"`
	...
	InheritedSizeInBytes                         *int64                                        `json:"inheritedSizeInBytes,omitempty"`
