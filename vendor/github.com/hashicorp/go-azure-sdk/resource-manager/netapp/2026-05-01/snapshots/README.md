...
## `github.com/hashicorp/go-azure-sdk/resource-manager/netapp/2026-05-01/snapshots` Documentation

The `snapshots` SDK allows for interaction with Azure Resource Manager `netapp` (API Version `2026-05-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/netapp/2026-05-01/snapshots"
```
