...
type ResetCifsPasswordOperationResponse struct {
...
// ResetCifsPassword ...
func (c VolumesClient) ResetCifsPassword(ctx context.Context, id VolumeId) (result ResetCifsPasswordOperationResponse, err error) {
...
func (c VolumesClient) ResetCifsPasswordCallbackThenPoll(ctx context.Context, id VolumeId, callback func() error) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after ResetCifsPassword: %+v", err)
	}
