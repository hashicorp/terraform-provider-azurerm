...
func PossibleValuesForAcceptGrowCapacityPoolForShortTermCloneSplit() []string {
	return []string{
		string(AcceptGrowCapacityPoolForShortTermCloneSplitAccepted),
		string(AcceptGrowCapacityPoolForShortTermCloneSplitDeclined),
	}
}

func (s *AcceptGrowCapacityPoolForShortTermCloneSplit) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseAcceptGrowCapacityPoolForShortTermCloneSplit(decoded)
	if err != nil {
...
func parseAcceptGrowCapacityPoolForShortTermCloneSplit(input string) (*AcceptGrowCapacityPoolForShortTermCloneSplit, error) {
	vals := map[string]AcceptGrowCapacityPoolForShortTermCloneSplit{
		"accepted": AcceptGrowCapacityPoolForShortTermCloneSplitAccepted,
		"declined": AcceptGrowCapacityPoolForShortTermCloneSplitDeclined,
	}
	...
	out := AcceptGrowCapacityPoolForShortTermCloneSplit(input)
	return &out, nil
}
...
func PossibleValuesForActualRansomwareProtectionState() []string {
	return []string{
		string(ActualRansomwareProtectionStateDisabled),
		string(ActualRansomwareProtectionStateEnabled),
		string(ActualRansomwareProtectionStateLearning),
		string(ActualRansomwareProtectionStatePaused),
	}
}

func (s *ActualRansomwareProtectionState) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseActualRansomwareProtectionState(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseActualRansomwareProtectionState(input string) (*ActualRansomwareProtectionState, error) {
	vals := map[string]ActualRansomwareProtectionState{
		"disabled": ActualRansomwareProtectionStateDisabled,
		"enabled":  ActualRansomwareProtectionStateEnabled,
		"learning": ActualRansomwareProtectionStateLearning,
		"paused":   ActualRansomwareProtectionStatePaused,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := ActualRansomwareProtectionState(input)
	return &out, nil
}
...
func PossibleValuesForBreakthroughMode() []string {
	return []string{
		string(BreakthroughModeDisabled),
		string(BreakthroughModeEnabled),
	}
}

func (s *BreakthroughMode) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseBreakthroughMode(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseBreakthroughMode(input string) (*BreakthroughMode, error) {
	vals := map[string]BreakthroughMode{
		"disabled": BreakthroughModeDisabled,
		"enabled":  BreakthroughModeEnabled,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
...
func PossibleValuesForDesiredRansomwareProtectionState() []string {
	return []string{
		string(DesiredRansomwareProtectionStateDisabled),
		string(DesiredRansomwareProtectionStateEnabled),
	}
}

func (s *DesiredRansomwareProtectionState) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseDesiredRansomwareProtectionState(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseDesiredRansomwareProtectionState(input string) (*DesiredRansomwareProtectionState, error) {
	vals := map[string]DesiredRansomwareProtectionState{
		"disabled": DesiredRansomwareProtectionStateDisabled,
		"enabled":  DesiredRansomwareProtectionStateEnabled,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := DesiredRansomwareProtectionState(input)
	return &out, nil
}
...
func PossibleValuesForExclude() []string {
	return []string{
...
func (s *Exclude) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseExclude(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseExclude(input string) (*Exclude, error) {
	vals := map[string]Exclude{
...
func PossibleValuesForExternalReplicationSetupStatus() []string {
	return []string{
		string(ExternalReplicationSetupStatusClusterPeerPending),
		string(ExternalReplicationSetupStatusClusterPeerRequired),
		string(ExternalReplicationSetupStatusNoActionRequired),
		string(ExternalReplicationSetupStatusReplicationCreateRequired),
		string(ExternalReplicationSetupStatusVServerPeerRequired),
	}
}

func (s *ExternalReplicationSetupStatus) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseExternalReplicationSetupStatus(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseExternalReplicationSetupStatus(input string) (*ExternalReplicationSetupStatus, error) {
	vals := map[string]ExternalReplicationSetupStatus{
		"clusterpeerpending":        ExternalReplicationSetupStatusClusterPeerPending,
		"clusterpeerrequired":       ExternalReplicationSetupStatusClusterPeerRequired,
		"noactionrequired":          ExternalReplicationSetupStatusNoActionRequired,
		"replicationcreaterequired": ExternalReplicationSetupStatusReplicationCreateRequired,
		"vserverpeerrequired":       ExternalReplicationSetupStatusVServerPeerRequired,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := ExternalReplicationSetupStatus(input)
	return &out, nil
}
...
func PossibleValuesForReplicationMirrorState() []string {
	return []string{
		string(ReplicationMirrorStateBroken),
		string(ReplicationMirrorStateMirrored),
		string(ReplicationMirrorStateUninitialized),
	}
}

func (s *ReplicationMirrorState) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseReplicationMirrorState(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseReplicationMirrorState(input string) (*ReplicationMirrorState, error) {
	vals := map[string]ReplicationMirrorState{
		"broken":        ReplicationMirrorStateBroken,
		"mirrored":      ReplicationMirrorStateMirrored,
		"uninitialized": ReplicationMirrorStateUninitialized,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := ReplicationMirrorState(input)
	return &out, nil
}
