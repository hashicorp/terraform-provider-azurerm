...
type FinalizeRelocationOperationResponse struct {
...
// FinalizeRelocation ...
func (c VolumesClient) FinalizeRelocation(ctx context.Context, id VolumeId) (result FinalizeRelocationOperationResponse, err error) {
...
func (c VolumesClient) FinalizeRelocationCallbackThenPoll(ctx context.Context, id VolumeId, callback func() error) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after FinalizeRelocation: %+v", err)
	}
