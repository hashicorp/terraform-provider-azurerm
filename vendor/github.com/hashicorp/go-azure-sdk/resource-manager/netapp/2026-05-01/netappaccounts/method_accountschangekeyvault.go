...
type AccountsChangeKeyVaultOperationResponse struct {
...
func (c NetAppAccountsClient) AccountsChangeKeyVault(ctx context.Context, id NetAppAccountId, input ChangeKeyVault) (result AccountsChangeKeyVaultOperationResponse, err error) {
...
func (c NetAppAccountsClient) AccountsChangeKeyVaultCallbackThenPoll(ctx context.Context, id NetAppAccountId, input ChangeKeyVault, callback func() error) error {
	...
	if err := result.Poller.PollUntilDone(ctx); err != nil {
		return fmt.Errorf("polling after AccountsChangeKeyVault: %+v", err)
	}
