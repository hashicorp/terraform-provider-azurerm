...
## `github.com/hashicorp/go-azure-sdk/resource-manager/netapp/2026-01-01/netappaccounts` Documentation

The `netappaccounts` SDK allows for interaction with Azure Resource Manager `netapp` (API Version `2026-01-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/netapp/2026-01-01/netappaccounts"
```
