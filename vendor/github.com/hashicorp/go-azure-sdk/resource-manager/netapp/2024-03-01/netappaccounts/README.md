...
## `github.com/hashicorp/go-azure-sdk/resource-manager/netapp/2024-03-01/netappaccounts` Documentation

The `netappaccounts` SDK allows for interaction with the Azure Resource Manager Service `netapp` (API Version `2024-03-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/netapp/2024-03-01/netappaccounts"
```
