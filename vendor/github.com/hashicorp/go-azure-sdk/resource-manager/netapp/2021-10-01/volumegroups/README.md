...
## `github.com/hashicorp/go-azure-sdk/resource-manager/netapp/2021-10-01/volumegroups` Documentation

The `volumegroups` SDK allows for interaction with the Azure Resource Manager Service `netapp` (API Version `2021-10-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/netapp/2021-10-01/volumegroups"
```
