...
func (c FleetsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id FleetId, input Fleet, options CreateOrUpdateOperationOptions, callback func() error) error {
