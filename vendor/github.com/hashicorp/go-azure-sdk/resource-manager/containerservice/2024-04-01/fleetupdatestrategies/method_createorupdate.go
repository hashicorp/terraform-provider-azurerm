...
func (c FleetUpdateStrategiesClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id UpdateStrategyId, input FleetUpdateStrategy, options CreateOrUpdateOperationOptions, callback func() error) error {
