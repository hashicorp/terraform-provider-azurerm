...
func (c UpdateRunsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id UpdateRunId, input UpdateRun, options CreateOrUpdateOperationOptions, callback func() error) error {
