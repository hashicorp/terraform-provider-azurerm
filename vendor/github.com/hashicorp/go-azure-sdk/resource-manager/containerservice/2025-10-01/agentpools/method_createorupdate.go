...
func (c AgentPoolsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id AgentPoolId, input AgentPool, options CreateOrUpdateOperationOptions, callback func() error) error {
