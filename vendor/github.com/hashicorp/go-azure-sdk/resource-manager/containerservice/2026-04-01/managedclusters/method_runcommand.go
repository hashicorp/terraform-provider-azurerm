...
func (c ManagedClustersClient) RunCommandCallbackThenPoll(ctx context.Context, id commonids.KubernetesClusterId, input RunCommandRequest, callback func() error) error {
