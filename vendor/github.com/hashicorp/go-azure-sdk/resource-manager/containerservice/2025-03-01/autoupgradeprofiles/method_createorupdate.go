...
// CreateOrUpdate ...
func (c AutoUpgradeProfilesClient) CreateOrUpdate(ctx context.Context, id AutoUpgradeProfileId, input AutoUpgradeProfile, options CreateOrUpdateOperationOptions) (result CreateOrUpdateOperationResponse, err error) {
