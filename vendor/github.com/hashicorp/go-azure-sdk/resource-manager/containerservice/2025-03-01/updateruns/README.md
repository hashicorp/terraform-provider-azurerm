...
// alternatively `client.ListByFleet(ctx, id, updateruns.DefaultListByFleetOperationOptions())` can be used to do batched pagination
items, err := client.ListByFleetComplete(ctx, id, updateruns.DefaultListByFleetOperationOptions())
if err != nil {
	// handle the error
}
