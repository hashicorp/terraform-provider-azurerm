...
func PossibleValuesForAccelerationMode() []string {
	return []string{
		string(AccelerationModeBpfVeth),
		string(AccelerationModeNone),
	}
}

func (s *AccelerationMode) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseAccelerationMode(decoded)
	if err != nil {
...
func parseAccelerationMode(input string) (*AccelerationMode, error) {
	vals := map[string]AccelerationMode{
		"bpfveth": AccelerationModeBpfVeth,
		"none":    AccelerationModeNone,
	}
...
func PossibleValuesForGatewayAPIIstioEnabled() []string {
	return []string{
		string(GatewayAPIIstioEnabledDisabled),
		string(GatewayAPIIstioEnabledEnabled),
	}
}

func (s *GatewayAPIIstioEnabled) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseGatewayAPIIstioEnabled(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseGatewayAPIIstioEnabled(input string) (*GatewayAPIIstioEnabled, error) {
	vals := map[string]GatewayAPIIstioEnabled{
		"disabled": GatewayAPIIstioEnabledDisabled,
		"enabled":  GatewayAPIIstioEnabledEnabled,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := GatewayAPIIstioEnabled(input)
	return &out, nil
}
...
func PossibleValuesForManagedGatewayType() []string {
	return []string{
		string(ManagedGatewayTypeDisabled),
		string(ManagedGatewayTypeStandard),
	}
}

func (s *ManagedGatewayType) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseManagedGatewayType(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseManagedGatewayType(input string) (*ManagedGatewayType, error) {
	vals := map[string]ManagedGatewayType{
		"disabled": ManagedGatewayTypeDisabled,
		"standard": ManagedGatewayTypeStandard,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
...
func PossibleValuesForNodeProvisioningDefaultNodePools() []string {
	return []string{
		string(NodeProvisioningDefaultNodePoolsAuto),
		string(NodeProvisioningDefaultNodePoolsNone),
	}
}

func (s *NodeProvisioningDefaultNodePools) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseNodeProvisioningDefaultNodePools(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseNodeProvisioningDefaultNodePools(input string) (*NodeProvisioningDefaultNodePools, error) {
	vals := map[string]NodeProvisioningDefaultNodePools{
		"auto": NodeProvisioningDefaultNodePoolsAuto,
		"none": NodeProvisioningDefaultNodePoolsNone,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := NodeProvisioningDefaultNodePools(input)
	return &out, nil
}
...
func PossibleValuesForProxyRedirectionMechanism() []string {
	return []string{
		string(ProxyRedirectionMechanismCNIChaining),
		string(ProxyRedirectionMechanismInitContainers),
	}
}

func (s *ProxyRedirectionMechanism) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseProxyRedirectionMechanism(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseProxyRedirectionMechanism(input string) (*ProxyRedirectionMechanism, error) {
	vals := map[string]ProxyRedirectionMechanism{
		"cnichaining":    ProxyRedirectionMechanismCNIChaining,
		"initcontainers": ProxyRedirectionMechanismInitContainers,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := ProxyRedirectionMechanism(input)
	return &out, nil
}
...
func PossibleValuesForSchedulerConfigMode() []string {
	return []string{
		string(SchedulerConfigModeDefault),
		string(SchedulerConfigModeManagedByCRD),
	}
}

func (s *SchedulerConfigMode) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseSchedulerConfigMode(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseSchedulerConfigMode(input string) (*SchedulerConfigMode, error) {
	vals := map[string]SchedulerConfigMode{
		"default":      SchedulerConfigModeDefault,
		"managedbycrd": SchedulerConfigModeManagedByCRD,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
...
func PossibleValuesForTransitEncryptionType() []string {
	return []string{
		string(TransitEncryptionTypeNone),
		string(TransitEncryptionTypeWireGuard),
	}
}

func (s *TransitEncryptionType) UnmarshalJSON(bytes []byte) error {
	var decoded string
	if err := json.Unmarshal(bytes, &decoded); err != nil {
		return fmt.Errorf("unmarshaling: %+v", err)
	}
	out, err := parseTransitEncryptionType(decoded)
	if err != nil {
		return fmt.Errorf("parsing %q: %+v", decoded, err)
	}
	*s = *out
...
func parseTransitEncryptionType(input string) (*TransitEncryptionType, error) {
	vals := map[string]TransitEncryptionType{
		"none":      TransitEncryptionTypeNone,
		"wireguard": TransitEncryptionTypeWireGuard,
	}
	if v, ok := vals[strings.ToLower(input)]; ok {
		return &v, nil
	}
	...
	// otherwise presume it's an undefined value and best-effort it
	out := TransitEncryptionType(input)
	return &out, nil
}
