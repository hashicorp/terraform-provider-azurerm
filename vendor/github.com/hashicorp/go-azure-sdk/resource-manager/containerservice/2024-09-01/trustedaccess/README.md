...
## `github.com/hashicorp/go-azure-sdk/resource-manager/containerservice/2024-09-01/trustedaccess` Documentation

The `trustedaccess` SDK allows for interaction with Azure Resource Manager `containerservice` (API Version `2024-09-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/containerservice/2024-09-01/trustedaccess"
```
