...
type GuardrailsAvailableVersionOperationPredicate struct {
	Id   *string
	Name *string
	Type *string
}

func (p GuardrailsAvailableVersionOperationPredicate) Matches(input GuardrailsAvailableVersion) bool {
