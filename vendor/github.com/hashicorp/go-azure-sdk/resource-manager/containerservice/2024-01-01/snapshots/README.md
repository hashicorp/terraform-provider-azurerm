...
## `github.com/hashicorp/go-azure-sdk/resource-manager/containerservice/2024-01-01/snapshots` Documentation

The `snapshots` SDK allows for interaction with the Azure Resource Manager Service `containerservice` (API Version `2024-01-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/containerservice/2024-01-01/snapshots"
```
