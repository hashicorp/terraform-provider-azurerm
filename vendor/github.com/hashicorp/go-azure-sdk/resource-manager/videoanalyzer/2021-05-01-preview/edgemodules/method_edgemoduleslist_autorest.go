...
// EdgeModulesList ...
func (c EdgeModulesClient) EdgeModulesList(ctx context.Context, id VideoAnalyzerId, options EdgeModulesListOperationOptions) (resp EdgeModulesListOperationResponse, err error) {
	req, err := c.preparerForEdgeModulesList(ctx, id, options)
	if err != nil {
		err = autorest.NewErrorWithError(err, "edgemodules.EdgeModulesClient", "EdgeModulesList", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "edgemodules.EdgeModulesClient", "EdgeModulesList", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForEdgeModulesList(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "edgemodules.EdgeModulesClient", "EdgeModulesList", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c EdgeModulesClient) preparerForEdgeModulesList(ctx context.Context, id VideoAnalyzerId, options EdgeModulesListOperationOptions) (*http.Request, error) {
...
func (c EdgeModulesClient) preparerForEdgeModulesListWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c EdgeModulesClient) responderForEdgeModulesList(resp *http.Response) (result EdgeModulesListOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result EdgeModulesListOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "edgemodules.EdgeModulesClient", "EdgeModulesList", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForEdgeModulesList(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "edgemodules.EdgeModulesClient", "EdgeModulesList", result.HttpResponse, "Failure responding to request")
				return
			}
...
func (c EdgeModulesClient) EdgeModulesListCompleteMatchingPredicate(ctx context.Context, id VideoAnalyzerId, options EdgeModulesListOperationOptions, predicate EdgeModuleEntityOperationPredicate) (resp EdgeModulesListCompleteResult, err error) {
