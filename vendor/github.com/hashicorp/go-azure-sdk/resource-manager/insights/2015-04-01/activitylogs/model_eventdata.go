...
type EventData struct {
	...
	Category             *MicrosoftCommonLocalizableString `json:"category,omitempty"`
	Claims               *map[string]string                `json:"claims,omitempty"`
	CorrelationId        *string                           `json:"correlationId,omitempty"`
	Description          *string                           `json:"description,omitempty"`
	EventDataId          *string                           `json:"eventDataId,omitempty"`
	EventName            *MicrosoftCommonLocalizableString `json:"eventName,omitempty"`
	EventTimestamp       *string                           `json:"eventTimestamp,omitempty"`
	HTTPRequest          *HTTPRequestInfo                  `json:"httpRequest,omitempty"`
	Id                   *string                           `json:"id,omitempty"`
	Level                *EventLevel                       `json:"level,omitempty"`
	OperationId          *string                           `json:"operationId,omitempty"`
	OperationName        *MicrosoftCommonLocalizableString `json:"operationName,omitempty"`
	Properties           *map[string]string                `json:"properties,omitempty"`
	ResourceGroupName    *string                           `json:"resourceGroupName,omitempty"`
	ResourceId           *string                           `json:"resourceId,omitempty"`
	ResourceProviderName *MicrosoftCommonLocalizableString `json:"resourceProviderName,omitempty"`
	ResourceType         *MicrosoftCommonLocalizableString `json:"resourceType,omitempty"`
	Status               *MicrosoftCommonLocalizableString `json:"status,omitempty"`
	SubStatus            *MicrosoftCommonLocalizableString `json:"subStatus,omitempty"`
