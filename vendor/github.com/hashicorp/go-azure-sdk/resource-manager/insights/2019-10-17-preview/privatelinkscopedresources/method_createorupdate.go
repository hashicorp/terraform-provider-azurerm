...
func (c PrivateLinkScopedResourcesClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id ScopedResourceId, input ScopedResource, callback func() error) error {
