...
func (c ConfigurationAssignmentsClient) Get(ctx context.Context, id ScopedConfigurationAssignmentId) (result GetOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "configurationassignments.ConfigurationAssignmentsClient", "Get", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForGet(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "configurationassignments.ConfigurationAssignmentsClient", "Get", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c ConfigurationAssignmentsClient) responderForGet(resp *http.Response) (result GetOperationResponse, err error) {
