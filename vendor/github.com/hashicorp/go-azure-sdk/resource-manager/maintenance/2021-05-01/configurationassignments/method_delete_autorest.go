...
func (c ConfigurationAssignmentsClient) Delete(ctx context.Context, id ConfigurationAssignmentId) (result DeleteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "configurationassignments.ConfigurationAssignmentsClient", "Delete", result.HttpResponse, "Failure sending request")
		return
	}

	result, err = c.responderForDelete(result.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "configurationassignments.ConfigurationAssignmentsClient", "Delete", result.HttpResponse, "Failure responding to request")
		return
	}
...
func (c ConfigurationAssignmentsClient) responderForDelete(resp *http.Response) (result DeleteOperationResponse, err error) {
