...
func (c CloudEndpointResourceClient) CloudEndpointsPostBackupThenPoll(ctx context.Context, id CloudEndpointId, input BackupRequest) error {
	return c.CloudEndpointsPostBackupCallbackThenPoll(ctx, id, input, nil)
}

// CloudEndpointsPostBackupCallbackThenPoll performs CloudEndpointsPostBackup, runs the optional callback function, then polls until it's completed
func (c CloudEndpointResourceClient) CloudEndpointsPostBackupCallbackThenPoll(ctx context.Context, id CloudEndpointId, input BackupRequest, callback func() error) error {
