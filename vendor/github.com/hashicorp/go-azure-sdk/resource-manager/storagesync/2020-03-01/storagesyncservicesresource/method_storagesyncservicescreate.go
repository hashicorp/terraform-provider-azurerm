...
func (c StorageSyncServicesResourceClient) StorageSyncServicesCreateThenPoll(ctx context.Context, id StorageSyncServiceId, input StorageSyncServiceCreateParameters) error {
	return c.StorageSyncServicesCreateCallbackThenPoll(ctx, id, input, nil)
}

// StorageSyncServicesCreateCallbackThenPoll performs StorageSyncServicesCreate, runs the optional callback function, then polls until it's completed
func (c StorageSyncServicesResourceClient) StorageSyncServicesCreateCallbackThenPoll(ctx context.Context, id StorageSyncServiceId, input StorageSyncServiceCreateParameters, callback func() error) error {
