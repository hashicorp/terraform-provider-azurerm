...
## `github.com/hashicorp/go-azure-sdk/resource-manager/desktopvirtualization/2025-10-10/hostpool` Documentation

The `hostpool` SDK allows for interaction with Azure Resource Manager `desktopvirtualization` (API Version `2025-10-10`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/desktopvirtualization/2025-10-10/hostpool"
```
