...
func (o *ExpandMsixImageProperties) GetCertificateExpiryAsTime() (*time.Time, error) {
...
func (o *ExpandMsixImageProperties) SetCertificateExpiryAsTime(input time.Time) {
