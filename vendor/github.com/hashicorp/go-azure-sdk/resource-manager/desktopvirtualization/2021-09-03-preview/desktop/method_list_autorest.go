...
// List ...
func (c DesktopClient) List(ctx context.Context, id ApplicationGroupId) (resp ListOperationResponse, err error) {
...
func (c DesktopClient) preparerForList(ctx context.Context, id ApplicationGroupId) (*http.Request, error) {
