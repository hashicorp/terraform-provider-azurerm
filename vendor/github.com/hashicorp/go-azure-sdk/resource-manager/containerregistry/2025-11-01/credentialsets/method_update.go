...
func (c CredentialSetsClient) UpdateCallbackThenPoll(ctx context.Context, id CredentialSetId, input CredentialSetUpdateParameters, callback func() error) error {
