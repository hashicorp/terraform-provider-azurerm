...
## `github.com/hashicorp/go-azure-sdk/resource-manager/containerregistry/2025-11-01/cacherules` Documentation

The `cacherules` SDK allows for interaction with Azure Resource Manager `containerregistry` (API Version `2025-11-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/containerregistry/2025-11-01/cacherules"
```
