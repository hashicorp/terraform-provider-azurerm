...
func (c ConnectedRegistriesClient) UpdateCallbackThenPoll(ctx context.Context, id ConnectedRegistryId, input ConnectedRegistryUpdateParameters, callback func() error) error {
