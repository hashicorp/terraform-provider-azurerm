...
## `github.com/hashicorp/go-azure-sdk/resource-manager/containerregistry/2025-11-01/replications` Documentation

The `replications` SDK allows for interaction with Azure Resource Manager `containerregistry` (API Version `2025-11-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/containerregistry/2025-11-01/replications"
```
