...
type RegistryProperties struct {
	...
	NetworkRuleBypassAllowedForTasks *bool                        `json:"networkRuleBypassAllowedForTasks,omitempty"`
	...
	RoleAssignmentMode               *RoleAssignmentMode          `json:"roleAssignmentMode,omitempty"`
