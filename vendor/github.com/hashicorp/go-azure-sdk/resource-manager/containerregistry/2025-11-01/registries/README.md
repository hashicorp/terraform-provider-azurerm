...
## `github.com/hashicorp/go-azure-sdk/resource-manager/containerregistry/2025-11-01/registries` Documentation

The `registries` SDK allows for interaction with Azure Resource Manager `containerregistry` (API Version `2025-11-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/containerregistry/2025-11-01/registries"
```
...
### Example Usage: `RegistriesClient.CheckNameAvailability`

```go
ctx := context.TODO()
id := commonids.NewSubscriptionID("12345678-1234-9876-4563-123456789012")

payload := registries.RegistryNameCheckRequest{
	// ...
}
