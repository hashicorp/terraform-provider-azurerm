...
## `github.com/hashicorp/go-azure-sdk/resource-manager/containerregistry/2025-04-01/registries` Documentation

The `registries` SDK allows for interaction with Azure Resource Manager `containerregistry` (API Version `2025-04-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/containerregistry/2025-04-01/registries"
```
