...
## `github.com/hashicorp/go-azure-sdk/resource-manager/operationalinsights/2025-07-01/workspaces` Documentation

The `workspaces` SDK allows for interaction with Azure Resource Manager `operationalinsights` (API Version `2025-07-01`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/operationalinsights/2025-07-01/workspaces"
```
...
// alternatively `client.ManagementGroupsList(ctx, id)` can be used to do batched pagination
items, err := client.ManagementGroupsListComplete(ctx, id)
if err != nil {
	// handle the error
}
for _, item := range items {
