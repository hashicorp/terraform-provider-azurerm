...
func (c WorkspacesClient) UsagesListComplete(ctx context.Context, id WorkspaceId) (UsagesListCompleteResult, error) {
	return c.UsagesListCompleteMatchingPredicate(ctx, id, UsageMetricOperationPredicate{})
}

// UsagesListCompleteMatchingPredicate retrieves all the results and then applies the predicate
func (c WorkspacesClient) UsagesListCompleteMatchingPredicate(ctx context.Context, id WorkspaceId, predicate UsageMetricOperationPredicate) (result UsagesListCompleteResult, err error) {
	items := make([]UsageMetric, 0)
