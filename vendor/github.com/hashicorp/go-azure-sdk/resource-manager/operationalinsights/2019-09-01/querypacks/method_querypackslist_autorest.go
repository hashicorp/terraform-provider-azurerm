...
// QueryPacksList ...
func (c QueryPacksClient) QueryPacksList(ctx context.Context, id commonids.SubscriptionId) (resp QueryPacksListOperationResponse, err error) {
	req, err := c.preparerForQueryPacksList(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "querypacks.QueryPacksClient", "QueryPacksList", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "querypacks.QueryPacksClient", "QueryPacksList", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForQueryPacksList(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "querypacks.QueryPacksClient", "QueryPacksList", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c QueryPacksClient) preparerForQueryPacksList(ctx context.Context, id commonids.SubscriptionId) (*http.Request, error) {
...
func (c QueryPacksClient) preparerForQueryPacksListWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c QueryPacksClient) responderForQueryPacksList(resp *http.Response) (result QueryPacksListOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result QueryPacksListOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "querypacks.QueryPacksClient", "QueryPacksList", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForQueryPacksList(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "querypacks.QueryPacksClient", "QueryPacksList", result.HttpResponse, "Failure responding to request")
				return
			}
