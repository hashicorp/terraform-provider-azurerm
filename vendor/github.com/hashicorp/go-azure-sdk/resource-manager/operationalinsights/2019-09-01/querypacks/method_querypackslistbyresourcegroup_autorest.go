...
func (c QueryPacksClient) QueryPacksListByResourceGroup(ctx context.Context, id commonids.ResourceGroupId) (resp QueryPacksListByResourceGroupOperationResponse, err error) {
	req, err := c.preparerForQueryPacksListByResourceGroup(ctx, id)
	if err != nil {
		err = autorest.NewErrorWithError(err, "querypacks.QueryPacksClient", "QueryPacksListByResourceGroup", nil, "Failure preparing request")
		return
	}

	resp.HttpResponse, err = c.Client.Send(req, azure.DoRetryWithRegistration(c.Client))
	if err != nil {
		err = autorest.NewErrorWithError(err, "querypacks.QueryPacksClient", "QueryPacksListByResourceGroup", resp.HttpResponse, "Failure sending request")
		return
	}

	resp, err = c.responderForQueryPacksListByResourceGroup(resp.HttpResponse)
	if err != nil {
		err = autorest.NewErrorWithError(err, "querypacks.QueryPacksClient", "QueryPacksListByResourceGroup", resp.HttpResponse, "Failure responding to request")
		return
	}
	return
}
...
func (c QueryPacksClient) preparerForQueryPacksListByResourceGroup(ctx context.Context, id commonids.ResourceGroupId) (*http.Request, error) {
...
func (c QueryPacksClient) preparerForQueryPacksListByResourceGroupWithNextLink(ctx context.Context, nextLink string) (*http.Request, error) {
...
func (c QueryPacksClient) responderForQueryPacksListByResourceGroup(resp *http.Response) (result QueryPacksListByResourceGroupOperationResponse, err error) {
	type page struct {
	...
	if respObj.NextLink != nil {
		result.nextPageFunc = func(ctx context.Context, nextLink string) (result QueryPacksListByResourceGroupOperationResponse, err error) {
			...
			if err != nil {
				err = autorest.NewErrorWithError(err, "querypacks.QueryPacksClient", "QueryPacksListByResourceGroup", result.HttpResponse, "Failure sending request")
				return
			}

			result, err = c.responderForQueryPacksListByResourceGroup(result.HttpResponse)
			if err != nil {
				err = autorest.NewErrorWithError(err, "querypacks.QueryPacksClient", "QueryPacksListByResourceGroup", result.HttpResponse, "Failure responding to request")
				return
			}
