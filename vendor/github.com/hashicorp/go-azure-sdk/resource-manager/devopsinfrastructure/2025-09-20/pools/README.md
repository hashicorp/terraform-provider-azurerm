...
## `github.com/hashicorp/go-azure-sdk/resource-manager/devopsinfrastructure/2025-09-20/pools` Documentation

The `pools` SDK allows for interaction with Azure Resource Manager `devopsinfrastructure` (API Version `2025-09-20`).
...
import "github.com/hashicorp/go-azure-sdk/resource-manager/devopsinfrastructure/2025-09-20/pools"
```
...
### Example Usage: `PoolsClient.DeleteResources`

```go
ctx := context.TODO()
id := pools.NewPoolID("12345678-1234-9876-4563-123456789012", "example-resource-group", "poolName")

payload := pools.DeleteResourcesDetails{
	// ...
}


read, err := client.DeleteResources(ctx, id, payload)
if err != nil {
	// handle the error
}
if model := read.Model; model != nil {
