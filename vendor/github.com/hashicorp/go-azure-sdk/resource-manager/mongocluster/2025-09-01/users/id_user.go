...
func NewUserID(subscriptionId string, resourceGroupName string, mongoClusterName string, userName string) UserId {
	return UserId{
...
func (id UserId) ID() string {
	fmtString := "/subscriptions/%s/resourceGroups/%s/providers/Microsoft.DocumentDB/mongoClusters/%s/users/%s"
	return fmt.Sprintf(fmtString, id.SubscriptionId, id.ResourceGroupName, id.MongoClusterName, id.UserName)
}
