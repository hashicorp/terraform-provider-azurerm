...
func (c AccountClient) Create(ctx context.Context, id AccountId, input Account) (result CreateOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "account.AccountClient", "Create", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForCreate(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "account.AccountClient", "Create", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c AccountClient) preparerForCreate(ctx context.Context, id AccountId, input Account) (*http.Request, error) {
...
func (c AccountClient) senderForCreate(ctx context.Context, req *http.Request) (future CreateOperationResponse, err error) {
