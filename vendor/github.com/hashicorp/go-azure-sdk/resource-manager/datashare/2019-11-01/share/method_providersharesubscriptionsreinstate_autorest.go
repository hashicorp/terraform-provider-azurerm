...
func (c ShareClient) ProviderShareSubscriptionsReinstate(ctx context.Context, id ProviderShareSubscriptionId) (result ProviderShareSubscriptionsReinstateOperationResponse, err error) {
	req, err := c.preparerForProviderShareSubscriptionsReinstate(ctx, id)
	if err != nil {
...
func (c ShareClient) preparerForProviderShareSubscriptionsReinstate(ctx context.Context, id ProviderShareSubscriptionId) (*http.Request, error) {
