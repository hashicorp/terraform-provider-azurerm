...
func (c ResourceClient) ServicesDelete(ctx context.Context, id ServiceId) (result ServicesDeleteOperationResponse, err error) {
	...
	if err != nil {
		err = autorest.NewErrorWithError(err, "resource.ResourceClient", "ServicesDelete", nil, "Failure preparing request")
		return
	}

	result, err = c.senderForServicesDelete(ctx, req)
	if err != nil {
		err = autorest.NewErrorWithError(err, "resource.ResourceClient", "ServicesDelete", result.HttpResponse, "Failure sending request")
		return
	}
...
func (c ResourceClient) preparerForServicesDelete(ctx context.Context, id ServiceId) (*http.Request, error) {
...
func (c ResourceClient) senderForServicesDelete(ctx context.Context, req *http.Request) (future ServicesDeleteOperationResponse, err error) {
