...
// ListByWorkspace ...
func (c IotConnectorsClient) ListByWorkspace(ctx context.Context, id WorkspaceId) (resp ListByWorkspaceOperationResponse, err error) {
...
func (c IotConnectorsClient) responderForListByWorkspace(resp *http.Response) (result ListByWorkspaceOperationResponse, err error) {
	type page struct {
