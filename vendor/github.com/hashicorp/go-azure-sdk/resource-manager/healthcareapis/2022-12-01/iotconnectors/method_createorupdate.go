...
// CreateOrUpdate ...
func (c IotConnectorsClient) CreateOrUpdate(ctx context.Context, id IotConnectorId, input IotConnector) (result CreateOrUpdateOperationResponse, err error) {
...
func (c IotConnectorsClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id IotConnectorId, input IotConnector, callback func() error) error {
