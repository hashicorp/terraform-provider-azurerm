...
## `github.com/hashicorp/go-azure-sdk/resource-manager/healthcareapis/2021-11-01/iotconnectors` Documentation

The `iotconnectors` SDK allows for interaction with the Azure Resource Manager Service `healthcareapis` (API Version `2021-11-01`).
...
```go
import "github.com/hashicorp/go-azure-sdk/resource-manager/healthcareapis/2021-11-01/iotconnectors"
```
