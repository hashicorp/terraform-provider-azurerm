...
func (c CommunicationServicesClient) CreateOrUpdateCallbackThenPoll(ctx context.Context, id CommunicationServiceId, input CommunicationServiceResource, callback func() error) error {
