...
// Update ...
func (c DomainsClient) Update(ctx context.Context, id DomainId, input UpdateDomainRequestParameters) (result UpdateOperationResponse, err error) {
...
func (c DomainsClient) UpdateCallbackThenPoll(ctx context.Context, id DomainId, input UpdateDomainRequestParameters, callback func() error) error {
