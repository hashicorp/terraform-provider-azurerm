...
func (c CommunicationServiceClient) preparerForCheckNameAvailability(ctx context.Context, id commonids.SubscriptionId, input NameAvailabilityParameters) (*http.Request, error) {
...
func (c CommunicationServiceClient) responderForCheckNameAvailability(resp *http.Response) (result CheckNameAvailabilityOperationResponse, err error) {
