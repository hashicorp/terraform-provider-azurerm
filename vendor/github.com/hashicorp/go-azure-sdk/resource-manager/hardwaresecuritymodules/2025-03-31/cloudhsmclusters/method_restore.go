...
// Restore ...
func (c CloudHsmClustersClient) Restore(ctx context.Context, id CloudHsmClusterId, input RestoreRequestProperties) (result RestoreOperationResponse, err error) {
...
func (c CloudHsmClustersClient) RestoreThenPoll(ctx context.Context, id CloudHsmClusterId, input RestoreRequestProperties) error {
