...
var _ validator.Map = valueInt32sAreValidator{}
...
func (v valueInt32sAreValidator) ValidateMap(ctx context.Context, req validator.MapRequest, resp *validator.MapResponse) {
