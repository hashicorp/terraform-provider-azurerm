...
var _ validator.Map = valueInt64sAreValidator{}
...
func (v valueInt64sAreValidator) ValidateMap(ctx context.Context, req validator.MapRequest, resp *validator.MapResponse) {
