...
/*
// parseAzureResourceID converts a long-form cosmos path
// into a ResourceID. We make assumptions about the structure of URLs,
// which is obviously not good, but the best thing available given the API.
func ParseCosmosPath(ID string) (*CosmosPath, error) {
