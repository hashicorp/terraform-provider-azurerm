...
* `azurerm_sentinel_alert_rule_scheduled` - increase combined limit of `entity_mapping` and `sentinel_entity_mapping` to 10 ([#28195](https://github.com/hashicorp/terraform-provider-azurerm/issues/28195))
...
* `azurerm_virtual_network_gateway` - updating `ip_configuration` now recreates the resource ([#27828](https://github.com/hashicorp/terraform-provider-azurerm/issues/27828))
